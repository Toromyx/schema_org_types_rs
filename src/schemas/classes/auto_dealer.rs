...
/// This trait is for properties from <https://schema.org/AutoDealer>.
pub trait AutoDealerTrait {}
impl AutoDealerTrait for AutoDealer {}
impl AutomotiveBusinessTrait for AutoDealer {}
impl LocalBusinessTrait for AutoDealer {
...
impl ThingTrait for AutoDealer {
...
mod serde {
	...
	impl Serialize for AutoDealer {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AutoDealer", len)?;
	...
	impl<'de> Deserialize<'de> for AutoDealer {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoDealer;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoDealer")
				}
			...
			deserializer.deserialize_struct("AutoDealer", FIELDS, ClassVisitor)
		}
	}
}
