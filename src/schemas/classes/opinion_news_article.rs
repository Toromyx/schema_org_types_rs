...
/// This trait is for properties from <https://schema.org/OpinionNewsArticle>.
pub trait OpinionNewsArticleTrait {}
impl OpinionNewsArticleTrait for OpinionNewsArticle {}
impl ArticleTrait for OpinionNewsArticle {
...
impl CreativeWorkTrait for OpinionNewsArticle {
...
impl NewsArticleTrait for OpinionNewsArticle {
...
impl ThingTrait for OpinionNewsArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for OpinionNewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OpinionNewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for OpinionNewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OpinionNewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OpinionNewsArticle")
				}
			...
			deserializer.deserialize_struct("OpinionNewsArticle", FIELDS, ClassVisitor)
		}
	}
}
