...
/// This trait is for properties from <https://schema.org/SocialEvent>.
pub trait SocialEventTrait {}
impl SocialEventTrait for SocialEvent {}
impl EventTrait for SocialEvent {
...
impl ThingTrait for SocialEvent {
...
mod serde {
	...
	impl Serialize for SocialEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SocialEvent", len)?;
	...
	impl<'de> Deserialize<'de> for SocialEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SocialEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SocialEvent")
				}
			...
			deserializer.deserialize_struct("SocialEvent", FIELDS, ClassVisitor)
		}
	}
}
