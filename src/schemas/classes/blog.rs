...
pub struct Blog {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "blogPost"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/blogPost"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/blogPost"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "blogPosts"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/blogPosts"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/blogPosts"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
