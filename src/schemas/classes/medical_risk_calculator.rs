...
/// This trait is for properties from <https://schema.org/MedicalRiskCalculator>.
pub trait MedicalRiskCalculatorTrait {}
impl MedicalRiskCalculatorTrait for MedicalRiskCalculator {}
impl MedicalEntityTrait for MedicalRiskCalculator {
...
impl MedicalRiskEstimatorTrait for MedicalRiskCalculator {
...
impl ThingTrait for MedicalRiskCalculator {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalRiskCalculator {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalRiskCalculator", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalRiskCalculator {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalRiskCalculator;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalRiskCalculator")
				}
			...
			deserializer.deserialize_struct("MedicalRiskCalculator", FIELDS, ClassVisitor)
		}
	}
}
