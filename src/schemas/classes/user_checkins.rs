...
/// This trait is for properties from <https://schema.org/UserCheckins>.
pub trait UserCheckinsTrait {}
impl UserCheckinsTrait for UserCheckins {}
impl EventTrait for UserCheckins {
...
impl ThingTrait for UserCheckins {
...
impl UserInteractionTrait for UserCheckins {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for UserCheckins {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserCheckins", len)?;
	...
	impl<'de> Deserialize<'de> for UserCheckins {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserCheckins;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserCheckins")
				}
			...
			deserializer.deserialize_struct("UserCheckins", FIELDS, ClassVisitor)
		}
	}
}
