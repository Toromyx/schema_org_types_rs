...
/// This trait is for properties from <https://schema.org/HowToTip>.
pub trait HowToTipTrait {}
impl HowToTipTrait for HowToTip {}
impl CreativeWorkTrait for HowToTip {
...
impl ListItemTrait for HowToTip {
...
mod serde {
	...
	impl Serialize for HowToTip {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HowToTip", len)?;
	...
	impl<'de> Deserialize<'de> for HowToTip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HowToTip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HowToTip")
				}
			...
			deserializer.deserialize_struct("HowToTip", FIELDS, ClassVisitor)
		}
	}
}
