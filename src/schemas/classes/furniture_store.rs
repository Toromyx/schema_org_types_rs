...
/// This trait is for properties from <https://schema.org/FurnitureStore>.
pub trait FurnitureStoreTrait {}
impl FurnitureStoreTrait for FurnitureStore {}
impl LocalBusinessTrait for FurnitureStore {
...
impl StoreTrait for FurnitureStore {}
impl ThingTrait for FurnitureStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for FurnitureStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FurnitureStore", len)?;
	...
	impl<'de> Deserialize<'de> for FurnitureStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FurnitureStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FurnitureStore")
				}
			...
			deserializer.deserialize_struct("FurnitureStore", FIELDS, ClassVisitor)
		}
	}
}
