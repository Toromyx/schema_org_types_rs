...
/// This trait is for properties from <https://schema.org/OccupationalExperienceRequirements>.
pub trait OccupationalExperienceRequirementsTrait {
	/// Get <https://schema.org/monthsOfExperience> from [`Self`] as borrowed slice.
	fn get_months_of_experience(&self) -> &[MonthsOfExperienceProperty];
	/// Take <https://schema.org/monthsOfExperience> from [`Self`] as owned vector.
...
mod serde {
	...
	use super::*;
	impl Serialize for OccupationalExperienceRequirements {
	...
	impl<'de> Deserialize<'de> for OccupationalExperienceRequirements {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OccupationalExperienceRequirements;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OccupationalExperienceRequirements")
				}
