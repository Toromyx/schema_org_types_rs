...
/// This trait is for properties from <https://schema.org/TaxiService>.
pub trait TaxiServiceTrait {}
impl TaxiServiceTrait for TaxiService {}
impl ServiceTrait for TaxiService {
...
impl ThingTrait for TaxiService {
...
mod serde {
	...
	use super::*;
	impl Serialize for TaxiService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TaxiService", len)?;
	...
	impl<'de> Deserialize<'de> for TaxiService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TaxiService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TaxiService")
				}
			...
			deserializer.deserialize_struct("TaxiService", FIELDS, ClassVisitor)
		}
	}
}
