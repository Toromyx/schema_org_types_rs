...
pub struct DeliveryEvent {
	...
	pub r#access_code: Vec<AccessCodeProperty>,
	/// <https://schema.org/availableFrom>
	pub r#available_from: Vec<AvailableFromProperty>,
	/// <https://schema.org/availableThrough>
	pub r#available_through: Vec<AvailableThroughProperty>,
...
pub trait DeliveryEventTrait {
	/// Get <https://schema.org/accessCode> from [`Self`] as borrowed slice.
	fn get_access_code(&self) -> &[AccessCodeProperty];
	/// Take <https://schema.org/accessCode> from [`Self`] as owned vector.
	fn take_access_code(&mut self) -> Vec<AccessCodeProperty>;
	/// Get <https://schema.org/availableFrom> from [`Self`] as borrowed slice.
	fn get_available_from(&self) -> &[AvailableFromProperty];
	/// Take <https://schema.org/availableFrom> from [`Self`] as owned vector.
	fn take_available_from(&mut self) -> Vec<AvailableFromProperty>;
	/// Get <https://schema.org/availableThrough> from [`Self`] as borrowed slice.
	fn get_available_through(&self) -> &[AvailableThroughProperty];
	/// Take <https://schema.org/availableThrough> from [`Self`] as owned vector.
...
impl DeliveryEventTrait for DeliveryEvent {
	fn get_access_code(&self) -> &[AccessCodeProperty] {
		self.r#access_code.as_slice()
	}
	fn take_access_code(&mut self) -> Vec<AccessCodeProperty> {
		std::mem::take(&mut self.r#access_code)
	}
	fn get_available_from(&self) -> &[AvailableFromProperty] {
		self.r#available_from.as_slice()
	}
	fn take_available_from(&mut self) -> Vec<AvailableFromProperty> {
		std::mem::take(&mut self.r#available_from)
	}
	fn get_available_through(&self) -> &[AvailableThroughProperty] {
		self.r#available_through.as_slice()
	}
	fn take_available_through(&mut self) -> Vec<AvailableThroughProperty> {
		std::mem::take(&mut self.r#available_through)
	}
	fn get_has_delivery_method(&self) -> &[HasDeliveryMethodProperty] {
...
impl EventTrait for DeliveryEvent {
...
impl ThingTrait for DeliveryEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for DeliveryEvent {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#access_code) as usize,
				!Vec::is_empty(&self.r#available_from) as usize,
				!Vec::is_empty(&self.r#available_through) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DeliveryEvent", len)?;
			if !Vec::is_empty(&self.r#access_code) {
				serialize_struct.serialize_field("accessCode", {
					struct SerializeWith<'a>(&'a Vec<AccessCodeProperty>);
					...
					&SerializeWith(&self.r#access_code)
				})?;
			} else {
				serialize_struct.skip_field("accessCode")?;
			}
			if !Vec::is_empty(&self.r#available_from) {
				serialize_struct.serialize_field("availableFrom", {
					struct SerializeWith<'a>(&'a Vec<AvailableFromProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#available_from)
				})?;
			} else {
				serialize_struct.skip_field("availableFrom")?;
			}
			if !Vec::is_empty(&self.r#available_through) {
				serialize_struct.serialize_field("availableThrough", {
					struct SerializeWith<'a>(&'a Vec<AvailableThroughProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#available_through)
				})?;
			} else {
				serialize_struct.skip_field("availableThrough")?;
			}
	...
	impl<'de> Deserialize<'de> for DeliveryEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"accessCode" => Ok(Field::AccessCode),
						"availableFrom" => Ok(Field::AvailableFrom),
						"availableThrough" => Ok(Field::AvailableThrough),
				...
				{
					match value {
						b"accessCode" => Ok(Field::AccessCode),
						b"availableFrom" => Ok(Field::AvailableFrom),
						b"availableThrough" => Ok(Field::AvailableThrough),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DeliveryEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DeliveryEvent")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#access_code_property = None;
					let mut r#available_from_property = None;
					let mut r#available_through_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AccessCode => {
								if r#access_code_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"accessCode",
									));
								}
								r#access_code_property = Some({
									struct DeserializeWith(Vec<AccessCodeProperty>);
							...
							Field::AvailableFrom => {
								if r#available_from_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"availableFrom",
									));
								}
								r#available_from_property = Some({
									struct DeserializeWith(Vec<AvailableFromProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::AvailableThrough => {
								if r#available_through_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"availableThrough",
									));
								}
								r#available_through_property = Some({
									struct DeserializeWith(Vec<AvailableThroughProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(DeliveryEvent {
						r#access_code: r#access_code_property.unwrap_or_default(),
						r#available_from: r#available_from_property.unwrap_or_default(),
						r#available_through: r#available_through_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("DeliveryEvent", FIELDS, ClassVisitor)
		}
	}
}
