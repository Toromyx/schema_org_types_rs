...
pub struct DeliveryEvent {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "accessCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/accessCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/accessCode"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "availableFrom"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/availableFrom"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/availableFrom"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "availableThrough"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/availableThrough")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/availableThrough"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
