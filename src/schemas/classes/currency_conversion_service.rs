...
/// This trait is for properties from <https://schema.org/CurrencyConversionService>.
pub trait CurrencyConversionServiceTrait {}
impl CurrencyConversionServiceTrait for CurrencyConversionService {}
impl FinancialProductTrait for CurrencyConversionService {
...
impl ServiceTrait for CurrencyConversionService {
...
impl ThingTrait for CurrencyConversionService {
...
mod serde {
	...
	use super::*;
	impl Serialize for CurrencyConversionService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CurrencyConversionService", len)?;
	...
	impl<'de> Deserialize<'de> for CurrencyConversionService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CurrencyConversionService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CurrencyConversionService")
				}
			...
			deserializer.deserialize_struct("CurrencyConversionService", FIELDS, ClassVisitor)
		}
	}
}
