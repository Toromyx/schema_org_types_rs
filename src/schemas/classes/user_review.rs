...
/// This trait is for properties from <https://schema.org/UserReview>.
pub trait UserReviewTrait {}
impl UserReviewTrait for UserReview {}
impl CreativeWorkTrait for UserReview {
...
impl ReviewTrait for UserReview {
...
impl ThingTrait for UserReview {
...
mod serde {
	...
	impl Serialize for UserReview {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "UserReview", len)?;
	...
	impl<'de> Deserialize<'de> for UserReview {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserReview;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserReview")
				}
			...
			deserializer.deserialize_struct("UserReview", FIELDS, ClassVisitor)
		}
	}
}
