...
impl CourseInstanceTrait for CourseInstance {
	fn get_course_mode(&self) -> &[CourseModeProperty] {
		self.r#course_mode.as_slice()
	}
	fn take_course_mode(&mut self) -> Vec<CourseModeProperty> {
		std::mem::take(&mut self.r#course_mode)
	}
	fn get_course_schedule(&self) -> &[CourseScheduleProperty] {
		self.r#course_schedule.as_slice()
	}
	fn take_course_schedule(&mut self) -> Vec<CourseScheduleProperty> {
		std::mem::take(&mut self.r#course_schedule)
	}
	fn get_course_workload(&self) -> &[CourseWorkloadProperty] {
		self.r#course_workload.as_slice()
	}
	fn take_course_workload(&mut self) -> Vec<CourseWorkloadProperty> {
		std::mem::take(&mut self.r#course_workload)
	}
	fn get_instructor(&self) -> &[InstructorProperty] {
		self.r#instructor.as_slice()
	}
	fn take_instructor(&mut self) -> Vec<InstructorProperty> {
		std::mem::take(&mut self.r#instructor)
	}
}
impl EventTrait for CourseInstance {
...
impl ThingTrait for CourseInstance {
...
mod serde {
	...
	impl Serialize for CourseInstance {
		...
		{
			let len: usize = [
				!Vec::is_empty(&self.r#course_mode) as usize,
				!Vec::is_empty(&self.r#course_schedule) as usize,
				!Vec::is_empty(&self.r#course_workload) as usize,
				!Vec::is_empty(&self.r#instructor) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CourseInstance", len)?;
			if !Vec::is_empty(&self.r#course_mode) {
				serialize_struct.serialize_field("courseMode", {
					struct SerializeWith<'a>(&'a Vec<CourseModeProperty>);
					...
					&SerializeWith(&self.r#course_mode)
				})?;
			} else {
				serialize_struct.skip_field("courseMode")?;
			}
			if !Vec::is_empty(&self.r#course_schedule) {
				serialize_struct.serialize_field("courseSchedule", {
					struct SerializeWith<'a>(&'a Vec<CourseScheduleProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#course_schedule)
				})?;
			} else {
				serialize_struct.skip_field("courseSchedule")?;
			}
			if !Vec::is_empty(&self.r#course_workload) {
				serialize_struct.serialize_field("courseWorkload", {
					struct SerializeWith<'a>(&'a Vec<CourseWorkloadProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#course_workload)
				})?;
			} else {
				serialize_struct.skip_field("courseWorkload")?;
			}
			if !Vec::is_empty(&self.r#instructor) {
				serialize_struct.serialize_field("instructor", {
					struct SerializeWith<'a>(&'a Vec<InstructorProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#instructor)
				})?;
			} else {
				serialize_struct.skip_field("instructor")?;
			}
	...
	impl<'de> Deserialize<'de> for CourseInstance {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"courseMode" => Ok(Field::CourseMode),
						"courseSchedule" => Ok(Field::CourseSchedule),
						"courseWorkload" => Ok(Field::CourseWorkload),
				...
				{
					match value {
						b"courseMode" => Ok(Field::CourseMode),
						b"courseSchedule" => Ok(Field::CourseSchedule),
						b"courseWorkload" => Ok(Field::CourseWorkload),
						b"instructor" => Ok(Field::Instructor),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CourseInstance;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CourseInstance")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#course_mode_property = None;
					let mut r#course_schedule_property = None;
					let mut r#course_workload_property = None;
					let mut r#instructor_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::CourseMode => {
								if r#course_mode_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"courseMode",
									));
								}
								r#course_mode_property = Some({
									struct DeserializeWith(Vec<CourseModeProperty>);
							...
							Field::CourseSchedule => {
								if r#course_schedule_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"courseSchedule",
									));
								}
								r#course_schedule_property = Some({
									struct DeserializeWith(Vec<CourseScheduleProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::CourseWorkload => {
								if r#course_workload_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"courseWorkload",
									));
								}
								r#course_workload_property = Some({
									struct DeserializeWith(Vec<CourseWorkloadProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Instructor => {
								if r#instructor_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"instructor",
									));
								}
								r#instructor_property = Some({
									struct DeserializeWith(Vec<InstructorProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(CourseInstance {
						r#course_mode: r#course_mode_property.unwrap_or_default(),
						r#course_schedule: r#course_schedule_property.unwrap_or_default(),
						r#course_workload: r#course_workload_property.unwrap_or_default(),
						r#instructor: r#instructor_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("CourseInstance", FIELDS, ClassVisitor)
		}
	}
}
