...
pub trait InfectiousDiseaseTrait {
	/// Get <https://schema.org/infectiousAgent> from [`Self`] as borrowed slice.
	fn get_infectious_agent(&self) -> &[InfectiousAgentProperty];
	/// Take <https://schema.org/infectiousAgent> from [`Self`] as owned vector.
	fn take_infectious_agent(&mut self) -> Vec<InfectiousAgentProperty>;
	/// Get <https://schema.org/infectiousAgentClass> from [`Self`] as borrowed slice.
	fn get_infectious_agent_class(&self) -> &[InfectiousAgentClassProperty];
	/// Take <https://schema.org/infectiousAgentClass> from [`Self`] as owned vector.
	fn take_infectious_agent_class(&mut self) -> Vec<InfectiousAgentClassProperty>;
	/// Get <https://schema.org/transmissionMethod> from [`Self`] as borrowed slice.
	fn get_transmission_method(&self) -> &[TransmissionMethodProperty];
	/// Take <https://schema.org/transmissionMethod> from [`Self`] as owned vector.
	fn take_transmission_method(&mut self) -> Vec<TransmissionMethodProperty>;
}
impl InfectiousDiseaseTrait for InfectiousDisease {
	fn get_infectious_agent(&self) -> &[InfectiousAgentProperty] {
		self.r#infectious_agent.as_slice()
	}
	fn take_infectious_agent(&mut self) -> Vec<InfectiousAgentProperty> {
		std::mem::take(&mut self.r#infectious_agent)
	}
	fn get_infectious_agent_class(&self) -> &[InfectiousAgentClassProperty] {
		self.r#infectious_agent_class.as_slice()
	}
	fn take_infectious_agent_class(&mut self) -> Vec<InfectiousAgentClassProperty> {
		std::mem::take(&mut self.r#infectious_agent_class)
	}
	fn get_transmission_method(&self) -> &[TransmissionMethodProperty] {
		self.r#transmission_method.as_slice()
	}
	fn take_transmission_method(&mut self) -> Vec<TransmissionMethodProperty> {
		std::mem::take(&mut self.r#transmission_method)
	}
}
impl MedicalConditionTrait for InfectiousDisease {
...
impl MedicalEntityTrait for InfectiousDisease {
...
impl ThingTrait for InfectiousDisease {
...
mod serde {
	...
	use super::*;
	impl Serialize for InfectiousDisease {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#infectious_agent) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InfectiousDisease", len)?;
			if !Vec::is_empty(&self.r#infectious_agent) {
				serialize_struct.serialize_field("infectiousAgent", {
					struct SerializeWith<'a>(&'a Vec<InfectiousAgentProperty>);
					...
					&SerializeWith(&self.r#infectious_agent)
				})?;
			} else {
				serialize_struct.skip_field("infectiousAgent")?;
			}
			if !Vec::is_empty(&self.r#infectious_agent_class) {
				serialize_struct.serialize_field("infectiousAgentClass", {
					struct SerializeWith<'a>(&'a Vec<InfectiousAgentClassProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#infectious_agent_class)
				})?;
			} else {
				serialize_struct.skip_field("infectiousAgentClass")?;
			}
			if !Vec::is_empty(&self.r#transmission_method) {
				serialize_struct.serialize_field("transmissionMethod", {
					struct SerializeWith<'a>(&'a Vec<TransmissionMethodProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#transmission_method)
				})?;
			} else {
				serialize_struct.skip_field("transmissionMethod")?;
			}
	...
	impl<'de> Deserialize<'de> for InfectiousDisease {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"infectiousAgent" => Ok(Field::InfectiousAgent),
				...
				{
					match value {
						b"infectiousAgent" => Ok(Field::InfectiousAgent),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InfectiousDisease;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InfectiousDisease")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#infectious_agent_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::InfectiousAgent => {
								if r#infectious_agent_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"infectiousAgent",
									));
								}
								r#infectious_agent_property = Some({
									struct DeserializeWith(Vec<InfectiousAgentProperty>);
							...
							Field::InfectiousAgentClass => {
								if r#infectious_agent_class_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"infectiousAgentClass",
									));
								}
								r#infectious_agent_class_property = Some({
									struct DeserializeWith(Vec<InfectiousAgentClassProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TransmissionMethod => {
								if r#transmission_method_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"transmissionMethod",
									));
								}
								r#transmission_method_property = Some({
									struct DeserializeWith(Vec<TransmissionMethodProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(InfectiousDisease {
						r#infectious_agent: r#infectious_agent_property.unwrap_or_default(),
						r#infectious_agent_class: r#infectious_agent_class_property
							.unwrap_or_default(),
			...
			deserializer.deserialize_struct("InfectiousDisease", FIELDS, ClassVisitor)
		}
	}
}
