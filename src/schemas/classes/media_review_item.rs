...
pub struct MediaReviewItem {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "mediaItemAppearance"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/mediaItemAppearance")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/mediaItemAppearance")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
