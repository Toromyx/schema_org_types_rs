...
/// This trait is for properties from <https://schema.org/AppendAction>.
pub trait AppendActionTrait {}
impl AppendActionTrait for AppendAction {}
...
impl AddActionTrait for AppendAction {}
impl InsertActionTrait for AppendAction {
...
impl ThingTrait for AppendAction {
...
impl UpdateActionTrait for AppendAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AppendAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AppendAction", len)?;
	...
	impl<'de> Deserialize<'de> for AppendAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AppendAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AppendAction")
				}
			...
			deserializer.deserialize_struct("AppendAction", FIELDS, ClassVisitor)
		}
	}
}
