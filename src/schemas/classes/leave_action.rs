...
/// This trait is for properties from <https://schema.org/LeaveAction>.
pub trait LeaveActionTrait {
...
impl LeaveActionTrait for LeaveAction {
	fn get_event(&self) -> &[EventProperty] {
...
impl InteractActionTrait for LeaveAction {}
impl ThingTrait for LeaveAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for LeaveAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LeaveAction", len)?;
	...
	impl<'de> Deserialize<'de> for LeaveAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LeaveAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LeaveAction")
				}
			...
			deserializer.deserialize_struct("LeaveAction", FIELDS, ClassVisitor)
		}
	}
}
