...
/// This trait is for properties from <https://schema.org/DrinkAction>.
pub trait DrinkActionTrait {}
impl DrinkActionTrait for DrinkAction {}
...
impl ConsumeActionTrait for DrinkAction {
...
impl ThingTrait for DrinkAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DrinkAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DrinkAction", len)?;
	...
	impl<'de> Deserialize<'de> for DrinkAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DrinkAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DrinkAction")
				}
			...
			deserializer.deserialize_struct("DrinkAction", FIELDS, ClassVisitor)
		}
	}
}
