...
/// This trait is for properties from <https://schema.org/ComicStory>.
pub trait ComicStoryTrait {
...
impl ComicStoryTrait for ComicStory {
	fn get_artist(&self) -> &[ArtistProperty] {
...
impl CreativeWorkTrait for ComicStory {
...
impl ThingTrait for ComicStory {
...
mod serde {
	...
	impl Serialize for ComicStory {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ComicStory", len)?;
	...
	impl<'de> Deserialize<'de> for ComicStory {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComicStory;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComicStory")
				}
			...
			deserializer.deserialize_struct("ComicStory", FIELDS, ClassVisitor)
		}
	}
}
