...
impl RecommendationTrait for Recommendation {
	fn get_category(&self) -> &[CategoryProperty] {
...
impl CreativeWorkTrait for Recommendation {
...
impl ReviewTrait for Recommendation {
...
impl ThingTrait for Recommendation {
	...
	impl Serialize for Recommendation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "Recommendation", len)?;
	...
	impl<'de> Deserialize<'de> for Recommendation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Recommendation")
				}
			...
			deserializer.deserialize_struct("Recommendation", FIELDS, ClassVisitor)
		}
	}
}
