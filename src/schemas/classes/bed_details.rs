...
pub struct BedDetails {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/numberOfBeds"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/numberOfBeds"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/typeOfBed"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/typeOfBed"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
