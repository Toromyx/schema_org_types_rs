...
/// This trait is for properties from <https://schema.org/AuthorizeAction>.
pub trait AuthorizeActionTrait {
...
impl AuthorizeActionTrait for AuthorizeAction {
	fn get_recipient(&self) -> &[RecipientProperty] {
...
impl AllocateActionTrait for AuthorizeAction {}
impl OrganizeActionTrait for AuthorizeAction {}
impl ThingTrait for AuthorizeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AuthorizeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AuthorizeAction", len)?;
	...
	impl<'de> Deserialize<'de> for AuthorizeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AuthorizeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AuthorizeAction")
				}
			...
			deserializer.deserialize_struct("AuthorizeAction", FIELDS, ClassVisitor)
		}
	}
}
