...
/// This trait is for properties from <https://schema.org/DownloadAction>.
pub trait DownloadActionTrait {}
impl DownloadActionTrait for DownloadAction {}
...
impl ThingTrait for DownloadAction {
...
impl TransferActionTrait for DownloadAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DownloadAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DownloadAction", len)?;
	...
	impl<'de> Deserialize<'de> for DownloadAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DownloadAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DownloadAction")
				}
			...
			deserializer.deserialize_struct("DownloadAction", FIELDS, ClassVisitor)
		}
	}
}
