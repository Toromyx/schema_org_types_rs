...
/// This trait is for properties from <https://schema.org/SportingGoodsStore>.
pub trait SportingGoodsStoreTrait {}
impl SportingGoodsStoreTrait for SportingGoodsStore {}
impl LocalBusinessTrait for SportingGoodsStore {
...
impl StoreTrait for SportingGoodsStore {}
impl ThingTrait for SportingGoodsStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for SportingGoodsStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SportingGoodsStore", len)?;
	...
	impl<'de> Deserialize<'de> for SportingGoodsStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SportingGoodsStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SportingGoodsStore")
				}
			...
			deserializer.deserialize_struct("SportingGoodsStore", FIELDS, ClassVisitor)
		}
	}
}
