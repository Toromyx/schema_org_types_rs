...
/// This trait is for properties from <https://schema.org/PodcastEpisode>.
pub trait PodcastEpisodeTrait {}
impl PodcastEpisodeTrait for PodcastEpisode {}
impl CreativeWorkTrait for PodcastEpisode {
...
impl EpisodeTrait for PodcastEpisode {
...
impl ThingTrait for PodcastEpisode {
	...
	impl Serialize for PodcastEpisode {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PodcastEpisode", len)?;
	...
	impl<'de> Deserialize<'de> for PodcastEpisode {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PodcastEpisode;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PodcastEpisode")
				}
			...
			deserializer.deserialize_struct("PodcastEpisode", FIELDS, ClassVisitor)
		}
	}
}
