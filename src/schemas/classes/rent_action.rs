...
pub struct RentAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "landlord"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/landlord"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/landlord"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "realEstateAgent"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/realEstateAgent"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/realEstateAgent"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
