...
/// This trait is for properties from <https://schema.org/ConfirmAction>.
pub trait ConfirmActionTrait {}
impl ConfirmActionTrait for ConfirmAction {}
...
impl CommunicateActionTrait for ConfirmAction {
...
impl InformActionTrait for ConfirmAction {
...
impl InteractActionTrait for ConfirmAction {}
impl ThingTrait for ConfirmAction {
...
mod serde {
	...
	impl Serialize for ConfirmAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ConfirmAction", len)?;
	...
	impl<'de> Deserialize<'de> for ConfirmAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ConfirmAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ConfirmAction")
				}
			...
			deserializer.deserialize_struct("ConfirmAction", FIELDS, ClassVisitor)
		}
	}
}
