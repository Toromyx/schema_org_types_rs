...
/// This trait is for properties from <https://schema.org/ComicCoverArt>.
pub trait ComicCoverArtTrait {}
impl ComicCoverArtTrait for ComicCoverArt {}
impl ComicStoryTrait for ComicCoverArt {
...
impl CoverArtTrait for ComicCoverArt {}
impl CreativeWorkTrait for ComicCoverArt {
...
impl ThingTrait for ComicCoverArt {
...
impl VisualArtworkTrait for ComicCoverArt {
	...
	fn get_artwork_surface(&self) -> &[ArtworkSurfaceProperty] {
		self.r#artwork_surface.as_slice()
	}
	fn take_artwork_surface(&mut self) -> Vec<ArtworkSurfaceProperty> {
		std::mem::take(&mut self.r#artwork_surface)
	}
	fn get_colorist(&self) -> &[ColoristProperty] {
		self.r#colorist.as_slice()
	}
	...
	fn get_surface(&self) -> &[SurfaceProperty] {
		self.r#surface.as_slice()
	}
	fn take_surface(&mut self) -> Vec<SurfaceProperty> {
		std::mem::take(&mut self.r#surface)
	}
...
mod serde {
	...
	use super::*;
	impl Serialize for ComicCoverArt {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#art_edition) as usize,
				!Vec::is_empty(&self.r#art_medium) as usize,
				!Vec::is_empty(&self.r#artform) as usize,
				!Vec::is_empty(&self.r#artwork_surface) as usize,
				!Vec::is_empty(&self.r#depth) as usize,
				!Vec::is_empty(&self.r#height) as usize,
				!Vec::is_empty(&self.r#surface) as usize,
				!Vec::is_empty(&self.r#width) as usize,
			]
			.iter()
			.sum();
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ComicCoverArt", len)?;
			...
			if !Vec::is_empty(&self.r#art_edition) {
				serialize_struct.serialize_field("artEdition", {
					struct SerializeWith<'a>(&'a Vec<ArtEditionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#art_edition)
				})?;
			} else {
				serialize_struct.skip_field("artEdition")?;
			}
			if !Vec::is_empty(&self.r#art_medium) {
				serialize_struct.serialize_field("artMedium", {
					struct SerializeWith<'a>(&'a Vec<ArtMediumProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#art_medium)
				})?;
			} else {
				serialize_struct.skip_field("artMedium")?;
			}
			if !Vec::is_empty(&self.r#artform) {
				serialize_struct.serialize_field("artform", {
					struct SerializeWith<'a>(&'a Vec<ArtformProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#artform)
				})?;
			} else {
				serialize_struct.skip_field("artform")?;
			}
			if !Vec::is_empty(&self.r#artwork_surface) {
				serialize_struct.serialize_field("artworkSurface", {
					struct SerializeWith<'a>(&'a Vec<ArtworkSurfaceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#artwork_surface)
				})?;
			} else {
				serialize_struct.skip_field("artworkSurface")?;
			}
			...
			if !Vec::is_empty(&self.r#surface) {
				serialize_struct.serialize_field("surface", {
					struct SerializeWith<'a>(&'a Vec<SurfaceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#surface)
				})?;
			} else {
				serialize_struct.skip_field("surface")?;
			}
	...
	impl<'de> Deserialize<'de> for ComicCoverArt {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"url" => Ok(Field::Url),
						"artEdition" => Ok(Field::ArtEdition),
						"artMedium" => Ok(Field::ArtMedium),
						"artform" => Ok(Field::Artform),
						"artworkSurface" => Ok(Field::ArtworkSurface),
					...
					E: de::Error,
				{
					match value {
						...
						b"url" => Ok(Field::Url),
						b"artEdition" => Ok(Field::ArtEdition),
						b"artMedium" => Ok(Field::ArtMedium),
						b"artform" => Ok(Field::Artform),
						b"artworkSurface" => Ok(Field::ArtworkSurface),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComicCoverArt;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComicCoverArt")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#art_edition_property = None;
					let mut r#art_medium_property = None;
					let mut r#artform_property = None;
					let mut r#artwork_surface_property = None;
					let mut r#depth_property = None;
					let mut r#height_property = None;
					let mut r#surface_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::ArtEdition => {
								if r#art_edition_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"artEdition",
									));
								}
								r#art_edition_property = Some({
									struct DeserializeWith(Vec<ArtEditionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ArtMedium => {
								if r#art_medium_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"artMedium",
									));
								}
								r#art_medium_property = Some({
									struct DeserializeWith(Vec<ArtMediumProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Artform => {
								if r#artform_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"artform",
									));
								}
								r#artform_property = Some({
									struct DeserializeWith(Vec<ArtformProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ArtworkSurface => {
								if r#artwork_surface_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"artworkSurface",
									));
								}
								r#artwork_surface_property = Some({
									struct DeserializeWith(Vec<ArtworkSurfaceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Surface => {
								if r#surface_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"surface",
									));
								}
								r#surface_property = Some({
									struct DeserializeWith(Vec<SurfaceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(ComicCoverArt {
						...
						r#art_edition: r#art_edition_property.unwrap_or_default(),
						r#art_medium: r#art_medium_property.unwrap_or_default(),
						r#artform: r#artform_property.unwrap_or_default(),
						r#artwork_surface: r#artwork_surface_property.unwrap_or_default(),
						r#depth: r#depth_property.unwrap_or_default(),
						r#height: r#height_property.unwrap_or_default(),
						r#surface: r#surface_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("ComicCoverArt", FIELDS, ClassVisitor)
		}
	}
}
