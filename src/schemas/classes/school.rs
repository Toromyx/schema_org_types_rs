...
/// This trait is for properties from <https://schema.org/School>.
pub trait SchoolTrait {}
impl SchoolTrait for School {}
impl CivicStructureTrait for School {
...
impl EducationalOrganizationTrait for School {
...
mod serde {
	...
	impl Serialize for School {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "School", len)?;
	...
	impl<'de> Deserialize<'de> for School {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = School;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema School")
				}
			...
			deserializer.deserialize_struct("School", FIELDS, ClassVisitor)
		}
	}
}
