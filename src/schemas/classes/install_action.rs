...
/// This trait is for properties from <https://schema.org/InstallAction>.
pub trait InstallActionTrait {}
impl InstallActionTrait for InstallAction {}
...
impl ConsumeActionTrait for InstallAction {
...
impl ThingTrait for InstallAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for InstallAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InstallAction", len)?;
	...
	impl<'de> Deserialize<'de> for InstallAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InstallAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InstallAction")
				}
			...
			deserializer.deserialize_struct("InstallAction", FIELDS, ClassVisitor)
		}
	}
}
