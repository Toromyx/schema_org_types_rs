...
/// This trait is for properties from <https://schema.org/SubscribeAction>.
pub trait SubscribeActionTrait {}
impl SubscribeActionTrait for SubscribeAction {}
...
impl InteractActionTrait for SubscribeAction {}
impl ThingTrait for SubscribeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for SubscribeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SubscribeAction", len)?;
	...
	impl<'de> Deserialize<'de> for SubscribeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SubscribeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SubscribeAction")
				}
			...
			deserializer.deserialize_struct("SubscribeAction", FIELDS, ClassVisitor)
		}
	}
}
