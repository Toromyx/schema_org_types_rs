...
/// This trait is for properties from <https://schema.org/BookSeries>.
pub trait BookSeriesTrait {}
impl BookSeriesTrait for BookSeries {}
impl CreativeWorkTrait for BookSeries {
...
impl CreativeWorkSeriesTrait for BookSeries {
...
impl ThingTrait for BookSeries {
...
mod serde {
	...
	impl Serialize for BookSeries {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "BookSeries", len)?;
	...
	impl<'de> Deserialize<'de> for BookSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BookSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BookSeries")
				}
			...
			deserializer.deserialize_struct("BookSeries", FIELDS, ClassVisitor)
		}
	}
}
