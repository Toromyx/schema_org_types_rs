...
pub trait LegislationTrait {
	...
	/// Get <https://schema.org/legislationJurisdiction> from [`Self`] as borrowed slice.
	fn get_legislation_jurisdiction(&self) -> &[LegislationJurisdictionProperty];
	/// Take <https://schema.org/legislationJurisdiction> from [`Self`] as owned vector.
	...
	/// Take <https://schema.org/legislationLegalForce> from [`Self`] as owned vector.
	...
	/// Take <https://schema.org/legislationTransposes> from [`Self`] as owned vector.
...
impl LegislationTrait for Legislation {
	fn get_jurisdiction(&self) -> &[JurisdictionProperty] {
...
impl CreativeWorkTrait for Legislation {
...
impl ThingTrait for Legislation {
