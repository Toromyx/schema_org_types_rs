...
/// This trait is for properties from <https://schema.org/Brewery>.
pub trait BreweryTrait {}
impl BreweryTrait for Brewery {}
impl FoodEstablishmentTrait for Brewery {
...
impl LocalBusinessTrait for Brewery {
...
mod serde {
	...
	impl Serialize for Brewery {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Brewery", len)?;
	...
	impl<'de> Deserialize<'de> for Brewery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Brewery;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Brewery")
				}
			...
			deserializer.deserialize_struct("Brewery", FIELDS, ClassVisitor)
		}
	}
}
