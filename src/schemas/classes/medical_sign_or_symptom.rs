...
/// This trait is for properties from <https://schema.org/MedicalSignOrSymptom>.
pub trait MedicalSignOrSymptomTrait {
...
impl MedicalSignOrSymptomTrait for MedicalSignOrSymptom {
	fn get_possible_treatment(&self) -> &[PossibleTreatmentProperty] {
...
impl MedicalConditionTrait for MedicalSignOrSymptom {
...
impl MedicalEntityTrait for MedicalSignOrSymptom {
...
impl ThingTrait for MedicalSignOrSymptom {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalSignOrSymptom {
	...
	impl<'de> Deserialize<'de> for MedicalSignOrSymptom {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalSignOrSymptom;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalSignOrSymptom")
				}
