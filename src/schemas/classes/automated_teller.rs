...
/// This trait is for properties from <https://schema.org/AutomatedTeller>.
pub trait AutomatedTellerTrait {}
impl AutomatedTellerTrait for AutomatedTeller {}
impl FinancialServiceTrait for AutomatedTeller {
...
impl LocalBusinessTrait for AutomatedTeller {
...
impl ThingTrait for AutomatedTeller {
...
mod serde {
	...
	use super::*;
	impl Serialize for AutomatedTeller {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AutomatedTeller", len)?;
	...
	impl<'de> Deserialize<'de> for AutomatedTeller {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutomatedTeller;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutomatedTeller")
				}
			...
			deserializer.deserialize_struct("AutomatedTeller", FIELDS, ClassVisitor)
		}
	}
}
