...
pub struct BankAccount {
	...
	pub r#account_minimum_inflow: Vec<AccountMinimumInflowProperty>,
	/// <https://schema.org/accountOverdraftLimit>
	pub r#account_overdraft_limit: Vec<AccountOverdraftLimitProperty>,
	/// <https://schema.org/bankAccountType>
	pub r#bank_account_type: Vec<BankAccountTypeProperty>,
...
pub trait BankAccountTrait {
	/// Get <https://schema.org/accountMinimumInflow> from [`Self`] as borrowed slice.
	fn get_account_minimum_inflow(&self) -> &[AccountMinimumInflowProperty];
	/// Take <https://schema.org/accountMinimumInflow> from [`Self`] as owned vector.
	fn take_account_minimum_inflow(&mut self) -> Vec<AccountMinimumInflowProperty>;
	/// Get <https://schema.org/accountOverdraftLimit> from [`Self`] as borrowed slice.
	fn get_account_overdraft_limit(&self) -> &[AccountOverdraftLimitProperty];
	/// Take <https://schema.org/accountOverdraftLimit> from [`Self`] as owned vector.
	fn take_account_overdraft_limit(&mut self) -> Vec<AccountOverdraftLimitProperty>;
	/// Get <https://schema.org/bankAccountType> from [`Self`] as borrowed slice.
	fn get_bank_account_type(&self) -> &[BankAccountTypeProperty];
	/// Take <https://schema.org/bankAccountType> from [`Self`] as owned vector.
	fn take_bank_account_type(&mut self) -> Vec<BankAccountTypeProperty>;
}
impl BankAccountTrait for BankAccount {
	fn get_account_minimum_inflow(&self) -> &[AccountMinimumInflowProperty] {
		self.r#account_minimum_inflow.as_slice()
	}
	fn take_account_minimum_inflow(&mut self) -> Vec<AccountMinimumInflowProperty> {
		std::mem::take(&mut self.r#account_minimum_inflow)
	}
	fn get_account_overdraft_limit(&self) -> &[AccountOverdraftLimitProperty] {
		self.r#account_overdraft_limit.as_slice()
	}
	fn take_account_overdraft_limit(&mut self) -> Vec<AccountOverdraftLimitProperty> {
		std::mem::take(&mut self.r#account_overdraft_limit)
	}
	fn get_bank_account_type(&self) -> &[BankAccountTypeProperty] {
		self.r#bank_account_type.as_slice()
	}
	fn take_bank_account_type(&mut self) -> Vec<BankAccountTypeProperty> {
		std::mem::take(&mut self.r#bank_account_type)
	}
}
impl FinancialProductTrait for BankAccount {
...
impl ServiceTrait for BankAccount {
...
impl ThingTrait for BankAccount {
...
mod serde {
	...
	impl Serialize for BankAccount {
		...
		{
			let len: usize = [
				!Vec::is_empty(&self.r#account_minimum_inflow) as usize,
				!Vec::is_empty(&self.r#account_overdraft_limit) as usize,
				!Vec::is_empty(&self.r#bank_account_type) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BankAccount", len)?;
			if !Vec::is_empty(&self.r#account_minimum_inflow) {
				serialize_struct.serialize_field("accountMinimumInflow", {
					struct SerializeWith<'a>(&'a Vec<AccountMinimumInflowProperty>);
					...
					&SerializeWith(&self.r#account_minimum_inflow)
				})?;
			} else {
				serialize_struct.skip_field("accountMinimumInflow")?;
			}
			if !Vec::is_empty(&self.r#account_overdraft_limit) {
				serialize_struct.serialize_field("accountOverdraftLimit", {
					struct SerializeWith<'a>(&'a Vec<AccountOverdraftLimitProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#account_overdraft_limit)
				})?;
			} else {
				serialize_struct.skip_field("accountOverdraftLimit")?;
			}
			if !Vec::is_empty(&self.r#bank_account_type) {
				serialize_struct.serialize_field("bankAccountType", {
					struct SerializeWith<'a>(&'a Vec<BankAccountTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#bank_account_type)
				})?;
			} else {
				serialize_struct.skip_field("bankAccountType")?;
			}
	...
	impl<'de> Deserialize<'de> for BankAccount {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"accountMinimumInflow" => Ok(Field::AccountMinimumInflow),
						"accountOverdraftLimit" => Ok(Field::AccountOverdraftLimit),
						"bankAccountType" => Ok(Field::BankAccountType),
				...
				{
					match value {
						b"accountMinimumInflow" => Ok(Field::AccountMinimumInflow),
						b"accountOverdraftLimit" => Ok(Field::AccountOverdraftLimit),
						b"bankAccountType" => Ok(Field::BankAccountType),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BankAccount")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#account_minimum_inflow_property = None;
					let mut r#account_overdraft_limit_property = None;
					let mut r#bank_account_type_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AccountMinimumInflow => {
								if r#account_minimum_inflow_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"accountMinimumInflow",
									));
								}
								r#account_minimum_inflow_property = Some({
									struct DeserializeWith(Vec<AccountMinimumInflowProperty>);
							...
							Field::AccountOverdraftLimit => {
								if r#account_overdraft_limit_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"accountOverdraftLimit",
									));
								}
								r#account_overdraft_limit_property = Some({
									struct DeserializeWith(Vec<AccountOverdraftLimitProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::BankAccountType => {
								if r#bank_account_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"bankAccountType",
									));
								}
								r#bank_account_type_property = Some({
									struct DeserializeWith(Vec<BankAccountTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(BankAccount {
						r#account_minimum_inflow: r#account_minimum_inflow_property
							.unwrap_or_default(),
						r#account_overdraft_limit: r#account_overdraft_limit_property
							.unwrap_or_default(),
						r#bank_account_type: r#bank_account_type_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("BankAccount", FIELDS, ClassVisitor)
		}
	}
}
