...
pub struct WebPageElement {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "cssSelector"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/cssSelector"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/cssSelector"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "xpath"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/xpath"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/xpath"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
