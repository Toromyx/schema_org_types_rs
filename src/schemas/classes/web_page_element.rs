...
impl WebPageElementTrait for WebPageElement {
	fn get_css_selector(&self) -> &[CssSelectorProperty] {
...
impl CreativeWorkTrait for WebPageElement {
...
impl ThingTrait for WebPageElement {
...
mod serde {
	...
	use super::*;
	impl Serialize for WebPageElement {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "WebPageElement", len)?;
	...
	impl<'de> Deserialize<'de> for WebPageElement {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WebPageElement;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WebPageElement")
				}
			...
			deserializer.deserialize_struct("WebPageElement", FIELDS, ClassVisitor)
		}
	}
}
