...
pub struct Barcode {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "exifData"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#exif_data: Vec<ExifDataProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "representativeOfPage"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#representative_of_page: Vec<RepresentativeOfPageProperty>,
    #[cfg(any(
        any(
