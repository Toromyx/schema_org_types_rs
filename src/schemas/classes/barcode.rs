...
/// This trait is for properties from <https://schema.org/Barcode>.
pub trait BarcodeTrait {}
impl BarcodeTrait for Barcode {}
impl CreativeWorkTrait for Barcode {
...
impl ImageObjectTrait for Barcode {
...
impl MediaObjectTrait for Barcode {
...
mod serde {
	...
	impl Serialize for Barcode {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Barcode", len)?;
	...
	impl<'de> Deserialize<'de> for Barcode {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Barcode;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Barcode")
				}
			...
			deserializer.deserialize_struct("Barcode", FIELDS, ClassVisitor)
		}
	}
}
