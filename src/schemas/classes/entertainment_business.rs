...
/// This trait is for properties from <https://schema.org/EntertainmentBusiness>.
pub trait EntertainmentBusinessTrait {}
impl EntertainmentBusinessTrait for EntertainmentBusiness {}
impl LocalBusinessTrait for EntertainmentBusiness {
...
impl ThingTrait for EntertainmentBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for EntertainmentBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EntertainmentBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for EntertainmentBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EntertainmentBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EntertainmentBusiness")
				}
			...
			deserializer.deserialize_struct("EntertainmentBusiness", FIELDS, ClassVisitor)
		}
	}
}
