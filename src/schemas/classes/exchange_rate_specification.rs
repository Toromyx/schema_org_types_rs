...
pub struct ExchangeRateSpecification {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "currentExchangeRate"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/currentExchangeRate")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/currentExchangeRate")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "exchangeRateSpread"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/exchangeRateSpread")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/exchangeRateSpread")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
