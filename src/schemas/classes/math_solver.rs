...
pub struct MathSolver {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "mathExpression"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/mathExpression"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/mathExpression"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
