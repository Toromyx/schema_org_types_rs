...
pub struct RentalCarReservation {
	...
	pub r#dropoff_location: Vec<DropoffLocationProperty>,
	/// <https://schema.org/dropoffTime>
	pub r#dropoff_time: Vec<DropoffTimeProperty>,
	/// <https://schema.org/pickupLocation>
	pub r#pickup_location: Vec<PickupLocationProperty>,
...
pub trait RentalCarReservationTrait {
	/// Get <https://schema.org/dropoffLocation> from [`Self`] as borrowed slice.
	fn get_dropoff_location(&self) -> &[DropoffLocationProperty];
	/// Take <https://schema.org/dropoffLocation> from [`Self`] as owned vector.
	fn take_dropoff_location(&mut self) -> Vec<DropoffLocationProperty>;
	/// Get <https://schema.org/dropoffTime> from [`Self`] as borrowed slice.
	fn get_dropoff_time(&self) -> &[DropoffTimeProperty];
	/// Take <https://schema.org/dropoffTime> from [`Self`] as owned vector.
	fn take_dropoff_time(&mut self) -> Vec<DropoffTimeProperty>;
	/// Get <https://schema.org/pickupLocation> from [`Self`] as borrowed slice.
	fn get_pickup_location(&self) -> &[PickupLocationProperty];
	/// Take <https://schema.org/pickupLocation> from [`Self`] as owned vector.
	fn take_pickup_location(&mut self) -> Vec<PickupLocationProperty>;
	/// Get <https://schema.org/pickupTime> from [`Self`] as borrowed slice.
	fn get_pickup_time(&self) -> &[PickupTimeProperty];
	/// Take <https://schema.org/pickupTime> from [`Self`] as owned vector.
	fn take_pickup_time(&mut self) -> Vec<PickupTimeProperty>;
}
impl RentalCarReservationTrait for RentalCarReservation {
	fn get_dropoff_location(&self) -> &[DropoffLocationProperty] {
		self.r#dropoff_location.as_slice()
	}
	fn take_dropoff_location(&mut self) -> Vec<DropoffLocationProperty> {
		std::mem::take(&mut self.r#dropoff_location)
	}
	fn get_dropoff_time(&self) -> &[DropoffTimeProperty] {
		self.r#dropoff_time.as_slice()
	}
	fn take_dropoff_time(&mut self) -> Vec<DropoffTimeProperty> {
		std::mem::take(&mut self.r#dropoff_time)
	}
	fn get_pickup_location(&self) -> &[PickupLocationProperty] {
		self.r#pickup_location.as_slice()
	}
	fn take_pickup_location(&mut self) -> Vec<PickupLocationProperty> {
		std::mem::take(&mut self.r#pickup_location)
	}
	fn get_pickup_time(&self) -> &[PickupTimeProperty] {
		self.r#pickup_time.as_slice()
	}
	fn take_pickup_time(&mut self) -> Vec<PickupTimeProperty> {
		std::mem::take(&mut self.r#pickup_time)
	}
}
impl ReservationTrait for RentalCarReservation {
...
impl ThingTrait for RentalCarReservation {
...
mod serde {
	...
	use super::*;
	impl Serialize for RentalCarReservation {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#dropoff_location) as usize,
				!Vec::is_empty(&self.r#dropoff_time) as usize,
				!Vec::is_empty(&self.r#pickup_location) as usize,
				!Vec::is_empty(&self.r#pickup_time) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RentalCarReservation", len)?;
			if !Vec::is_empty(&self.r#dropoff_location) {
				serialize_struct.serialize_field("dropoffLocation", {
					struct SerializeWith<'a>(&'a Vec<DropoffLocationProperty>);
					...
					&SerializeWith(&self.r#dropoff_location)
				})?;
			} else {
				serialize_struct.skip_field("dropoffLocation")?;
			}
			if !Vec::is_empty(&self.r#dropoff_time) {
				serialize_struct.serialize_field("dropoffTime", {
					struct SerializeWith<'a>(&'a Vec<DropoffTimeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#dropoff_time)
				})?;
			} else {
				serialize_struct.skip_field("dropoffTime")?;
			}
			if !Vec::is_empty(&self.r#pickup_location) {
				serialize_struct.serialize_field("pickupLocation", {
					struct SerializeWith<'a>(&'a Vec<PickupLocationProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#pickup_location)
				})?;
			} else {
				serialize_struct.skip_field("pickupLocation")?;
			}
			if !Vec::is_empty(&self.r#pickup_time) {
				serialize_struct.serialize_field("pickupTime", {
					struct SerializeWith<'a>(&'a Vec<PickupTimeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#pickup_time)
				})?;
			} else {
				serialize_struct.skip_field("pickupTime")?;
			}
	...
	impl<'de> Deserialize<'de> for RentalCarReservation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"dropoffLocation" => Ok(Field::DropoffLocation),
						"dropoffTime" => Ok(Field::DropoffTime),
						"pickupLocation" => Ok(Field::PickupLocation),
						"pickupTime" => Ok(Field::PickupTime),
				...
				{
					match value {
						b"dropoffLocation" => Ok(Field::DropoffLocation),
						b"dropoffTime" => Ok(Field::DropoffTime),
						b"pickupLocation" => Ok(Field::PickupLocation),
						b"pickupTime" => Ok(Field::PickupTime),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RentalCarReservation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RentalCarReservation")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#dropoff_location_property = None;
					let mut r#dropoff_time_property = None;
					let mut r#pickup_location_property = None;
					let mut r#pickup_time_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::DropoffLocation => {
								if r#dropoff_location_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dropoffLocation",
									));
								}
								r#dropoff_location_property = Some({
									struct DeserializeWith(Vec<DropoffLocationProperty>);
							...
							Field::DropoffTime => {
								if r#dropoff_time_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dropoffTime",
									));
								}
								r#dropoff_time_property = Some({
									struct DeserializeWith(Vec<DropoffTimeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::PickupLocation => {
								if r#pickup_location_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"pickupLocation",
									));
								}
								r#pickup_location_property = Some({
									struct DeserializeWith(Vec<PickupLocationProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::PickupTime => {
								if r#pickup_time_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"pickupTime",
									));
								}
								r#pickup_time_property = Some({
									struct DeserializeWith(Vec<PickupTimeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(RentalCarReservation {
						r#dropoff_location: r#dropoff_location_property.unwrap_or_default(),
						r#dropoff_time: r#dropoff_time_property.unwrap_or_default(),
						r#pickup_location: r#pickup_location_property.unwrap_or_default(),
						r#pickup_time: r#pickup_time_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("RentalCarReservation", FIELDS, ClassVisitor)
		}
	}
}
