...
/// This trait is for properties from <https://schema.org/GasStation>.
pub trait GasStationTrait {}
impl GasStationTrait for GasStation {}
impl AutomotiveBusinessTrait for GasStation {}
impl LocalBusinessTrait for GasStation {
...
impl ThingTrait for GasStation {
...
mod serde {
	...
	impl Serialize for GasStation {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "GasStation", len)?;
	...
	impl<'de> Deserialize<'de> for GasStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GasStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GasStation")
				}
			...
			deserializer.deserialize_struct("GasStation", FIELDS, ClassVisitor)
		}
	}
}
