...
/// This trait is for properties from <https://schema.org/Motel>.
pub trait MotelTrait {}
impl MotelTrait for Motel {}
impl LocalBusinessTrait for Motel {
...
impl LodgingBusinessTrait for Motel {
...
mod serde {
	...
	impl Serialize for Motel {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Motel", len)?;
	...
	impl<'de> Deserialize<'de> for Motel {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Motel;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Motel")
				}
			...
			deserializer.deserialize_struct("Motel", FIELDS, ClassVisitor)
		}
	}
}
