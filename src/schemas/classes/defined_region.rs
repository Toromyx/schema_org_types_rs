...
pub struct DefinedRegion {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "postalCodePrefix"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/postalCodePrefix")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/postalCodePrefix"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "postalCodeRange"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/postalCodeRange"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/postalCodeRange"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
