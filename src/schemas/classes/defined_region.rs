...
mod serde {
	...
	use super::*;
	impl Serialize for DefinedRegion {
	...
	impl<'de> Deserialize<'de> for DefinedRegion {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DefinedRegion;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DefinedRegion")
				}
			...
			deserializer.deserialize_struct("DefinedRegion", FIELDS, ClassVisitor)
		}
	}
}
