...
/// This trait is for properties from <https://schema.org/FastFoodRestaurant>.
pub trait FastFoodRestaurantTrait {}
impl FastFoodRestaurantTrait for FastFoodRestaurant {}
impl FoodEstablishmentTrait for FastFoodRestaurant {
...
impl LocalBusinessTrait for FastFoodRestaurant {
...
impl ThingTrait for FastFoodRestaurant {
...
mod serde {
	...
	use super::*;
	impl Serialize for FastFoodRestaurant {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FastFoodRestaurant", len)?;
	...
	impl<'de> Deserialize<'de> for FastFoodRestaurant {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FastFoodRestaurant;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FastFoodRestaurant")
				}
			...
			deserializer.deserialize_struct("FastFoodRestaurant", FIELDS, ClassVisitor)
		}
	}
}
