...
pub struct ReplaceAction {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "collection"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "replacee"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "replacer"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "targetCollection"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
