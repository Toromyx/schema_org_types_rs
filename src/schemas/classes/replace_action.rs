...
pub struct ReplaceAction {
	...
	pub r#replacee: Vec<ReplaceeProperty>,
	/// <https://schema.org/replacer>
	pub r#replacer: Vec<ReplacerProperty>,
...
impl ReplaceActionTrait for ReplaceAction {
	fn get_replacee(&self) -> &[ReplaceeProperty] {
		self.r#replacee.as_slice()
	}
	fn take_replacee(&mut self) -> Vec<ReplaceeProperty> {
		std::mem::take(&mut self.r#replacee)
	}
	fn get_replacer(&self) -> &[ReplacerProperty] {
		self.r#replacer.as_slice()
	}
	fn take_replacer(&mut self) -> Vec<ReplacerProperty> {
		std::mem::take(&mut self.r#replacer)
	}
}
...
impl ThingTrait for ReplaceAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReplaceAction {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#replacee) as usize,
				!Vec::is_empty(&self.r#replacer) as usize,
				...
				!Vec::is_empty(&self.r#collection) as usize,
				!Vec::is_empty(&self.r#target_collection) as usize,
			]
			.iter()
			.sum();
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReplaceAction", len)?;
			if !Vec::is_empty(&self.r#replacee) {
				serialize_struct.serialize_field("replacee", {
					struct SerializeWith<'a>(&'a Vec<ReplaceeProperty>);
					...
					&SerializeWith(&self.r#replacee)
				})?;
			} else {
				serialize_struct.skip_field("replacee")?;
			}
			if !Vec::is_empty(&self.r#replacer) {
				serialize_struct.serialize_field("replacer", {
					struct SerializeWith<'a>(&'a Vec<ReplacerProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#replacer)
				})?;
			} else {
				serialize_struct.skip_field("replacer")?;
			}
			...
			if !Vec::is_empty(&self.r#collection) {
				serialize_struct.serialize_field("collection", {
					struct SerializeWith<'a>(&'a Vec<CollectionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#collection)
				})?;
			} else {
				serialize_struct.skip_field("collection")?;
			}
			if !Vec::is_empty(&self.r#target_collection) {
				serialize_struct.serialize_field("targetCollection", {
					struct SerializeWith<'a>(&'a Vec<TargetCollectionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#target_collection)
				})?;
			} else {
				serialize_struct.skip_field("targetCollection")?;
			}
			serialize_struct.end()
		}
	}
	impl<'de> Deserialize<'de> for ReplaceAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"replacee" => Ok(Field::Replacee),
						"replacer" => Ok(Field::Replacer),
				...
				{
					match value {
						b"replacee" => Ok(Field::Replacee),
						b"replacer" => Ok(Field::Replacer),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReplaceAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReplaceAction")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#replacee_property = None;
					let mut r#replacer_property = None;
					...
					let mut r#collection_property = None;
					let mut r#target_collection_property = None;
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Replacee => {
								if r#replacee_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"replacee",
									));
								}
								r#replacee_property = Some({
									struct DeserializeWith(Vec<ReplaceeProperty>);
							...
							Field::Replacer => {
								if r#replacer_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"replacer",
									));
								}
								r#replacer_property = Some({
									struct DeserializeWith(Vec<ReplacerProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Collection => {
								if r#collection_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"collection",
									));
								}
								r#collection_property = Some({
									struct DeserializeWith(Vec<CollectionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TargetCollection => {
								if r#target_collection_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"targetCollection",
									));
								}
								r#target_collection_property = Some({
									struct DeserializeWith(Vec<TargetCollectionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(ReplaceAction {
						r#replacee: r#replacee_property.unwrap_or_default(),
						r#replacer: r#replacer_property.unwrap_or_default(),
						...
						r#collection: r#collection_property.unwrap_or_default(),
						r#target_collection: r#target_collection_property.unwrap_or_default(),
					})
				}
			}
			const FIELDS: &[&str] = &[
			...
			deserializer.deserialize_struct("ReplaceAction", FIELDS, ClassVisitor)
		}
	}
}
