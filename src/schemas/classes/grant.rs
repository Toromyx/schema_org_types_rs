...
pub struct Grant {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "fundedItem"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/fundedItem"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/fundedItem"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
