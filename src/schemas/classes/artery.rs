...
pub struct Artery {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "arterialBranch"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/arterialBranch"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/arterialBranch"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "supplyTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/supplyTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/supplyTo"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
