...
/// This trait is for properties from <https://schema.org/WPSideBar>.
pub trait WpSideBarTrait {}
impl WpSideBarTrait for WpSideBar {}
impl CreativeWorkTrait for WpSideBar {
...
impl WebPageElementTrait for WpSideBar {
...
mod serde {
	...
	impl Serialize for WpSideBar {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "WpSideBar", len)?;
	...
	impl<'de> Deserialize<'de> for WpSideBar {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WpSideBar;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WPSideBar")
				}
			...
			deserializer.deserialize_struct("WpSideBar", FIELDS, ClassVisitor)
		}
	}
}
