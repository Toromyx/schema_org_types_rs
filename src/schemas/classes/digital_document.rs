...
/// This trait is for properties from <https://schema.org/DigitalDocument>.
pub trait DigitalDocumentTrait {
	/// Get <https://schema.org/hasDigitalDocumentPermission> from [`Self`] as borrowed slice.
	fn get_has_digital_document_permission(&self) -> &[HasDigitalDocumentPermissionProperty];
	/// Take <https://schema.org/hasDigitalDocumentPermission> from [`Self`] as owned vector.
	fn take_has_digital_document_permission(&mut self)
	-> Vec<HasDigitalDocumentPermissionProperty>;
}
impl DigitalDocumentTrait for DigitalDocument {
	fn get_has_digital_document_permission(&self) -> &[HasDigitalDocumentPermissionProperty] {
...
impl CreativeWorkTrait for DigitalDocument {
...
impl ThingTrait for DigitalDocument {
...
mod serde {
	...
	use super::*;
	impl Serialize for DigitalDocument {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DigitalDocument", len)?;
	...
	impl<'de> Deserialize<'de> for DigitalDocument {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DigitalDocument;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DigitalDocument")
				}
			...
			deserializer.deserialize_struct("DigitalDocument", FIELDS, ClassVisitor)
		}
	}
}
