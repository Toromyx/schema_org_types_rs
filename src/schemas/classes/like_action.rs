...
/// This trait is for properties from <https://schema.org/LikeAction>.
pub trait LikeActionTrait {}
impl LikeActionTrait for LikeAction {}
...
impl AssessActionTrait for LikeAction {}
impl ReactActionTrait for LikeAction {}
impl ThingTrait for LikeAction {
...
mod serde {
	...
	impl Serialize for LikeAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "LikeAction", len)?;
	...
	impl<'de> Deserialize<'de> for LikeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LikeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LikeAction")
				}
			...
			deserializer.deserialize_struct("LikeAction", FIELDS, ClassVisitor)
		}
	}
}
