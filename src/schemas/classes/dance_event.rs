...
/// This trait is for properties from <https://schema.org/DanceEvent>.
pub trait DanceEventTrait {}
impl DanceEventTrait for DanceEvent {}
impl EventTrait for DanceEvent {
...
impl ThingTrait for DanceEvent {
...
mod serde {
	...
	impl Serialize for DanceEvent {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "DanceEvent", len)?;
	...
	impl<'de> Deserialize<'de> for DanceEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DanceEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DanceEvent")
				}
			...
			deserializer.deserialize_struct("DanceEvent", FIELDS, ClassVisitor)
		}
	}
}
