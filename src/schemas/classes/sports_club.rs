...
/// This trait is for properties from <https://schema.org/SportsClub>.
pub trait SportsClubTrait {}
impl SportsClubTrait for SportsClub {}
impl LocalBusinessTrait for SportsClub {
...
impl SportsActivityLocationTrait for SportsClub {}
impl ThingTrait for SportsClub {
...
mod serde {
	...
	impl Serialize for SportsClub {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "SportsClub", len)?;
	...
	impl<'de> Deserialize<'de> for SportsClub {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SportsClub;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SportsClub")
				}
			...
			deserializer.deserialize_struct("SportsClub", FIELDS, ClassVisitor)
		}
	}
}
