...
/// This trait is for properties from <https://schema.org/DisagreeAction>.
pub trait DisagreeActionTrait {}
impl DisagreeActionTrait for DisagreeAction {}
...
impl AssessActionTrait for DisagreeAction {}
impl ReactActionTrait for DisagreeAction {}
impl ThingTrait for DisagreeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DisagreeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DisagreeAction", len)?;
	...
	impl<'de> Deserialize<'de> for DisagreeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DisagreeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DisagreeAction")
				}
			...
			deserializer.deserialize_struct("DisagreeAction", FIELDS, ClassVisitor)
		}
	}
}
