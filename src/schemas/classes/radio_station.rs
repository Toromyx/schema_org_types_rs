...
/// This trait is for properties from <https://schema.org/RadioStation>.
pub trait RadioStationTrait {}
impl RadioStationTrait for RadioStation {}
impl LocalBusinessTrait for RadioStation {
...
impl ThingTrait for RadioStation {
	...
	impl Serialize for RadioStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RadioStation", len)?;
	...
	impl<'de> Deserialize<'de> for RadioStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioStation")
				}
			...
			deserializer.deserialize_struct("RadioStation", FIELDS, ClassVisitor)
		}
	}
}
