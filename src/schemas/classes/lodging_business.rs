...
/// This trait is for properties from <https://schema.org/LodgingBusiness>.
pub trait LodgingBusinessTrait {
...
impl LodgingBusinessTrait for LodgingBusiness {
	fn get_amenity_feature(&self) -> &[AmenityFeatureProperty] {
...
impl LocalBusinessTrait for LodgingBusiness {
...
impl ThingTrait for LodgingBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for LodgingBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LodgingBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for LodgingBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LodgingBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LodgingBusiness")
				}
			...
			deserializer.deserialize_struct("LodgingBusiness", FIELDS, ClassVisitor)
		}
	}
}
