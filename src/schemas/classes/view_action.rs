...
/// This trait is for properties from <https://schema.org/ViewAction>.
pub trait ViewActionTrait {}
impl ViewActionTrait for ViewAction {}
...
impl ConsumeActionTrait for ViewAction {
...
impl ThingTrait for ViewAction {
...
mod serde {
	...
	impl Serialize for ViewAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ViewAction", len)?;
	...
	impl<'de> Deserialize<'de> for ViewAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ViewAction")
				}
			...
			deserializer.deserialize_struct("ViewAction", FIELDS, ClassVisitor)
		}
	}
}
