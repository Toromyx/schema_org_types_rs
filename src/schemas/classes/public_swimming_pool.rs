...
/// This trait is for properties from <https://schema.org/PublicSwimmingPool>.
pub trait PublicSwimmingPoolTrait {}
impl PublicSwimmingPoolTrait for PublicSwimmingPool {}
impl LocalBusinessTrait for PublicSwimmingPool {
...
impl SportsActivityLocationTrait for PublicSwimmingPool {}
impl ThingTrait for PublicSwimmingPool {
...
mod serde {
	...
	use super::*;
	impl Serialize for PublicSwimmingPool {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PublicSwimmingPool", len)?;
	...
	impl<'de> Deserialize<'de> for PublicSwimmingPool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PublicSwimmingPool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PublicSwimmingPool")
				}
			...
			deserializer.deserialize_struct("PublicSwimmingPool", FIELDS, ClassVisitor)
		}
	}
}
