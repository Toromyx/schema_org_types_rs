...
pub struct SportsEvent {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/awayTeam"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/awayTeam"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/competitor"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/competitor"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/homeTeam"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/homeTeam"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
