...
impl SportsEventTrait for SportsEvent {
	...
	fn take_away_team(&mut self) -> Vec<AwayTeamProperty> {
		std::mem::take(&mut self.r#away_team)
	}
	fn get_competitor(&self) -> &[CompetitorProperty] {
		self.r#competitor.as_slice()
	}
	fn take_competitor(&mut self) -> Vec<CompetitorProperty> {
		std::mem::take(&mut self.r#competitor)
	}
	fn get_home_team(&self) -> &[HomeTeamProperty] {
		self.r#home_team.as_slice()
	}
	fn take_home_team(&mut self) -> Vec<HomeTeamProperty> {
		std::mem::take(&mut self.r#home_team)
	}
	fn get_sport(&self) -> &[SportProperty] {
		self.r#sport.as_slice()
	}
	fn take_sport(&mut self) -> Vec<SportProperty> {
		std::mem::take(&mut self.r#sport)
	}
}
...
mod serde {
	...
	use super::*;
	impl Serialize for SportsEvent {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#away_team) as usize,
				!Vec::is_empty(&self.r#competitor) as usize,
				!Vec::is_empty(&self.r#home_team) as usize,
				!Vec::is_empty(&self.r#sport) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SportsEvent", len)?;
			if !Vec::is_empty(&self.r#away_team) {
				serialize_struct.serialize_field("awayTeam", {
					struct SerializeWith<'a>(&'a Vec<AwayTeamProperty>);
					...
					&SerializeWith(&self.r#away_team)
				})?;
			} else {
				serialize_struct.skip_field("awayTeam")?;
			}
			if !Vec::is_empty(&self.r#competitor) {
				serialize_struct.serialize_field("competitor", {
					struct SerializeWith<'a>(&'a Vec<CompetitorProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#competitor)
				})?;
			} else {
				serialize_struct.skip_field("competitor")?;
			}
			if !Vec::is_empty(&self.r#home_team) {
				serialize_struct.serialize_field("homeTeam", {
					struct SerializeWith<'a>(&'a Vec<HomeTeamProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#home_team)
				})?;
			} else {
				serialize_struct.skip_field("homeTeam")?;
			}
			if !Vec::is_empty(&self.r#sport) {
				serialize_struct.serialize_field("sport", {
					struct SerializeWith<'a>(&'a Vec<SportProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#sport)
				})?;
			} else {
				serialize_struct.skip_field("sport")?;
			}
	...
	impl<'de> Deserialize<'de> for SportsEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"awayTeam" => Ok(Field::AwayTeam),
						"competitor" => Ok(Field::Competitor),
						"homeTeam" => Ok(Field::HomeTeam),
				...
				{
					match value {
						b"awayTeam" => Ok(Field::AwayTeam),
						b"competitor" => Ok(Field::Competitor),
						b"homeTeam" => Ok(Field::HomeTeam),
						b"sport" => Ok(Field::Sport),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SportsEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SportsEvent")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#away_team_property = None;
					let mut r#competitor_property = None;
					let mut r#home_team_property = None;
					let mut r#sport_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AwayTeam => {
								if r#away_team_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"awayTeam",
									));
								}
								r#away_team_property = Some({
									struct DeserializeWith(Vec<AwayTeamProperty>);
							...
							Field::Competitor => {
								if r#competitor_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"competitor",
									));
								}
								r#competitor_property = Some({
									struct DeserializeWith(Vec<CompetitorProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::HomeTeam => {
								if r#home_team_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"homeTeam",
									));
								}
								r#home_team_property = Some({
									struct DeserializeWith(Vec<HomeTeamProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Sport => {
								if r#sport_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("sport"));
								}
								r#sport_property = Some({
									struct DeserializeWith(Vec<SportProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(SportsEvent {
						r#away_team: r#away_team_property.unwrap_or_default(),
						r#competitor: r#competitor_property.unwrap_or_default(),
						r#home_team: r#home_team_property.unwrap_or_default(),
						r#sport: r#sport_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("SportsEvent", FIELDS, ClassVisitor)
		}
	}
}
