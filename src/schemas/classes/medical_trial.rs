...
pub struct MedicalTrial {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "studyLocation"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/studyLocation"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/studyLocation"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "studySubject"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/studySubject"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/studySubject"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "trialDesign"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/trialDesign"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/trialDesign"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
