...
/// This trait is for properties from <https://schema.org/CafeOrCoffeeShop>.
pub trait CafeOrCoffeeShopTrait {}
impl CafeOrCoffeeShopTrait for CafeOrCoffeeShop {}
impl FoodEstablishmentTrait for CafeOrCoffeeShop {
...
impl LocalBusinessTrait for CafeOrCoffeeShop {
...
impl ThingTrait for CafeOrCoffeeShop {
...
mod serde {
	...
	use super::*;
	impl Serialize for CafeOrCoffeeShop {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CafeOrCoffeeShop", len)?;
	...
	impl<'de> Deserialize<'de> for CafeOrCoffeeShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CafeOrCoffeeShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CafeOrCoffeeShop")
				}
			...
			deserializer.deserialize_struct("CafeOrCoffeeShop", FIELDS, ClassVisitor)
		}
	}
}
