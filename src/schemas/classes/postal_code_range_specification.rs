...
pub struct PostalCodeRangeSpecification {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "postalCodeBegin"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/postalCodeBegin"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/postalCodeBegin"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "postalCodeEnd"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/postalCodeEnd"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/postalCodeEnd"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
