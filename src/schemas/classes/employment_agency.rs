...
/// This trait is for properties from <https://schema.org/EmploymentAgency>.
pub trait EmploymentAgencyTrait {}
impl EmploymentAgencyTrait for EmploymentAgency {}
impl LocalBusinessTrait for EmploymentAgency {
...
impl ThingTrait for EmploymentAgency {
...
mod serde {
	...
	use super::*;
	impl Serialize for EmploymentAgency {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EmploymentAgency", len)?;
	...
	impl<'de> Deserialize<'de> for EmploymentAgency {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EmploymentAgency;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EmploymentAgency")
				}
			...
			deserializer.deserialize_struct("EmploymentAgency", FIELDS, ClassVisitor)
		}
	}
}
