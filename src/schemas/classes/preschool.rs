...
/// This trait is for properties from <https://schema.org/Preschool>.
pub trait PreschoolTrait {}
impl PreschoolTrait for Preschool {}
impl CivicStructureTrait for Preschool {
...
impl EducationalOrganizationTrait for Preschool {
...
mod serde {
	...
	impl Serialize for Preschool {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Preschool", len)?;
	...
	impl<'de> Deserialize<'de> for Preschool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Preschool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Preschool")
				}
			...
			deserializer.deserialize_struct("Preschool", FIELDS, ClassVisitor)
		}
	}
}
