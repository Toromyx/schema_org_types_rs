...
/// This trait is for properties from <https://schema.org/Campground>.
pub trait CampgroundTrait {}
impl CampgroundTrait for Campground {}
impl CivicStructureTrait for Campground {
...
impl LocalBusinessTrait for Campground {
...
impl LodgingBusinessTrait for Campground {
...
impl ThingTrait for Campground {
...
mod serde {
	...
	impl Serialize for Campground {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Campground", len)?;
	...
	impl<'de> Deserialize<'de> for Campground {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Campground;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Campground")
				}
			...
			deserializer.deserialize_struct("Campground", FIELDS, ClassVisitor)
		}
	}
}
