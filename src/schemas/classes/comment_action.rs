...
impl CommentActionTrait for CommentAction {
	fn get_result_comment(&self) -> &[ResultCommentProperty] {
...
impl CommunicateActionTrait for CommentAction {
...
impl InteractActionTrait for CommentAction {}
impl ThingTrait for CommentAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CommentAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CommentAction", len)?;
	...
	impl<'de> Deserialize<'de> for CommentAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CommentAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CommentAction")
				}
			...
			deserializer.deserialize_struct("CommentAction", FIELDS, ClassVisitor)
		}
	}
}
