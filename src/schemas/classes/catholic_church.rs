...
/// This trait is for properties from <https://schema.org/CatholicChurch>.
pub trait CatholicChurchTrait {}
impl CatholicChurchTrait for CatholicChurch {}
impl ChurchTrait for CatholicChurch {}
impl CivicStructureTrait for CatholicChurch {
...
impl PlaceOfWorshipTrait for CatholicChurch {}
impl ThingTrait for CatholicChurch {
...
mod serde {
	...
	use super::*;
	impl Serialize for CatholicChurch {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CatholicChurch", len)?;
	...
	impl<'de> Deserialize<'de> for CatholicChurch {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CatholicChurch;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CatholicChurch")
				}
			...
			deserializer.deserialize_struct("CatholicChurch", FIELDS, ClassVisitor)
		}
	}
}
