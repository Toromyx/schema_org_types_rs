...
/// This trait is for properties from <https://schema.org/QuoteAction>.
pub trait QuoteActionTrait {}
impl QuoteActionTrait for QuoteAction {}
...
impl ThingTrait for QuoteAction {
...
impl TradeActionTrait for QuoteAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for QuoteAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "QuoteAction", len)?;
	...
	impl<'de> Deserialize<'de> for QuoteAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = QuoteAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema QuoteAction")
				}
			...
			deserializer.deserialize_struct("QuoteAction", FIELDS, ClassVisitor)
		}
	}
}
