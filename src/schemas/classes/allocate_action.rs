...
/// This trait is for properties from <https://schema.org/AllocateAction>.
pub trait AllocateActionTrait {}
impl AllocateActionTrait for AllocateAction {}
...
impl OrganizeActionTrait for AllocateAction {}
impl ThingTrait for AllocateAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AllocateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AllocateAction", len)?;
	...
	impl<'de> Deserialize<'de> for AllocateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AllocateAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AllocateAction")
				}
			...
			deserializer.deserialize_struct("AllocateAction", FIELDS, ClassVisitor)
		}
	}
}
