...
/// This trait is for properties from <https://schema.org/DepartAction>.
pub trait DepartActionTrait {}
impl DepartActionTrait for DepartAction {}
...
impl MoveActionTrait for DepartAction {
...
impl ThingTrait for DepartAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DepartAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DepartAction", len)?;
	...
	impl<'de> Deserialize<'de> for DepartAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DepartAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DepartAction")
				}
			...
			deserializer.deserialize_struct("DepartAction", FIELDS, ClassVisitor)
		}
	}
}
