...
/// This trait is for properties from <https://schema.org/HealthAndBeautyBusiness>.
pub trait HealthAndBeautyBusinessTrait {}
impl HealthAndBeautyBusinessTrait for HealthAndBeautyBusiness {}
impl LocalBusinessTrait for HealthAndBeautyBusiness {
...
impl ThingTrait for HealthAndBeautyBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for HealthAndBeautyBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HealthAndBeautyBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for HealthAndBeautyBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HealthAndBeautyBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HealthAndBeautyBusiness")
				}
			...
			deserializer.deserialize_struct("HealthAndBeautyBusiness", FIELDS, ClassVisitor)
		}
	}
}
