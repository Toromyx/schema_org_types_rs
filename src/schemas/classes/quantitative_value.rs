...
impl QuantitativeValueTrait for QuantitativeValue {
	fn get_additional_property(&self) -> &[AdditionalPropertyProperty] {
...
impl StructuredValueTrait for QuantitativeValue {}
impl ThingTrait for QuantitativeValue {
...
mod serde {
	...
	use super::*;
	impl Serialize for QuantitativeValue {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "QuantitativeValue", len)?;
	...
	impl<'de> Deserialize<'de> for QuantitativeValue {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = QuantitativeValue;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema QuantitativeValue")
				}
			...
			deserializer.deserialize_struct("QuantitativeValue", FIELDS, ClassVisitor)
		}
	}
}
