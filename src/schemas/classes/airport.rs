...
pub struct Airport {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "iataCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/iataCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/iataCode"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "icaoCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/icaoCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/icaoCode"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
