...
/// This trait is for properties from <https://schema.org/TattooParlor>.
pub trait TattooParlorTrait {}
impl TattooParlorTrait for TattooParlor {}
impl HealthAndBeautyBusinessTrait for TattooParlor {}
impl LocalBusinessTrait for TattooParlor {
...
impl ThingTrait for TattooParlor {
...
mod serde {
	...
	use super::*;
	impl Serialize for TattooParlor {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TattooParlor", len)?;
	...
	impl<'de> Deserialize<'de> for TattooParlor {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TattooParlor;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TattooParlor")
				}
			...
			deserializer.deserialize_struct("TattooParlor", FIELDS, ClassVisitor)
		}
	}
}
