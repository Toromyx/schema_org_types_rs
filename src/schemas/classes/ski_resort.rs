...
/// This trait is for properties from <https://schema.org/SkiResort>.
pub trait SkiResortTrait {}
impl SkiResortTrait for SkiResort {}
impl LocalBusinessTrait for SkiResort {
...
impl LodgingBusinessTrait for SkiResort {
...
impl ResortTrait for SkiResort {}
impl SportsActivityLocationTrait for SkiResort {}
impl ThingTrait for SkiResort {
...
mod serde {
	...
	impl Serialize for SkiResort {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "SkiResort", len)?;
	...
	impl<'de> Deserialize<'de> for SkiResort {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SkiResort;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SkiResort")
				}
			...
			deserializer.deserialize_struct("SkiResort", FIELDS, ClassVisitor)
		}
	}
}
