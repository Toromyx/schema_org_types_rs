...
pub struct Property {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "domainIncludes"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/domainIncludes"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/domainIncludes"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "inverseOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/inverseOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/inverseOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "rangeIncludes"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/rangeIncludes"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/rangeIncludes"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
