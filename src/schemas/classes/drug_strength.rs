...
impl DrugStrengthTrait for DrugStrength {
	...
	fn get_available_in(&self) -> &[AvailableInProperty] {
		self.r#available_in.as_slice()
	}
	fn take_available_in(&mut self) -> Vec<AvailableInProperty> {
		std::mem::take(&mut self.r#available_in)
	}
	fn get_maximum_intake(&self) -> &[MaximumIntakeProperty] {
	...
	fn get_strength_unit(&self) -> &[StrengthUnitProperty] {
		self.r#strength_unit.as_slice()
	}
	fn take_strength_unit(&mut self) -> Vec<StrengthUnitProperty> {
		std::mem::take(&mut self.r#strength_unit)
	}
	fn get_strength_value(&self) -> &[StrengthValueProperty] {
		self.r#strength_value.as_slice()
	}
	fn take_strength_value(&mut self) -> Vec<StrengthValueProperty> {
		std::mem::take(&mut self.r#strength_value)
	}
}
impl MedicalEntityTrait for DrugStrength {
...
impl MedicalIntangibleTrait for DrugStrength {}
impl ThingTrait for DrugStrength {
...
mod serde {
	...
	use super::*;
	impl Serialize for DrugStrength {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#available_in) as usize,
				!Vec::is_empty(&self.r#maximum_intake) as usize,
				!Vec::is_empty(&self.r#strength_unit) as usize,
				!Vec::is_empty(&self.r#strength_value) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DrugStrength", len)?;
			...
			if !Vec::is_empty(&self.r#available_in) {
				serialize_struct.serialize_field("availableIn", {
					struct SerializeWith<'a>(&'a Vec<AvailableInProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#available_in)
				})?;
			} else {
				serialize_struct.skip_field("availableIn")?;
			}
			...
			if !Vec::is_empty(&self.r#strength_unit) {
				serialize_struct.serialize_field("strengthUnit", {
					struct SerializeWith<'a>(&'a Vec<StrengthUnitProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#strength_unit)
				})?;
			} else {
				serialize_struct.skip_field("strengthUnit")?;
			}
			if !Vec::is_empty(&self.r#strength_value) {
				serialize_struct.serialize_field("strengthValue", {
					struct SerializeWith<'a>(&'a Vec<StrengthValueProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#strength_value)
				})?;
			} else {
				serialize_struct.skip_field("strengthValue")?;
			}
	...
	impl<'de> Deserialize<'de> for DrugStrength {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"availableIn" => Ok(Field::AvailableIn),
						"maximumIntake" => Ok(Field::MaximumIntake),
						"strengthUnit" => Ok(Field::StrengthUnit),
						"strengthValue" => Ok(Field::StrengthValue),
						"code" => Ok(Field::Code),
					...
					E: de::Error,
				{
					match value {
						...
						b"availableIn" => Ok(Field::AvailableIn),
						b"maximumIntake" => Ok(Field::MaximumIntake),
						b"strengthUnit" => Ok(Field::StrengthUnit),
						b"strengthValue" => Ok(Field::StrengthValue),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DrugStrength;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DrugStrength")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#available_in_property = None;
					let mut r#maximum_intake_property = None;
					let mut r#strength_unit_property = None;
					let mut r#strength_value_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::AvailableIn => {
								if r#available_in_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"availableIn",
									));
								}
								r#available_in_property = Some({
									struct DeserializeWith(Vec<AvailableInProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::StrengthUnit => {
								if r#strength_unit_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"strengthUnit",
									));
								}
								r#strength_unit_property = Some({
									struct DeserializeWith(Vec<StrengthUnitProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::StrengthValue => {
								if r#strength_value_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"strengthValue",
									));
								}
								r#strength_value_property = Some({
									struct DeserializeWith(Vec<StrengthValueProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(DrugStrength {
						...
						r#available_in: r#available_in_property.unwrap_or_default(),
						r#maximum_intake: r#maximum_intake_property.unwrap_or_default(),
						r#strength_unit: r#strength_unit_property.unwrap_or_default(),
						r#strength_value: r#strength_value_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("DrugStrength", FIELDS, ClassVisitor)
		}
	}
}
