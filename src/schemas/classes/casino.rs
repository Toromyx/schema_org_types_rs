...
/// This trait is for properties from <https://schema.org/Casino>.
pub trait CasinoTrait {}
impl CasinoTrait for Casino {}
impl EntertainmentBusinessTrait for Casino {}
impl LocalBusinessTrait for Casino {
...
mod serde {
	...
	impl Serialize for Casino {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Casino", len)?;
	...
	impl<'de> Deserialize<'de> for Casino {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Casino;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Casino")
				}
			...
			deserializer.deserialize_struct("Casino", FIELDS, ClassVisitor)
		}
	}
}
