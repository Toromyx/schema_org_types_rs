...
/// This trait is for properties from <https://schema.org/PoliticalParty>.
pub trait PoliticalPartyTrait {}
impl PoliticalPartyTrait for PoliticalParty {}
...
impl ThingTrait for PoliticalParty {
...
mod serde {
	...
	use super::*;
	impl Serialize for PoliticalParty {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PoliticalParty", len)?;
	...
	impl<'de> Deserialize<'de> for PoliticalParty {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PoliticalParty;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PoliticalParty")
				}
			...
			deserializer.deserialize_struct("PoliticalParty", FIELDS, ClassVisitor)
		}
	}
}
