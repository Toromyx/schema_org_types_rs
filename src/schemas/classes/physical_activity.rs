...
impl PhysicalActivityTrait for PhysicalActivity {
	fn get_associated_anatomy(&self) -> &[AssociatedAnatomyProperty] {
...
impl LifestyleModificationTrait for PhysicalActivity {}
impl MedicalEntityTrait for PhysicalActivity {
...
impl ThingTrait for PhysicalActivity {
...
mod serde {
	...
	use super::*;
	impl Serialize for PhysicalActivity {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PhysicalActivity", len)?;
	...
	impl<'de> Deserialize<'de> for PhysicalActivity {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PhysicalActivity;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PhysicalActivity")
				}
			...
			deserializer.deserialize_struct("PhysicalActivity", FIELDS, ClassVisitor)
		}
	}
}
