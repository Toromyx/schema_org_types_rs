...
/// This trait is for properties from <https://schema.org/Florist>.
pub trait FloristTrait {}
impl FloristTrait for Florist {}
impl LocalBusinessTrait for Florist {
...
impl StoreTrait for Florist {}
impl ThingTrait for Florist {
...
mod serde {
	...
	impl Serialize for Florist {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Florist", len)?;
	...
	impl<'de> Deserialize<'de> for Florist {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Florist;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Florist")
				}
			...
			deserializer.deserialize_struct("Florist", FIELDS, ClassVisitor)
		}
	}
}
