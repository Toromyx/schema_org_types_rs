...
/// This trait is for properties from <https://schema.org/BusStation>.
pub trait BusStationTrait {}
impl BusStationTrait for BusStation {}
impl CivicStructureTrait for BusStation {
...
impl ThingTrait for BusStation {
...
mod serde {
	...
	impl Serialize for BusStation {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "BusStation", len)?;
	...
	impl<'de> Deserialize<'de> for BusStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BusStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BusStation")
				}
			...
			deserializer.deserialize_struct("BusStation", FIELDS, ClassVisitor)
		}
	}
}
