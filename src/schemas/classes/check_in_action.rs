...
/// This trait is for properties from <https://schema.org/CheckInAction>.
pub trait CheckInActionTrait {}
impl CheckInActionTrait for CheckInAction {}
...
impl CommunicateActionTrait for CheckInAction {
...
impl InteractActionTrait for CheckInAction {}
impl ThingTrait for CheckInAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CheckInAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CheckInAction", len)?;
	...
	impl<'de> Deserialize<'de> for CheckInAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CheckInAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CheckInAction")
				}
			...
			deserializer.deserialize_struct("CheckInAction", FIELDS, ClassVisitor)
		}
	}
}
