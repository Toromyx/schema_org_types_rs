...
pub struct ProductModel {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/predecessorOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/predecessorOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/successorOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/successorOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
