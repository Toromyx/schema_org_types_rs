...
/// This trait is for properties from <https://schema.org/AnimalShelter>.
pub trait AnimalShelterTrait {}
impl AnimalShelterTrait for AnimalShelter {}
impl LocalBusinessTrait for AnimalShelter {
...
impl ThingTrait for AnimalShelter {
...
mod serde {
	...
	use super::*;
	impl Serialize for AnimalShelter {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AnimalShelter", len)?;
	...
	impl<'de> Deserialize<'de> for AnimalShelter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AnimalShelter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AnimalShelter")
				}
			...
			deserializer.deserialize_struct("AnimalShelter", FIELDS, ClassVisitor)
		}
	}
}
