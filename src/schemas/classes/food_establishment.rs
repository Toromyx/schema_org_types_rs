...
impl FoodEstablishmentTrait for FoodEstablishment {
	fn get_accepts_reservations(&self) -> &[AcceptsReservationsProperty] {
...
impl LocalBusinessTrait for FoodEstablishment {
...
impl ThingTrait for FoodEstablishment {
...
mod serde {
	...
	use super::*;
	impl Serialize for FoodEstablishment {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FoodEstablishment", len)?;
	...
	impl<'de> Deserialize<'de> for FoodEstablishment {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FoodEstablishment;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FoodEstablishment")
				}
			...
			deserializer.deserialize_struct("FoodEstablishment", FIELDS, ClassVisitor)
		}
	}
}
