...
/// This trait is for properties from <https://schema.org/AudioObjectSnapshot>.
pub trait AudioObjectSnapshotTrait {}
impl AudioObjectSnapshotTrait for AudioObjectSnapshot {}
impl AudioObjectTrait for AudioObjectSnapshot {
...
impl CreativeWorkTrait for AudioObjectSnapshot {
...
impl MediaObjectTrait for AudioObjectSnapshot {
...
impl ThingTrait for AudioObjectSnapshot {
...
mod serde {
	...
	use super::*;
	impl Serialize for AudioObjectSnapshot {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AudioObjectSnapshot", len)?;
	...
	impl<'de> Deserialize<'de> for AudioObjectSnapshot {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AudioObjectSnapshot;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AudioObjectSnapshot")
				}
			...
			deserializer.deserialize_struct("AudioObjectSnapshot", FIELDS, ClassVisitor)
		}
	}
}
