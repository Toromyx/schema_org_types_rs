...
/// This trait is for properties from <https://schema.org/VideoGameClip>.
pub trait VideoGameClipTrait {}
impl VideoGameClipTrait for VideoGameClip {}
impl ClipTrait for VideoGameClip {
...
impl CreativeWorkTrait for VideoGameClip {
...
impl ThingTrait for VideoGameClip {
...
mod serde {
	...
	use super::*;
	impl Serialize for VideoGameClip {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "VideoGameClip", len)?;
	...
	impl<'de> Deserialize<'de> for VideoGameClip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = VideoGameClip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema VideoGameClip")
				}
			...
			deserializer.deserialize_struct("VideoGameClip", FIELDS, ClassVisitor)
		}
	}
}
