...
/// This trait is for properties from <https://schema.org/HVACBusiness>.
pub trait HvacBusinessTrait {}
impl HvacBusinessTrait for HvacBusiness {}
impl HomeAndConstructionBusinessTrait for HvacBusiness {}
impl LocalBusinessTrait for HvacBusiness {
...
impl ThingTrait for HvacBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for HvacBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HvacBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for HvacBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HvacBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HVACBusiness")
				}
			...
			deserializer.deserialize_struct("HvacBusiness", FIELDS, ClassVisitor)
		}
	}
}
