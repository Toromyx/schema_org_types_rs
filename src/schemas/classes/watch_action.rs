...
/// This trait is for properties from <https://schema.org/WatchAction>.
pub trait WatchActionTrait {}
impl WatchActionTrait for WatchAction {}
...
impl ConsumeActionTrait for WatchAction {
...
impl ThingTrait for WatchAction {
	...
	impl Serialize for WatchAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "WatchAction", len)?;
	...
	impl<'de> Deserialize<'de> for WatchAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WatchAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WatchAction")
				}
			...
			deserializer.deserialize_struct("WatchAction", FIELDS, ClassVisitor)
		}
	}
}
