...
/// This trait is for properties from <https://schema.org/CityHall>.
pub trait CityHallTrait {}
impl CityHallTrait for CityHall {}
impl CivicStructureTrait for CityHall {
...
impl GovernmentBuildingTrait for CityHall {}
...
mod serde {
	...
	impl Serialize for CityHall {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "CityHall", len)?;
	...
	impl<'de> Deserialize<'de> for CityHall {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CityHall;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CityHall")
				}
			...
			deserializer.deserialize_struct("CityHall", FIELDS, ClassVisitor)
		}
	}
}
