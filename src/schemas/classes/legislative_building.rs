...
/// This trait is for properties from <https://schema.org/LegislativeBuilding>.
pub trait LegislativeBuildingTrait {}
impl LegislativeBuildingTrait for LegislativeBuilding {}
impl CivicStructureTrait for LegislativeBuilding {
...
impl GovernmentBuildingTrait for LegislativeBuilding {}
...
impl ThingTrait for LegislativeBuilding {
...
mod serde {
	...
	use super::*;
	impl Serialize for LegislativeBuilding {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LegislativeBuilding", len)?;
	...
	impl<'de> Deserialize<'de> for LegislativeBuilding {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LegislativeBuilding;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LegislativeBuilding")
				}
			...
			deserializer.deserialize_struct("LegislativeBuilding", FIELDS, ClassVisitor)
		}
	}
}
