...
/// This trait is for properties from <https://schema.org/OnlineStore>.
pub trait OnlineStoreTrait {}
impl OnlineStoreTrait for OnlineStore {}
impl OnlineBusinessTrait for OnlineStore {}
...
impl ThingTrait for OnlineStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for OnlineStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OnlineStore", len)?;
	...
	impl<'de> Deserialize<'de> for OnlineStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OnlineStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OnlineStore")
				}
			...
			deserializer.deserialize_struct("OnlineStore", FIELDS, ClassVisitor)
		}
	}
}
