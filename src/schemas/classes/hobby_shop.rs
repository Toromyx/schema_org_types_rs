...
/// This trait is for properties from <https://schema.org/HobbyShop>.
pub trait HobbyShopTrait {}
impl HobbyShopTrait for HobbyShop {}
impl LocalBusinessTrait for HobbyShop {
...
impl StoreTrait for HobbyShop {}
impl ThingTrait for HobbyShop {
...
mod serde {
	...
	impl Serialize for HobbyShop {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HobbyShop", len)?;
	...
	impl<'de> Deserialize<'de> for HobbyShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HobbyShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HobbyShop")
				}
			...
			deserializer.deserialize_struct("HobbyShop", FIELDS, ClassVisitor)
		}
	}
}
