...
/// This trait is for properties from <https://schema.org/BankOrCreditUnion>.
pub trait BankOrCreditUnionTrait {}
impl BankOrCreditUnionTrait for BankOrCreditUnion {}
impl FinancialServiceTrait for BankOrCreditUnion {
...
impl LocalBusinessTrait for BankOrCreditUnion {
...
impl ThingTrait for BankOrCreditUnion {
...
mod serde {
	...
	use super::*;
	impl Serialize for BankOrCreditUnion {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BankOrCreditUnion", len)?;
	...
	impl<'de> Deserialize<'de> for BankOrCreditUnion {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BankOrCreditUnion;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BankOrCreditUnion")
				}
			...
			deserializer.deserialize_struct("BankOrCreditUnion", FIELDS, ClassVisitor)
		}
	}
}
