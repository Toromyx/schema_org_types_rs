...
mod serde {
	...
	use super::*;
	impl Serialize for MerchantReturnPolicySeasonalOverride {
	...
	impl<'de> Deserialize<'de> for MerchantReturnPolicySeasonalOverride {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MerchantReturnPolicySeasonalOverride;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MerchantReturnPolicySeasonalOverride")
				}
