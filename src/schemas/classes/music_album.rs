...
pub trait MusicAlbumTrait {
	/// Get <https://schema.org/albumProductionType> from [`Self`] as borrowed slice.
	fn get_album_production_type(&self) -> &[AlbumProductionTypeProperty];
	/// Take <https://schema.org/albumProductionType> from [`Self`] as owned vector.
	fn take_album_production_type(&mut self) -> Vec<AlbumProductionTypeProperty>;
	/// Get <https://schema.org/albumRelease> from [`Self`] as borrowed slice.
	fn get_album_release(&self) -> &[AlbumReleaseProperty];
	/// Take <https://schema.org/albumRelease> from [`Self`] as owned vector.
	fn take_album_release(&mut self) -> Vec<AlbumReleaseProperty>;
	/// Get <https://schema.org/albumReleaseType> from [`Self`] as borrowed slice.
	fn get_album_release_type(&self) -> &[AlbumReleaseTypeProperty];
	/// Take <https://schema.org/albumReleaseType> from [`Self`] as owned vector.
...
impl MusicAlbumTrait for MusicAlbum {
	fn get_album_production_type(&self) -> &[AlbumProductionTypeProperty] {
		self.r#album_production_type.as_slice()
	}
	fn take_album_production_type(&mut self) -> Vec<AlbumProductionTypeProperty> {
		std::mem::take(&mut self.r#album_production_type)
	}
	fn get_album_release(&self) -> &[AlbumReleaseProperty] {
		self.r#album_release.as_slice()
	}
	fn take_album_release(&mut self) -> Vec<AlbumReleaseProperty> {
		std::mem::take(&mut self.r#album_release)
	}
	fn get_album_release_type(&self) -> &[AlbumReleaseTypeProperty] {
		self.r#album_release_type.as_slice()
	}
	fn take_album_release_type(&mut self) -> Vec<AlbumReleaseTypeProperty> {
		std::mem::take(&mut self.r#album_release_type)
	}
	fn get_by_artist(&self) -> &[ByArtistProperty] {
		self.r#by_artist.as_slice()
	}
	fn take_by_artist(&mut self) -> Vec<ByArtistProperty> {
		std::mem::take(&mut self.r#by_artist)
	}
}
impl CreativeWorkTrait for MusicAlbum {
...
impl MusicPlaylistTrait for MusicAlbum {
...
impl ThingTrait for MusicAlbum {
...
mod serde {
	...
	use super::*;
	impl Serialize for MusicAlbum {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#album_production_type) as usize,
				!Vec::is_empty(&self.r#album_release) as usize,
				!Vec::is_empty(&self.r#album_release_type) as usize,
				!Vec::is_empty(&self.r#by_artist) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "MusicAlbum", len)?;
			if !Vec::is_empty(&self.r#album_production_type) {
				serialize_struct.serialize_field("albumProductionType", {
					struct SerializeWith<'a>(&'a Vec<AlbumProductionTypeProperty>);
					...
					&SerializeWith(&self.r#album_production_type)
				})?;
			} else {
				serialize_struct.skip_field("albumProductionType")?;
			}
			if !Vec::is_empty(&self.r#album_release) {
				serialize_struct.serialize_field("albumRelease", {
					struct SerializeWith<'a>(&'a Vec<AlbumReleaseProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#album_release)
				})?;
			} else {
				serialize_struct.skip_field("albumRelease")?;
			}
			if !Vec::is_empty(&self.r#album_release_type) {
				serialize_struct.serialize_field("albumReleaseType", {
					struct SerializeWith<'a>(&'a Vec<AlbumReleaseTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#album_release_type)
				})?;
			} else {
				serialize_struct.skip_field("albumReleaseType")?;
			}
			if !Vec::is_empty(&self.r#by_artist) {
				serialize_struct.serialize_field("byArtist", {
					struct SerializeWith<'a>(&'a Vec<ByArtistProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#by_artist)
				})?;
			} else {
				serialize_struct.skip_field("byArtist")?;
			}
	...
	impl<'de> Deserialize<'de> for MusicAlbum {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"albumProductionType" => Ok(Field::AlbumProductionType),
						"albumRelease" => Ok(Field::AlbumRelease),
						"albumReleaseType" => Ok(Field::AlbumReleaseType),
						"byArtist" => Ok(Field::ByArtist),
				...
				{
					match value {
						b"albumProductionType" => Ok(Field::AlbumProductionType),
						b"albumRelease" => Ok(Field::AlbumRelease),
						b"albumReleaseType" => Ok(Field::AlbumReleaseType),
						b"byArtist" => Ok(Field::ByArtist),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicAlbum;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicAlbum")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#album_production_type_property = None;
					let mut r#album_release_property = None;
					let mut r#album_release_type_property = None;
					let mut r#by_artist_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AlbumProductionType => {
								if r#album_production_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"albumProductionType",
									));
								}
								r#album_production_type_property = Some({
									struct DeserializeWith(Vec<AlbumProductionTypeProperty>);
							...
							Field::AlbumRelease => {
								if r#album_release_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"albumRelease",
									));
								}
								r#album_release_property = Some({
									struct DeserializeWith(Vec<AlbumReleaseProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::AlbumReleaseType => {
								if r#album_release_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"albumReleaseType",
									));
								}
								r#album_release_type_property = Some({
									struct DeserializeWith(Vec<AlbumReleaseTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ByArtist => {
								if r#by_artist_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"byArtist",
									));
								}
								r#by_artist_property = Some({
									struct DeserializeWith(Vec<ByArtistProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MusicAlbum {
						r#album_production_type: r#album_production_type_property
							.unwrap_or_default(),
						r#album_release: r#album_release_property.unwrap_or_default(),
						r#album_release_type: r#album_release_type_property.unwrap_or_default(),
						r#by_artist: r#by_artist_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MusicAlbum", FIELDS, ClassVisitor)
		}
	}
}
