...
mod serde {
	...
	use super::*;
	impl Serialize for DeliveryTimeSettings {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DeliveryTimeSettings", len)?;
	...
	impl<'de> Deserialize<'de> for DeliveryTimeSettings {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DeliveryTimeSettings;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DeliveryTimeSettings")
				}
			...
			deserializer.deserialize_struct("DeliveryTimeSettings", FIELDS, ClassVisitor)
		}
	}
}
