...
/// This trait is for properties from <https://schema.org/TelevisionStation>.
pub trait TelevisionStationTrait {}
impl TelevisionStationTrait for TelevisionStation {}
impl LocalBusinessTrait for TelevisionStation {
...
impl ThingTrait for TelevisionStation {
...
mod serde {
	...
	use super::*;
	impl Serialize for TelevisionStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TelevisionStation", len)?;
	...
	impl<'de> Deserialize<'de> for TelevisionStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TelevisionStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TelevisionStation")
				}
			...
			deserializer.deserialize_struct("TelevisionStation", FIELDS, ClassVisitor)
		}
	}
}
