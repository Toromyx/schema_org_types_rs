...
impl MedicalEntityTrait for MedicalGuideline {
...
impl ThingTrait for MedicalGuideline {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalGuideline {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalGuideline", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalGuideline {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalGuideline;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalGuideline")
				}
			...
			deserializer.deserialize_struct("MedicalGuideline", FIELDS, ClassVisitor)
		}
	}
}
