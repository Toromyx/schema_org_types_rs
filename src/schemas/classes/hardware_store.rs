...
/// This trait is for properties from <https://schema.org/HardwareStore>.
pub trait HardwareStoreTrait {}
impl HardwareStoreTrait for HardwareStore {}
impl LocalBusinessTrait for HardwareStore {
...
impl StoreTrait for HardwareStore {}
impl ThingTrait for HardwareStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for HardwareStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HardwareStore", len)?;
	...
	impl<'de> Deserialize<'de> for HardwareStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HardwareStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HardwareStore")
				}
			...
			deserializer.deserialize_struct("HardwareStore", FIELDS, ClassVisitor)
		}
	}
}
