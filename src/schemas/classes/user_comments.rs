...
impl UserCommentsTrait for UserComments {
	fn get_comment_text(&self) -> &[CommentTextProperty] {
		self.r#comment_text.as_slice()
	}
	fn take_comment_text(&mut self) -> Vec<CommentTextProperty> {
		std::mem::take(&mut self.r#comment_text)
	}
	fn get_comment_time(&self) -> &[CommentTimeProperty] {
		self.r#comment_time.as_slice()
	}
	fn take_comment_time(&mut self) -> Vec<CommentTimeProperty> {
		std::mem::take(&mut self.r#comment_time)
	}
	fn get_creator(&self) -> &[CreatorProperty] {
	...
	fn get_discusses(&self) -> &[DiscussesProperty] {
		self.r#discusses.as_slice()
	}
	fn take_discusses(&mut self) -> Vec<DiscussesProperty> {
		std::mem::take(&mut self.r#discusses)
	}
	fn get_reply_to_url(&self) -> &[ReplyToUrlProperty] {
		self.r#reply_to_url.as_slice()
	}
	fn take_reply_to_url(&mut self) -> Vec<ReplyToUrlProperty> {
		std::mem::take(&mut self.r#reply_to_url)
	}
}
impl EventTrait for UserComments {
...
impl ThingTrait for UserComments {
...
impl UserInteractionTrait for UserComments {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for UserComments {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#comment_text) as usize,
				!Vec::is_empty(&self.r#comment_time) as usize,
				!Vec::is_empty(&self.r#creator) as usize,
				!Vec::is_empty(&self.r#discusses) as usize,
				!Vec::is_empty(&self.r#reply_to_url) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserComments", len)?;
			if !Vec::is_empty(&self.r#comment_text) {
				serialize_struct.serialize_field("commentText", {
					struct SerializeWith<'a>(&'a Vec<CommentTextProperty>);
					...
					&SerializeWith(&self.r#comment_text)
				})?;
			} else {
				serialize_struct.skip_field("commentText")?;
			}
			if !Vec::is_empty(&self.r#comment_time) {
				serialize_struct.serialize_field("commentTime", {
					struct SerializeWith<'a>(&'a Vec<CommentTimeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#comment_time)
				})?;
			} else {
				serialize_struct.skip_field("commentTime")?;
			}
			...
			if !Vec::is_empty(&self.r#discusses) {
				serialize_struct.serialize_field("discusses", {
					struct SerializeWith<'a>(&'a Vec<DiscussesProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#discusses)
				})?;
			} else {
				serialize_struct.skip_field("discusses")?;
			}
			if !Vec::is_empty(&self.r#reply_to_url) {
				serialize_struct.serialize_field("replyToUrl", {
					struct SerializeWith<'a>(&'a Vec<ReplyToUrlProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#reply_to_url)
				})?;
			} else {
				serialize_struct.skip_field("replyToUrl")?;
			}
	...
	impl<'de> Deserialize<'de> for UserComments {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"commentText" => Ok(Field::CommentText),
						"commentTime" => Ok(Field::CommentTime),
						"creator" => Ok(Field::Creator),
						"discusses" => Ok(Field::Discusses),
						"replyToUrl" => Ok(Field::ReplyToUrl),
				...
				{
					match value {
						b"commentText" => Ok(Field::CommentText),
						b"commentTime" => Ok(Field::CommentTime),
						b"creator" => Ok(Field::Creator),
						b"discusses" => Ok(Field::Discusses),
						b"replyToUrl" => Ok(Field::ReplyToUrl),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserComments")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#comment_text_property = None;
					let mut r#comment_time_property = None;
					let mut r#creator_property = None;
					let mut r#discusses_property = None;
					let mut r#reply_to_url_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::CommentText => {
								if r#comment_text_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"commentText",
									));
								}
								r#comment_text_property = Some({
									struct DeserializeWith(Vec<CommentTextProperty>);
							...
							Field::CommentTime => {
								if r#comment_time_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"commentTime",
									));
								}
								r#comment_time_property = Some({
									struct DeserializeWith(Vec<CommentTimeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Discusses => {
								if r#discusses_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"discusses",
									));
								}
								r#discusses_property = Some({
									struct DeserializeWith(Vec<DiscussesProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ReplyToUrl => {
								if r#reply_to_url_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"replyToUrl",
									));
								}
								r#reply_to_url_property = Some({
									struct DeserializeWith(Vec<ReplyToUrlProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(UserComments {
						r#comment_text: r#comment_text_property.unwrap_or_default(),
						r#comment_time: r#comment_time_property.unwrap_or_default(),
						r#creator: r#creator_property.unwrap_or_default(),
						r#discusses: r#discusses_property.unwrap_or_default(),
						r#reply_to_url: r#reply_to_url_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("UserComments", FIELDS, ClassVisitor)
		}
	}
}
