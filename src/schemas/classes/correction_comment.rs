...
/// This trait is for properties from <https://schema.org/CorrectionComment>.
pub trait CorrectionCommentTrait {}
impl CorrectionCommentTrait for CorrectionComment {}
impl CommentTrait for CorrectionComment {
...
impl CreativeWorkTrait for CorrectionComment {
...
impl ThingTrait for CorrectionComment {
...
mod serde {
	...
	use super::*;
	impl Serialize for CorrectionComment {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CorrectionComment", len)?;
	...
	impl<'de> Deserialize<'de> for CorrectionComment {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CorrectionComment;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CorrectionComment")
				}
			...
			deserializer.deserialize_struct("CorrectionComment", FIELDS, ClassVisitor)
		}
	}
}
