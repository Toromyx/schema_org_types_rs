...
/// This trait is for properties from <https://schema.org/TravelAgency>.
pub trait TravelAgencyTrait {}
impl TravelAgencyTrait for TravelAgency {}
impl LocalBusinessTrait for TravelAgency {
...
impl ThingTrait for TravelAgency {
...
mod serde {
	...
	use super::*;
	impl Serialize for TravelAgency {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TravelAgency", len)?;
	...
	impl<'de> Deserialize<'de> for TravelAgency {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TravelAgency;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TravelAgency")
				}
			...
			deserializer.deserialize_struct("TravelAgency", FIELDS, ClassVisitor)
		}
	}
}
