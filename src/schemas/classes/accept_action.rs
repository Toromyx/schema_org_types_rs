...
/// This trait is for properties from <https://schema.org/AcceptAction>.
pub trait AcceptActionTrait {}
impl AcceptActionTrait for AcceptAction {}
...
impl AllocateActionTrait for AcceptAction {}
impl OrganizeActionTrait for AcceptAction {}
impl ThingTrait for AcceptAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AcceptAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AcceptAction", len)?;
	...
	impl<'de> Deserialize<'de> for AcceptAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AcceptAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AcceptAction")
				}
			...
			deserializer.deserialize_struct("AcceptAction", FIELDS, ClassVisitor)
		}
	}
}
