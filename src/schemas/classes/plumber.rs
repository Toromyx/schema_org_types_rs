...
/// This trait is for properties from <https://schema.org/Plumber>.
pub trait PlumberTrait {}
impl PlumberTrait for Plumber {}
impl HomeAndConstructionBusinessTrait for Plumber {}
impl LocalBusinessTrait for Plumber {
...
mod serde {
	...
	impl Serialize for Plumber {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Plumber", len)?;
	...
	impl<'de> Deserialize<'de> for Plumber {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Plumber;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Plumber")
				}
			...
			deserializer.deserialize_struct("Plumber", FIELDS, ClassVisitor)
		}
	}
}
