...
pub struct BusOrCoach {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/acrissCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/acrissCode"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/roofLoad"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/roofLoad"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
