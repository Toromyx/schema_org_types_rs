...
/// This trait is for properties from <https://schema.org/PhysicalTherapy>.
pub trait PhysicalTherapyTrait {}
impl PhysicalTherapyTrait for PhysicalTherapy {}
impl MedicalEntityTrait for PhysicalTherapy {
...
impl MedicalProcedureTrait for PhysicalTherapy {
...
impl MedicalTherapyTrait for PhysicalTherapy {
...
impl TherapeuticProcedureTrait for PhysicalTherapy {
...
impl ThingTrait for PhysicalTherapy {
...
mod serde {
	...
	use super::*;
	impl Serialize for PhysicalTherapy {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PhysicalTherapy", len)?;
	...
	impl<'de> Deserialize<'de> for PhysicalTherapy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PhysicalTherapy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PhysicalTherapy")
				}
			...
			deserializer.deserialize_struct("PhysicalTherapy", FIELDS, ClassVisitor)
		}
	}
}
