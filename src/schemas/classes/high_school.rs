...
/// This trait is for properties from <https://schema.org/HighSchool>.
pub trait HighSchoolTrait {}
impl HighSchoolTrait for HighSchool {}
impl CivicStructureTrait for HighSchool {
...
impl EducationalOrganizationTrait for HighSchool {
...
impl ThingTrait for HighSchool {
...
mod serde {
	...
	impl Serialize for HighSchool {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HighSchool", len)?;
	...
	impl<'de> Deserialize<'de> for HighSchool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HighSchool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HighSchool")
				}
			...
			deserializer.deserialize_struct("HighSchool", FIELDS, ClassVisitor)
		}
	}
}
