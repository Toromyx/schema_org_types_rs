...
impl ThingTrait for DonateAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DonateAction {
	...
	impl<'de> Deserialize<'de> for DonateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DonateAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DonateAction")
				}
