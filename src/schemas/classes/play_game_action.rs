...
pub struct PlayGameAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "actionAccessibilityRequirement"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/actionAccessibilityRequirement")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/actionAccessibilityRequirement")
    )]
    ...
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/expectsAcceptanceOf")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/expectsAcceptanceOf")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "gameAvailabilityType"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/gameAvailabilityType")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/gameAvailabilityType")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
