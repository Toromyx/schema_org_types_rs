...
/// This trait is for properties from <https://schema.org/HowToStep>.
pub trait HowToStepTrait {}
impl HowToStepTrait for HowToStep {}
impl CreativeWorkTrait for HowToStep {
...
impl ItemListTrait for HowToStep {
...
impl ListItemTrait for HowToStep {
...
mod serde {
	...
	impl Serialize for HowToStep {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HowToStep", len)?;
	...
	impl<'de> Deserialize<'de> for HowToStep {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HowToStep;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HowToStep")
				}
			...
			deserializer.deserialize_struct("HowToStep", FIELDS, ClassVisitor)
		}
	}
}
