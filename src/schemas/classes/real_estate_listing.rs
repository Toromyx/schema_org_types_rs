...
impl RealEstateListingTrait for RealEstateListing {
	fn get_date_posted(&self) -> &[DatePostedProperty] {
...
impl CreativeWorkTrait for RealEstateListing {
...
impl ThingTrait for RealEstateListing {
...
impl WebPageTrait for RealEstateListing {
...
mod serde {
	...
	use super::*;
	impl Serialize for RealEstateListing {
	...
	impl<'de> Deserialize<'de> for RealEstateListing {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RealEstateListing;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RealEstateListing")
				}
