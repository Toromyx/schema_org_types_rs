...
/// This trait is for properties from <https://schema.org/RadioSeries>.
pub trait RadioSeriesTrait {
...
impl RadioSeriesTrait for RadioSeries {
	fn get_actor(&self) -> &[ActorProperty] {
...
impl CreativeWorkTrait for RadioSeries {
...
impl CreativeWorkSeriesTrait for RadioSeries {
...
impl ThingTrait for RadioSeries {
...
mod serde {
	...
	use super::*;
	impl Serialize for RadioSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RadioSeries", len)?;
	...
	impl<'de> Deserialize<'de> for RadioSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioSeries")
				}
			...
			deserializer.deserialize_struct("RadioSeries", FIELDS, ClassVisitor)
		}
	}
}
