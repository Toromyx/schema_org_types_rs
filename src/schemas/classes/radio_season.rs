...
/// This trait is for properties from <https://schema.org/RadioSeason>.
pub trait RadioSeasonTrait {}
impl RadioSeasonTrait for RadioSeason {}
impl CreativeWorkTrait for RadioSeason {
...
impl CreativeWorkSeasonTrait for RadioSeason {
...
impl ThingTrait for RadioSeason {
...
mod serde {
	...
	use super::*;
	impl Serialize for RadioSeason {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RadioSeason", len)?;
	...
	impl<'de> Deserialize<'de> for RadioSeason {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioSeason;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioSeason")
				}
			...
			deserializer.deserialize_struct("RadioSeason", FIELDS, ClassVisitor)
		}
	}
}
