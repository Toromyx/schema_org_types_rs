...
/// This trait is for properties from <https://schema.org/ComputerStore>.
pub trait ComputerStoreTrait {}
impl ComputerStoreTrait for ComputerStore {}
impl LocalBusinessTrait for ComputerStore {
...
impl StoreTrait for ComputerStore {}
impl ThingTrait for ComputerStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for ComputerStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ComputerStore", len)?;
	...
	impl<'de> Deserialize<'de> for ComputerStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComputerStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComputerStore")
				}
			...
			deserializer.deserialize_struct("ComputerStore", FIELDS, ClassVisitor)
		}
	}
}
