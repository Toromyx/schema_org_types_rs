...
/// This trait is for properties from <https://schema.org/MusicVideoObject>.
pub trait MusicVideoObjectTrait {}
impl MusicVideoObjectTrait for MusicVideoObject {}
impl CreativeWorkTrait for MusicVideoObject {
...
impl MediaObjectTrait for MusicVideoObject {
...
impl ThingTrait for MusicVideoObject {
...
mod serde {
	...
	use super::*;
	impl Serialize for MusicVideoObject {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MusicVideoObject", len)?;
	...
	impl<'de> Deserialize<'de> for MusicVideoObject {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicVideoObject;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicVideoObject")
				}
			...
			deserializer.deserialize_struct("MusicVideoObject", FIELDS, ClassVisitor)
		}
	}
}
