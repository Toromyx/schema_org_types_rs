...
pub struct LinkRole {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "linkRelationship"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/linkRelationship")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/linkRelationship"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
