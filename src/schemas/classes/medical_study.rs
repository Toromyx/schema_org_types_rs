...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalStudy {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalStudy", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalStudy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalStudy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalStudy")
				}
			...
			deserializer.deserialize_struct("MedicalStudy", FIELDS, ClassVisitor)
		}
	}
}
