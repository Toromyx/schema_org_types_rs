...
/// This trait is for properties from <https://schema.org/UserDownloads>.
#[deprecated = "This schema is superseded by <https://schema.org/InteractionCounter>."]
pub trait UserDownloadsTrait {}
impl UserDownloadsTrait for UserDownloads {}
impl EventTrait for UserDownloads {
...
impl ThingTrait for UserDownloads {
...
impl UserInteractionTrait for UserDownloads {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for UserDownloads {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserDownloads", len)?;
	...
	impl<'de> Deserialize<'de> for UserDownloads {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserDownloads;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserDownloads")
				}
			...
			deserializer.deserialize_struct("UserDownloads", FIELDS, ClassVisitor)
		}
	}
}
