...
pub struct RepaymentSpecification {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "downPayment"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/downPayment"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/downPayment"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "earlyPrepaymentPenalty"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/earlyPrepaymentPenalty")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/earlyPrepaymentPenalty")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "loanPaymentAmount"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/loanPaymentAmount")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/loanPaymentAmount")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "loanPaymentFrequency"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/loanPaymentFrequency")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/loanPaymentFrequency")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "numberOfLoanPayments"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/numberOfLoanPayments")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/numberOfLoanPayments")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
