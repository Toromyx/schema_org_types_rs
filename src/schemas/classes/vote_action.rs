...
pub struct VoteAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "actionOption"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/actionOption"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/actionOption"))]
    ...
    #[cfg_attr(feature = "serde", serde(rename = "candidate"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/candidate"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/candidate"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/option"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/option"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
