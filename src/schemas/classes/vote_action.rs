...
pub struct VoteAction {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "actionOption"))]
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "candidate"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "option"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
