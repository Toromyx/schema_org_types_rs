...
impl ExercisePlanTrait for ExercisePlan {
	fn get_activity_duration(&self) -> &[ActivityDurationProperty] {
		self.r#activity_duration.as_slice()
	}
	fn take_activity_duration(&mut self) -> Vec<ActivityDurationProperty> {
		std::mem::take(&mut self.r#activity_duration)
	}
	fn get_activity_frequency(&self) -> &[ActivityFrequencyProperty] {
		self.r#activity_frequency.as_slice()
	}
	fn take_activity_frequency(&mut self) -> Vec<ActivityFrequencyProperty> {
		std::mem::take(&mut self.r#activity_frequency)
	}
	fn get_additional_variable(&self) -> &[AdditionalVariableProperty] {
		self.r#additional_variable.as_slice()
	}
	fn take_additional_variable(&mut self) -> Vec<AdditionalVariableProperty> {
		std::mem::take(&mut self.r#additional_variable)
	}
	fn get_exercise_type(&self) -> &[ExerciseTypeProperty] {
	...
	fn get_intensity(&self) -> &[IntensityProperty] {
		self.r#intensity.as_slice()
	}
	fn take_intensity(&mut self) -> Vec<IntensityProperty> {
		std::mem::take(&mut self.r#intensity)
	}
	fn get_repetitions(&self) -> &[RepetitionsProperty] {
		self.r#repetitions.as_slice()
	}
	fn take_repetitions(&mut self) -> Vec<RepetitionsProperty> {
		std::mem::take(&mut self.r#repetitions)
	}
	fn get_rest_periods(&self) -> &[RestPeriodsProperty] {
		self.r#rest_periods.as_slice()
	}
	fn take_rest_periods(&mut self) -> Vec<RestPeriodsProperty> {
		std::mem::take(&mut self.r#rest_periods)
	}
	fn get_workload(&self) -> &[WorkloadProperty] {
		self.r#workload.as_slice()
	}
	fn take_workload(&mut self) -> Vec<WorkloadProperty> {
		std::mem::take(&mut self.r#workload)
	}
}
impl CreativeWorkTrait for ExercisePlan {
...
impl LifestyleModificationTrait for ExercisePlan {}
impl MedicalEntityTrait for ExercisePlan {
...
impl PhysicalActivityTrait for ExercisePlan {
...
impl ThingTrait for ExercisePlan {
...
mod serde {
	...
	use super::*;
	impl Serialize for ExercisePlan {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#activity_duration) as usize,
				!Vec::is_empty(&self.r#activity_frequency) as usize,
				!Vec::is_empty(&self.r#additional_variable) as usize,
				!Vec::is_empty(&self.r#exercise_type) as usize,
				!Vec::is_empty(&self.r#intensity) as usize,
				!Vec::is_empty(&self.r#repetitions) as usize,
				!Vec::is_empty(&self.r#rest_periods) as usize,
				!Vec::is_empty(&self.r#workload) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ExercisePlan", len)?;
			if !Vec::is_empty(&self.r#activity_duration) {
				serialize_struct.serialize_field("activityDuration", {
					struct SerializeWith<'a>(&'a Vec<ActivityDurationProperty>);
					...
					&SerializeWith(&self.r#activity_duration)
				})?;
			} else {
				serialize_struct.skip_field("activityDuration")?;
			}
			if !Vec::is_empty(&self.r#activity_frequency) {
				serialize_struct.serialize_field("activityFrequency", {
					struct SerializeWith<'a>(&'a Vec<ActivityFrequencyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#activity_frequency)
				})?;
			} else {
				serialize_struct.skip_field("activityFrequency")?;
			}
			if !Vec::is_empty(&self.r#additional_variable) {
				serialize_struct.serialize_field("additionalVariable", {
					struct SerializeWith<'a>(&'a Vec<AdditionalVariableProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#additional_variable)
				})?;
			} else {
				serialize_struct.skip_field("additionalVariable")?;
			}
			...
			if !Vec::is_empty(&self.r#intensity) {
				serialize_struct.serialize_field("intensity", {
					struct SerializeWith<'a>(&'a Vec<IntensityProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#intensity)
				})?;
			} else {
				serialize_struct.skip_field("intensity")?;
			}
			if !Vec::is_empty(&self.r#repetitions) {
				serialize_struct.serialize_field("repetitions", {
					struct SerializeWith<'a>(&'a Vec<RepetitionsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#repetitions)
				})?;
			} else {
				serialize_struct.skip_field("repetitions")?;
			}
			if !Vec::is_empty(&self.r#rest_periods) {
				serialize_struct.serialize_field("restPeriods", {
					struct SerializeWith<'a>(&'a Vec<RestPeriodsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#rest_periods)
				})?;
			} else {
				serialize_struct.skip_field("restPeriods")?;
			}
			if !Vec::is_empty(&self.r#workload) {
				serialize_struct.serialize_field("workload", {
					struct SerializeWith<'a>(&'a Vec<WorkloadProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#workload)
				})?;
			} else {
				serialize_struct.skip_field("workload")?;
			}
	...
	impl<'de> Deserialize<'de> for ExercisePlan {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"activityDuration" => Ok(Field::ActivityDuration),
						"activityFrequency" => Ok(Field::ActivityFrequency),
						"additionalVariable" => Ok(Field::AdditionalVariable),
						"exerciseType" => Ok(Field::ExerciseType),
						"intensity" => Ok(Field::Intensity),
						"repetitions" => Ok(Field::Repetitions),
						"restPeriods" => Ok(Field::RestPeriods),
						"workload" => Ok(Field::Workload),
				...
				{
					match value {
						b"activityDuration" => Ok(Field::ActivityDuration),
						b"activityFrequency" => Ok(Field::ActivityFrequency),
						b"additionalVariable" => Ok(Field::AdditionalVariable),
						b"exerciseType" => Ok(Field::ExerciseType),
						b"intensity" => Ok(Field::Intensity),
						b"repetitions" => Ok(Field::Repetitions),
						b"restPeriods" => Ok(Field::RestPeriods),
						b"workload" => Ok(Field::Workload),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ExercisePlan;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ExercisePlan")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#activity_duration_property = None;
					let mut r#activity_frequency_property = None;
					let mut r#additional_variable_property = None;
					let mut r#exercise_type_property = None;
					let mut r#intensity_property = None;
					let mut r#repetitions_property = None;
					let mut r#rest_periods_property = None;
					let mut r#workload_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::ActivityDuration => {
								if r#activity_duration_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"activityDuration",
									));
								}
								r#activity_duration_property = Some({
									struct DeserializeWith(Vec<ActivityDurationProperty>);
							...
							Field::ActivityFrequency => {
								if r#activity_frequency_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"activityFrequency",
									));
								}
								r#activity_frequency_property = Some({
									struct DeserializeWith(Vec<ActivityFrequencyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::AdditionalVariable => {
								if r#additional_variable_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"additionalVariable",
									));
								}
								r#additional_variable_property = Some({
									struct DeserializeWith(Vec<AdditionalVariableProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Intensity => {
								if r#intensity_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"intensity",
									));
								}
								r#intensity_property = Some({
									struct DeserializeWith(Vec<IntensityProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Repetitions => {
								if r#repetitions_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"repetitions",
									));
								}
								r#repetitions_property = Some({
									struct DeserializeWith(Vec<RepetitionsProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RestPeriods => {
								if r#rest_periods_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"restPeriods",
									));
								}
								r#rest_periods_property = Some({
									struct DeserializeWith(Vec<RestPeriodsProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Workload => {
								if r#workload_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"workload",
									));
								}
								r#workload_property = Some({
									struct DeserializeWith(Vec<WorkloadProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(ExercisePlan {
						r#activity_duration: r#activity_duration_property.unwrap_or_default(),
						r#activity_frequency: r#activity_frequency_property.unwrap_or_default(),
						r#additional_variable: r#additional_variable_property.unwrap_or_default(),
						r#exercise_type: r#exercise_type_property.unwrap_or_default(),
						r#intensity: r#intensity_property.unwrap_or_default(),
						r#repetitions: r#repetitions_property.unwrap_or_default(),
						r#rest_periods: r#rest_periods_property.unwrap_or_default(),
						r#workload: r#workload_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("ExercisePlan", FIELDS, ClassVisitor)
		}
	}
}
