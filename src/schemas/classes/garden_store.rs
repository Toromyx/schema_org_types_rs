...
/// This trait is for properties from <https://schema.org/GardenStore>.
pub trait GardenStoreTrait {}
impl GardenStoreTrait for GardenStore {}
impl LocalBusinessTrait for GardenStore {
...
impl StoreTrait for GardenStore {}
impl ThingTrait for GardenStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for GardenStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GardenStore", len)?;
	...
	impl<'de> Deserialize<'de> for GardenStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GardenStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GardenStore")
				}
			...
			deserializer.deserialize_struct("GardenStore", FIELDS, ClassVisitor)
		}
	}
}
