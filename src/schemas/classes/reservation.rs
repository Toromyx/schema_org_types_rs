...
impl ThingTrait for Reservation {
	...
	impl Serialize for Reservation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "Reservation", len)?;
	...
	impl<'de> Deserialize<'de> for Reservation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Reservation")
				}
			...
			deserializer.deserialize_struct("Reservation", FIELDS, ClassVisitor)
		}
	}
}
