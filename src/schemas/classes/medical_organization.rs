...
/// This trait is for properties from <https://schema.org/MedicalOrganization>.
pub trait MedicalOrganizationTrait {
	...
	/// Get <https://schema.org/isAcceptingNewPatients> from [`Self`] as borrowed slice.
	fn get_is_accepting_new_patients(&self) -> &[IsAcceptingNewPatientsProperty];
	/// Take <https://schema.org/isAcceptingNewPatients> from [`Self`] as owned vector.
...
impl MedicalOrganizationTrait for MedicalOrganization {
	fn get_health_plan_network_id(&self) -> &[HealthPlanNetworkIdProperty] {
...
impl ThingTrait for MedicalOrganization {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalOrganization")
				}
			...
			deserializer.deserialize_struct("MedicalOrganization", FIELDS, ClassVisitor)
		}
	}
}
