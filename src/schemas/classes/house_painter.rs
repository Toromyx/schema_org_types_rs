...
/// This trait is for properties from <https://schema.org/HousePainter>.
pub trait HousePainterTrait {}
impl HousePainterTrait for HousePainter {}
impl HomeAndConstructionBusinessTrait for HousePainter {}
impl LocalBusinessTrait for HousePainter {
...
impl ThingTrait for HousePainter {
...
mod serde {
	...
	use super::*;
	impl Serialize for HousePainter {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HousePainter", len)?;
	...
	impl<'de> Deserialize<'de> for HousePainter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HousePainter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HousePainter")
				}
			...
			deserializer.deserialize_struct("HousePainter", FIELDS, ClassVisitor)
		}
	}
}
