...
impl AnatomicalSystemTrait for AnatomicalSystem {
	...
	fn get_comprised_of(&self) -> &[ComprisedOfProperty] {
		self.r#comprised_of.as_slice()
	}
	fn take_comprised_of(&mut self) -> Vec<ComprisedOfProperty> {
		std::mem::take(&mut self.r#comprised_of)
	}
	fn get_related_condition(&self) -> &[RelatedConditionProperty] {
	...
	fn get_related_structure(&self) -> &[RelatedStructureProperty] {
		self.r#related_structure.as_slice()
	}
	fn take_related_structure(&mut self) -> Vec<RelatedStructureProperty> {
		std::mem::take(&mut self.r#related_structure)
	}
	fn get_related_therapy(&self) -> &[RelatedTherapyProperty] {
...
impl MedicalEntityTrait for AnatomicalSystem {
...
impl ThingTrait for AnatomicalSystem {
...
mod serde {
	...
	use super::*;
	impl Serialize for AnatomicalSystem {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#comprised_of) as usize,
				!Vec::is_empty(&self.r#related_condition) as usize,
				!Vec::is_empty(&self.r#related_structure) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AnatomicalSystem", len)?;
			...
			if !Vec::is_empty(&self.r#comprised_of) {
				serialize_struct.serialize_field("comprisedOf", {
					struct SerializeWith<'a>(&'a Vec<ComprisedOfProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#comprised_of)
				})?;
			} else {
				serialize_struct.skip_field("comprisedOf")?;
			}
			...
			if !Vec::is_empty(&self.r#related_structure) {
				serialize_struct.serialize_field("relatedStructure", {
					struct SerializeWith<'a>(&'a Vec<RelatedStructureProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#related_structure)
				})?;
			} else {
				serialize_struct.skip_field("relatedStructure")?;
			}
	...
	impl<'de> Deserialize<'de> for AnatomicalSystem {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"comprisedOf" => Ok(Field::ComprisedOf),
						"relatedCondition" => Ok(Field::RelatedCondition),
						"relatedStructure" => Ok(Field::RelatedStructure),
					...
					E: de::Error,
				{
					match value {
						...
						b"comprisedOf" => Ok(Field::ComprisedOf),
						b"relatedCondition" => Ok(Field::RelatedCondition),
						b"relatedStructure" => Ok(Field::RelatedStructure),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AnatomicalSystem;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AnatomicalSystem")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#comprised_of_property = None;
					let mut r#related_condition_property = None;
					let mut r#related_structure_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::ComprisedOf => {
								if r#comprised_of_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"comprisedOf",
									));
								}
								r#comprised_of_property = Some({
									struct DeserializeWith(Vec<ComprisedOfProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RelatedStructure => {
								if r#related_structure_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"relatedStructure",
									));
								}
								r#related_structure_property = Some({
									struct DeserializeWith(Vec<RelatedStructureProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(AnatomicalSystem {
						r#associated_pathophysiology: r#associated_pathophysiology_property
							.unwrap_or_default(),
						r#comprised_of: r#comprised_of_property.unwrap_or_default(),
						r#related_condition: r#related_condition_property.unwrap_or_default(),
						r#related_structure: r#related_structure_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("AnatomicalSystem", FIELDS, ClassVisitor)
		}
	}
}
