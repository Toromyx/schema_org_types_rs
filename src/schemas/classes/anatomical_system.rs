...
pub struct AnatomicalSystem {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "comprisedOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/comprisedOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/comprisedOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "relatedStructure"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/relatedStructure")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/relatedStructure"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
