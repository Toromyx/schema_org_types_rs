...
mod serde {
	...
	use super::*;
	impl Serialize for MediaSubscription {
	...
	impl<'de> Deserialize<'de> for MediaSubscription {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MediaSubscription;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MediaSubscription")
				}
			...
			deserializer.deserialize_struct("MediaSubscription", FIELDS, ClassVisitor)
		}
	}
}
