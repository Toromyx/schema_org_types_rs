...
pub struct MediaSubscription {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "authenticator"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/authenticator"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/authenticator"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
