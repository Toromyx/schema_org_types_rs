...
/// This trait is for properties from <https://schema.org/CableOrSatelliteService>.
pub trait CableOrSatelliteServiceTrait {}
impl CableOrSatelliteServiceTrait for CableOrSatelliteService {}
impl ServiceTrait for CableOrSatelliteService {
...
impl ThingTrait for CableOrSatelliteService {
...
mod serde {
	...
	use super::*;
	impl Serialize for CableOrSatelliteService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CableOrSatelliteService", len)?;
	...
	impl<'de> Deserialize<'de> for CableOrSatelliteService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CableOrSatelliteService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CableOrSatelliteService")
				}
			...
			deserializer.deserialize_struct("CableOrSatelliteService", FIELDS, ClassVisitor)
		}
	}
}
