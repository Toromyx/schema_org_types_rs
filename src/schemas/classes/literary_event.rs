...
/// This trait is for properties from <https://schema.org/LiteraryEvent>.
pub trait LiteraryEventTrait {}
impl LiteraryEventTrait for LiteraryEvent {}
impl EventTrait for LiteraryEvent {
...
impl ThingTrait for LiteraryEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for LiteraryEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LiteraryEvent", len)?;
	...
	impl<'de> Deserialize<'de> for LiteraryEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LiteraryEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LiteraryEvent")
				}
			...
			deserializer.deserialize_struct("LiteraryEvent", FIELDS, ClassVisitor)
		}
	}
}
