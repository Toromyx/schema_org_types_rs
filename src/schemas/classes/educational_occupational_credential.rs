...
mod serde {
	...
	use super::*;
	impl Serialize for EducationalOccupationalCredential {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EducationalOccupationalCredential", len)?;
	...
	impl<'de> Deserialize<'de> for EducationalOccupationalCredential {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EducationalOccupationalCredential;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EducationalOccupationalCredential")
				}
