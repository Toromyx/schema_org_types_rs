...
pub struct EducationalOccupationalCredential {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "credentialCategory"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/credentialCategory")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/credentialCategory")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "recognizedBy"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/recognizedBy"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/recognizedBy"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
