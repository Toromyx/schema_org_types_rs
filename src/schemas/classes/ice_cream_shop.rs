...
/// This trait is for properties from <https://schema.org/IceCreamShop>.
pub trait IceCreamShopTrait {}
impl IceCreamShopTrait for IceCreamShop {}
impl FoodEstablishmentTrait for IceCreamShop {
...
impl LocalBusinessTrait for IceCreamShop {
...
impl ThingTrait for IceCreamShop {
...
mod serde {
	...
	use super::*;
	impl Serialize for IceCreamShop {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "IceCreamShop", len)?;
	...
	impl<'de> Deserialize<'de> for IceCreamShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = IceCreamShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema IceCreamShop")
				}
			...
			deserializer.deserialize_struct("IceCreamShop", FIELDS, ClassVisitor)
		}
	}
}
