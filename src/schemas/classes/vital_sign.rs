...
pub struct VitalSign {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/identifyingExam"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/identifyingExam"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/identifyingTest"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/identifyingTest"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
