...
/// This trait is for properties from <https://schema.org/VitalSign>.
pub trait VitalSignTrait {}
impl VitalSignTrait for VitalSign {}
impl MedicalConditionTrait for VitalSign {
...
impl MedicalEntityTrait for VitalSign {
...
impl MedicalSignTrait for VitalSign {
...
impl MedicalSignOrSymptomTrait for VitalSign {
	fn get_possible_treatment(&self) -> &[PossibleTreatmentProperty] {
		self.r#possible_treatment.as_slice()
	}
	fn take_possible_treatment(&mut self) -> Vec<PossibleTreatmentProperty> {
