...
pub struct HealthPlanCostSharingSpecification {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/healthPlanCoinsuranceOption")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/healthPlanCoinsuranceOption")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/healthPlanCoinsuranceRate")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/healthPlanCoinsuranceRate")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/healthPlanCopay"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/healthPlanCopay"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/healthPlanCopayOption")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/healthPlanCopayOption")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/healthPlanPharmacyCategory")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/healthPlanPharmacyCategory")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
