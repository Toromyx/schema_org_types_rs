...
/// This trait is for properties from <https://schema.org/InviteAction>.
pub trait InviteActionTrait {
...
impl InviteActionTrait for InviteAction {
	fn get_event(&self) -> &[EventProperty] {
...
impl CommunicateActionTrait for InviteAction {
...
impl InteractActionTrait for InviteAction {}
impl ThingTrait for InviteAction {
	...
	impl Serialize for InviteAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InviteAction", len)?;
	...
	impl<'de> Deserialize<'de> for InviteAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InviteAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InviteAction")
				}
			...
			deserializer.deserialize_struct("InviteAction", FIELDS, ClassVisitor)
		}
	}
}
