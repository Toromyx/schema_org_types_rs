...
impl EducationEventTrait for EducationEvent {
	fn get_assesses(&self) -> &[AssessesProperty] {
...
impl EventTrait for EducationEvent {
...
impl ThingTrait for EducationEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for EducationEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EducationEvent", len)?;
	...
	impl<'de> Deserialize<'de> for EducationEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EducationEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EducationEvent")
				}
			...
			deserializer.deserialize_struct("EducationEvent", FIELDS, ClassVisitor)
		}
	}
}
