...
/// This trait is for properties from <https://schema.org/Sculpture>.
pub trait SculptureTrait {}
impl SculptureTrait for Sculpture {}
impl CreativeWorkTrait for Sculpture {
...
mod serde {
	...
	impl Serialize for Sculpture {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Sculpture", len)?;
	...
	impl<'de> Deserialize<'de> for Sculpture {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Sculpture;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Sculpture")
				}
			...
			deserializer.deserialize_struct("Sculpture", FIELDS, ClassVisitor)
		}
	}
}
