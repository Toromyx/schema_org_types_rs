...
/// This trait is for properties from <https://schema.org/PoliceStation>.
pub trait PoliceStationTrait {}
impl PoliceStationTrait for PoliceStation {}
impl CivicStructureTrait for PoliceStation {
...
impl EmergencyServiceTrait for PoliceStation {}
impl LocalBusinessTrait for PoliceStation {
...
impl ThingTrait for PoliceStation {
...
mod serde {
	...
	use super::*;
	impl Serialize for PoliceStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PoliceStation", len)?;
	...
	impl<'de> Deserialize<'de> for PoliceStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PoliceStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PoliceStation")
				}
			...
			deserializer.deserialize_struct("PoliceStation", FIELDS, ClassVisitor)
		}
	}
}
