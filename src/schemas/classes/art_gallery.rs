...
/// This trait is for properties from <https://schema.org/ArtGallery>.
pub trait ArtGalleryTrait {}
impl ArtGalleryTrait for ArtGallery {}
impl EntertainmentBusinessTrait for ArtGallery {}
impl LocalBusinessTrait for ArtGallery {
...
impl ThingTrait for ArtGallery {
...
mod serde {
	...
	impl Serialize for ArtGallery {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ArtGallery", len)?;
	...
	impl<'de> Deserialize<'de> for ArtGallery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ArtGallery;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ArtGallery")
				}
			...
			deserializer.deserialize_struct("ArtGallery", FIELDS, ClassVisitor)
		}
	}
}
