...
/// This trait is for properties from <https://schema.org/Locksmith>.
pub trait LocksmithTrait {}
impl LocksmithTrait for Locksmith {}
impl HomeAndConstructionBusinessTrait for Locksmith {}
impl LocalBusinessTrait for Locksmith {
...
mod serde {
	...
	impl Serialize for Locksmith {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Locksmith", len)?;
	...
	impl<'de> Deserialize<'de> for Locksmith {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Locksmith;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Locksmith")
				}
			...
			deserializer.deserialize_struct("Locksmith", FIELDS, ClassVisitor)
		}
	}
}
