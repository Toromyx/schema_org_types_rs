...
/// This trait is for properties from <https://schema.org/RealEstateAgent>.
pub trait RealEstateAgentTrait {}
impl RealEstateAgentTrait for RealEstateAgent {}
impl LocalBusinessTrait for RealEstateAgent {
...
impl ThingTrait for RealEstateAgent {
...
mod serde {
	...
	use super::*;
	impl Serialize for RealEstateAgent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RealEstateAgent", len)?;
	...
	impl<'de> Deserialize<'de> for RealEstateAgent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RealEstateAgent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RealEstateAgent")
				}
			...
			deserializer.deserialize_struct("RealEstateAgent", FIELDS, ClassVisitor)
		}
	}
}
