...
/// This trait is for properties from <https://schema.org/RadioEpisode>.
pub trait RadioEpisodeTrait {}
impl RadioEpisodeTrait for RadioEpisode {}
impl CreativeWorkTrait for RadioEpisode {
...
impl EpisodeTrait for RadioEpisode {
...
impl ThingTrait for RadioEpisode {
...
mod serde {
	...
	use super::*;
	impl Serialize for RadioEpisode {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RadioEpisode", len)?;
	...
	impl<'de> Deserialize<'de> for RadioEpisode {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioEpisode;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioEpisode")
				}
			...
			deserializer.deserialize_struct("RadioEpisode", FIELDS, ClassVisitor)
		}
	}
}
