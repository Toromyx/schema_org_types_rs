...
/// This trait is for properties from <https://schema.org/ReactAction>.
pub trait ReactActionTrait {}
impl ReactActionTrait for ReactAction {}
...
impl AssessActionTrait for ReactAction {}
impl ThingTrait for ReactAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReactAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReactAction", len)?;
	...
	impl<'de> Deserialize<'de> for ReactAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReactAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReactAction")
				}
			...
			deserializer.deserialize_struct("ReactAction", FIELDS, ClassVisitor)
		}
	}
}
