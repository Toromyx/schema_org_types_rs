...
/// This trait is for properties from <https://schema.org/DiscoverAction>.
pub trait DiscoverActionTrait {}
impl DiscoverActionTrait for DiscoverAction {}
...
impl FindActionTrait for DiscoverAction {}
impl ThingTrait for DiscoverAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DiscoverAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DiscoverAction", len)?;
	...
	impl<'de> Deserialize<'de> for DiscoverAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DiscoverAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DiscoverAction")
				}
			...
			deserializer.deserialize_struct("DiscoverAction", FIELDS, ClassVisitor)
		}
	}
}
