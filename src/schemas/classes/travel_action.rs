...
impl TravelActionTrait for TravelAction {
	fn get_distance(&self) -> &[DistanceProperty] {
...
impl MoveActionTrait for TravelAction {
...
impl ThingTrait for TravelAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for TravelAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TravelAction", len)?;
	...
	impl<'de> Deserialize<'de> for TravelAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TravelAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TravelAction")
				}
			...
			deserializer.deserialize_struct("TravelAction", FIELDS, ClassVisitor)
		}
	}
}
