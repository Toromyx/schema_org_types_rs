...
/// This trait is for properties from <https://schema.org/AutoBodyShop>.
pub trait AutoBodyShopTrait {}
impl AutoBodyShopTrait for AutoBodyShop {}
impl AutomotiveBusinessTrait for AutoBodyShop {}
impl LocalBusinessTrait for AutoBodyShop {
...
impl ThingTrait for AutoBodyShop {
...
mod serde {
	...
	use super::*;
	impl Serialize for AutoBodyShop {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AutoBodyShop", len)?;
	...
	impl<'de> Deserialize<'de> for AutoBodyShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoBodyShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoBodyShop")
				}
			...
			deserializer.deserialize_struct("AutoBodyShop", FIELDS, ClassVisitor)
		}
	}
}
