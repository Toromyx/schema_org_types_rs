...
/// This trait is for properties from <https://schema.org/SportsActivityLocation>.
pub trait SportsActivityLocationTrait {}
impl SportsActivityLocationTrait for SportsActivityLocation {}
impl LocalBusinessTrait for SportsActivityLocation {
...
impl ThingTrait for SportsActivityLocation {
...
mod serde {
	...
	use super::*;
	impl Serialize for SportsActivityLocation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SportsActivityLocation", len)?;
	...
	impl<'de> Deserialize<'de> for SportsActivityLocation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SportsActivityLocation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SportsActivityLocation")
				}
			...
			deserializer.deserialize_struct("SportsActivityLocation", FIELDS, ClassVisitor)
		}
	}
}
