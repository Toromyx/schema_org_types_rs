...
/// This trait is for properties from <https://schema.org/Electrician>.
pub trait ElectricianTrait {}
impl ElectricianTrait for Electrician {}
impl HomeAndConstructionBusinessTrait for Electrician {}
impl LocalBusinessTrait for Electrician {
...
impl ThingTrait for Electrician {
...
mod serde {
	...
	use super::*;
	impl Serialize for Electrician {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "Electrician", len)?;
	...
	impl<'de> Deserialize<'de> for Electrician {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Electrician;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Electrician")
				}
			...
			deserializer.deserialize_struct("Electrician", FIELDS, ClassVisitor)
		}
	}
}
