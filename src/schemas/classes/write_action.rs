...
impl CreateActionTrait for WriteAction {}
impl ThingTrait for WriteAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for WriteAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "WriteAction", len)?;
	...
	impl<'de> Deserialize<'de> for WriteAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WriteAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WriteAction")
				}
			...
			deserializer.deserialize_struct("WriteAction", FIELDS, ClassVisitor)
		}
	}
}
