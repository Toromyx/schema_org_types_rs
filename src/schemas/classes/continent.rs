...
/// This trait is for properties from <https://schema.org/Continent>.
pub trait ContinentTrait {}
impl ContinentTrait for Continent {}
impl LandformTrait for Continent {}
...
mod serde {
	...
	impl Serialize for Continent {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Continent", len)?;
	...
	impl<'de> Deserialize<'de> for Continent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Continent")
				}
			...
			deserializer.deserialize_struct("Continent", FIELDS, ClassVisitor)
		}
	}
}
