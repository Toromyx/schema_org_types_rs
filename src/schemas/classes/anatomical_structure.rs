...
impl AnatomicalStructureTrait for AnatomicalStructure {
	fn get_associated_pathophysiology(&self) -> &[AssociatedPathophysiologyProperty] {
...
impl MedicalEntityTrait for AnatomicalStructure {
...
impl ThingTrait for AnatomicalStructure {
...
mod serde {
	...
	use super::*;
	impl Serialize for AnatomicalStructure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AnatomicalStructure", len)?;
	...
	impl<'de> Deserialize<'de> for AnatomicalStructure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AnatomicalStructure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AnatomicalStructure")
				}
			...
			deserializer.deserialize_struct("AnatomicalStructure", FIELDS, ClassVisitor)
		}
	}
}
