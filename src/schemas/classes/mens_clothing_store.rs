...
/// This trait is for properties from <https://schema.org/MensClothingStore>.
pub trait MensClothingStoreTrait {}
impl MensClothingStoreTrait for MensClothingStore {}
impl LocalBusinessTrait for MensClothingStore {
...
impl StoreTrait for MensClothingStore {}
impl ThingTrait for MensClothingStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for MensClothingStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MensClothingStore", len)?;
	...
	impl<'de> Deserialize<'de> for MensClothingStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MensClothingStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MensClothingStore")
				}
			...
			deserializer.deserialize_struct("MensClothingStore", FIELDS, ClassVisitor)
		}
	}
}
