...
/// This trait is for properties from <https://schema.org/RegisterAction>.
pub trait RegisterActionTrait {}
impl RegisterActionTrait for RegisterAction {}
...
impl InteractActionTrait for RegisterAction {}
impl ThingTrait for RegisterAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for RegisterAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RegisterAction", len)?;
	...
	impl<'de> Deserialize<'de> for RegisterAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RegisterAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RegisterAction")
				}
			...
			deserializer.deserialize_struct("RegisterAction", FIELDS, ClassVisitor)
		}
	}
}
