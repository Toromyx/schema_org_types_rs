...
mod serde {
	...
	use super::*;
	impl Serialize for SpeakableSpecification {
	...
	impl<'de> Deserialize<'de> for SpeakableSpecification {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SpeakableSpecification;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SpeakableSpecification")
				}
