...
/// This trait is for properties from <https://schema.org/Mosque>.
pub trait MosqueTrait {}
impl MosqueTrait for Mosque {}
impl CivicStructureTrait for Mosque {
...
impl PlaceOfWorshipTrait for Mosque {}
impl ThingTrait for Mosque {
...
mod serde {
	...
	impl Serialize for Mosque {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Mosque", len)?;
	...
	impl<'de> Deserialize<'de> for Mosque {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Mosque;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Mosque")
				}
			...
			deserializer.deserialize_struct("Mosque", FIELDS, ClassVisitor)
		}
	}
}
