...
mod serde {
	...
	use super::*;
	impl Serialize for InteractionCounter {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#interaction_service) as usize,
				!Vec::is_empty(&self.r#interaction_type) as usize,
				!Vec::is_empty(&self.r#location) as usize,
				!Vec::is_empty(&self.r#start_time) as usize,
				!Vec::is_empty(&self.r#user_interaction_count) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InteractionCounter", len)?;
			...
			if !Vec::is_empty(&self.r#interaction_service) {
				serialize_struct.serialize_field("interactionService", {
					struct SerializeWith<'a>(&'a Vec<InteractionServiceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#interaction_service)
				})?;
			} else {
				serialize_struct.skip_field("interactionService")?;
			}
			if !Vec::is_empty(&self.r#interaction_type) {
				serialize_struct.serialize_field("interactionType", {
					struct SerializeWith<'a>(&'a Vec<InteractionTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#interaction_type)
				})?;
			} else {
				serialize_struct.skip_field("interactionType")?;
			}
			...
			if !Vec::is_empty(&self.r#user_interaction_count) {
				serialize_struct.serialize_field("userInteractionCount", {
					struct SerializeWith<'a>(&'a Vec<UserInteractionCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#user_interaction_count)
				})?;
			} else {
				serialize_struct.skip_field("userInteractionCount")?;
			}
	...
	impl<'de> Deserialize<'de> for InteractionCounter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"interactionService" => Ok(Field::InteractionService),
						"interactionType" => Ok(Field::InteractionType),
						"location" => Ok(Field::Location),
						"startTime" => Ok(Field::StartTime),
						"userInteractionCount" => Ok(Field::UserInteractionCount),
					...
					E: de::Error,
				{
					match value {
						...
						b"interactionService" => Ok(Field::InteractionService),
						b"interactionType" => Ok(Field::InteractionType),
						b"location" => Ok(Field::Location),
						b"startTime" => Ok(Field::StartTime),
						b"userInteractionCount" => Ok(Field::UserInteractionCount),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InteractionCounter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InteractionCounter")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#interaction_service_property = None;
					let mut r#interaction_type_property = None;
					let mut r#location_property = None;
					let mut r#start_time_property = None;
					let mut r#user_interaction_count_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::InteractionService => {
								if r#interaction_service_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"interactionService",
									));
								}
								r#interaction_service_property = Some({
									struct DeserializeWith(Vec<InteractionServiceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::InteractionType => {
								if r#interaction_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"interactionType",
									));
								}
								r#interaction_type_property = Some({
									struct DeserializeWith(Vec<InteractionTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::UserInteractionCount => {
								if r#user_interaction_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"userInteractionCount",
									));
								}
								r#user_interaction_count_property = Some({
									struct DeserializeWith(Vec<UserInteractionCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(InteractionCounter {
						...
						r#interaction_service: r#interaction_service_property.unwrap_or_default(),
						r#interaction_type: r#interaction_type_property.unwrap_or_default(),
						r#location: r#location_property.unwrap_or_default(),
						r#start_time: r#start_time_property.unwrap_or_default(),
						r#user_interaction_count: r#user_interaction_count_property
							.unwrap_or_default(),
			...
			deserializer.deserialize_struct("InteractionCounter", FIELDS, ClassVisitor)
		}
	}
}
