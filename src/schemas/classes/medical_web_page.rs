...
impl MedicalWebPageTrait for MedicalWebPage {
	fn get_aspect(&self) -> &[AspectProperty] {
		self.r#aspect.as_slice()
	}
	fn take_aspect(&mut self) -> Vec<AspectProperty> {
		std::mem::take(&mut self.r#aspect)
	}
	fn get_medical_audience(&self) -> &[MedicalAudienceProperty] {
		self.r#medical_audience.as_slice()
	}
	fn take_medical_audience(&mut self) -> Vec<MedicalAudienceProperty> {
		std::mem::take(&mut self.r#medical_audience)
	}
}
impl CreativeWorkTrait for MedicalWebPage {
...
impl ThingTrait for MedicalWebPage {
...
impl WebPageTrait for MedicalWebPage {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalWebPage {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#aspect) as usize,
				!Vec::is_empty(&self.r#medical_audience) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalWebPage", len)?;
			if !Vec::is_empty(&self.r#aspect) {
				serialize_struct.serialize_field("aspect", {
					struct SerializeWith<'a>(&'a Vec<AspectProperty>);
					...
					&SerializeWith(&self.r#aspect)
				})?;
			} else {
				serialize_struct.skip_field("aspect")?;
			}
			if !Vec::is_empty(&self.r#medical_audience) {
				serialize_struct.serialize_field("medicalAudience", {
					struct SerializeWith<'a>(&'a Vec<MedicalAudienceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#medical_audience)
				})?;
			} else {
				serialize_struct.skip_field("medicalAudience")?;
			}
			...
			if !Vec::is_empty(&self.r#breadcrumb) {
				serialize_struct.serialize_field("breadcrumb", {
					...
					&SerializeWith(&self.r#breadcrumb)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#last_reviewed) {
				serialize_struct.serialize_field("lastReviewed", {
					...
					&SerializeWith(&self.r#last_reviewed)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#main_content_of_page) {
				serialize_struct.serialize_field("mainContentOfPage", {
					...
					&SerializeWith(&self.r#main_content_of_page)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#primary_image_of_page) {
				serialize_struct.serialize_field("primaryImageOfPage", {
					...
					&SerializeWith(&self.r#primary_image_of_page)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#related_link) {
				serialize_struct.serialize_field("relatedLink", {
					...
					&SerializeWith(&self.r#related_link)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#reviewed_by) {
				serialize_struct.serialize_field("reviewedBy", {
					...
					&SerializeWith(&self.r#reviewed_by)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#significant_link) {
				serialize_struct.serialize_field("significantLink", {
					...
					&SerializeWith(&self.r#significant_link)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#significant_links) {
				serialize_struct.serialize_field("significantLinks", {
					...
					&SerializeWith(&self.r#significant_links)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#specialty) {
				serialize_struct.serialize_field("specialty", {
					...
					&SerializeWith(&self.r#specialty)
				})?;
			} else {
	...
	impl<'de> Deserialize<'de> for MedicalWebPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"aspect" => Ok(Field::Aspect),
						"medicalAudience" => Ok(Field::MedicalAudience),
				...
				{
					match value {
						b"aspect" => Ok(Field::Aspect),
						b"medicalAudience" => Ok(Field::MedicalAudience),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalWebPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalWebPage")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#aspect_property = None;
					let mut r#medical_audience_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Aspect => {
								if r#aspect_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("aspect"));
								}
								r#aspect_property = Some({
									struct DeserializeWith(Vec<AspectProperty>);
							...
							Field::MedicalAudience => {
								if r#medical_audience_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"medicalAudience",
									));
								}
								r#medical_audience_property = Some({
									struct DeserializeWith(Vec<MedicalAudienceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Breadcrumb => {
								...
								r#breadcrumb_property = Some({
									struct DeserializeWith(Vec<BreadcrumbProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::LastReviewed => {
								...
								r#last_reviewed_property = Some({
									struct DeserializeWith(Vec<LastReviewedProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MainContentOfPage => {
								...
								r#main_content_of_page_property = Some({
									struct DeserializeWith(Vec<MainContentOfPageProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::PrimaryImageOfPage => {
								...
								r#primary_image_of_page_property = Some({
									struct DeserializeWith(Vec<PrimaryImageOfPageProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RelatedLink => {
								...
								r#related_link_property = Some({
									struct DeserializeWith(Vec<RelatedLinkProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ReviewedBy => {
								...
								r#reviewed_by_property = Some({
									struct DeserializeWith(Vec<ReviewedByProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SignificantLink => {
								...
								r#significant_link_property = Some({
									struct DeserializeWith(Vec<SignificantLinkProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SignificantLinks => {
								...
								r#significant_links_property = Some({
									struct DeserializeWith(Vec<SignificantLinksProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Specialty => {
								...
								r#specialty_property = Some({
									struct DeserializeWith(Vec<SpecialtyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MedicalWebPage {
						r#aspect: r#aspect_property.unwrap_or_default(),
						r#medical_audience: r#medical_audience_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MedicalWebPage", FIELDS, ClassVisitor)
		}
	}
}
