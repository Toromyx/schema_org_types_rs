...
pub struct MedicalWebPage {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "aspect"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/aspect"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/aspect"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "medicalAudience"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/medicalAudience"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/medicalAudience"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
