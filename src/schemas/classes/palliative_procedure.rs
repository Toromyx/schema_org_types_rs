...
impl MedicalProcedureTrait for PalliativeProcedure {
...
impl MedicalTherapyTrait for PalliativeProcedure {
...
impl TherapeuticProcedureTrait for PalliativeProcedure {
...
impl ThingTrait for PalliativeProcedure {
...
mod serde {
	...
	use super::*;
	impl Serialize for PalliativeProcedure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PalliativeProcedure", len)?;
	...
	impl<'de> Deserialize<'de> for PalliativeProcedure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PalliativeProcedure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PalliativeProcedure")
				}
			...
			deserializer.deserialize_struct("PalliativeProcedure", FIELDS, ClassVisitor)
		}
	}
}
