...
/// This trait is for properties from <https://schema.org/AgreeAction>.
pub trait AgreeActionTrait {}
impl AgreeActionTrait for AgreeAction {}
...
impl AssessActionTrait for AgreeAction {}
impl ReactActionTrait for AgreeAction {}
impl ThingTrait for AgreeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AgreeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AgreeAction", len)?;
	...
	impl<'de> Deserialize<'de> for AgreeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AgreeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AgreeAction")
				}
			...
			deserializer.deserialize_struct("AgreeAction", FIELDS, ClassVisitor)
		}
	}
}
