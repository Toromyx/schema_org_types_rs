...
impl ThingTrait for DefinedTerm {
...
mod serde {
	...
	use super::*;
	impl Serialize for DefinedTerm {
	...
	impl<'de> Deserialize<'de> for DefinedTerm {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DefinedTerm;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DefinedTerm")
				}
			...
			deserializer.deserialize_struct("DefinedTerm", FIELDS, ClassVisitor)
		}
	}
}
