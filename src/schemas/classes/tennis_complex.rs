...
/// This trait is for properties from <https://schema.org/TennisComplex>.
pub trait TennisComplexTrait {}
impl TennisComplexTrait for TennisComplex {}
impl LocalBusinessTrait for TennisComplex {
...
impl SportsActivityLocationTrait for TennisComplex {}
impl ThingTrait for TennisComplex {
...
mod serde {
	...
	use super::*;
	impl Serialize for TennisComplex {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TennisComplex", len)?;
	...
	impl<'de> Deserialize<'de> for TennisComplex {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TennisComplex;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TennisComplex")
				}
			...
			deserializer.deserialize_struct("TennisComplex", FIELDS, ClassVisitor)
		}
	}
}
