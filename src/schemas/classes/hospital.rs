...
pub trait HospitalTrait {
	...
	/// Take <https://schema.org/availableService> from [`Self`] as owned vector.
	...
	fn get_healthcare_reporting_data(&self) -> &[HealthcareReportingDataProperty];
	/// Take <https://schema.org/healthcareReportingData> from [`Self`] as owned vector.
	fn take_healthcare_reporting_data(&mut self) -> Vec<HealthcareReportingDataProperty>;
...
impl HospitalTrait for Hospital {
	...
	fn take_available_service(&mut self) -> Vec<AvailableServiceProperty> {
		std::mem::take(&mut self.r#available_service)
	}
	fn get_healthcare_reporting_data(&self) -> &[HealthcareReportingDataProperty] {
		self.r#healthcare_reporting_data.as_slice()
	}
	fn take_healthcare_reporting_data(&mut self) -> Vec<HealthcareReportingDataProperty> {
		std::mem::take(&mut self.r#healthcare_reporting_data)
	}
	fn get_medical_specialty(&self) -> &[MedicalSpecialtyProperty] {
...
impl MedicalOrganizationTrait for Hospital {
	...
	fn take_health_plan_network_id(&mut self) -> Vec<HealthPlanNetworkIdProperty> {
		std::mem::take(&mut self.r#health_plan_network_id)
	}
	fn get_is_accepting_new_patients(&self) -> &[IsAcceptingNewPatientsProperty] {
		self.r#is_accepting_new_patients.as_slice()
	}
	fn take_is_accepting_new_patients(&mut self) -> Vec<IsAcceptingNewPatientsProperty> {
		std::mem::take(&mut self.r#is_accepting_new_patients)
	}
	fn get_medical_specialty(&self) -> &[MedicalSpecialtyProperty] {
		self.r#medical_specialty.as_slice()
	}
...
mod serde {
	...
	impl Serialize for Hospital {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#healthcare_reporting_data) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Hospital", len)?;
			if !Vec::is_empty(&self.r#available_service) {
				serialize_struct.serialize_field("availableService", {
					struct SerializeWith<'a>(&'a Vec<AvailableServiceProperty>);
					...
					&SerializeWith(&self.r#available_service)
				})?;
			} else {
				serialize_struct.skip_field("availableService")?;
			}
			if !Vec::is_empty(&self.r#healthcare_reporting_data) {
				serialize_struct.serialize_field("healthcareReportingData", {
					struct SerializeWith<'a>(&'a Vec<HealthcareReportingDataProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#healthcare_reporting_data)
				})?;
			} else {
				serialize_struct.skip_field("healthcareReportingData")?;
			}
			if !Vec::is_empty(&self.r#medical_specialty) {
				serialize_struct.serialize_field("medicalSpecialty", {
					struct SerializeWith<'a>(&'a Vec<MedicalSpecialtyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#medical_specialty)
				})?;
			} else {
			...
			if !Vec::is_empty(&self.r#health_plan_network_id) {
				serialize_struct.serialize_field("healthPlanNetworkId", {
					struct SerializeWith<'a>(&'a Vec<HealthPlanNetworkIdProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#health_plan_network_id)
				})?;
			} else {
				serialize_struct.skip_field("healthPlanNetworkId")?;
			}
			if !Vec::is_empty(&self.r#is_accepting_new_patients) {
				serialize_struct.serialize_field("isAcceptingNewPatients", {
					struct SerializeWith<'a>(&'a Vec<IsAcceptingNewPatientsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#is_accepting_new_patients)
				})?;
			} else {
	...
	impl<'de> Deserialize<'de> for Hospital {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"healthcareReportingData" => Ok(Field::HealthcareReportingData),
					...
					E: de::Error,
				{
					match value {
						...
						b"healthcareReportingData" => Ok(Field::HealthcareReportingData),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Hospital;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Hospital")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#healthcare_reporting_data_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AvailableService => {
								if r#available_service_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"availableService",
									));
								}
								r#available_service_property = Some({
									struct DeserializeWith(Vec<AvailableServiceProperty>);
							...
							Field::HealthcareReportingData => {
								if r#healthcare_reporting_data_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"healthcareReportingData",
									));
								}
								r#healthcare_reporting_data_property = Some({
									struct DeserializeWith(Vec<HealthcareReportingDataProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MedicalSpecialty => {
								if r#medical_specialty_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"medicalSpecialty",
									));
								}
								r#medical_specialty_property = Some({
									struct DeserializeWith(Vec<MedicalSpecialtyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::HealthPlanNetworkId => {
								if r#health_plan_network_id_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"healthPlanNetworkId",
									));
								}
								r#health_plan_network_id_property = Some({
									struct DeserializeWith(Vec<HealthPlanNetworkIdProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IsAcceptingNewPatients => {
								if r#is_accepting_new_patients_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"isAcceptingNewPatients",
									));
								}
					...
					Ok(Hospital {
						...
						r#healthcare_reporting_data: r#healthcare_reporting_data_property
							.unwrap_or_default(),
			...
			deserializer.deserialize_struct("Hospital", FIELDS, ClassVisitor)
		}
	}
}
