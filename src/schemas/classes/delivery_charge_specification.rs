...
mod serde {
	...
	use super::*;
	impl Serialize for DeliveryChargeSpecification {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DeliveryChargeSpecification", len)?;
	...
	impl<'de> Deserialize<'de> for DeliveryChargeSpecification {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DeliveryChargeSpecification;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DeliveryChargeSpecification")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					Ok(DeliveryChargeSpecification {
			...
			deserializer.deserialize_struct("DeliveryChargeSpecification", FIELDS, ClassVisitor)
		}
	}
}
