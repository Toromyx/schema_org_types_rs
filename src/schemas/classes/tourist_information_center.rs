...
/// This trait is for properties from <https://schema.org/TouristInformationCenter>.
pub trait TouristInformationCenterTrait {}
impl TouristInformationCenterTrait for TouristInformationCenter {}
impl LocalBusinessTrait for TouristInformationCenter {
...
impl ThingTrait for TouristInformationCenter {
...
mod serde {
	...
	use super::*;
	impl Serialize for TouristInformationCenter {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TouristInformationCenter", len)?;
	...
	impl<'de> Deserialize<'de> for TouristInformationCenter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TouristInformationCenter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TouristInformationCenter")
				}
			...
			deserializer.deserialize_struct("TouristInformationCenter", FIELDS, ClassVisitor)
		}
	}
}
