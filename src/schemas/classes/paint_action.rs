...
/// This trait is for properties from <https://schema.org/PaintAction>.
pub trait PaintActionTrait {}
impl PaintActionTrait for PaintAction {}
...
impl CreateActionTrait for PaintAction {}
impl ThingTrait for PaintAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for PaintAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PaintAction", len)?;
	...
	impl<'de> Deserialize<'de> for PaintAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PaintAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PaintAction")
				}
			...
			deserializer.deserialize_struct("PaintAction", FIELDS, ClassVisitor)
		}
	}
}
