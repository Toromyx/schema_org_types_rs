...
pub struct MedicalRiskFactor {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "increasesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/increasesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/increasesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
