...
/// This trait is for properties from <https://schema.org/HealthClub>.
pub trait HealthClubTrait {}
impl HealthClubTrait for HealthClub {}
impl HealthAndBeautyBusinessTrait for HealthClub {}
impl LocalBusinessTrait for HealthClub {
...
impl SportsActivityLocationTrait for HealthClub {}
impl ThingTrait for HealthClub {
...
mod serde {
	...
	impl Serialize for HealthClub {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HealthClub", len)?;
	...
	impl<'de> Deserialize<'de> for HealthClub {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HealthClub;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HealthClub")
				}
			...
			deserializer.deserialize_struct("HealthClub", FIELDS, ClassVisitor)
		}
	}
}
