...
pub trait ConsumeActionTrait {
	/// Get <https://schema.org/actionAccessibilityRequirement> from [`Self`] as borrowed slice.
	fn get_action_accessibility_requirement(&self) -> &[ActionAccessibilityRequirementProperty];
	/// Take <https://schema.org/actionAccessibilityRequirement> from [`Self`] as owned vector.
...
impl ConsumeActionTrait for ConsumeAction {
	fn get_action_accessibility_requirement(&self) -> &[ActionAccessibilityRequirementProperty] {
...
impl ThingTrait for ConsumeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ConsumeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ConsumeAction", len)?;
	...
	impl<'de> Deserialize<'de> for ConsumeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ConsumeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ConsumeAction")
				}
			...
			deserializer.deserialize_struct("ConsumeAction", FIELDS, ClassVisitor)
		}
	}
}
