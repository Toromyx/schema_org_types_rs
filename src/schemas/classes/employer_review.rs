...
/// This trait is for properties from <https://schema.org/EmployerReview>.
pub trait EmployerReviewTrait {}
impl EmployerReviewTrait for EmployerReview {}
impl CreativeWorkTrait for EmployerReview {
...
impl ReviewTrait for EmployerReview {
...
impl ThingTrait for EmployerReview {
...
mod serde {
	...
	use super::*;
	impl Serialize for EmployerReview {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EmployerReview", len)?;
	...
	impl<'de> Deserialize<'de> for EmployerReview {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EmployerReview;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EmployerReview")
				}
			...
			deserializer.deserialize_struct("EmployerReview", FIELDS, ClassVisitor)
		}
	}
}
