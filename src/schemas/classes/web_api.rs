...
pub struct WebApi {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "documentation"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/documentation"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/documentation"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
