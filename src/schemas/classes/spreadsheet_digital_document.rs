...
/// This trait is for properties from <https://schema.org/SpreadsheetDigitalDocument>.
pub trait SpreadsheetDigitalDocumentTrait {}
impl SpreadsheetDigitalDocumentTrait for SpreadsheetDigitalDocument {}
impl CreativeWorkTrait for SpreadsheetDigitalDocument {
...
impl DigitalDocumentTrait for SpreadsheetDigitalDocument {
...
impl ThingTrait for SpreadsheetDigitalDocument {
...
mod serde {
	...
	use super::*;
	impl Serialize for SpreadsheetDigitalDocument {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SpreadsheetDigitalDocument", len)?;
	...
	impl<'de> Deserialize<'de> for SpreadsheetDigitalDocument {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SpreadsheetDigitalDocument;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SpreadsheetDigitalDocument")
				}
			...
			deserializer.deserialize_struct("SpreadsheetDigitalDocument", FIELDS, ClassVisitor)
		}
	}
}
