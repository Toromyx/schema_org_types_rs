...
/// This trait is for properties from <https://schema.org/Conversation>.
pub trait ConversationTrait {}
impl ConversationTrait for Conversation {}
impl CreativeWorkTrait for Conversation {
...
impl ThingTrait for Conversation {
	...
	impl Serialize for Conversation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "Conversation", len)?;
	...
	impl<'de> Deserialize<'de> for Conversation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Conversation")
				}
			...
			deserializer.deserialize_struct("Conversation", FIELDS, ClassVisitor)
		}
	}
}
