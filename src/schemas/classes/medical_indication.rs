...
/// This trait is for properties from <https://schema.org/MedicalIndication>.
pub trait MedicalIndicationTrait {}
impl MedicalIndicationTrait for MedicalIndication {}
impl MedicalEntityTrait for MedicalIndication {
...
impl ThingTrait for MedicalIndication {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalIndication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalIndication", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalIndication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalIndication;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalIndication")
				}
			...
			deserializer.deserialize_struct("MedicalIndication", FIELDS, ClassVisitor)
		}
	}
}
