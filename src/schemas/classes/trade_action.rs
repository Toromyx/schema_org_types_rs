...
impl TradeActionTrait for TradeAction {
	fn get_price(&self) -> &[PriceProperty] {
...
impl ThingTrait for TradeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for TradeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TradeAction", len)?;
	...
	impl<'de> Deserialize<'de> for TradeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TradeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TradeAction")
				}
			...
			deserializer.deserialize_struct("TradeAction", FIELDS, ClassVisitor)
		}
	}
}
