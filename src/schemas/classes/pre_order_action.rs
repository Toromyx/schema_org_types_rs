...
/// This trait is for properties from <https://schema.org/PreOrderAction>.
pub trait PreOrderActionTrait {}
impl PreOrderActionTrait for PreOrderAction {}
...
impl ThingTrait for PreOrderAction {
...
impl TradeActionTrait for PreOrderAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for PreOrderAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PreOrderAction", len)?;
	...
	impl<'de> Deserialize<'de> for PreOrderAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PreOrderAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PreOrderAction")
				}
			...
			deserializer.deserialize_struct("PreOrderAction", FIELDS, ClassVisitor)
		}
	}
}
