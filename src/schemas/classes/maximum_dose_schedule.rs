...
/// This trait is for properties from <https://schema.org/MaximumDoseSchedule>.
pub trait MaximumDoseScheduleTrait {}
impl MaximumDoseScheduleTrait for MaximumDoseSchedule {}
impl DoseScheduleTrait for MaximumDoseSchedule {
...
impl MedicalEntityTrait for MaximumDoseSchedule {
...
impl MedicalIntangibleTrait for MaximumDoseSchedule {}
impl ThingTrait for MaximumDoseSchedule {
...
mod serde {
	...
	use super::*;
	impl Serialize for MaximumDoseSchedule {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MaximumDoseSchedule", len)?;
	...
	impl<'de> Deserialize<'de> for MaximumDoseSchedule {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MaximumDoseSchedule;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MaximumDoseSchedule")
				}
			...
			deserializer.deserialize_struct("MaximumDoseSchedule", FIELDS, ClassVisitor)
		}
	}
}
