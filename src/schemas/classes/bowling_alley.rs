...
/// This trait is for properties from <https://schema.org/BowlingAlley>.
pub trait BowlingAlleyTrait {}
impl BowlingAlleyTrait for BowlingAlley {}
impl LocalBusinessTrait for BowlingAlley {
...
impl SportsActivityLocationTrait for BowlingAlley {}
impl ThingTrait for BowlingAlley {
...
mod serde {
	...
	use super::*;
	impl Serialize for BowlingAlley {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BowlingAlley", len)?;
	...
	impl<'de> Deserialize<'de> for BowlingAlley {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BowlingAlley;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BowlingAlley")
				}
			...
			deserializer.deserialize_struct("BowlingAlley", FIELDS, ClassVisitor)
		}
	}
}
