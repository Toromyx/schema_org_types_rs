...
/// This trait is for properties from <https://schema.org/WebContent>.
pub trait WebContentTrait {}
impl WebContentTrait for WebContent {}
impl CreativeWorkTrait for WebContent {
...
impl ThingTrait for WebContent {
...
mod serde {
	...
	impl Serialize for WebContent {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "WebContent", len)?;
	...
	impl<'de> Deserialize<'de> for WebContent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WebContent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WebContent")
				}
			...
			deserializer.deserialize_struct("WebContent", FIELDS, ClassVisitor)
		}
	}
}
