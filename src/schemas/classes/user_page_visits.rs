...
/// This trait is for properties from <https://schema.org/UserPageVisits>.
pub trait UserPageVisitsTrait {}
impl UserPageVisitsTrait for UserPageVisits {}
impl EventTrait for UserPageVisits {
...
impl ThingTrait for UserPageVisits {
...
impl UserInteractionTrait for UserPageVisits {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for UserPageVisits {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserPageVisits", len)?;
	...
	impl<'de> Deserialize<'de> for UserPageVisits {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserPageVisits;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserPageVisits")
				}
			...
			deserializer.deserialize_struct("UserPageVisits", FIELDS, ClassVisitor)
		}
	}
}
