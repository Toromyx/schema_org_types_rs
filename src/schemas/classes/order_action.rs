...
/// This trait is for properties from <https://schema.org/OrderAction>.
pub trait OrderActionTrait {
...
impl OrderActionTrait for OrderAction {
	fn get_delivery_method(&self) -> &[DeliveryMethodProperty] {
...
impl ThingTrait for OrderAction {
...
impl TradeActionTrait for OrderAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for OrderAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OrderAction", len)?;
	...
	impl<'de> Deserialize<'de> for OrderAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OrderAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OrderAction")
				}
			...
			deserializer.deserialize_struct("OrderAction", FIELDS, ClassVisitor)
		}
	}
}
