...
/// This trait is for properties from <https://schema.org/MusicVenue>.
pub trait MusicVenueTrait {}
impl MusicVenueTrait for MusicVenue {}
impl CivicStructureTrait for MusicVenue {
...
impl ThingTrait for MusicVenue {
...
mod serde {
	...
	impl Serialize for MusicVenue {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "MusicVenue", len)?;
	...
	impl<'de> Deserialize<'de> for MusicVenue {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicVenue;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicVenue")
				}
			...
			deserializer.deserialize_struct("MusicVenue", FIELDS, ClassVisitor)
		}
	}
}
