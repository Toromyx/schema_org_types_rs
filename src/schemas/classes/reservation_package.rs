...
pub struct ReservationPackage {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "subReservation"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/subReservation"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/subReservation"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
