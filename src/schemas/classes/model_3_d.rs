...
pub struct Model3D {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "isResizable"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/isResizable"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/isResizable"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
