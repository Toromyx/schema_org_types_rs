...
pub struct ScreeningEvent {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "workPresented"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/workPresented"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/workPresented"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
