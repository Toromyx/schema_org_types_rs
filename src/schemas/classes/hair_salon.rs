...
/// This trait is for properties from <https://schema.org/HairSalon>.
pub trait HairSalonTrait {}
impl HairSalonTrait for HairSalon {}
impl HealthAndBeautyBusinessTrait for HairSalon {}
impl LocalBusinessTrait for HairSalon {
...
mod serde {
	...
	impl Serialize for HairSalon {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HairSalon", len)?;
	...
	impl<'de> Deserialize<'de> for HairSalon {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HairSalon;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HairSalon")
				}
			...
			deserializer.deserialize_struct("HairSalon", FIELDS, ClassVisitor)
		}
	}
}
