...
pub trait NewsArticleTrait {
	/// Get <https://schema.org/dateline> from [`Self`] as borrowed slice.
	fn get_dateline(&self) -> &[DatelineProperty];
	/// Take <https://schema.org/dateline> from [`Self`] as owned vector.
	fn take_dateline(&mut self) -> Vec<DatelineProperty>;
	/// Get <https://schema.org/printColumn> from [`Self`] as borrowed slice.
	fn get_print_column(&self) -> &[PrintColumnProperty];
	/// Take <https://schema.org/printColumn> from [`Self`] as owned vector.
	fn take_print_column(&mut self) -> Vec<PrintColumnProperty>;
	/// Get <https://schema.org/printEdition> from [`Self`] as borrowed slice.
	fn get_print_edition(&self) -> &[PrintEditionProperty];
	/// Take <https://schema.org/printEdition> from [`Self`] as owned vector.
	fn take_print_edition(&mut self) -> Vec<PrintEditionProperty>;
	/// Get <https://schema.org/printPage> from [`Self`] as borrowed slice.
	fn get_print_page(&self) -> &[PrintPageProperty];
	/// Take <https://schema.org/printPage> from [`Self`] as owned vector.
	fn take_print_page(&mut self) -> Vec<PrintPageProperty>;
	/// Get <https://schema.org/printSection> from [`Self`] as borrowed slice.
	fn get_print_section(&self) -> &[PrintSectionProperty];
	/// Take <https://schema.org/printSection> from [`Self`] as owned vector.
	fn take_print_section(&mut self) -> Vec<PrintSectionProperty>;
}
impl NewsArticleTrait for NewsArticle {
	fn get_dateline(&self) -> &[DatelineProperty] {
...
impl ArticleTrait for NewsArticle {
...
impl CreativeWorkTrait for NewsArticle {
...
impl ThingTrait for NewsArticle {
	...
	impl Serialize for NewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "NewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for NewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = NewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema NewsArticle")
				}
			...
			deserializer.deserialize_struct("NewsArticle", FIELDS, ClassVisitor)
		}
	}
}
