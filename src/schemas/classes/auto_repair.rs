...
/// This trait is for properties from <https://schema.org/AutoRepair>.
pub trait AutoRepairTrait {}
impl AutoRepairTrait for AutoRepair {}
impl AutomotiveBusinessTrait for AutoRepair {}
impl LocalBusinessTrait for AutoRepair {
...
impl ThingTrait for AutoRepair {
...
mod serde {
	...
	impl Serialize for AutoRepair {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AutoRepair", len)?;
	...
	impl<'de> Deserialize<'de> for AutoRepair {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoRepair;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoRepair")
				}
			...
			deserializer.deserialize_struct("AutoRepair", FIELDS, ClassVisitor)
		}
	}
}
