...
/// This trait is for properties from <https://schema.org/IgnoreAction>.
pub trait IgnoreActionTrait {}
impl IgnoreActionTrait for IgnoreAction {}
...
impl AssessActionTrait for IgnoreAction {}
impl ThingTrait for IgnoreAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for IgnoreAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "IgnoreAction", len)?;
	...
	impl<'de> Deserialize<'de> for IgnoreAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema IgnoreAction")
				}
			...
			deserializer.deserialize_struct("IgnoreAction", FIELDS, ClassVisitor)
		}
	}
}
