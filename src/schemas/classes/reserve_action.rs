...
/// This trait is for properties from <https://schema.org/ReserveAction>.
pub trait ReserveActionTrait {}
impl ReserveActionTrait for ReserveAction {}
...
impl OrganizeActionTrait for ReserveAction {}
impl PlanActionTrait for ReserveAction {
...
impl ThingTrait for ReserveAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReserveAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReserveAction", len)?;
	...
	impl<'de> Deserialize<'de> for ReserveAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReserveAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReserveAction")
				}
			...
			deserializer.deserialize_struct("ReserveAction", FIELDS, ClassVisitor)
		}
	}
}
