...
/// This trait is for properties from <https://schema.org/MedicalClinic>.
pub trait MedicalClinicTrait {
...
impl MedicalClinicTrait for MedicalClinic {
	fn get_available_service(&self) -> &[AvailableServiceProperty] {
...
impl LocalBusinessTrait for MedicalClinic {
...
impl MedicalBusinessTrait for MedicalClinic {}
impl MedicalOrganizationTrait for MedicalClinic {
...
impl ThingTrait for MedicalClinic {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalClinic {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalClinic", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalClinic {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalClinic;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalClinic")
				}
			...
			deserializer.deserialize_struct("MedicalClinic", FIELDS, ClassVisitor)
		}
	}
}
