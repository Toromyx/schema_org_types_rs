...
/// This trait is for properties from <https://schema.org/StadiumOrArena>.
pub trait StadiumOrArenaTrait {}
impl StadiumOrArenaTrait for StadiumOrArena {}
impl CivicStructureTrait for StadiumOrArena {
...
impl LocalBusinessTrait for StadiumOrArena {
...
impl SportsActivityLocationTrait for StadiumOrArena {}
impl ThingTrait for StadiumOrArena {
...
mod serde {
	...
	use super::*;
	impl Serialize for StadiumOrArena {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "StadiumOrArena", len)?;
	...
	impl<'de> Deserialize<'de> for StadiumOrArena {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = StadiumOrArena;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema StadiumOrArena")
				}
			...
			deserializer.deserialize_struct("StadiumOrArena", FIELDS, ClassVisitor)
		}
	}
}
