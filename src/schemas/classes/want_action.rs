...
/// This trait is for properties from <https://schema.org/WantAction>.
pub trait WantActionTrait {}
impl WantActionTrait for WantAction {}
...
impl AssessActionTrait for WantAction {}
impl ReactActionTrait for WantAction {}
impl ThingTrait for WantAction {
...
mod serde {
	...
	impl Serialize for WantAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "WantAction", len)?;
	...
	impl<'de> Deserialize<'de> for WantAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WantAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WantAction")
				}
			...
			deserializer.deserialize_struct("WantAction", FIELDS, ClassVisitor)
		}
	}
}
