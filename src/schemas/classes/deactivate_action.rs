...
/// This trait is for properties from <https://schema.org/DeactivateAction>.
pub trait DeactivateActionTrait {}
impl DeactivateActionTrait for DeactivateAction {}
...
impl ControlActionTrait for DeactivateAction {}
impl ThingTrait for DeactivateAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DeactivateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DeactivateAction", len)?;
	...
	impl<'de> Deserialize<'de> for DeactivateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DeactivateAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DeactivateAction")
				}
			...
			deserializer.deserialize_struct("DeactivateAction", FIELDS, ClassVisitor)
		}
	}
}
