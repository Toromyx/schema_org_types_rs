...
/// This trait is for properties from <https://schema.org/SelfStorage>.
pub trait SelfStorageTrait {}
impl SelfStorageTrait for SelfStorage {}
impl LocalBusinessTrait for SelfStorage {
...
impl ThingTrait for SelfStorage {
...
mod serde {
	...
	use super::*;
	impl Serialize for SelfStorage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SelfStorage", len)?;
	...
	impl<'de> Deserialize<'de> for SelfStorage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SelfStorage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SelfStorage")
				}
			...
			deserializer.deserialize_struct("SelfStorage", FIELDS, ClassVisitor)
		}
	}
}
