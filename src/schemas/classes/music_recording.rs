...
impl MusicRecordingTrait for MusicRecording {
	fn get_by_artist(&self) -> &[ByArtistProperty] {
	...
	fn get_in_album(&self) -> &[InAlbumProperty] {
		self.r#in_album.as_slice()
	}
	fn take_in_album(&mut self) -> Vec<InAlbumProperty> {
		std::mem::take(&mut self.r#in_album)
	}
	fn get_in_playlist(&self) -> &[InPlaylistProperty] {
		self.r#in_playlist.as_slice()
	}
	fn take_in_playlist(&mut self) -> Vec<InPlaylistProperty> {
		std::mem::take(&mut self.r#in_playlist)
	}
	fn get_isrc_code(&self) -> &[IsrcCodeProperty] {
		self.r#isrc_code.as_slice()
	}
	fn take_isrc_code(&mut self) -> Vec<IsrcCodeProperty> {
		std::mem::take(&mut self.r#isrc_code)
	}
	fn get_recording_of(&self) -> &[RecordingOfProperty] {
		self.r#recording_of.as_slice()
	}
	fn take_recording_of(&mut self) -> Vec<RecordingOfProperty> {
		std::mem::take(&mut self.r#recording_of)
	}
}
impl CreativeWorkTrait for MusicRecording {
...
impl ThingTrait for MusicRecording {
...
mod serde {
	...
	use super::*;
	impl Serialize for MusicRecording {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#in_album) as usize,
				!Vec::is_empty(&self.r#in_playlist) as usize,
				!Vec::is_empty(&self.r#isrc_code) as usize,
				!Vec::is_empty(&self.r#recording_of) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MusicRecording", len)?;
			...
			if !Vec::is_empty(&self.r#in_album) {
				serialize_struct.serialize_field("inAlbum", {
					struct SerializeWith<'a>(&'a Vec<InAlbumProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#in_album)
				})?;
			} else {
				serialize_struct.skip_field("inAlbum")?;
			}
			if !Vec::is_empty(&self.r#in_playlist) {
				serialize_struct.serialize_field("inPlaylist", {
					struct SerializeWith<'a>(&'a Vec<InPlaylistProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#in_playlist)
				})?;
			} else {
				serialize_struct.skip_field("inPlaylist")?;
			}
			if !Vec::is_empty(&self.r#isrc_code) {
				serialize_struct.serialize_field("isrcCode", {
					struct SerializeWith<'a>(&'a Vec<IsrcCodeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#isrc_code)
				})?;
			} else {
				serialize_struct.skip_field("isrcCode")?;
			}
			if !Vec::is_empty(&self.r#recording_of) {
				serialize_struct.serialize_field("recordingOf", {
					struct SerializeWith<'a>(&'a Vec<RecordingOfProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#recording_of)
				})?;
			} else {
				serialize_struct.skip_field("recordingOf")?;
			}
	...
	impl<'de> Deserialize<'de> for MusicRecording {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"inAlbum" => Ok(Field::InAlbum),
						"inPlaylist" => Ok(Field::InPlaylist),
						"isrcCode" => Ok(Field::IsrcCode),
						"recordingOf" => Ok(Field::RecordingOf),
					...
					E: de::Error,
				{
					match value {
						...
						b"inAlbum" => Ok(Field::InAlbum),
						b"inPlaylist" => Ok(Field::InPlaylist),
						b"isrcCode" => Ok(Field::IsrcCode),
						b"recordingOf" => Ok(Field::RecordingOf),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicRecording;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicRecording")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#in_album_property = None;
					let mut r#in_playlist_property = None;
					let mut r#isrc_code_property = None;
					let mut r#recording_of_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::InAlbum => {
								if r#in_album_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"inAlbum",
									));
								}
								r#in_album_property = Some({
									struct DeserializeWith(Vec<InAlbumProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::InPlaylist => {
								if r#in_playlist_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"inPlaylist",
									));
								}
								r#in_playlist_property = Some({
									struct DeserializeWith(Vec<InPlaylistProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IsrcCode => {
								if r#isrc_code_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"isrcCode",
									));
								}
								r#isrc_code_property = Some({
									struct DeserializeWith(Vec<IsrcCodeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RecordingOf => {
								if r#recording_of_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"recordingOf",
									));
								}
								r#recording_of_property = Some({
									struct DeserializeWith(Vec<RecordingOfProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MusicRecording {
						...
						r#in_album: r#in_album_property.unwrap_or_default(),
						r#in_playlist: r#in_playlist_property.unwrap_or_default(),
						r#isrc_code: r#isrc_code_property.unwrap_or_default(),
						r#recording_of: r#recording_of_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MusicRecording", FIELDS, ClassVisitor)
		}
	}
}
