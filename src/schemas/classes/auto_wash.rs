...
/// This trait is for properties from <https://schema.org/AutoWash>.
pub trait AutoWashTrait {}
impl AutoWashTrait for AutoWash {}
impl AutomotiveBusinessTrait for AutoWash {}
impl LocalBusinessTrait for AutoWash {
...
mod serde {
	...
	impl Serialize for AutoWash {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AutoWash", len)?;
	...
	impl<'de> Deserialize<'de> for AutoWash {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoWash;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoWash")
				}
			...
			deserializer.deserialize_struct("AutoWash", FIELDS, ClassVisitor)
		}
	}
}
