...
impl StructuredValueTrait for DatedMoneySpecification {}
impl ThingTrait for DatedMoneySpecification {
...
mod serde {
	...
	use super::*;
	impl Serialize for DatedMoneySpecification {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DatedMoneySpecification", len)?;
	...
	impl<'de> Deserialize<'de> for DatedMoneySpecification {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DatedMoneySpecification;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DatedMoneySpecification")
				}
			...
			deserializer.deserialize_struct("DatedMoneySpecification", FIELDS, ClassVisitor)
		}
	}
}
