...
pub struct FollowAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "followee"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/followee"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/followee"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
