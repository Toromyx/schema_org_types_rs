...
/// This trait is for properties from <https://schema.org/AboutPage>.
pub trait AboutPageTrait {}
impl AboutPageTrait for AboutPage {}
impl CreativeWorkTrait for AboutPage {
...
impl WebPageTrait for AboutPage {
...
mod serde {
	...
	impl Serialize for AboutPage {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AboutPage", len)?;
	...
	impl<'de> Deserialize<'de> for AboutPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AboutPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AboutPage")
				}
			...
			deserializer.deserialize_struct("AboutPage", FIELDS, ClassVisitor)
		}
	}
}
