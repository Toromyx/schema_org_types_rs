...
/// This trait is for properties from <https://schema.org/TouristAttraction>.
pub trait TouristAttractionTrait {
...
impl TouristAttractionTrait for TouristAttraction {
	fn get_available_language(&self) -> &[AvailableLanguageProperty] {
...
impl ThingTrait for TouristAttraction {
...
mod serde {
	...
	use super::*;
	impl Serialize for TouristAttraction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TouristAttraction", len)?;
	...
	impl<'de> Deserialize<'de> for TouristAttraction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TouristAttraction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TouristAttraction")
				}
			...
			deserializer.deserialize_struct("TouristAttraction", FIELDS, ClassVisitor)
		}
	}
}
