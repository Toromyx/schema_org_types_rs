...
impl RatingTrait for AggregateRating {
...
impl ThingTrait for AggregateRating {
...
mod serde {
	...
	use super::*;
	impl Serialize for AggregateRating {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AggregateRating", len)?;
	...
	impl<'de> Deserialize<'de> for AggregateRating {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AggregateRating;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AggregateRating")
				}
			...
			deserializer.deserialize_struct("AggregateRating", FIELDS, ClassVisitor)
		}
	}
}
