...
impl CreativeWorkTrait for HowToSection {
...
impl ListItemTrait for HowToSection {
...
impl ThingTrait for HowToSection {
...
mod serde {
	...
	use super::*;
	impl Serialize for HowToSection {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HowToSection", len)?;
	...
	impl<'de> Deserialize<'de> for HowToSection {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HowToSection;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HowToSection")
				}
			...
			deserializer.deserialize_struct("HowToSection", FIELDS, ClassVisitor)
		}
	}
}
