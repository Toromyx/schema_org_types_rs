...
/// This trait is for properties from <https://schema.org/HomeAndConstructionBusiness>.
pub trait HomeAndConstructionBusinessTrait {}
impl HomeAndConstructionBusinessTrait for HomeAndConstructionBusiness {}
impl LocalBusinessTrait for HomeAndConstructionBusiness {
...
impl ThingTrait for HomeAndConstructionBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for HomeAndConstructionBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HomeAndConstructionBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for HomeAndConstructionBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HomeAndConstructionBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HomeAndConstructionBusiness")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					Ok(HomeAndConstructionBusiness {
			...
			deserializer.deserialize_struct("HomeAndConstructionBusiness", FIELDS, ClassVisitor)
		}
	}
}
