...
/// This trait is for properties from <https://schema.org/FoodService>.
pub trait FoodServiceTrait {}
impl FoodServiceTrait for FoodService {}
impl ServiceTrait for FoodService {
...
impl ThingTrait for FoodService {
...
mod serde {
	...
	use super::*;
	impl Serialize for FoodService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FoodService", len)?;
	...
	impl<'de> Deserialize<'de> for FoodService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FoodService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FoodService")
				}
			...
			deserializer.deserialize_struct("FoodService", FIELDS, ClassVisitor)
		}
	}
}
