...
/// This trait is for properties from <https://schema.org/Reservoir>.
pub trait ReservoirTrait {}
impl ReservoirTrait for Reservoir {}
impl BodyOfWaterTrait for Reservoir {}
impl LandformTrait for Reservoir {}
...
mod serde {
	...
	impl Serialize for Reservoir {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Reservoir", len)?;
	...
	impl<'de> Deserialize<'de> for Reservoir {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Reservoir;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Reservoir")
				}
			...
			deserializer.deserialize_struct("Reservoir", FIELDS, ClassVisitor)
		}
	}
}
