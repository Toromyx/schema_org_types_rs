...
mod serde {
	...
	use super::*;
	impl Serialize for MonetaryGrant {
	...
	impl<'de> Deserialize<'de> for MonetaryGrant {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MonetaryGrant;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MonetaryGrant")
				}
			...
			deserializer.deserialize_struct("MonetaryGrant", FIELDS, ClassVisitor)
		}
	}
}
