...
/// This trait is for properties from <https://schema.org/ParkingFacility>.
pub trait ParkingFacilityTrait {}
impl ParkingFacilityTrait for ParkingFacility {}
impl CivicStructureTrait for ParkingFacility {
...
impl ThingTrait for ParkingFacility {
...
mod serde {
	...
	use super::*;
	impl Serialize for ParkingFacility {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ParkingFacility", len)?;
	...
	impl<'de> Deserialize<'de> for ParkingFacility {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ParkingFacility;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ParkingFacility")
				}
			...
			deserializer.deserialize_struct("ParkingFacility", FIELDS, ClassVisitor)
		}
	}
}
