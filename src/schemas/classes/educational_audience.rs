...
pub struct EducationalAudience {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "educationalRole"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/educationalRole"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/educationalRole"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
