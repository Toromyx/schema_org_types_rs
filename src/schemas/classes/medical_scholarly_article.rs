...
pub struct MedicalScholarlyArticle {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "publicationType"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/publicationType"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/publicationType"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
