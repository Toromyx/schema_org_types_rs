...
pub trait LocalBusinessTrait {
	/// Get <https://schema.org/branchOf> from [`Self`] as borrowed slice.
	#[deprecated = "This schema is superseded by <https://schema.org/parentOrganization>."]
	fn get_branch_of(&self) -> &[BranchOfProperty];
	/// Take <https://schema.org/branchOf> from [`Self`] as owned vector.
	#[deprecated = "This schema is superseded by <https://schema.org/parentOrganization>."]
	fn take_branch_of(&mut self) -> Vec<BranchOfProperty>;
	/// Get <https://schema.org/currenciesAccepted> from [`Self`] as borrowed slice.
	fn get_currencies_accepted(&self) -> &[CurrenciesAcceptedProperty];
	/// Take <https://schema.org/currenciesAccepted> from [`Self`] as owned vector.
	fn take_currencies_accepted(&mut self) -> Vec<CurrenciesAcceptedProperty>;
	/// Get <https://schema.org/openingHours> from [`Self`] as borrowed slice.
	fn get_opening_hours(&self) -> &[OpeningHoursProperty];
	/// Take <https://schema.org/openingHours> from [`Self`] as owned vector.
	fn take_opening_hours(&mut self) -> Vec<OpeningHoursProperty>;
	/// Get <https://schema.org/paymentAccepted> from [`Self`] as borrowed slice.
	fn get_payment_accepted(&self) -> &[PaymentAcceptedProperty];
	/// Take <https://schema.org/paymentAccepted> from [`Self`] as owned vector.
	fn take_payment_accepted(&mut self) -> Vec<PaymentAcceptedProperty>;
	/// Get <https://schema.org/priceRange> from [`Self`] as borrowed slice.
	fn get_price_range(&self) -> &[PriceRangeProperty];
	/// Take <https://schema.org/priceRange> from [`Self`] as owned vector.
	fn take_price_range(&mut self) -> Vec<PriceRangeProperty>;
}
impl LocalBusinessTrait for LocalBusiness {
	fn get_branch_of(&self) -> &[BranchOfProperty] {
...
impl ThingTrait for LocalBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for LocalBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LocalBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for LocalBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LocalBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LocalBusiness")
				}
			...
			deserializer.deserialize_struct("LocalBusiness", FIELDS, ClassVisitor)
		}
	}
}
