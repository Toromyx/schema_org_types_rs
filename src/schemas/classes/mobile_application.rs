...
pub struct MobileApplication {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "carrierRequirements"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/carrierRequirements")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/carrierRequirements")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
