...
/// This trait is for properties from <https://schema.org/PublicToilet>.
pub trait PublicToiletTrait {}
impl PublicToiletTrait for PublicToilet {}
impl CivicStructureTrait for PublicToilet {
...
impl ThingTrait for PublicToilet {
...
mod serde {
	...
	use super::*;
	impl Serialize for PublicToilet {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PublicToilet", len)?;
	...
	impl<'de> Deserialize<'de> for PublicToilet {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PublicToilet;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PublicToilet")
				}
			...
			deserializer.deserialize_struct("PublicToilet", FIELDS, ClassVisitor)
		}
	}
}
