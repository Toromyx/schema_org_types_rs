...
pub trait DoseScheduleTrait {
	/// Get <https://schema.org/doseUnit> from [`Self`] as borrowed slice.
	fn get_dose_unit(&self) -> &[DoseUnitProperty];
	/// Take <https://schema.org/doseUnit> from [`Self`] as owned vector.
	fn take_dose_unit(&mut self) -> Vec<DoseUnitProperty>;
	/// Get <https://schema.org/doseValue> from [`Self`] as borrowed slice.
	fn get_dose_value(&self) -> &[DoseValueProperty];
	/// Take <https://schema.org/doseValue> from [`Self`] as owned vector.
	fn take_dose_value(&mut self) -> Vec<DoseValueProperty>;
	/// Get <https://schema.org/frequency> from [`Self`] as borrowed slice.
	fn get_frequency(&self) -> &[FrequencyProperty];
	/// Take <https://schema.org/frequency> from [`Self`] as owned vector.
...
impl DoseScheduleTrait for DoseSchedule {
	fn get_dose_unit(&self) -> &[DoseUnitProperty] {
		self.r#dose_unit.as_slice()
	}
	fn take_dose_unit(&mut self) -> Vec<DoseUnitProperty> {
		std::mem::take(&mut self.r#dose_unit)
	}
	fn get_dose_value(&self) -> &[DoseValueProperty] {
		self.r#dose_value.as_slice()
	}
	fn take_dose_value(&mut self) -> Vec<DoseValueProperty> {
		std::mem::take(&mut self.r#dose_value)
	}
	fn get_frequency(&self) -> &[FrequencyProperty] {
		self.r#frequency.as_slice()
	}
	fn take_frequency(&mut self) -> Vec<FrequencyProperty> {
		std::mem::take(&mut self.r#frequency)
	}
	fn get_target_population(&self) -> &[TargetPopulationProperty] {
		self.r#target_population.as_slice()
	}
	fn take_target_population(&mut self) -> Vec<TargetPopulationProperty> {
		std::mem::take(&mut self.r#target_population)
	}
}
impl MedicalEntityTrait for DoseSchedule {
...
impl MedicalIntangibleTrait for DoseSchedule {}
impl ThingTrait for DoseSchedule {
...
mod serde {
	...
	use super::*;
	impl Serialize for DoseSchedule {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#dose_unit) as usize,
				!Vec::is_empty(&self.r#dose_value) as usize,
				!Vec::is_empty(&self.r#frequency) as usize,
				!Vec::is_empty(&self.r#target_population) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DoseSchedule", len)?;
			if !Vec::is_empty(&self.r#dose_unit) {
				serialize_struct.serialize_field("doseUnit", {
					struct SerializeWith<'a>(&'a Vec<DoseUnitProperty>);
					...
					&SerializeWith(&self.r#dose_unit)
				})?;
			} else {
				serialize_struct.skip_field("doseUnit")?;
			}
			if !Vec::is_empty(&self.r#dose_value) {
				serialize_struct.serialize_field("doseValue", {
					struct SerializeWith<'a>(&'a Vec<DoseValueProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#dose_value)
				})?;
			} else {
				serialize_struct.skip_field("doseValue")?;
			}
			if !Vec::is_empty(&self.r#frequency) {
				serialize_struct.serialize_field("frequency", {
					struct SerializeWith<'a>(&'a Vec<FrequencyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#frequency)
				})?;
			} else {
				serialize_struct.skip_field("frequency")?;
			}
			if !Vec::is_empty(&self.r#target_population) {
				serialize_struct.serialize_field("targetPopulation", {
					struct SerializeWith<'a>(&'a Vec<TargetPopulationProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#target_population)
				})?;
			} else {
				serialize_struct.skip_field("targetPopulation")?;
			}
	...
	impl<'de> Deserialize<'de> for DoseSchedule {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"doseUnit" => Ok(Field::DoseUnit),
						"doseValue" => Ok(Field::DoseValue),
						"frequency" => Ok(Field::Frequency),
						"targetPopulation" => Ok(Field::TargetPopulation),
						"code" => Ok(Field::Code),
				...
				{
					match value {
						b"doseUnit" => Ok(Field::DoseUnit),
						b"doseValue" => Ok(Field::DoseValue),
						b"frequency" => Ok(Field::Frequency),
						b"targetPopulation" => Ok(Field::TargetPopulation),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DoseSchedule;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DoseSchedule")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#dose_unit_property = None;
					let mut r#dose_value_property = None;
					let mut r#frequency_property = None;
					let mut r#target_population_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::DoseUnit => {
								if r#dose_unit_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"doseUnit",
									));
								}
								r#dose_unit_property = Some({
									struct DeserializeWith(Vec<DoseUnitProperty>);
							...
							Field::DoseValue => {
								if r#dose_value_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"doseValue",
									));
								}
								r#dose_value_property = Some({
									struct DeserializeWith(Vec<DoseValueProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Frequency => {
								if r#frequency_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"frequency",
									));
								}
								r#frequency_property = Some({
									struct DeserializeWith(Vec<FrequencyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TargetPopulation => {
								if r#target_population_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"targetPopulation",
									));
								}
								r#target_population_property = Some({
									struct DeserializeWith(Vec<TargetPopulationProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(DoseSchedule {
						r#dose_unit: r#dose_unit_property.unwrap_or_default(),
						r#dose_value: r#dose_value_property.unwrap_or_default(),
						r#frequency: r#frequency_property.unwrap_or_default(),
						r#target_population: r#target_population_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("DoseSchedule", FIELDS, ClassVisitor)
		}
	}
}
