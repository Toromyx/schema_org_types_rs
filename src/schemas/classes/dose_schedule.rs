...
pub struct DoseSchedule {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/doseUnit"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/doseUnit"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/doseValue"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/doseValue"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/frequency"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/frequency"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
