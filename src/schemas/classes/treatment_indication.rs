...
/// This trait is for properties from <https://schema.org/TreatmentIndication>.
pub trait TreatmentIndicationTrait {}
impl TreatmentIndicationTrait for TreatmentIndication {}
impl MedicalEntityTrait for TreatmentIndication {
...
impl MedicalIndicationTrait for TreatmentIndication {}
impl ThingTrait for TreatmentIndication {
...
mod serde {
	...
	use super::*;
	impl Serialize for TreatmentIndication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TreatmentIndication", len)?;
	...
	impl<'de> Deserialize<'de> for TreatmentIndication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TreatmentIndication;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TreatmentIndication")
				}
			...
			deserializer.deserialize_struct("TreatmentIndication", FIELDS, ClassVisitor)
		}
	}
}
