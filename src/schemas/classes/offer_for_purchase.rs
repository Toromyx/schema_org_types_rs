...
mod serde {
	...
	use super::*;
	impl Serialize for OfferForPurchase {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OfferForPurchase", len)?;
	...
	impl<'de> Deserialize<'de> for OfferForPurchase {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OfferForPurchase;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OfferForPurchase")
				}
			...
			deserializer.deserialize_struct("OfferForPurchase", FIELDS, ClassVisitor)
		}
	}
}
