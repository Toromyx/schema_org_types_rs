...
pub struct BoatTrip {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "arrivalBoatTerminal"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/arrivalBoatTerminal")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/arrivalBoatTerminal")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "departureBoatTerminal"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/departureBoatTerminal")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/departureBoatTerminal")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
