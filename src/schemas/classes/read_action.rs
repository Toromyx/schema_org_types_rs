...
/// This trait is for properties from <https://schema.org/ReadAction>.
pub trait ReadActionTrait {}
impl ReadActionTrait for ReadAction {}
...
impl ConsumeActionTrait for ReadAction {
...
impl ThingTrait for ReadAction {
...
mod serde {
	...
	impl Serialize for ReadAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ReadAction", len)?;
	...
	impl<'de> Deserialize<'de> for ReadAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReadAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReadAction")
				}
			...
			deserializer.deserialize_struct("ReadAction", FIELDS, ClassVisitor)
		}
	}
}
