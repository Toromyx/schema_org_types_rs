...
/// This trait is for properties from <https://schema.org/TextObject>.
pub trait TextObjectTrait {}
impl TextObjectTrait for TextObject {}
impl CreativeWorkTrait for TextObject {
...
impl MediaObjectTrait for TextObject {
...
impl ThingTrait for TextObject {
...
mod serde {
	...
	impl Serialize for TextObject {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "TextObject", len)?;
	...
	impl<'de> Deserialize<'de> for TextObject {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TextObject")
				}
			...
			deserializer.deserialize_struct("TextObject", FIELDS, ClassVisitor)
		}
	}
}
