...
/// This trait is for properties from <https://schema.org/DryCleaningOrLaundry>.
pub trait DryCleaningOrLaundryTrait {}
impl DryCleaningOrLaundryTrait for DryCleaningOrLaundry {}
impl LocalBusinessTrait for DryCleaningOrLaundry {
...
impl ThingTrait for DryCleaningOrLaundry {
...
mod serde {
	...
	use super::*;
	impl Serialize for DryCleaningOrLaundry {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DryCleaningOrLaundry", len)?;
	...
	impl<'de> Deserialize<'de> for DryCleaningOrLaundry {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DryCleaningOrLaundry;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DryCleaningOrLaundry")
				}
			...
			deserializer.deserialize_struct("DryCleaningOrLaundry", FIELDS, ClassVisitor)
		}
	}
}
