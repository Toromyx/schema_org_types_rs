...
pub struct TvSeason {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "seasonNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/seasonNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/seasonNumber"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
