...
/// This trait is for properties from <https://schema.org/InformAction>.
pub trait InformActionTrait {
...
impl InformActionTrait for InformAction {
	fn get_event(&self) -> &[EventProperty] {
...
impl CommunicateActionTrait for InformAction {
...
impl InteractActionTrait for InformAction {}
impl ThingTrait for InformAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for InformAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InformAction", len)?;
	...
	impl<'de> Deserialize<'de> for InformAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InformAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InformAction")
				}
			...
			deserializer.deserialize_struct("InformAction", FIELDS, ClassVisitor)
		}
	}
}
