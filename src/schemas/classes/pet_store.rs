...
/// This trait is for properties from <https://schema.org/PetStore>.
pub trait PetStoreTrait {}
impl PetStoreTrait for PetStore {}
impl LocalBusinessTrait for PetStore {
...
impl StoreTrait for PetStore {}
impl ThingTrait for PetStore {
...
mod serde {
	...
	impl Serialize for PetStore {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "PetStore", len)?;
	...
	impl<'de> Deserialize<'de> for PetStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PetStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PetStore")
				}
			...
			deserializer.deserialize_struct("PetStore", FIELDS, ClassVisitor)
		}
	}
}
