...
/// This trait is for properties from <https://schema.org/Mountain>.
pub trait MountainTrait {}
impl MountainTrait for Mountain {}
impl LandformTrait for Mountain {}
