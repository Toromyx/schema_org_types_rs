...
/// This trait is for properties from <https://schema.org/ElectronicsStore>.
pub trait ElectronicsStoreTrait {}
impl ElectronicsStoreTrait for ElectronicsStore {}
impl LocalBusinessTrait for ElectronicsStore {
...
impl StoreTrait for ElectronicsStore {}
impl ThingTrait for ElectronicsStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for ElectronicsStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ElectronicsStore", len)?;
	...
	impl<'de> Deserialize<'de> for ElectronicsStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ElectronicsStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ElectronicsStore")
				}
			...
			deserializer.deserialize_struct("ElectronicsStore", FIELDS, ClassVisitor)
		}
	}
}
