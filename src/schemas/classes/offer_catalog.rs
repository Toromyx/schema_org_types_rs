...
/// This trait is for properties from <https://schema.org/OfferCatalog>.
...
mod serde {
	...
	use super::*;
	impl Serialize for OfferCatalog {
	...
	impl<'de> Deserialize<'de> for OfferCatalog {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OfferCatalog;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OfferCatalog")
				}
			...
			deserializer.deserialize_struct("OfferCatalog", FIELDS, ClassVisitor)
		}
	}
}
