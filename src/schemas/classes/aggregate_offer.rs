...
pub struct AggregateOffer {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/highPrice"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/highPrice"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/lowPrice"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/lowPrice"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/offerCount"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/offerCount"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
