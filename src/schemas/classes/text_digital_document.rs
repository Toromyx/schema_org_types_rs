...
/// This trait is for properties from <https://schema.org/TextDigitalDocument>.
pub trait TextDigitalDocumentTrait {}
impl TextDigitalDocumentTrait for TextDigitalDocument {}
...
mod serde {
	...
	use super::*;
	impl Serialize for TextDigitalDocument {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TextDigitalDocument", len)?;
	...
	impl<'de> Deserialize<'de> for TextDigitalDocument {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TextDigitalDocument;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TextDigitalDocument")
				}
			...
			deserializer.deserialize_struct("TextDigitalDocument", FIELDS, ClassVisitor)
		}
	}
}
