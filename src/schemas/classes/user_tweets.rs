...
/// This trait is for properties from <https://schema.org/UserTweets>.
#[deprecated = "This schema is superseded by <https://schema.org/InteractionCounter>."]
pub trait UserTweetsTrait {}
impl UserTweetsTrait for UserTweets {}
impl EventTrait for UserTweets {
...
impl ThingTrait for UserTweets {
...
impl UserInteractionTrait for UserTweets {}
#[cfg(feature = "serde")]
mod serde {
	...
	impl Serialize for UserTweets {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "UserTweets", len)?;
	...
	impl<'de> Deserialize<'de> for UserTweets {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserTweets;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserTweets")
				}
			...
			deserializer.deserialize_struct("UserTweets", FIELDS, ClassVisitor)
		}
	}
}
