...
/// This trait is for properties from <https://schema.org/Distillery>.
pub trait DistilleryTrait {}
impl DistilleryTrait for Distillery {}
impl FoodEstablishmentTrait for Distillery {
...
impl LocalBusinessTrait for Distillery {
...
impl ThingTrait for Distillery {
...
mod serde {
	...
	impl Serialize for Distillery {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Distillery", len)?;
	...
	impl<'de> Deserialize<'de> for Distillery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Distillery;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Distillery")
				}
			...
			deserializer.deserialize_struct("Distillery", FIELDS, ClassVisitor)
		}
	}
}
