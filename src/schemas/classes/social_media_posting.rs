...
/// This trait is for properties from <https://schema.org/SocialMediaPosting>.
pub trait SocialMediaPostingTrait {
	/// Get <https://schema.org/sharedContent> from [`Self`] as borrowed slice.
	fn get_shared_content(&self) -> &[SharedContentProperty];
	/// Take <https://schema.org/sharedContent> from [`Self`] as owned vector.
	fn take_shared_content(&mut self) -> Vec<SharedContentProperty>;
}
impl SocialMediaPostingTrait for SocialMediaPosting {
	fn get_shared_content(&self) -> &[SharedContentProperty] {
...
impl ArticleTrait for SocialMediaPosting {
...
impl CreativeWorkTrait for SocialMediaPosting {
...
impl ThingTrait for SocialMediaPosting {
...
mod serde {
	...
	use super::*;
	impl Serialize for SocialMediaPosting {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SocialMediaPosting", len)?;
	...
	impl<'de> Deserialize<'de> for SocialMediaPosting {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SocialMediaPosting;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SocialMediaPosting")
				}
			...
			deserializer.deserialize_struct("SocialMediaPosting", FIELDS, ClassVisitor)
		}
	}
}
