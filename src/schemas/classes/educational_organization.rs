...
/// This trait is for properties from <https://schema.org/EducationalOrganization>.
pub trait EducationalOrganizationTrait {
...
impl EducationalOrganizationTrait for EducationalOrganization {
	fn get_alumni(&self) -> &[AlumniProperty] {
...
impl CivicStructureTrait for EducationalOrganization {
...
impl ThingTrait for EducationalOrganization {
...
mod serde {
	...
	use super::*;
	impl Serialize for EducationalOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EducationalOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for EducationalOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EducationalOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EducationalOrganization")
				}
			...
			deserializer.deserialize_struct("EducationalOrganization", FIELDS, ClassVisitor)
		}
	}
}
