...
pub struct MedicalRiskScore {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "algorithm"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/algorithm"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/algorithm"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "estimatesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/estimatesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/estimatesRiskOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "includedRiskFactor"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/includedRiskFactor")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/includedRiskFactor")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
