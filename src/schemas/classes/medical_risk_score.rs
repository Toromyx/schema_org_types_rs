...
pub struct MedicalRiskScore {
	...
	pub r#algorithm: Vec<AlgorithmProperty>,
	...
	pub r#estimates_risk_of: Vec<EstimatesRiskOfProperty>,
	/// <https://schema.org/includedRiskFactor>
	pub r#included_risk_factor: Vec<IncludedRiskFactorProperty>,
...
impl MedicalRiskScoreTrait for MedicalRiskScore {
	fn get_algorithm(&self) -> &[AlgorithmProperty] {
		self.r#algorithm.as_slice()
	}
	fn take_algorithm(&mut self) -> Vec<AlgorithmProperty> {
		std::mem::take(&mut self.r#algorithm)
	}
}
impl MedicalEntityTrait for MedicalRiskScore {
...
impl MedicalRiskEstimatorTrait for MedicalRiskScore {
	fn get_estimates_risk_of(&self) -> &[EstimatesRiskOfProperty] {
		self.r#estimates_risk_of.as_slice()
	}
	fn take_estimates_risk_of(&mut self) -> Vec<EstimatesRiskOfProperty> {
		std::mem::take(&mut self.r#estimates_risk_of)
	}
	fn get_included_risk_factor(&self) -> &[IncludedRiskFactorProperty] {
		self.r#included_risk_factor.as_slice()
	}
	fn take_included_risk_factor(&mut self) -> Vec<IncludedRiskFactorProperty> {
		std::mem::take(&mut self.r#included_risk_factor)
	}
}
impl ThingTrait for MedicalRiskScore {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalRiskScore {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#algorithm) as usize,
				...
				!Vec::is_empty(&self.r#estimates_risk_of) as usize,
				!Vec::is_empty(&self.r#included_risk_factor) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalRiskScore", len)?;
			if !Vec::is_empty(&self.r#algorithm) {
				serialize_struct.serialize_field("algorithm", {
					struct SerializeWith<'a>(&'a Vec<AlgorithmProperty>);
					...
					&SerializeWith(&self.r#algorithm)
				})?;
			} else {
				serialize_struct.skip_field("algorithm")?;
			}
			...
			if !Vec::is_empty(&self.r#estimates_risk_of) {
				serialize_struct.serialize_field("estimatesRiskOf", {
					struct SerializeWith<'a>(&'a Vec<EstimatesRiskOfProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#estimates_risk_of)
				})?;
			} else {
				serialize_struct.skip_field("estimatesRiskOf")?;
			}
			if !Vec::is_empty(&self.r#included_risk_factor) {
				serialize_struct.serialize_field("includedRiskFactor", {
					struct SerializeWith<'a>(&'a Vec<IncludedRiskFactorProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#included_risk_factor)
				})?;
			} else {
				serialize_struct.skip_field("includedRiskFactor")?;
			}
	...
	impl<'de> Deserialize<'de> for MedicalRiskScore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"estimatesRiskOf" => Ok(Field::EstimatesRiskOf),
						"includedRiskFactor" => Ok(Field::IncludedRiskFactor),
				...
				{
					match value {
						b"algorithm" => Ok(Field::Algorithm),
						...
						b"estimatesRiskOf" => Ok(Field::EstimatesRiskOf),
						b"includedRiskFactor" => Ok(Field::IncludedRiskFactor),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalRiskScore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalRiskScore")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#algorithm_property = None;
					...
					let mut r#estimates_risk_of_property = None;
					let mut r#included_risk_factor_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Algorithm => {
								if r#algorithm_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"algorithm",
									));
								}
								r#algorithm_property = Some({
									struct DeserializeWith(Vec<AlgorithmProperty>);
							...
							Field::EstimatesRiskOf => {
								if r#estimates_risk_of_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"estimatesRiskOf",
									));
								}
								r#estimates_risk_of_property = Some({
									struct DeserializeWith(Vec<EstimatesRiskOfProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IncludedRiskFactor => {
								if r#included_risk_factor_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"includedRiskFactor",
									));
								}
								r#included_risk_factor_property = Some({
									struct DeserializeWith(Vec<IncludedRiskFactorProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MedicalRiskScore {
						r#algorithm: r#algorithm_property.unwrap_or_default(),
						...
						r#estimates_risk_of: r#estimates_risk_of_property.unwrap_or_default(),
						r#included_risk_factor: r#included_risk_factor_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MedicalRiskScore", FIELDS, ClassVisitor)
		}
	}
}
