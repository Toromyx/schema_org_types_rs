...
/// This trait is for properties from <https://schema.org/ArriveAction>.
pub trait ArriveActionTrait {}
impl ArriveActionTrait for ArriveAction {}
...
impl MoveActionTrait for ArriveAction {
...
impl ThingTrait for ArriveAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ArriveAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ArriveAction", len)?;
	...
	impl<'de> Deserialize<'de> for ArriveAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ArriveAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ArriveAction")
				}
			...
			deserializer.deserialize_struct("ArriveAction", FIELDS, ClassVisitor)
		}
	}
}
