...
/// This trait is for properties from <https://schema.org/CollegeOrUniversity>.
pub trait CollegeOrUniversityTrait {}
impl CollegeOrUniversityTrait for CollegeOrUniversity {}
impl CivicStructureTrait for CollegeOrUniversity {
...
impl EducationalOrganizationTrait for CollegeOrUniversity {
...
impl ThingTrait for CollegeOrUniversity {
...
mod serde {
	...
	use super::*;
	impl Serialize for CollegeOrUniversity {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CollegeOrUniversity", len)?;
	...
	impl<'de> Deserialize<'de> for CollegeOrUniversity {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CollegeOrUniversity;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CollegeOrUniversity")
				}
			...
			deserializer.deserialize_struct("CollegeOrUniversity", FIELDS, ClassVisitor)
		}
	}
}
