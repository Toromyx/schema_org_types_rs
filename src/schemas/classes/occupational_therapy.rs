...
/// This trait is for properties from <https://schema.org/OccupationalTherapy>.
pub trait OccupationalTherapyTrait {}
impl OccupationalTherapyTrait for OccupationalTherapy {}
impl MedicalEntityTrait for OccupationalTherapy {
...
impl MedicalProcedureTrait for OccupationalTherapy {
...
impl MedicalTherapyTrait for OccupationalTherapy {
...
impl TherapeuticProcedureTrait for OccupationalTherapy {
...
impl ThingTrait for OccupationalTherapy {
...
mod serde {
	...
	use super::*;
	impl Serialize for OccupationalTherapy {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OccupationalTherapy", len)?;
	...
	impl<'de> Deserialize<'de> for OccupationalTherapy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OccupationalTherapy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OccupationalTherapy")
				}
			...
			deserializer.deserialize_struct("OccupationalTherapy", FIELDS, ClassVisitor)
		}
	}
}
