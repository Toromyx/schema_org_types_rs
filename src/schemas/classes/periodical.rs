...
/// This trait is for properties from <https://schema.org/Periodical>.
pub trait PeriodicalTrait {}
impl PeriodicalTrait for Periodical {}
impl CreativeWorkTrait for Periodical {
...
impl CreativeWorkSeriesTrait for Periodical {
...
impl ThingTrait for Periodical {
...
mod serde {
	...
	impl Serialize for Periodical {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Periodical", len)?;
	...
	impl<'de> Deserialize<'de> for Periodical {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Periodical;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Periodical")
				}
			...
			deserializer.deserialize_struct("Periodical", FIELDS, ClassVisitor)
		}
	}
}
