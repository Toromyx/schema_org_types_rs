...
pub struct JobPosting {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "applicationContact"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "baseSalary"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "benefits"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "directApply"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "educationRequirements"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "employerOverview"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "employmentType"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "employmentUnit"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "estimatedSalary"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "experienceRequirements"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "hiringOrganization"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "incentiveCompensation"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "incentives"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "industry"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "jobBenefits"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "jobImmediateStart"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "jobLocation"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "jobLocationType"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "jobStartDate"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "occupationalCategory"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "physicalRequirement"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "qualifications"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "relevantOccupation"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "responsibilities"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "salaryCurrency"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "sensoryRequirement"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "skills"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "specialCommitments"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "title"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "totalJobOpenings"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "workHours"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
