...
pub trait SpecialAnnouncementTrait {
	...
	/// Take <https://schema.org/diseasePreventionInfo> from [`Self`] as owned vector.
	fn take_disease_prevention_info(&mut self) -> Vec<DiseasePreventionInfoProperty>;
	/// Get <https://schema.org/diseaseSpreadStatistics> from [`Self`] as borrowed slice.
	fn get_disease_spread_statistics(&self) -> &[DiseaseSpreadStatisticsProperty];
	/// Take <https://schema.org/diseaseSpreadStatistics> from [`Self`] as owned vector.
	...
	/// Take <https://schema.org/governmentBenefitsInfo> from [`Self`] as owned vector.
	fn take_government_benefits_info(&mut self) -> Vec<GovernmentBenefitsInfoProperty>;
	/// Get <https://schema.org/newsUpdatesAndGuidelines> from [`Self`] as borrowed slice.
	fn get_news_updates_and_guidelines(&self) -> &[NewsUpdatesAndGuidelinesProperty];
	/// Take <https://schema.org/newsUpdatesAndGuidelines> from [`Self`] as owned vector.
	fn take_news_updates_and_guidelines(&mut self) -> Vec<NewsUpdatesAndGuidelinesProperty>;
	/// Get <https://schema.org/publicTransportClosuresInfo> from [`Self`] as borrowed slice.
	fn get_public_transport_closures_info(&self) -> &[PublicTransportClosuresInfoProperty];
	/// Take <https://schema.org/publicTransportClosuresInfo> from [`Self`] as owned vector.
...
impl SpecialAnnouncementTrait for SpecialAnnouncement {
	fn get_announcement_location(&self) -> &[AnnouncementLocationProperty] {
		self.r#announcement_location.as_slice()
	}
	fn take_announcement_location(&mut self) -> Vec<AnnouncementLocationProperty> {
		std::mem::take(&mut self.r#announcement_location)
	}
	fn get_category(&self) -> &[CategoryProperty] {
	...
	fn get_disease_prevention_info(&self) -> &[DiseasePreventionInfoProperty] {
		self.r#disease_prevention_info.as_slice()
	}
	fn take_disease_prevention_info(&mut self) -> Vec<DiseasePreventionInfoProperty> {
		std::mem::take(&mut self.r#disease_prevention_info)
	}
	fn get_disease_spread_statistics(&self) -> &[DiseaseSpreadStatisticsProperty] {
		self.r#disease_spread_statistics.as_slice()
	}
	fn take_disease_spread_statistics(&mut self) -> Vec<DiseaseSpreadStatisticsProperty> {
		std::mem::take(&mut self.r#disease_spread_statistics)
	}
	fn get_getting_tested_info(&self) -> &[GettingTestedInfoProperty] {
		self.r#getting_tested_info.as_slice()
	}
	fn take_getting_tested_info(&mut self) -> Vec<GettingTestedInfoProperty> {
		std::mem::take(&mut self.r#getting_tested_info)
	}
	fn get_government_benefits_info(&self) -> &[GovernmentBenefitsInfoProperty] {
		self.r#government_benefits_info.as_slice()
	}
	fn take_government_benefits_info(&mut self) -> Vec<GovernmentBenefitsInfoProperty> {
		std::mem::take(&mut self.r#government_benefits_info)
	}
	fn get_news_updates_and_guidelines(&self) -> &[NewsUpdatesAndGuidelinesProperty] {
		self.r#news_updates_and_guidelines.as_slice()
	}
	fn take_news_updates_and_guidelines(&mut self) -> Vec<NewsUpdatesAndGuidelinesProperty> {
		std::mem::take(&mut self.r#news_updates_and_guidelines)
	}
	fn get_public_transport_closures_info(&self) -> &[PublicTransportClosuresInfoProperty] {
		self.r#public_transport_closures_info.as_slice()
	}
	fn take_public_transport_closures_info(&mut self) -> Vec<PublicTransportClosuresInfoProperty> {
		std::mem::take(&mut self.r#public_transport_closures_info)
	}
	fn get_quarantine_guidelines(&self) -> &[QuarantineGuidelinesProperty] {
		self.r#quarantine_guidelines.as_slice()
	}
	fn take_quarantine_guidelines(&mut self) -> Vec<QuarantineGuidelinesProperty> {
		std::mem::take(&mut self.r#quarantine_guidelines)
	}
	fn get_school_closures_info(&self) -> &[SchoolClosuresInfoProperty] {
		self.r#school_closures_info.as_slice()
	}
	fn take_school_closures_info(&mut self) -> Vec<SchoolClosuresInfoProperty> {
		std::mem::take(&mut self.r#school_closures_info)
	}
	fn get_travel_bans(&self) -> &[TravelBansProperty] {
		self.r#travel_bans.as_slice()
	}
	fn take_travel_bans(&mut self) -> Vec<TravelBansProperty> {
		std::mem::take(&mut self.r#travel_bans)
	}
	fn get_web_feed(&self) -> &[WebFeedProperty] {
		self.r#web_feed.as_slice()
	}
	fn take_web_feed(&mut self) -> Vec<WebFeedProperty> {
		std::mem::take(&mut self.r#web_feed)
	}
}
impl CreativeWorkTrait for SpecialAnnouncement {
...
impl ThingTrait for SpecialAnnouncement {
...
mod serde {
	...
	use super::*;
	impl Serialize for SpecialAnnouncement {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#announcement_location) as usize,
				!Vec::is_empty(&self.r#category) as usize,
				!Vec::is_empty(&self.r#date_posted) as usize,
				!Vec::is_empty(&self.r#disease_prevention_info) as usize,
				!Vec::is_empty(&self.r#disease_spread_statistics) as usize,
				!Vec::is_empty(&self.r#getting_tested_info) as usize,
				!Vec::is_empty(&self.r#government_benefits_info) as usize,
				!Vec::is_empty(&self.r#news_updates_and_guidelines) as usize,
				!Vec::is_empty(&self.r#public_transport_closures_info) as usize,
				!Vec::is_empty(&self.r#quarantine_guidelines) as usize,
				!Vec::is_empty(&self.r#school_closures_info) as usize,
				!Vec::is_empty(&self.r#travel_bans) as usize,
				!Vec::is_empty(&self.r#web_feed) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SpecialAnnouncement", len)?;
			if !Vec::is_empty(&self.r#announcement_location) {
				serialize_struct.serialize_field("announcementLocation", {
					struct SerializeWith<'a>(&'a Vec<AnnouncementLocationProperty>);
					...
					&SerializeWith(&self.r#announcement_location)
				})?;
			} else {
				serialize_struct.skip_field("announcementLocation")?;
			}
			...
			if !Vec::is_empty(&self.r#disease_prevention_info) {
				serialize_struct.serialize_field("diseasePreventionInfo", {
					struct SerializeWith<'a>(&'a Vec<DiseasePreventionInfoProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#disease_prevention_info)
				})?;
			} else {
				serialize_struct.skip_field("diseasePreventionInfo")?;
			}
			if !Vec::is_empty(&self.r#disease_spread_statistics) {
				serialize_struct.serialize_field("diseaseSpreadStatistics", {
					struct SerializeWith<'a>(&'a Vec<DiseaseSpreadStatisticsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#disease_spread_statistics)
				})?;
			} else {
				serialize_struct.skip_field("diseaseSpreadStatistics")?;
			}
			if !Vec::is_empty(&self.r#getting_tested_info) {
				serialize_struct.serialize_field("gettingTestedInfo", {
					struct SerializeWith<'a>(&'a Vec<GettingTestedInfoProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#getting_tested_info)
				})?;
			} else {
				serialize_struct.skip_field("gettingTestedInfo")?;
			}
			if !Vec::is_empty(&self.r#government_benefits_info) {
				serialize_struct.serialize_field("governmentBenefitsInfo", {
					struct SerializeWith<'a>(&'a Vec<GovernmentBenefitsInfoProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#government_benefits_info)
				})?;
			} else {
				serialize_struct.skip_field("governmentBenefitsInfo")?;
			}
			if !Vec::is_empty(&self.r#news_updates_and_guidelines) {
				serialize_struct.serialize_field("newsUpdatesAndGuidelines", {
					struct SerializeWith<'a>(&'a Vec<NewsUpdatesAndGuidelinesProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#news_updates_and_guidelines)
				})?;
			} else {
				serialize_struct.skip_field("newsUpdatesAndGuidelines")?;
			}
			if !Vec::is_empty(&self.r#public_transport_closures_info) {
				serialize_struct.serialize_field("publicTransportClosuresInfo", {
					struct SerializeWith<'a>(&'a Vec<PublicTransportClosuresInfoProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#public_transport_closures_info)
				})?;
			} else {
				serialize_struct.skip_field("publicTransportClosuresInfo")?;
			}
			if !Vec::is_empty(&self.r#quarantine_guidelines) {
				serialize_struct.serialize_field("quarantineGuidelines", {
					struct SerializeWith<'a>(&'a Vec<QuarantineGuidelinesProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#quarantine_guidelines)
				})?;
			} else {
				serialize_struct.skip_field("quarantineGuidelines")?;
			}
			if !Vec::is_empty(&self.r#school_closures_info) {
				serialize_struct.serialize_field("schoolClosuresInfo", {
					struct SerializeWith<'a>(&'a Vec<SchoolClosuresInfoProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#school_closures_info)
				})?;
			} else {
				serialize_struct.skip_field("schoolClosuresInfo")?;
			}
			if !Vec::is_empty(&self.r#travel_bans) {
				serialize_struct.serialize_field("travelBans", {
					struct SerializeWith<'a>(&'a Vec<TravelBansProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#travel_bans)
				})?;
			} else {
				serialize_struct.skip_field("travelBans")?;
			}
			if !Vec::is_empty(&self.r#web_feed) {
				serialize_struct.serialize_field("webFeed", {
					struct SerializeWith<'a>(&'a Vec<WebFeedProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#web_feed)
				})?;
			} else {
				serialize_struct.skip_field("webFeed")?;
			}
	...
	impl<'de> Deserialize<'de> for SpecialAnnouncement {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"announcementLocation" => Ok(Field::AnnouncementLocation),
						"category" => Ok(Field::Category),
						"datePosted" => Ok(Field::DatePosted),
						"diseasePreventionInfo" => Ok(Field::DiseasePreventionInfo),
						"diseaseSpreadStatistics" => Ok(Field::DiseaseSpreadStatistics),
						"gettingTestedInfo" => Ok(Field::GettingTestedInfo),
						"governmentBenefitsInfo" => Ok(Field::GovernmentBenefitsInfo),
						"newsUpdatesAndGuidelines" => Ok(Field::NewsUpdatesAndGuidelines),
						"publicTransportClosuresInfo" => Ok(Field::PublicTransportClosuresInfo),
						"quarantineGuidelines" => Ok(Field::QuarantineGuidelines),
						"schoolClosuresInfo" => Ok(Field::SchoolClosuresInfo),
						"travelBans" => Ok(Field::TravelBans),
						"webFeed" => Ok(Field::WebFeed),
				...
				{
					match value {
						b"announcementLocation" => Ok(Field::AnnouncementLocation),
						b"category" => Ok(Field::Category),
						b"datePosted" => Ok(Field::DatePosted),
						b"diseasePreventionInfo" => Ok(Field::DiseasePreventionInfo),
						b"diseaseSpreadStatistics" => Ok(Field::DiseaseSpreadStatistics),
						b"gettingTestedInfo" => Ok(Field::GettingTestedInfo),
						b"governmentBenefitsInfo" => Ok(Field::GovernmentBenefitsInfo),
						b"newsUpdatesAndGuidelines" => Ok(Field::NewsUpdatesAndGuidelines),
						b"publicTransportClosuresInfo" => Ok(Field::PublicTransportClosuresInfo),
						b"quarantineGuidelines" => Ok(Field::QuarantineGuidelines),
						b"schoolClosuresInfo" => Ok(Field::SchoolClosuresInfo),
						b"travelBans" => Ok(Field::TravelBans),
						b"webFeed" => Ok(Field::WebFeed),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SpecialAnnouncement;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SpecialAnnouncement")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#announcement_location_property = None;
					let mut r#category_property = None;
					let mut r#date_posted_property = None;
					let mut r#disease_prevention_info_property = None;
					let mut r#disease_spread_statistics_property = None;
					let mut r#getting_tested_info_property = None;
					let mut r#government_benefits_info_property = None;
					let mut r#news_updates_and_guidelines_property = None;
					let mut r#public_transport_closures_info_property = None;
					let mut r#quarantine_guidelines_property = None;
					let mut r#school_closures_info_property = None;
					let mut r#travel_bans_property = None;
					let mut r#web_feed_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AnnouncementLocation => {
								if r#announcement_location_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"announcementLocation",
									));
								}
								r#announcement_location_property = Some({
									struct DeserializeWith(Vec<AnnouncementLocationProperty>);
							...
							Field::DiseasePreventionInfo => {
								if r#disease_prevention_info_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"diseasePreventionInfo",
									));
								}
								r#disease_prevention_info_property = Some({
									struct DeserializeWith(Vec<DiseasePreventionInfoProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DiseaseSpreadStatistics => {
								if r#disease_spread_statistics_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"diseaseSpreadStatistics",
									));
								}
								r#disease_spread_statistics_property = Some({
									struct DeserializeWith(Vec<DiseaseSpreadStatisticsProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::GettingTestedInfo => {
								if r#getting_tested_info_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"gettingTestedInfo",
									));
								}
								r#getting_tested_info_property = Some({
									struct DeserializeWith(Vec<GettingTestedInfoProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::GovernmentBenefitsInfo => {
								if r#government_benefits_info_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"governmentBenefitsInfo",
									));
								}
								r#government_benefits_info_property = Some({
									struct DeserializeWith(Vec<GovernmentBenefitsInfoProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::NewsUpdatesAndGuidelines => {
								if r#news_updates_and_guidelines_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"newsUpdatesAndGuidelines",
									));
								}
								r#news_updates_and_guidelines_property = Some({
									struct DeserializeWith(Vec<NewsUpdatesAndGuidelinesProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::PublicTransportClosuresInfo => {
								if r#public_transport_closures_info_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"publicTransportClosuresInfo",
									));
								}
								r#public_transport_closures_info_property = Some({
									struct DeserializeWith(
										Vec<PublicTransportClosuresInfoProperty>,
									);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
							...
							Field::QuarantineGuidelines => {
								if r#quarantine_guidelines_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"quarantineGuidelines",
									));
								}
								r#quarantine_guidelines_property = Some({
									struct DeserializeWith(Vec<QuarantineGuidelinesProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SchoolClosuresInfo => {
								if r#school_closures_info_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"schoolClosuresInfo",
									));
								}
								r#school_closures_info_property = Some({
									struct DeserializeWith(Vec<SchoolClosuresInfoProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TravelBans => {
								if r#travel_bans_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"travelBans",
									));
								}
								r#travel_bans_property = Some({
									struct DeserializeWith(Vec<TravelBansProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::WebFeed => {
								if r#web_feed_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"webFeed",
									));
								}
								r#web_feed_property = Some({
									struct DeserializeWith(Vec<WebFeedProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(SpecialAnnouncement {
						r#announcement_location: r#announcement_location_property
							.unwrap_or_default(),
						r#category: r#category_property.unwrap_or_default(),
						r#date_posted: r#date_posted_property.unwrap_or_default(),
						r#disease_prevention_info: r#disease_prevention_info_property
							.unwrap_or_default(),
						r#disease_spread_statistics: r#disease_spread_statistics_property
							.unwrap_or_default(),
						r#getting_tested_info: r#getting_tested_info_property.unwrap_or_default(),
						r#government_benefits_info: r#government_benefits_info_property
							.unwrap_or_default(),
						r#news_updates_and_guidelines: r#news_updates_and_guidelines_property
							.unwrap_or_default(),
						r#public_transport_closures_info: r#public_transport_closures_info_property
							.unwrap_or_default(),
						r#quarantine_guidelines: r#quarantine_guidelines_property
							.unwrap_or_default(),
						r#school_closures_info: r#school_closures_info_property.unwrap_or_default(),
						r#travel_bans: r#travel_bans_property.unwrap_or_default(),
						r#web_feed: r#web_feed_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("SpecialAnnouncement", FIELDS, ClassVisitor)
		}
	}
}
