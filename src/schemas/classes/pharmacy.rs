...
/// This trait is for properties from <https://schema.org/Pharmacy>.
pub trait PharmacyTrait {}
impl PharmacyTrait for Pharmacy {}
impl LocalBusinessTrait for Pharmacy {
...
impl MedicalBusinessTrait for Pharmacy {}
impl MedicalOrganizationTrait for Pharmacy {
...
mod serde {
	...
	impl Serialize for Pharmacy {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Pharmacy", len)?;
	...
	impl<'de> Deserialize<'de> for Pharmacy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Pharmacy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Pharmacy")
				}
			...
			deserializer.deserialize_struct("Pharmacy", FIELDS, ClassVisitor)
		}
	}
}
