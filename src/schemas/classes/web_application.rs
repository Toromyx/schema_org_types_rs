...
pub struct WebApplication {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "browserRequirements"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/browserRequirements")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/browserRequirements")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
