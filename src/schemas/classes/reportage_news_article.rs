...
/// This trait is for properties from <https://schema.org/ReportageNewsArticle>.
pub trait ReportageNewsArticleTrait {}
impl ReportageNewsArticleTrait for ReportageNewsArticle {}
impl ArticleTrait for ReportageNewsArticle {
...
impl CreativeWorkTrait for ReportageNewsArticle {
...
impl NewsArticleTrait for ReportageNewsArticle {
...
impl ThingTrait for ReportageNewsArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReportageNewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReportageNewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for ReportageNewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReportageNewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReportageNewsArticle")
				}
			...
			deserializer.deserialize_struct("ReportageNewsArticle", FIELDS, ClassVisitor)
		}
	}
}
