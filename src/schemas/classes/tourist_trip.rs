...
mod serde {
	...
	use super::*;
	impl Serialize for TouristTrip {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TouristTrip", len)?;
	...
	impl<'de> Deserialize<'de> for TouristTrip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TouristTrip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TouristTrip")
				}
			...
			deserializer.deserialize_struct("TouristTrip", FIELDS, ClassVisitor)
		}
	}
}
