...
/// This trait is for properties from <https://schema.org/MotorcycleRepair>.
pub trait MotorcycleRepairTrait {}
impl MotorcycleRepairTrait for MotorcycleRepair {}
impl AutomotiveBusinessTrait for MotorcycleRepair {}
impl LocalBusinessTrait for MotorcycleRepair {
...
impl ThingTrait for MotorcycleRepair {
...
mod serde {
	...
	use super::*;
	impl Serialize for MotorcycleRepair {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MotorcycleRepair", len)?;
	...
	impl<'de> Deserialize<'de> for MotorcycleRepair {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MotorcycleRepair;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MotorcycleRepair")
				}
			...
			deserializer.deserialize_struct("MotorcycleRepair", FIELDS, ClassVisitor)
		}
	}
}
