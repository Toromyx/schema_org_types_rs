...
/// This trait is for properties from <https://schema.org/BarOrPub>.
pub trait BarOrPubTrait {}
impl BarOrPubTrait for BarOrPub {}
impl FoodEstablishmentTrait for BarOrPub {
...
impl LocalBusinessTrait for BarOrPub {
