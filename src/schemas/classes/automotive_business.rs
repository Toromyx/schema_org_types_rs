...
/// This trait is for properties from <https://schema.org/AutomotiveBusiness>.
pub trait AutomotiveBusinessTrait {}
impl AutomotiveBusinessTrait for AutomotiveBusiness {}
impl LocalBusinessTrait for AutomotiveBusiness {
...
impl ThingTrait for AutomotiveBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for AutomotiveBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AutomotiveBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for AutomotiveBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutomotiveBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutomotiveBusiness")
				}
			...
			deserializer.deserialize_struct("AutomotiveBusiness", FIELDS, ClassVisitor)
		}
	}
}
