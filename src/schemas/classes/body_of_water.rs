...
/// This trait is for properties from <https://schema.org/BodyOfWater>.
pub trait BodyOfWaterTrait {}
impl BodyOfWaterTrait for BodyOfWater {}
impl LandformTrait for BodyOfWater {}
...
impl ThingTrait for BodyOfWater {
...
mod serde {
	...
	use super::*;
	impl Serialize for BodyOfWater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BodyOfWater", len)?;
	...
	impl<'de> Deserialize<'de> for BodyOfWater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BodyOfWater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BodyOfWater")
				}
			...
			deserializer.deserialize_struct("BodyOfWater", FIELDS, ClassVisitor)
		}
	}
}
