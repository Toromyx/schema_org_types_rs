...
/// This trait is for properties from <https://schema.org/EmailMessage>.
pub trait EmailMessageTrait {}
impl EmailMessageTrait for EmailMessage {}
impl CreativeWorkTrait for EmailMessage {
	...
	impl Serialize for EmailMessage {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#bcc_recipient) as usize,
				!Vec::is_empty(&self.r#cc_recipient) as usize,
				!Vec::is_empty(&self.r#date_read) as usize,
				!Vec::is_empty(&self.r#date_received) as usize,
				!Vec::is_empty(&self.r#date_sent) as usize,
				!Vec::is_empty(&self.r#message_attachment) as usize,
				!Vec::is_empty(&self.r#recipient) as usize,
				!Vec::is_empty(&self.r#sender) as usize,
				!Vec::is_empty(&self.r#to_recipient) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EmailMessage", len)?;
			...
			if !Vec::is_empty(&self.r#bcc_recipient) {
				serialize_struct.serialize_field("bccRecipient", {
					struct SerializeWith<'a>(&'a Vec<BccRecipientProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#bcc_recipient)
				})?;
			} else {
				serialize_struct.skip_field("bccRecipient")?;
			}
			if !Vec::is_empty(&self.r#cc_recipient) {
				serialize_struct.serialize_field("ccRecipient", {
					struct SerializeWith<'a>(&'a Vec<CcRecipientProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#cc_recipient)
				})?;
			} else {
				serialize_struct.skip_field("ccRecipient")?;
			}
			if !Vec::is_empty(&self.r#date_read) {
				serialize_struct.serialize_field("dateRead", {
					struct SerializeWith<'a>(&'a Vec<DateReadProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#date_read)
				})?;
			} else {
				serialize_struct.skip_field("dateRead")?;
			}
			if !Vec::is_empty(&self.r#date_received) {
				serialize_struct.serialize_field("dateReceived", {
					struct SerializeWith<'a>(&'a Vec<DateReceivedProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#date_received)
				})?;
			} else {
				serialize_struct.skip_field("dateReceived")?;
			}
			if !Vec::is_empty(&self.r#date_sent) {
				serialize_struct.serialize_field("dateSent", {
					struct SerializeWith<'a>(&'a Vec<DateSentProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#date_sent)
				})?;
			} else {
				serialize_struct.skip_field("dateSent")?;
			}
			if !Vec::is_empty(&self.r#message_attachment) {
				serialize_struct.serialize_field("messageAttachment", {
					struct SerializeWith<'a>(&'a Vec<MessageAttachmentProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#message_attachment)
				})?;
			} else {
				serialize_struct.skip_field("messageAttachment")?;
			}
			if !Vec::is_empty(&self.r#recipient) {
				serialize_struct.serialize_field("recipient", {
					...
					&SerializeWith(&self.r#recipient)
				})?;
			} else {
				serialize_struct.skip_field("recipient")?;
			}
			if !Vec::is_empty(&self.r#sender) {
				serialize_struct.serialize_field("sender", {
					struct SerializeWith<'a>(&'a Vec<SenderProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#sender)
				})?;
			} else {
				serialize_struct.skip_field("sender")?;
			}
			if !Vec::is_empty(&self.r#to_recipient) {
				serialize_struct.serialize_field("toRecipient", {
					struct SerializeWith<'a>(&'a Vec<ToRecipientProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#to_recipient)
				})?;
			} else {
				serialize_struct.skip_field("toRecipient")?;
			}
	...
	impl<'de> Deserialize<'de> for EmailMessage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"bccRecipient" => Ok(Field::BccRecipient),
						"ccRecipient" => Ok(Field::CcRecipient),
						"dateRead" => Ok(Field::DateRead),
						"dateReceived" => Ok(Field::DateReceived),
						"dateSent" => Ok(Field::DateSent),
						"messageAttachment" => Ok(Field::MessageAttachment),
						"recipient" => Ok(Field::Recipient),
						"sender" => Ok(Field::Sender),
						"toRecipient" => Ok(Field::ToRecipient),
					...
					E: de::Error,
				{
					match value {
						...
						b"bccRecipient" => Ok(Field::BccRecipient),
						b"ccRecipient" => Ok(Field::CcRecipient),
						b"dateRead" => Ok(Field::DateRead),
						b"dateReceived" => Ok(Field::DateReceived),
						b"dateSent" => Ok(Field::DateSent),
						b"messageAttachment" => Ok(Field::MessageAttachment),
						b"recipient" => Ok(Field::Recipient),
						b"sender" => Ok(Field::Sender),
						b"toRecipient" => Ok(Field::ToRecipient),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EmailMessage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EmailMessage")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#bcc_recipient_property = None;
					let mut r#cc_recipient_property = None;
					let mut r#date_read_property = None;
					let mut r#date_received_property = None;
					let mut r#date_sent_property = None;
					let mut r#message_attachment_property = None;
					let mut r#recipient_property = None;
					let mut r#sender_property = None;
					let mut r#to_recipient_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::BccRecipient => {
								if r#bcc_recipient_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"bccRecipient",
									));
								}
								r#bcc_recipient_property = Some({
									struct DeserializeWith(Vec<BccRecipientProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::CcRecipient => {
								if r#cc_recipient_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"ccRecipient",
									));
								}
								r#cc_recipient_property = Some({
									struct DeserializeWith(Vec<CcRecipientProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DateRead => {
								if r#date_read_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dateRead",
									));
								}
								r#date_read_property = Some({
									struct DeserializeWith(Vec<DateReadProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DateReceived => {
								if r#date_received_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dateReceived",
									));
								}
								r#date_received_property = Some({
									struct DeserializeWith(Vec<DateReceivedProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DateSent => {
								if r#date_sent_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dateSent",
									));
								}
								r#date_sent_property = Some({
									struct DeserializeWith(Vec<DateSentProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MessageAttachment => {
								if r#message_attachment_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"messageAttachment",
									));
								}
								r#message_attachment_property = Some({
									struct DeserializeWith(Vec<MessageAttachmentProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Sender => {
								if r#sender_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("sender"));
								}
							...
							Field::ToRecipient => {
								if r#to_recipient_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"toRecipient",
									));
								}
								r#to_recipient_property = Some({
									struct DeserializeWith(Vec<ToRecipientProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(EmailMessage {
						...
						r#bcc_recipient: r#bcc_recipient_property.unwrap_or_default(),
						r#cc_recipient: r#cc_recipient_property.unwrap_or_default(),
						r#date_read: r#date_read_property.unwrap_or_default(),
						r#date_received: r#date_received_property.unwrap_or_default(),
						r#date_sent: r#date_sent_property.unwrap_or_default(),
						r#message_attachment: r#message_attachment_property.unwrap_or_default(),
						r#recipient: r#recipient_property.unwrap_or_default(),
						r#sender: r#sender_property.unwrap_or_default(),
						r#to_recipient: r#to_recipient_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("EmailMessage", FIELDS, ClassVisitor)
		}
	}
}
