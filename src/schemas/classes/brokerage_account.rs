...
/// This trait is for properties from <https://schema.org/BrokerageAccount>.
pub trait BrokerageAccountTrait {}
impl BrokerageAccountTrait for BrokerageAccount {}
impl FinancialProductTrait for BrokerageAccount {
...
impl InvestmentOrDepositTrait for BrokerageAccount {
...
impl ServiceTrait for BrokerageAccount {
...
impl ThingTrait for BrokerageAccount {
...
mod serde {
	...
	use super::*;
	impl Serialize for BrokerageAccount {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BrokerageAccount", len)?;
	...
	impl<'de> Deserialize<'de> for BrokerageAccount {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BrokerageAccount;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BrokerageAccount")
				}
			...
			deserializer.deserialize_struct("BrokerageAccount", FIELDS, ClassVisitor)
		}
	}
}
