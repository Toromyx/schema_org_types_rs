...
/// This trait is for properties from <https://schema.org/PodcastSeason>.
pub trait PodcastSeasonTrait {}
impl PodcastSeasonTrait for PodcastSeason {}
impl CreativeWorkTrait for PodcastSeason {
...
impl CreativeWorkSeasonTrait for PodcastSeason {
...
impl ThingTrait for PodcastSeason {
...
mod serde {
	...
	use super::*;
	impl Serialize for PodcastSeason {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PodcastSeason", len)?;
	...
	impl<'de> Deserialize<'de> for PodcastSeason {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PodcastSeason;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PodcastSeason")
				}
			...
			deserializer.deserialize_struct("PodcastSeason", FIELDS, ClassVisitor)
		}
	}
}
