...
/// This trait is for properties from <https://schema.org/FinancialService>.
pub trait FinancialServiceTrait {
...
impl LocalBusinessTrait for FinancialService {
...
impl ThingTrait for FinancialService {
...
mod serde {
	...
	use super::*;
	impl Serialize for FinancialService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FinancialService", len)?;
	...
	impl<'de> Deserialize<'de> for FinancialService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FinancialService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FinancialService")
				}
			...
			deserializer.deserialize_struct("FinancialService", FIELDS, ClassVisitor)
		}
	}
}
