...
pub struct WinAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "loser"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/loser"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/loser"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
