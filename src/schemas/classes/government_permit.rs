...
mod serde {
	...
	use super::*;
	impl Serialize for GovernmentPermit {
	...
	impl<'de> Deserialize<'de> for GovernmentPermit {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GovernmentPermit;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GovernmentPermit")
				}
