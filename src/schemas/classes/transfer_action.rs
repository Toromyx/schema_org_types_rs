...
/// This trait is for properties from <https://schema.org/TransferAction>.
pub trait TransferActionTrait {
...
impl TransferActionTrait for TransferAction {
	fn get_from_location(&self) -> &[FromLocationProperty] {
...
impl ThingTrait for TransferAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for TransferAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TransferAction", len)?;
	...
	impl<'de> Deserialize<'de> for TransferAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TransferAction")
				}
			...
			deserializer.deserialize_struct("TransferAction", FIELDS, ClassVisitor)
		}
	}
}
