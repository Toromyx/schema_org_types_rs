...
/// This trait is for properties from <https://schema.org/ComedyClub>.
pub trait ComedyClubTrait {}
impl ComedyClubTrait for ComedyClub {}
impl EntertainmentBusinessTrait for ComedyClub {}
impl LocalBusinessTrait for ComedyClub {
...
impl ThingTrait for ComedyClub {
...
mod serde {
	...
	impl Serialize for ComedyClub {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ComedyClub", len)?;
	...
	impl<'de> Deserialize<'de> for ComedyClub {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComedyClub;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComedyClub")
				}
			...
			deserializer.deserialize_struct("ComedyClub", FIELDS, ClassVisitor)
		}
	}
}
