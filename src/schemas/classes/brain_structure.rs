...
/// This trait is for properties from <https://schema.org/BrainStructure>.
pub trait BrainStructureTrait {}
impl BrainStructureTrait for BrainStructure {}
impl AnatomicalStructureTrait for BrainStructure {
...
impl MedicalEntityTrait for BrainStructure {
...
impl ThingTrait for BrainStructure {
...
mod serde {
	...
	use super::*;
	impl Serialize for BrainStructure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BrainStructure", len)?;
	...
	impl<'de> Deserialize<'de> for BrainStructure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BrainStructure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BrainStructure")
				}
			...
			deserializer.deserialize_struct("BrainStructure", FIELDS, ClassVisitor)
		}
	}
}
