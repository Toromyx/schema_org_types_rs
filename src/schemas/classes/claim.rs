...
pub struct Claim {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/appearance"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/appearance"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "claimInterpreter"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/claimInterpreter")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/claimInterpreter"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "firstAppearance"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/firstAppearance"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/firstAppearance"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
