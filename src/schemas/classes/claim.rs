...
pub trait ClaimTrait {
	/// Get <https://schema.org/appearance> from [`Self`] as borrowed slice.
	fn get_appearance(&self) -> &[AppearanceProperty];
	/// Take <https://schema.org/appearance> from [`Self`] as owned vector.
	fn take_appearance(&mut self) -> Vec<AppearanceProperty>;
	/// Get <https://schema.org/claimInterpreter> from [`Self`] as borrowed slice.
	fn get_claim_interpreter(&self) -> &[ClaimInterpreterProperty];
	/// Take <https://schema.org/claimInterpreter> from [`Self`] as owned vector.
	fn take_claim_interpreter(&mut self) -> Vec<ClaimInterpreterProperty>;
	/// Get <https://schema.org/firstAppearance> from [`Self`] as borrowed slice.
	fn get_first_appearance(&self) -> &[FirstAppearanceProperty];
	/// Take <https://schema.org/firstAppearance> from [`Self`] as owned vector.
	fn take_first_appearance(&mut self) -> Vec<FirstAppearanceProperty>;
}
impl ClaimTrait for Claim {
	fn get_appearance(&self) -> &[AppearanceProperty] {
		self.r#appearance.as_slice()
	}
	fn take_appearance(&mut self) -> Vec<AppearanceProperty> {
		std::mem::take(&mut self.r#appearance)
	}
	fn get_claim_interpreter(&self) -> &[ClaimInterpreterProperty] {
		self.r#claim_interpreter.as_slice()
	}
	fn take_claim_interpreter(&mut self) -> Vec<ClaimInterpreterProperty> {
		std::mem::take(&mut self.r#claim_interpreter)
	}
	fn get_first_appearance(&self) -> &[FirstAppearanceProperty] {
		self.r#first_appearance.as_slice()
	}
	fn take_first_appearance(&mut self) -> Vec<FirstAppearanceProperty> {
		std::mem::take(&mut self.r#first_appearance)
	}
}
impl CreativeWorkTrait for Claim {
...
mod serde {
	...
	impl Serialize for Claim {
		...
		{
			let len: usize = [
				!Vec::is_empty(&self.r#appearance) as usize,
				!Vec::is_empty(&self.r#claim_interpreter) as usize,
				!Vec::is_empty(&self.r#first_appearance) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Claim", len)?;
			if !Vec::is_empty(&self.r#appearance) {
				serialize_struct.serialize_field("appearance", {
					struct SerializeWith<'a>(&'a Vec<AppearanceProperty>);
					...
					&SerializeWith(&self.r#appearance)
				})?;
			} else {
				serialize_struct.skip_field("appearance")?;
			}
			if !Vec::is_empty(&self.r#claim_interpreter) {
				serialize_struct.serialize_field("claimInterpreter", {
					struct SerializeWith<'a>(&'a Vec<ClaimInterpreterProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#claim_interpreter)
				})?;
			} else {
				serialize_struct.skip_field("claimInterpreter")?;
			}
			if !Vec::is_empty(&self.r#first_appearance) {
				serialize_struct.serialize_field("firstAppearance", {
					struct SerializeWith<'a>(&'a Vec<FirstAppearanceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#first_appearance)
				})?;
			} else {
				serialize_struct.skip_field("firstAppearance")?;
			}
	...
	impl<'de> Deserialize<'de> for Claim {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"claimInterpreter" => Ok(Field::ClaimInterpreter),
						"firstAppearance" => Ok(Field::FirstAppearance),
					...
					E: de::Error,
				{
					match value {
						...
						b"claimInterpreter" => Ok(Field::ClaimInterpreter),
						b"firstAppearance" => Ok(Field::FirstAppearance),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Claim;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Claim")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#appearance_property = None;
					let mut r#claim_interpreter_property = None;
					let mut r#first_appearance_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Appearance => {
								if r#appearance_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"appearance",
									));
								}
								r#appearance_property = Some({
									struct DeserializeWith(Vec<AppearanceProperty>);
							...
							Field::ClaimInterpreter => {
								if r#claim_interpreter_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"claimInterpreter",
									));
								}
								r#claim_interpreter_property = Some({
									struct DeserializeWith(Vec<ClaimInterpreterProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::FirstAppearance => {
								if r#first_appearance_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"firstAppearance",
									));
								}
								r#first_appearance_property = Some({
									struct DeserializeWith(Vec<FirstAppearanceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(Claim {
						r#appearance: r#appearance_property.unwrap_or_default(),
						r#claim_interpreter: r#claim_interpreter_property.unwrap_or_default(),
						r#first_appearance: r#first_appearance_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("Claim", FIELDS, ClassVisitor)
		}
	}
}
