...
/// This trait is for properties from <https://schema.org/BefriendAction>.
pub trait BefriendActionTrait {}
impl BefriendActionTrait for BefriendAction {}
...
impl InteractActionTrait for BefriendAction {}
impl ThingTrait for BefriendAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for BefriendAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BefriendAction", len)?;
	...
	impl<'de> Deserialize<'de> for BefriendAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BefriendAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BefriendAction")
				}
			...
			deserializer.deserialize_struct("BefriendAction", FIELDS, ClassVisitor)
		}
	}
}
