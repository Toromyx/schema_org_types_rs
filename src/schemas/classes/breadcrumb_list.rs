...
/// This trait is for properties from <https://schema.org/BreadcrumbList>.
...
mod serde {
	...
	use super::*;
	impl Serialize for BreadcrumbList {
	...
	impl<'de> Deserialize<'de> for BreadcrumbList {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BreadcrumbList;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BreadcrumbList")
				}
			...
			deserializer.deserialize_struct("BreadcrumbList", FIELDS, ClassVisitor)
		}
	}
}
