...
/// This trait is for properties from <https://schema.org/PawnShop>.
pub trait PawnShopTrait {}
impl PawnShopTrait for PawnShop {}
impl LocalBusinessTrait for PawnShop {
...
impl StoreTrait for PawnShop {}
impl ThingTrait for PawnShop {
...
mod serde {
	...
	impl Serialize for PawnShop {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "PawnShop", len)?;
	...
	impl<'de> Deserialize<'de> for PawnShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PawnShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PawnShop")
				}
			...
			deserializer.deserialize_struct("PawnShop", FIELDS, ClassVisitor)
		}
	}
}
