...
/// This trait is for properties from <https://schema.org/DataDownload>.
pub trait DataDownloadTrait {
...
impl DataDownloadTrait for DataDownload {
	fn get_measurement_method(&self) -> &[MeasurementMethodProperty] {
...
impl CreativeWorkTrait for DataDownload {
...
impl MediaObjectTrait for DataDownload {
...
impl ThingTrait for DataDownload {
...
mod serde {
	...
	use super::*;
	impl Serialize for DataDownload {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DataDownload", len)?;
	...
	impl<'de> Deserialize<'de> for DataDownload {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DataDownload;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DataDownload")
				}
			...
			deserializer.deserialize_struct("DataDownload", FIELDS, ClassVisitor)
		}
	}
}
