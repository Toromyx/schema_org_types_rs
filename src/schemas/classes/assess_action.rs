...
/// This trait is for properties from <https://schema.org/AssessAction>.
pub trait AssessActionTrait {}
impl AssessActionTrait for AssessAction {}
...
impl ThingTrait for AssessAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AssessAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AssessAction", len)?;
	...
	impl<'de> Deserialize<'de> for AssessAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AssessAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AssessAction")
				}
			...
			deserializer.deserialize_struct("AssessAction", FIELDS, ClassVisitor)
		}
	}
}
