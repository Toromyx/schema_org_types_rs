...
pub struct Vein {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "drainsTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/drainsTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/drainsTo"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "tributary"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/tributary"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/tributary"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
