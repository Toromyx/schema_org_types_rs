...
impl VeinTrait for Vein {
	fn get_drains_to(&self) -> &[DrainsToProperty] {
		self.r#drains_to.as_slice()
	}
	fn take_drains_to(&mut self) -> Vec<DrainsToProperty> {
		std::mem::take(&mut self.r#drains_to)
	}
	fn get_region_drained(&self) -> &[RegionDrainedProperty] {
	...
	fn get_tributary(&self) -> &[TributaryProperty] {
		self.r#tributary.as_slice()
	}
	fn take_tributary(&mut self) -> Vec<TributaryProperty> {
		std::mem::take(&mut self.r#tributary)
	}
}
impl AnatomicalStructureTrait for Vein {
...
impl MedicalEntityTrait for Vein {
...
mod serde {
	...
	use super::*;
	impl Serialize for Vein {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#drains_to) as usize,
				!Vec::is_empty(&self.r#region_drained) as usize,
				!Vec::is_empty(&self.r#tributary) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Vein", len)?;
			if !Vec::is_empty(&self.r#drains_to) {
				serialize_struct.serialize_field("drainsTo", {
					struct SerializeWith<'a>(&'a Vec<DrainsToProperty>);
					...
					&SerializeWith(&self.r#drains_to)
				})?;
			} else {
				serialize_struct.skip_field("drainsTo")?;
			}
			...
			if !Vec::is_empty(&self.r#tributary) {
				serialize_struct.serialize_field("tributary", {
					struct SerializeWith<'a>(&'a Vec<TributaryProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#tributary)
				})?;
			} else {
				serialize_struct.skip_field("tributary")?;
			}
	...
	impl<'de> Deserialize<'de> for Vein {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"drainsTo" => Ok(Field::DrainsTo),
						"regionDrained" => Ok(Field::RegionDrained),
						"tributary" => Ok(Field::Tributary),
				...
				{
					match value {
						b"drainsTo" => Ok(Field::DrainsTo),
						b"regionDrained" => Ok(Field::RegionDrained),
						b"tributary" => Ok(Field::Tributary),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Vein;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Vein")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#drains_to_property = None;
					let mut r#region_drained_property = None;
					let mut r#tributary_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::DrainsTo => {
								if r#drains_to_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"drainsTo",
									));
								}
								r#drains_to_property = Some({
									struct DeserializeWith(Vec<DrainsToProperty>);
							...
							Field::Tributary => {
								if r#tributary_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"tributary",
									));
								}
								r#tributary_property = Some({
									struct DeserializeWith(Vec<TributaryProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(Vein {
						r#drains_to: r#drains_to_property.unwrap_or_default(),
						r#region_drained: r#region_drained_property.unwrap_or_default(),
						r#tributary: r#tributary_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("Vein", FIELDS, ClassVisitor)
		}
	}
}
