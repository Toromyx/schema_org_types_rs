...
/// This trait is for properties from <https://schema.org/MedicalSign>.
pub trait MedicalSignTrait {
	/// Get <https://schema.org/identifyingExam> from [`Self`] as borrowed slice.
	fn get_identifying_exam(&self) -> &[IdentifyingExamProperty];
	/// Take <https://schema.org/identifyingExam> from [`Self`] as owned vector.
	fn take_identifying_exam(&mut self) -> Vec<IdentifyingExamProperty>;
	/// Get <https://schema.org/identifyingTest> from [`Self`] as borrowed slice.
	fn get_identifying_test(&self) -> &[IdentifyingTestProperty];
	/// Take <https://schema.org/identifyingTest> from [`Self`] as owned vector.
	fn take_identifying_test(&mut self) -> Vec<IdentifyingTestProperty>;
}
impl MedicalSignTrait for MedicalSign {
	fn get_identifying_exam(&self) -> &[IdentifyingExamProperty] {
		self.r#identifying_exam.as_slice()
	}
	fn take_identifying_exam(&mut self) -> Vec<IdentifyingExamProperty> {
		std::mem::take(&mut self.r#identifying_exam)
	}
	fn get_identifying_test(&self) -> &[IdentifyingTestProperty] {
		self.r#identifying_test.as_slice()
	}
	fn take_identifying_test(&mut self) -> Vec<IdentifyingTestProperty> {
		std::mem::take(&mut self.r#identifying_test)
	}
}
impl MedicalConditionTrait for MedicalSign {
...
impl MedicalEntityTrait for MedicalSign {
...
impl MedicalSignOrSymptomTrait for MedicalSign {
	fn get_possible_treatment(&self) -> &[PossibleTreatmentProperty] {
		self.r#possible_treatment.as_slice()
	}
	fn take_possible_treatment(&mut self) -> Vec<PossibleTreatmentProperty> {
...
impl ThingTrait for MedicalSign {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalSign {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalSign", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalSign {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalSign;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalSign")
				}
			...
			deserializer.deserialize_struct("MedicalSign", FIELDS, ClassVisitor)
		}
	}
}
