...
pub struct SportsTeam {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "athlete"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/athlete"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/athlete"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "coach"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/coach"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/coach"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/sport"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/sport"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
