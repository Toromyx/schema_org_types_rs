...
/// This trait is for properties from <https://schema.org/PodcastSeries>.
pub trait PodcastSeriesTrait {
...
impl PodcastSeriesTrait for PodcastSeries {
	fn get_actor(&self) -> &[ActorProperty] {
...
impl CreativeWorkTrait for PodcastSeries {
...
impl CreativeWorkSeriesTrait for PodcastSeries {
...
impl ThingTrait for PodcastSeries {
...
mod serde {
	...
	use super::*;
	impl Serialize for PodcastSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PodcastSeries", len)?;
	...
	impl<'de> Deserialize<'de> for PodcastSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PodcastSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PodcastSeries")
				}
			...
			deserializer.deserialize_struct("PodcastSeries", FIELDS, ClassVisitor)
		}
	}
}
