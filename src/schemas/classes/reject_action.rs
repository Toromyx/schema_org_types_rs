...
/// This trait is for properties from <https://schema.org/RejectAction>.
pub trait RejectActionTrait {}
impl RejectActionTrait for RejectAction {}
...
impl AllocateActionTrait for RejectAction {}
impl OrganizeActionTrait for RejectAction {}
impl ThingTrait for RejectAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for RejectAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RejectAction", len)?;
	...
	impl<'de> Deserialize<'de> for RejectAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RejectAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RejectAction")
				}
			...
			deserializer.deserialize_struct("RejectAction", FIELDS, ClassVisitor)
		}
	}
}
