...
/// This trait is for properties from <https://schema.org/DiagnosticProcedure>.
pub trait DiagnosticProcedureTrait {}
impl DiagnosticProcedureTrait for DiagnosticProcedure {}
impl MedicalEntityTrait for DiagnosticProcedure {
...
impl MedicalProcedureTrait for DiagnosticProcedure {
...
impl ThingTrait for DiagnosticProcedure {
...
mod serde {
	...
	use super::*;
	impl Serialize for DiagnosticProcedure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DiagnosticProcedure", len)?;
	...
	impl<'de> Deserialize<'de> for DiagnosticProcedure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DiagnosticProcedure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DiagnosticProcedure")
				}
			...
			deserializer.deserialize_struct("DiagnosticProcedure", FIELDS, ClassVisitor)
		}
	}
}
