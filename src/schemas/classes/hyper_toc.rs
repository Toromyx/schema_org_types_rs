...
pub struct HyperToc {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "tocEntry"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/tocEntry"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/tocEntry"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
