...
/// This trait is for properties from <https://schema.org/ComicSeries>.
pub trait ComicSeriesTrait {}
impl ComicSeriesTrait for ComicSeries {}
impl CreativeWorkTrait for ComicSeries {
...
impl CreativeWorkSeriesTrait for ComicSeries {
...
impl PeriodicalTrait for ComicSeries {}
impl ThingTrait for ComicSeries {
...
mod serde {
	...
	use super::*;
	impl Serialize for ComicSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ComicSeries", len)?;
	...
	impl<'de> Deserialize<'de> for ComicSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComicSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComicSeries")
				}
			...
			deserializer.deserialize_struct("ComicSeries", FIELDS, ClassVisitor)
		}
	}
}
