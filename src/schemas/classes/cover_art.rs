...
/// This trait is for properties from <https://schema.org/CoverArt>.
pub trait CoverArtTrait {}
impl CoverArtTrait for CoverArt {}
impl CreativeWorkTrait for CoverArt {
...
impl VisualArtworkTrait for CoverArt {
...
mod serde {
	...
	impl Serialize for CoverArt {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "CoverArt", len)?;
	...
	impl<'de> Deserialize<'de> for CoverArt {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CoverArt;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CoverArt")
				}
			...
			deserializer.deserialize_struct("CoverArt", FIELDS, ClassVisitor)
		}
	}
}
