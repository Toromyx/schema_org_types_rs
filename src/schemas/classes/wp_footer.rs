...
/// This trait is for properties from <https://schema.org/WPFooter>.
pub trait WpFooterTrait {}
impl WpFooterTrait for WpFooter {}
impl CreativeWorkTrait for WpFooter {
...
impl WebPageElementTrait for WpFooter {
...
mod serde {
	...
	impl Serialize for WpFooter {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "WpFooter", len)?;
	...
	impl<'de> Deserialize<'de> for WpFooter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WpFooter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WPFooter")
				}
			...
			deserializer.deserialize_struct("WpFooter", FIELDS, ClassVisitor)
		}
	}
}
