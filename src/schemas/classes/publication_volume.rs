...
pub struct PublicationVolume {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "volumeNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/volumeNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/volumeNumber"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
