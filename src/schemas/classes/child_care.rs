...
/// This trait is for properties from <https://schema.org/ChildCare>.
pub trait ChildCareTrait {}
impl ChildCareTrait for ChildCare {}
impl LocalBusinessTrait for ChildCare {
...
mod serde {
	...
	impl Serialize for ChildCare {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ChildCare", len)?;
	...
	impl<'de> Deserialize<'de> for ChildCare {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ChildCare;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ChildCare")
				}
			...
			deserializer.deserialize_struct("ChildCare", FIELDS, ClassVisitor)
		}
	}
}
