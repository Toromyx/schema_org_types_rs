...
/// This trait is for properties from <https://schema.org/BeautySalon>.
pub trait BeautySalonTrait {}
impl BeautySalonTrait for BeautySalon {}
impl HealthAndBeautyBusinessTrait for BeautySalon {}
impl LocalBusinessTrait for BeautySalon {
...
impl ThingTrait for BeautySalon {
...
mod serde {
	...
	use super::*;
	impl Serialize for BeautySalon {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BeautySalon", len)?;
	...
	impl<'de> Deserialize<'de> for BeautySalon {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BeautySalon;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BeautySalon")
				}
			...
			deserializer.deserialize_struct("BeautySalon", FIELDS, ClassVisitor)
		}
	}
}
