...
/// This trait is for properties from <https://schema.org/NightClub>.
pub trait NightClubTrait {}
impl NightClubTrait for NightClub {}
impl EntertainmentBusinessTrait for NightClub {}
impl LocalBusinessTrait for NightClub {
...
mod serde {
	...
	impl Serialize for NightClub {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "NightClub", len)?;
	...
	impl<'de> Deserialize<'de> for NightClub {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema NightClub")
				}
			...
			deserializer.deserialize_struct("NightClub", FIELDS, ClassVisitor)
		}
	}
}
