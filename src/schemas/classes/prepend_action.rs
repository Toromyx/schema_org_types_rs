...
/// This trait is for properties from <https://schema.org/PrependAction>.
pub trait PrependActionTrait {}
impl PrependActionTrait for PrependAction {}
...
impl AddActionTrait for PrependAction {}
impl InsertActionTrait for PrependAction {
...
impl ThingTrait for PrependAction {
...
impl UpdateActionTrait for PrependAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for PrependAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PrependAction", len)?;
	...
	impl<'de> Deserialize<'de> for PrependAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PrependAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PrependAction")
				}
			...
			deserializer.deserialize_struct("PrependAction", FIELDS, ClassVisitor)
		}
	}
}
