...
pub struct MediaReview {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "mediaAuthenticityCategory"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/mediaAuthenticityCategory")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/mediaAuthenticityCategory")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "originalMediaContextDescription"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/originalMediaContextDescription")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/originalMediaContextDescription")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "originalMediaLink"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/originalMediaLink")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/originalMediaLink")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
