...
pub struct MediaReview {
	...
	pub r#media_authenticity_category: Vec<MediaAuthenticityCategoryProperty>,
	/// <https://schema.org/originalMediaContextDescription>
	pub r#original_media_context_description: Vec<OriginalMediaContextDescriptionProperty>,
	/// <https://schema.org/originalMediaLink>
	pub r#original_media_link: Vec<OriginalMediaLinkProperty>,
...
pub trait MediaReviewTrait {
	/// Get <https://schema.org/mediaAuthenticityCategory> from [`Self`] as borrowed slice.
	fn get_media_authenticity_category(&self) -> &[MediaAuthenticityCategoryProperty];
	/// Take <https://schema.org/mediaAuthenticityCategory> from [`Self`] as owned vector.
	fn take_media_authenticity_category(&mut self) -> Vec<MediaAuthenticityCategoryProperty>;
	/// Get <https://schema.org/originalMediaContextDescription> from [`Self`] as borrowed slice.
	fn get_original_media_context_description(&self) -> &[OriginalMediaContextDescriptionProperty];
	/// Take <https://schema.org/originalMediaContextDescription> from [`Self`] as owned vector.
	fn take_original_media_context_description(
		&mut self,
	) -> Vec<OriginalMediaContextDescriptionProperty>;
	/// Get <https://schema.org/originalMediaLink> from [`Self`] as borrowed slice.
	fn get_original_media_link(&self) -> &[OriginalMediaLinkProperty];
	/// Take <https://schema.org/originalMediaLink> from [`Self`] as owned vector.
	fn take_original_media_link(&mut self) -> Vec<OriginalMediaLinkProperty>;
}
impl MediaReviewTrait for MediaReview {
	fn get_media_authenticity_category(&self) -> &[MediaAuthenticityCategoryProperty] {
		self.r#media_authenticity_category.as_slice()
	}
	fn take_media_authenticity_category(&mut self) -> Vec<MediaAuthenticityCategoryProperty> {
		std::mem::take(&mut self.r#media_authenticity_category)
	}
	fn get_original_media_context_description(&self) -> &[OriginalMediaContextDescriptionProperty] {
		self.r#original_media_context_description.as_slice()
	}
	fn take_original_media_context_description(
		&mut self,
	) -> Vec<OriginalMediaContextDescriptionProperty> {
		std::mem::take(&mut self.r#original_media_context_description)
	}
	fn get_original_media_link(&self) -> &[OriginalMediaLinkProperty] {
		self.r#original_media_link.as_slice()
	}
	fn take_original_media_link(&mut self) -> Vec<OriginalMediaLinkProperty> {
		std::mem::take(&mut self.r#original_media_link)
	}
}
impl CreativeWorkTrait for MediaReview {
...
impl ReviewTrait for MediaReview {
...
impl ThingTrait for MediaReview {
...
mod serde {
	...
	use super::*;
	impl Serialize for MediaReview {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#media_authenticity_category) as usize,
				!Vec::is_empty(&self.r#original_media_context_description) as usize,
				!Vec::is_empty(&self.r#original_media_link) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MediaReview", len)?;
			if !Vec::is_empty(&self.r#media_authenticity_category) {
				serialize_struct.serialize_field("mediaAuthenticityCategory", {
					struct SerializeWith<'a>(&'a Vec<MediaAuthenticityCategoryProperty>);
					...
					&SerializeWith(&self.r#media_authenticity_category)
				})?;
			} else {
				serialize_struct.skip_field("mediaAuthenticityCategory")?;
			}
			if !Vec::is_empty(&self.r#original_media_context_description) {
				serialize_struct.serialize_field("originalMediaContextDescription", {
					struct SerializeWith<'a>(&'a Vec<OriginalMediaContextDescriptionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#original_media_context_description)
				})?;
			} else {
				serialize_struct.skip_field("originalMediaContextDescription")?;
			}
			if !Vec::is_empty(&self.r#original_media_link) {
				serialize_struct.serialize_field("originalMediaLink", {
					struct SerializeWith<'a>(&'a Vec<OriginalMediaLinkProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#original_media_link)
				})?;
			} else {
				serialize_struct.skip_field("originalMediaLink")?;
			}
	...
	impl<'de> Deserialize<'de> for MediaReview {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"mediaAuthenticityCategory" => Ok(Field::MediaAuthenticityCategory),
						"originalMediaContextDescription" => {
							Ok(Field::OriginalMediaContextDescription)
						}
						"originalMediaLink" => Ok(Field::OriginalMediaLink),
				...
				{
					match value {
						b"mediaAuthenticityCategory" => Ok(Field::MediaAuthenticityCategory),
						b"originalMediaContextDescription" => {
							Ok(Field::OriginalMediaContextDescription)
						}
						b"originalMediaLink" => Ok(Field::OriginalMediaLink),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MediaReview;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MediaReview")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#media_authenticity_category_property = None;
					let mut r#original_media_context_description_property = None;
					let mut r#original_media_link_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::MediaAuthenticityCategory => {
								if r#media_authenticity_category_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"mediaAuthenticityCategory",
									));
								}
								r#media_authenticity_category_property = Some({
									struct DeserializeWith(Vec<MediaAuthenticityCategoryProperty>);
							...
							Field::OriginalMediaContextDescription => {
								if r#original_media_context_description_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"originalMediaContextDescription",
									));
								}
								r#original_media_context_description_property = Some({
							...
							Field::OriginalMediaLink => {
								if r#original_media_link_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"originalMediaLink",
									));
								}
								r#original_media_link_property = Some({
									struct DeserializeWith(Vec<OriginalMediaLinkProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MediaReview {
						r#media_authenticity_category: r#media_authenticity_category_property
							.unwrap_or_default(),
						r#original_media_context_description:
							r#original_media_context_description_property.unwrap_or_default(),
						r#original_media_link: r#original_media_link_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MediaReview", FIELDS, ClassVisitor)
		}
	}
}
