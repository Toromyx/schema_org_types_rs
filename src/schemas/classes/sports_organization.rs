...
impl SportsOrganizationTrait for SportsOrganization {
	fn get_sport(&self) -> &[SportProperty] {
...
impl ThingTrait for SportsOrganization {
...
mod serde {
	...
	use super::*;
	impl Serialize for SportsOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SportsOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for SportsOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SportsOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SportsOrganization")
				}
			...
			deserializer.deserialize_struct("SportsOrganization", FIELDS, ClassVisitor)
		}
	}
}
