...
/// This trait is for properties from <https://schema.org/BookmarkAction>.
pub trait BookmarkActionTrait {}
impl BookmarkActionTrait for BookmarkAction {}
...
impl OrganizeActionTrait for BookmarkAction {}
impl ThingTrait for BookmarkAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for BookmarkAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BookmarkAction", len)?;
	...
	impl<'de> Deserialize<'de> for BookmarkAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BookmarkAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BookmarkAction")
				}
			...
			deserializer.deserialize_struct("BookmarkAction", FIELDS, ClassVisitor)
		}
	}
}
