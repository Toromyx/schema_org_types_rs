...
/// This trait is for properties from <https://schema.org/EventSeries>.
pub trait EventSeriesTrait {}
impl EventSeriesTrait for EventSeries {}
impl EventTrait for EventSeries {
...
impl ThingTrait for EventSeries {
	...
	impl Serialize for EventSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EventSeries", len)?;
	...
	impl<'de> Deserialize<'de> for EventSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EventSeries")
				}
			...
			deserializer.deserialize_struct("EventSeries", FIELDS, ClassVisitor)
		}
	}
}
