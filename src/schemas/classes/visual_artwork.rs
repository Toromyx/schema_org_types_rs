	...
	impl Serialize for VisualArtwork {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				if cfg!(any(
					any(
						feature = "artist-property-schema",
						feature = "bib-schema-section"
					),
					doc
				)) {
				...
				if cfg!(any(
					any(
						feature = "colorist-property-schema",
						feature = "bib-schema-section"
					),
					doc
				)) {
				...
				if cfg!(any(
					any(
						feature = "letterer-property-schema",
						feature = "bib-schema-section"
					),
					doc
				)) {
				...
				if cfg!(any(
					any(
						feature = "penciler-property-schema",
						feature = "bib-schema-section"
					),
					doc
				)) {
