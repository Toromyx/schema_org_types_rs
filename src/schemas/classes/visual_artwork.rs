...
impl VisualArtworkTrait for VisualArtwork {
	fn get_art_edition(&self) -> &[ArtEditionProperty] {
...
impl CreativeWorkTrait for VisualArtwork {
...
impl ThingTrait for VisualArtwork {
...
mod serde {
	...
	use super::*;
	impl Serialize for VisualArtwork {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "VisualArtwork", len)?;
	...
	impl<'de> Deserialize<'de> for VisualArtwork {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = VisualArtwork;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema VisualArtwork")
				}
			...
			deserializer.deserialize_struct("VisualArtwork", FIELDS, ClassVisitor)
		}
	}
}
