...
pub struct PerformanceRole {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "characterName"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/characterName"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/characterName"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
