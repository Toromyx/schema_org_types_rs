...
/// This trait is for properties from <https://schema.org/DislikeAction>.
pub trait DislikeActionTrait {}
impl DislikeActionTrait for DislikeAction {}
...
impl AssessActionTrait for DislikeAction {}
impl ReactActionTrait for DislikeAction {}
impl ThingTrait for DislikeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for DislikeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DislikeAction", len)?;
	...
	impl<'de> Deserialize<'de> for DislikeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DislikeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DislikeAction")
				}
			...
			deserializer.deserialize_struct("DislikeAction", FIELDS, ClassVisitor)
		}
	}
}
