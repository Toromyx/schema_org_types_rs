...
pub trait QuestionTrait {
	/// Get <https://schema.org/acceptedAnswer> from [`Self`] as borrowed slice.
	fn get_accepted_answer(&self) -> &[AcceptedAnswerProperty];
	/// Take <https://schema.org/acceptedAnswer> from [`Self`] as owned vector.
	fn take_accepted_answer(&mut self) -> Vec<AcceptedAnswerProperty>;
	/// Get <https://schema.org/answerCount> from [`Self`] as borrowed slice.
	fn get_answer_count(&self) -> &[AnswerCountProperty];
	/// Take <https://schema.org/answerCount> from [`Self`] as owned vector.
	fn take_answer_count(&mut self) -> Vec<AnswerCountProperty>;
	/// Get <https://schema.org/eduQuestionType> from [`Self`] as borrowed slice.
	fn get_edu_question_type(&self) -> &[EduQuestionTypeProperty];
	/// Take <https://schema.org/eduQuestionType> from [`Self`] as owned vector.
	fn take_edu_question_type(&mut self) -> Vec<EduQuestionTypeProperty>;
	/// Get <https://schema.org/parentItem> from [`Self`] as borrowed slice.
	fn get_parent_item(&self) -> &[ParentItemProperty];
	/// Take <https://schema.org/parentItem> from [`Self`] as owned vector.
	fn take_parent_item(&mut self) -> Vec<ParentItemProperty>;
	/// Get <https://schema.org/suggestedAnswer> from [`Self`] as borrowed slice.
	fn get_suggested_answer(&self) -> &[SuggestedAnswerProperty];
	/// Take <https://schema.org/suggestedAnswer> from [`Self`] as owned vector.
	fn take_suggested_answer(&mut self) -> Vec<SuggestedAnswerProperty>;
}
impl QuestionTrait for Question {
	fn get_accepted_answer(&self) -> &[AcceptedAnswerProperty] {
		self.r#accepted_answer.as_slice()
	}
	fn take_accepted_answer(&mut self) -> Vec<AcceptedAnswerProperty> {
		std::mem::take(&mut self.r#accepted_answer)
	}
	fn get_answer_count(&self) -> &[AnswerCountProperty] {
		self.r#answer_count.as_slice()
	}
	fn take_answer_count(&mut self) -> Vec<AnswerCountProperty> {
		std::mem::take(&mut self.r#answer_count)
	}
	fn get_edu_question_type(&self) -> &[EduQuestionTypeProperty] {
		self.r#edu_question_type.as_slice()
	}
	fn take_edu_question_type(&mut self) -> Vec<EduQuestionTypeProperty> {
		std::mem::take(&mut self.r#edu_question_type)
	}
	fn get_parent_item(&self) -> &[ParentItemProperty] {
		self.r#parent_item.as_slice()
	}
	fn take_parent_item(&mut self) -> Vec<ParentItemProperty> {
		std::mem::take(&mut self.r#parent_item)
	}
	fn get_suggested_answer(&self) -> &[SuggestedAnswerProperty] {
		self.r#suggested_answer.as_slice()
	}
	fn take_suggested_answer(&mut self) -> Vec<SuggestedAnswerProperty> {
		std::mem::take(&mut self.r#suggested_answer)
	}
}
impl CommentTrait for Question {
	fn get_downvote_count(&self) -> &[DownvoteCountProperty] {
		self.r#downvote_count.as_slice()
	}
	fn take_downvote_count(&mut self) -> Vec<DownvoteCountProperty> {
		std::mem::take(&mut self.r#downvote_count)
	}
	fn get_parent_item(&self) -> &[ParentItemProperty] {
		self.r#parent_item.as_slice()
	}
	...
	fn get_shared_content(&self) -> &[SharedContentProperty] {
		self.r#shared_content.as_slice()
	}
	fn take_shared_content(&mut self) -> Vec<SharedContentProperty> {
		std::mem::take(&mut self.r#shared_content)
	}
	fn get_upvote_count(&self) -> &[UpvoteCountProperty] {
		self.r#upvote_count.as_slice()
	}
	fn take_upvote_count(&mut self) -> Vec<UpvoteCountProperty> {
		std::mem::take(&mut self.r#upvote_count)
	}
}
impl CreativeWorkTrait for Question {
...
mod serde {
	...
	impl Serialize for Question {
		...
		{
			let len: usize = [
				!Vec::is_empty(&self.r#accepted_answer) as usize,
				!Vec::is_empty(&self.r#answer_count) as usize,
				!Vec::is_empty(&self.r#edu_question_type) as usize,
				!Vec::is_empty(&self.r#parent_item) as usize,
				!Vec::is_empty(&self.r#suggested_answer) as usize,
				!Vec::is_empty(&self.r#downvote_count) as usize,
				!Vec::is_empty(&self.r#shared_content) as usize,
				!Vec::is_empty(&self.r#upvote_count) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Question", len)?;
			if !Vec::is_empty(&self.r#accepted_answer) {
				serialize_struct.serialize_field("acceptedAnswer", {
					struct SerializeWith<'a>(&'a Vec<AcceptedAnswerProperty>);
					...
					&SerializeWith(&self.r#accepted_answer)
				})?;
			} else {
				serialize_struct.skip_field("acceptedAnswer")?;
			}
			if !Vec::is_empty(&self.r#answer_count) {
				serialize_struct.serialize_field("answerCount", {
					struct SerializeWith<'a>(&'a Vec<AnswerCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#answer_count)
				})?;
			} else {
				serialize_struct.skip_field("answerCount")?;
			}
			if !Vec::is_empty(&self.r#edu_question_type) {
				serialize_struct.serialize_field("eduQuestionType", {
					struct SerializeWith<'a>(&'a Vec<EduQuestionTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#edu_question_type)
				})?;
			} else {
				serialize_struct.skip_field("eduQuestionType")?;
			}
			if !Vec::is_empty(&self.r#parent_item) {
				serialize_struct.serialize_field("parentItem", {
					struct SerializeWith<'a>(&'a Vec<ParentItemProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#parent_item)
				})?;
			} else {
				serialize_struct.skip_field("parentItem")?;
			}
			if !Vec::is_empty(&self.r#suggested_answer) {
				serialize_struct.serialize_field("suggestedAnswer", {
					struct SerializeWith<'a>(&'a Vec<SuggestedAnswerProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#suggested_answer)
				})?;
			} else {
				serialize_struct.skip_field("suggestedAnswer")?;
			}
			if !Vec::is_empty(&self.r#downvote_count) {
				serialize_struct.serialize_field("downvoteCount", {
					struct SerializeWith<'a>(&'a Vec<DownvoteCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#downvote_count)
				})?;
			} else {
				serialize_struct.skip_field("downvoteCount")?;
			}
			if !Vec::is_empty(&self.r#shared_content) {
				serialize_struct.serialize_field("sharedContent", {
					struct SerializeWith<'a>(&'a Vec<SharedContentProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#shared_content)
				})?;
			} else {
				serialize_struct.skip_field("sharedContent")?;
			}
			if !Vec::is_empty(&self.r#upvote_count) {
				serialize_struct.serialize_field("upvoteCount", {
					struct SerializeWith<'a>(&'a Vec<UpvoteCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#upvote_count)
				})?;
			} else {
				serialize_struct.skip_field("upvoteCount")?;
			}
	...
	impl<'de> Deserialize<'de> for Question {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"acceptedAnswer" => Ok(Field::AcceptedAnswer),
						"answerCount" => Ok(Field::AnswerCount),
						"eduQuestionType" => Ok(Field::EduQuestionType),
						"parentItem" => Ok(Field::ParentItem),
						"suggestedAnswer" => Ok(Field::SuggestedAnswer),
						"downvoteCount" => Ok(Field::DownvoteCount),
						"sharedContent" => Ok(Field::SharedContent),
						"upvoteCount" => Ok(Field::UpvoteCount),
				...
				{
					match value {
						b"acceptedAnswer" => Ok(Field::AcceptedAnswer),
						b"answerCount" => Ok(Field::AnswerCount),
						b"eduQuestionType" => Ok(Field::EduQuestionType),
						b"parentItem" => Ok(Field::ParentItem),
						b"suggestedAnswer" => Ok(Field::SuggestedAnswer),
						b"downvoteCount" => Ok(Field::DownvoteCount),
						b"sharedContent" => Ok(Field::SharedContent),
						b"upvoteCount" => Ok(Field::UpvoteCount),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Question;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Question")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#accepted_answer_property = None;
					let mut r#answer_count_property = None;
					let mut r#edu_question_type_property = None;
					let mut r#parent_item_property = None;
					let mut r#suggested_answer_property = None;
					let mut r#downvote_count_property = None;
					let mut r#shared_content_property = None;
					let mut r#upvote_count_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AcceptedAnswer => {
								if r#accepted_answer_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"acceptedAnswer",
									));
								}
								r#accepted_answer_property = Some({
									struct DeserializeWith(Vec<AcceptedAnswerProperty>);
							...
							Field::AnswerCount => {
								if r#answer_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"answerCount",
									));
								}
								r#answer_count_property = Some({
									struct DeserializeWith(Vec<AnswerCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::EduQuestionType => {
								if r#edu_question_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"eduQuestionType",
									));
								}
								r#edu_question_type_property = Some({
									struct DeserializeWith(Vec<EduQuestionTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ParentItem => {
								if r#parent_item_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"parentItem",
									));
								}
								r#parent_item_property = Some({
									struct DeserializeWith(Vec<ParentItemProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SuggestedAnswer => {
								if r#suggested_answer_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"suggestedAnswer",
									));
								}
								r#suggested_answer_property = Some({
									struct DeserializeWith(Vec<SuggestedAnswerProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DownvoteCount => {
								if r#downvote_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"downvoteCount",
									));
								}
								r#downvote_count_property = Some({
									struct DeserializeWith(Vec<DownvoteCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SharedContent => {
								if r#shared_content_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"sharedContent",
									));
								}
								r#shared_content_property = Some({
									struct DeserializeWith(Vec<SharedContentProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::UpvoteCount => {
								if r#upvote_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"upvoteCount",
									));
								}
								r#upvote_count_property = Some({
									struct DeserializeWith(Vec<UpvoteCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(Question {
						r#accepted_answer: r#accepted_answer_property.unwrap_or_default(),
						r#answer_count: r#answer_count_property.unwrap_or_default(),
						r#edu_question_type: r#edu_question_type_property.unwrap_or_default(),
						r#parent_item: r#parent_item_property.unwrap_or_default(),
						r#suggested_answer: r#suggested_answer_property.unwrap_or_default(),
						r#downvote_count: r#downvote_count_property.unwrap_or_default(),
						r#shared_content: r#shared_content_property.unwrap_or_default(),
						r#upvote_count: r#upvote_count_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("Question", FIELDS, ClassVisitor)
		}
	}
}
