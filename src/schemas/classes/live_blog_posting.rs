...
pub trait LiveBlogPostingTrait {
	/// Get <https://schema.org/coverageEndTime> from [`Self`] as borrowed slice.
	fn get_coverage_end_time(&self) -> &[CoverageEndTimeProperty];
	/// Take <https://schema.org/coverageEndTime> from [`Self`] as owned vector.
	fn take_coverage_end_time(&mut self) -> Vec<CoverageEndTimeProperty>;
	/// Get <https://schema.org/coverageStartTime> from [`Self`] as borrowed slice.
	fn get_coverage_start_time(&self) -> &[CoverageStartTimeProperty];
	/// Take <https://schema.org/coverageStartTime> from [`Self`] as owned vector.
	fn take_coverage_start_time(&mut self) -> Vec<CoverageStartTimeProperty>;
	/// Get <https://schema.org/liveBlogUpdate> from [`Self`] as borrowed slice.
	fn get_live_blog_update(&self) -> &[LiveBlogUpdateProperty];
	/// Take <https://schema.org/liveBlogUpdate> from [`Self`] as owned vector.
	fn take_live_blog_update(&mut self) -> Vec<LiveBlogUpdateProperty>;
}
impl LiveBlogPostingTrait for LiveBlogPosting {
	fn get_coverage_end_time(&self) -> &[CoverageEndTimeProperty] {
		self.r#coverage_end_time.as_slice()
	}
	fn take_coverage_end_time(&mut self) -> Vec<CoverageEndTimeProperty> {
		std::mem::take(&mut self.r#coverage_end_time)
	}
	fn get_coverage_start_time(&self) -> &[CoverageStartTimeProperty] {
		self.r#coverage_start_time.as_slice()
	}
	fn take_coverage_start_time(&mut self) -> Vec<CoverageStartTimeProperty> {
		std::mem::take(&mut self.r#coverage_start_time)
	}
	fn get_live_blog_update(&self) -> &[LiveBlogUpdateProperty] {
		self.r#live_blog_update.as_slice()
	}
	fn take_live_blog_update(&mut self) -> Vec<LiveBlogUpdateProperty> {
		std::mem::take(&mut self.r#live_blog_update)
	}
}
impl ArticleTrait for LiveBlogPosting {
...
impl BlogPostingTrait for LiveBlogPosting {}
impl CreativeWorkTrait for LiveBlogPosting {
...
impl SocialMediaPostingTrait for LiveBlogPosting {
...
impl ThingTrait for LiveBlogPosting {
...
mod serde {
	...
	use super::*;
	impl Serialize for LiveBlogPosting {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#coverage_end_time) as usize,
				!Vec::is_empty(&self.r#coverage_start_time) as usize,
				!Vec::is_empty(&self.r#live_blog_update) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LiveBlogPosting", len)?;
			if !Vec::is_empty(&self.r#coverage_end_time) {
				serialize_struct.serialize_field("coverageEndTime", {
					struct SerializeWith<'a>(&'a Vec<CoverageEndTimeProperty>);
					...
					&SerializeWith(&self.r#coverage_end_time)
				})?;
			} else {
				serialize_struct.skip_field("coverageEndTime")?;
			}
			if !Vec::is_empty(&self.r#coverage_start_time) {
				serialize_struct.serialize_field("coverageStartTime", {
					struct SerializeWith<'a>(&'a Vec<CoverageStartTimeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#coverage_start_time)
				})?;
			} else {
				serialize_struct.skip_field("coverageStartTime")?;
			}
			if !Vec::is_empty(&self.r#live_blog_update) {
				serialize_struct.serialize_field("liveBlogUpdate", {
					struct SerializeWith<'a>(&'a Vec<LiveBlogUpdateProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#live_blog_update)
				})?;
			} else {
				serialize_struct.skip_field("liveBlogUpdate")?;
			}
	...
	impl<'de> Deserialize<'de> for LiveBlogPosting {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"coverageEndTime" => Ok(Field::CoverageEndTime),
						"coverageStartTime" => Ok(Field::CoverageStartTime),
						"liveBlogUpdate" => Ok(Field::LiveBlogUpdate),
				...
				{
					match value {
						b"coverageEndTime" => Ok(Field::CoverageEndTime),
						b"coverageStartTime" => Ok(Field::CoverageStartTime),
						b"liveBlogUpdate" => Ok(Field::LiveBlogUpdate),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LiveBlogPosting;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LiveBlogPosting")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#coverage_end_time_property = None;
					let mut r#coverage_start_time_property = None;
					let mut r#live_blog_update_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::CoverageEndTime => {
								if r#coverage_end_time_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"coverageEndTime",
									));
								}
								r#coverage_end_time_property = Some({
									struct DeserializeWith(Vec<CoverageEndTimeProperty>);
							...
							Field::CoverageStartTime => {
								if r#coverage_start_time_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"coverageStartTime",
									));
								}
								r#coverage_start_time_property = Some({
									struct DeserializeWith(Vec<CoverageStartTimeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::LiveBlogUpdate => {
								if r#live_blog_update_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"liveBlogUpdate",
									));
								}
								r#live_blog_update_property = Some({
									struct DeserializeWith(Vec<LiveBlogUpdateProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(LiveBlogPosting {
						r#coverage_end_time: r#coverage_end_time_property.unwrap_or_default(),
						r#coverage_start_time: r#coverage_start_time_property.unwrap_or_default(),
						r#live_blog_update: r#live_blog_update_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("LiveBlogPosting", FIELDS, ClassVisitor)
		}
	}
}
