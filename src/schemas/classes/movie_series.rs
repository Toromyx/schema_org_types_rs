...
/// This trait is for properties from <https://schema.org/MovieSeries>.
pub trait MovieSeriesTrait {
...
impl MovieSeriesTrait for MovieSeries {
	fn get_actor(&self) -> &[ActorProperty] {
...
impl CreativeWorkTrait for MovieSeries {
...
impl CreativeWorkSeriesTrait for MovieSeries {
...
impl ThingTrait for MovieSeries {
...
mod serde {
	...
	use super::*;
	impl Serialize for MovieSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MovieSeries", len)?;
	...
	impl<'de> Deserialize<'de> for MovieSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MovieSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MovieSeries")
				}
			...
			deserializer.deserialize_struct("MovieSeries", FIELDS, ClassVisitor)
		}
	}
}
