...
/// This trait is for properties from <https://schema.org/UserInteraction>.
#[deprecated = "This schema is superseded by <https://schema.org/InteractionCounter>."]
pub trait UserInteractionTrait {}
impl UserInteractionTrait for UserInteraction {}
impl EventTrait for UserInteraction {
...
impl ThingTrait for UserInteraction {
	...
	impl Serialize for UserInteraction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserInteraction", len)?;
	...
	impl<'de> Deserialize<'de> for UserInteraction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserInteraction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserInteraction")
				}
			...
			deserializer.deserialize_struct("UserInteraction", FIELDS, ClassVisitor)
		}
	}
}
