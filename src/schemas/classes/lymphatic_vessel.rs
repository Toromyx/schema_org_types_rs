...
pub struct LymphaticVessel {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "originatesFrom"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/originatesFrom"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/originatesFrom"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "regionDrained"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/regionDrained"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/regionDrained"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "runsTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/runsTo"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/runsTo"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
