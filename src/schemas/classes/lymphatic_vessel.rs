...
pub trait LymphaticVesselTrait {
	/// Get <https://schema.org/originatesFrom> from [`Self`] as borrowed slice.
	fn get_originates_from(&self) -> &[OriginatesFromProperty];
	/// Take <https://schema.org/originatesFrom> from [`Self`] as owned vector.
	...
	/// Get <https://schema.org/runsTo> from [`Self`] as borrowed slice.
	fn get_runs_to(&self) -> &[RunsToProperty];
	/// Take <https://schema.org/runsTo> from [`Self`] as owned vector.
	fn take_runs_to(&mut self) -> Vec<RunsToProperty>;
}
impl LymphaticVesselTrait for LymphaticVessel {
	fn get_originates_from(&self) -> &[OriginatesFromProperty] {
		self.r#originates_from.as_slice()
	}
	fn take_originates_from(&mut self) -> Vec<OriginatesFromProperty> {
		std::mem::take(&mut self.r#originates_from)
	}
	fn get_region_drained(&self) -> &[RegionDrainedProperty] {
		self.r#region_drained.as_slice()
	}
	fn take_region_drained(&mut self) -> Vec<RegionDrainedProperty> {
		std::mem::take(&mut self.r#region_drained)
	}
	fn get_runs_to(&self) -> &[RunsToProperty] {
		self.r#runs_to.as_slice()
	}
	fn take_runs_to(&mut self) -> Vec<RunsToProperty> {
		std::mem::take(&mut self.r#runs_to)
	}
}
impl AnatomicalStructureTrait for LymphaticVessel {
...
impl MedicalEntityTrait for LymphaticVessel {
...
impl ThingTrait for LymphaticVessel {
...
impl VesselTrait for LymphaticVessel {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for LymphaticVessel {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#originates_from) as usize,
				!Vec::is_empty(&self.r#region_drained) as usize,
				!Vec::is_empty(&self.r#runs_to) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LymphaticVessel", len)?;
			if !Vec::is_empty(&self.r#originates_from) {
				serialize_struct.serialize_field("originatesFrom", {
					struct SerializeWith<'a>(&'a Vec<OriginatesFromProperty>);
					...
					&SerializeWith(&self.r#originates_from)
				})?;
			} else {
				serialize_struct.skip_field("originatesFrom")?;
			}
			if !Vec::is_empty(&self.r#region_drained) {
				serialize_struct.serialize_field("regionDrained", {
					struct SerializeWith<'a>(&'a Vec<RegionDrainedProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#region_drained)
				})?;
			} else {
				serialize_struct.skip_field("regionDrained")?;
			}
			if !Vec::is_empty(&self.r#runs_to) {
				serialize_struct.serialize_field("runsTo", {
					struct SerializeWith<'a>(&'a Vec<RunsToProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#runs_to)
				})?;
			} else {
				serialize_struct.skip_field("runsTo")?;
			}
	...
	impl<'de> Deserialize<'de> for LymphaticVessel {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"originatesFrom" => Ok(Field::OriginatesFrom),
						"regionDrained" => Ok(Field::RegionDrained),
						"runsTo" => Ok(Field::RunsTo),
				...
				{
					match value {
						b"originatesFrom" => Ok(Field::OriginatesFrom),
						b"regionDrained" => Ok(Field::RegionDrained),
						b"runsTo" => Ok(Field::RunsTo),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LymphaticVessel;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LymphaticVessel")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#originates_from_property = None;
					let mut r#region_drained_property = None;
					let mut r#runs_to_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::OriginatesFrom => {
								if r#originates_from_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"originatesFrom",
									));
								}
								r#originates_from_property = Some({
									struct DeserializeWith(Vec<OriginatesFromProperty>);
							...
							Field::RegionDrained => {
								if r#region_drained_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"regionDrained",
									));
								}
								r#region_drained_property = Some({
									struct DeserializeWith(Vec<RegionDrainedProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RunsTo => {
								if r#runs_to_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("runsTo"));
								}
								r#runs_to_property = Some({
									struct DeserializeWith(Vec<RunsToProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(LymphaticVessel {
						r#originates_from: r#originates_from_property.unwrap_or_default(),
						r#region_drained: r#region_drained_property.unwrap_or_default(),
						r#runs_to: r#runs_to_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("LymphaticVessel", FIELDS, ClassVisitor)
		}
	}
}
