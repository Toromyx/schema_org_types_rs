...
pub struct PerformAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "entertainmentBusiness"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/entertainmentBusiness")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/entertainmentBusiness")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
