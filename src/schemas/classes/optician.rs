...
/// This trait is for properties from <https://schema.org/Optician>.
pub trait OpticianTrait {}
impl OpticianTrait for Optician {}
impl LocalBusinessTrait for Optician {
...
impl MedicalBusinessTrait for Optician {}
...
mod serde {
	...
	impl Serialize for Optician {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Optician", len)?;
	...
	impl<'de> Deserialize<'de> for Optician {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Optician;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Optician")
				}
			...
			deserializer.deserialize_struct("Optician", FIELDS, ClassVisitor)
		}
	}
}
