...
/// This trait is for properties from <https://schema.org/GeneralContractor>.
pub trait GeneralContractorTrait {}
impl GeneralContractorTrait for GeneralContractor {}
impl HomeAndConstructionBusinessTrait for GeneralContractor {}
impl LocalBusinessTrait for GeneralContractor {
...
impl ThingTrait for GeneralContractor {
...
mod serde {
	...
	use super::*;
	impl Serialize for GeneralContractor {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GeneralContractor", len)?;
	...
	impl<'de> Deserialize<'de> for GeneralContractor {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GeneralContractor;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GeneralContractor")
				}
			...
			deserializer.deserialize_struct("GeneralContractor", FIELDS, ClassVisitor)
		}
	}
}
