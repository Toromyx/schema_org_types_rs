...
pub struct DiagnosticLab {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "availableTest"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/availableTest"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/availableTest"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
