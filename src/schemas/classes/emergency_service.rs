...
/// This trait is for properties from <https://schema.org/EmergencyService>.
pub trait EmergencyServiceTrait {}
impl EmergencyServiceTrait for EmergencyService {}
impl LocalBusinessTrait for EmergencyService {
...
impl ThingTrait for EmergencyService {
...
mod serde {
	...
	use super::*;
	impl Serialize for EmergencyService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EmergencyService", len)?;
	...
	impl<'de> Deserialize<'de> for EmergencyService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EmergencyService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EmergencyService")
				}
			...
			deserializer.deserialize_struct("EmergencyService", FIELDS, ClassVisitor)
		}
	}
}
