...
/// This trait is for properties from <https://schema.org/FireStation>.
pub trait FireStationTrait {}
impl FireStationTrait for FireStation {}
impl CivicStructureTrait for FireStation {
...
impl EmergencyServiceTrait for FireStation {}
impl LocalBusinessTrait for FireStation {
...
impl ThingTrait for FireStation {
...
mod serde {
	...
	use super::*;
	impl Serialize for FireStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FireStation", len)?;
	...
	impl<'de> Deserialize<'de> for FireStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FireStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FireStation")
				}
			...
			deserializer.deserialize_struct("FireStation", FIELDS, ClassVisitor)
		}
	}
}
