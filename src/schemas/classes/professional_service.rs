...
/// This trait is for properties from <https://schema.org/ProfessionalService>.
pub trait ProfessionalServiceTrait {}
impl ProfessionalServiceTrait for ProfessionalService {}
impl LocalBusinessTrait for ProfessionalService {
...
impl ThingTrait for ProfessionalService {
...
mod serde {
	...
	use super::*;
	impl Serialize for ProfessionalService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ProfessionalService", len)?;
	...
	impl<'de> Deserialize<'de> for ProfessionalService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ProfessionalService")
				}
			...
			deserializer.deserialize_struct("ProfessionalService", FIELDS, ClassVisitor)
		}
	}
}
