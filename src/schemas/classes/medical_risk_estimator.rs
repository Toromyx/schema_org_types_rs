...
/// This trait is for properties from <https://schema.org/MedicalRiskEstimator>.
pub trait MedicalRiskEstimatorTrait {
	/// Get <https://schema.org/estimatesRiskOf> from [`Self`] as borrowed slice.
	fn get_estimates_risk_of(&self) -> &[EstimatesRiskOfProperty];
	/// Take <https://schema.org/estimatesRiskOf> from [`Self`] as owned vector.
	fn take_estimates_risk_of(&mut self) -> Vec<EstimatesRiskOfProperty>;
	/// Get <https://schema.org/includedRiskFactor> from [`Self`] as borrowed slice.
	fn get_included_risk_factor(&self) -> &[IncludedRiskFactorProperty];
	/// Take <https://schema.org/includedRiskFactor> from [`Self`] as owned vector.
	fn take_included_risk_factor(&mut self) -> Vec<IncludedRiskFactorProperty>;
}
impl MedicalRiskEstimatorTrait for MedicalRiskEstimator {
	fn get_estimates_risk_of(&self) -> &[EstimatesRiskOfProperty] {
...
impl MedicalEntityTrait for MedicalRiskEstimator {
...
impl ThingTrait for MedicalRiskEstimator {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalRiskEstimator {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalRiskEstimator", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalRiskEstimator {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalRiskEstimator;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalRiskEstimator")
				}
			...
			deserializer.deserialize_struct("MedicalRiskEstimator", FIELDS, ClassVisitor)
		}
	}
}
