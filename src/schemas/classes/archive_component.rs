...
pub trait ArchiveComponentTrait {
	/// Get <https://schema.org/holdingArchive> from [`Self`] as borrowed slice.
	fn get_holding_archive(&self) -> &[HoldingArchiveProperty];
	/// Take <https://schema.org/holdingArchive> from [`Self`] as owned vector.
	fn take_holding_archive(&mut self) -> Vec<HoldingArchiveProperty>;
	/// Get <https://schema.org/itemLocation> from [`Self`] as borrowed slice.
	fn get_item_location(&self) -> &[ItemLocationProperty];
	/// Take <https://schema.org/itemLocation> from [`Self`] as owned vector.
	fn take_item_location(&mut self) -> Vec<ItemLocationProperty>;
}
impl ArchiveComponentTrait for ArchiveComponent {
	fn get_holding_archive(&self) -> &[HoldingArchiveProperty] {
		self.r#holding_archive.as_slice()
	}
	fn take_holding_archive(&mut self) -> Vec<HoldingArchiveProperty> {
		std::mem::take(&mut self.r#holding_archive)
	}
	fn get_item_location(&self) -> &[ItemLocationProperty] {
		self.r#item_location.as_slice()
	}
	fn take_item_location(&mut self) -> Vec<ItemLocationProperty> {
		std::mem::take(&mut self.r#item_location)
	}
}
impl CreativeWorkTrait for ArchiveComponent {
...
impl ThingTrait for ArchiveComponent {
...
mod serde {
	...
	use super::*;
	impl Serialize for ArchiveComponent {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#holding_archive) as usize,
				!Vec::is_empty(&self.r#item_location) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ArchiveComponent", len)?;
			if !Vec::is_empty(&self.r#holding_archive) {
				serialize_struct.serialize_field("holdingArchive", {
					struct SerializeWith<'a>(&'a Vec<HoldingArchiveProperty>);
					...
					&SerializeWith(&self.r#holding_archive)
				})?;
			} else {
				serialize_struct.skip_field("holdingArchive")?;
			}
			if !Vec::is_empty(&self.r#item_location) {
				serialize_struct.serialize_field("itemLocation", {
					struct SerializeWith<'a>(&'a Vec<ItemLocationProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#item_location)
				})?;
			} else {
				serialize_struct.skip_field("itemLocation")?;
			}
	...
	impl<'de> Deserialize<'de> for ArchiveComponent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"holdingArchive" => Ok(Field::HoldingArchive),
						"itemLocation" => Ok(Field::ItemLocation),
				...
				{
					match value {
						b"holdingArchive" => Ok(Field::HoldingArchive),
						b"itemLocation" => Ok(Field::ItemLocation),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ArchiveComponent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ArchiveComponent")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#holding_archive_property = None;
					let mut r#item_location_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::HoldingArchive => {
								if r#holding_archive_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"holdingArchive",
									));
								}
								r#holding_archive_property = Some({
									struct DeserializeWith(Vec<HoldingArchiveProperty>);
							...
							Field::ItemLocation => {
								if r#item_location_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"itemLocation",
									));
								}
								r#item_location_property = Some({
									struct DeserializeWith(Vec<ItemLocationProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(ArchiveComponent {
						r#holding_archive: r#holding_archive_property.unwrap_or_default(),
						r#item_location: r#item_location_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("ArchiveComponent", FIELDS, ClassVisitor)
		}
	}
}
