...
pub struct ArchiveComponent {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "holdingArchive"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/holdingArchive"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/holdingArchive"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "itemLocation"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/itemLocation"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/itemLocation"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
