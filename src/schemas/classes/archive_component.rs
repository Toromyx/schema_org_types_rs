...
pub struct ArchiveComponent {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "holdingArchive"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#holding_archive: Vec<HoldingArchiveProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "itemLocation"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#item_location: Vec<ItemLocationProperty>,
    #[cfg(any(
        any(
