...
/// This trait is for properties from <https://schema.org/DeleteAction>.
pub trait DeleteActionTrait {}
impl DeleteActionTrait for DeleteAction {}
...
impl ThingTrait for DeleteAction {
...
impl UpdateActionTrait for DeleteAction {
	...
	impl Serialize for DeleteAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DeleteAction", len)?;
	...
	impl<'de> Deserialize<'de> for DeleteAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DeleteAction")
				}
			...
			deserializer.deserialize_struct("DeleteAction", FIELDS, ClassVisitor)
		}
	}
}
