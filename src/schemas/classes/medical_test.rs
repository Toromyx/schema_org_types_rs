...
impl MedicalEntityTrait for MedicalTest {
...
impl ThingTrait for MedicalTest {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalTest {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalTest", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalTest {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalTest;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalTest")
				}
			...
			deserializer.deserialize_struct("MedicalTest", FIELDS, ClassVisitor)
		}
	}
}
