...
/// This trait is for properties from <https://schema.org/SatiricalArticle>.
pub trait SatiricalArticleTrait {}
impl SatiricalArticleTrait for SatiricalArticle {}
impl ArticleTrait for SatiricalArticle {
...
impl CreativeWorkTrait for SatiricalArticle {
...
impl ThingTrait for SatiricalArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for SatiricalArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SatiricalArticle", len)?;
	...
	impl<'de> Deserialize<'de> for SatiricalArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SatiricalArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SatiricalArticle")
				}
			...
			deserializer.deserialize_struct("SatiricalArticle", FIELDS, ClassVisitor)
		}
	}
}
