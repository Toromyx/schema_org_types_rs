...
/// This trait is for properties from <https://schema.org/RadioBroadcastService>.
pub trait RadioBroadcastServiceTrait {}
impl RadioBroadcastServiceTrait for RadioBroadcastService {}
...
mod serde {
	...
	use super::*;
	impl Serialize for RadioBroadcastService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RadioBroadcastService", len)?;
	...
	impl<'de> Deserialize<'de> for RadioBroadcastService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioBroadcastService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioBroadcastService")
				}
			...
			deserializer.deserialize_struct("RadioBroadcastService", FIELDS, ClassVisitor)
		}
	}
}
