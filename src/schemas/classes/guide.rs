...
impl CreativeWorkTrait for Guide {
...
mod serde {
	...
	impl<'de> Deserialize<'de> for Guide {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Guide;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Guide")
				}
			...
			deserializer.deserialize_struct("Guide", FIELDS, ClassVisitor)
		}
	}
}
