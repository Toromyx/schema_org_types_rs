...
/// This trait is for properties from <https://schema.org/TireShop>.
pub trait TireShopTrait {}
impl TireShopTrait for TireShop {}
impl LocalBusinessTrait for TireShop {
...
impl StoreTrait for TireShop {}
impl ThingTrait for TireShop {
...
mod serde {
	...
	impl Serialize for TireShop {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "TireShop", len)?;
	...
	impl<'de> Deserialize<'de> for TireShop {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TireShop;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TireShop")
				}
			...
			deserializer.deserialize_struct("TireShop", FIELDS, ClassVisitor)
		}
	}
}
