...
/// This trait is for properties from <https://schema.org/LandmarksOrHistoricalBuildings>.
pub trait LandmarksOrHistoricalBuildingsTrait {}
impl LandmarksOrHistoricalBuildingsTrait for LandmarksOrHistoricalBuildings {}
...
impl ThingTrait for LandmarksOrHistoricalBuildings {
...
mod serde {
	...
	use super::*;
	impl Serialize for LandmarksOrHistoricalBuildings {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LandmarksOrHistoricalBuildings", len)?;
	...
	impl<'de> Deserialize<'de> for LandmarksOrHistoricalBuildings {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LandmarksOrHistoricalBuildings;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LandmarksOrHistoricalBuildings")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					Ok(LandmarksOrHistoricalBuildings {
			...
			deserializer.deserialize_struct("LandmarksOrHistoricalBuildings", FIELDS, ClassVisitor)
		}
	}
}
