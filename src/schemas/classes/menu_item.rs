...
pub struct MenuItem {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "menuAddOn"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/menuAddOn"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/menuAddOn"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
