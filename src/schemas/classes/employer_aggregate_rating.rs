...
/// This trait is for properties from <https://schema.org/EmployerAggregateRating>.
pub trait EmployerAggregateRatingTrait {}
impl EmployerAggregateRatingTrait for EmployerAggregateRating {}
impl AggregateRatingTrait for EmployerAggregateRating {
	...
	fn get_rating_count(&self) -> &[RatingCountProperty] {
		self.r#rating_count.as_slice()
	}
	fn take_rating_count(&mut self) -> Vec<RatingCountProperty> {
		std::mem::take(&mut self.r#rating_count)
	}
	fn get_review_count(&self) -> &[ReviewCountProperty] {
		self.r#review_count.as_slice()
	}
	fn take_review_count(&mut self) -> Vec<ReviewCountProperty> {
		std::mem::take(&mut self.r#review_count)
	}
}
impl RatingTrait for EmployerAggregateRating {
...
impl ThingTrait for EmployerAggregateRating {
...
mod serde {
	...
	use super::*;
	impl Serialize for EmployerAggregateRating {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#rating_count) as usize,
				!Vec::is_empty(&self.r#review_count) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EmployerAggregateRating", len)?;
			...
			if !Vec::is_empty(&self.r#rating_count) {
				serialize_struct.serialize_field("ratingCount", {
					struct SerializeWith<'a>(&'a Vec<RatingCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#rating_count)
				})?;
			} else {
				serialize_struct.skip_field("ratingCount")?;
			}
			if !Vec::is_empty(&self.r#review_count) {
				serialize_struct.serialize_field("reviewCount", {
					struct SerializeWith<'a>(&'a Vec<ReviewCountProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#review_count)
				})?;
			} else {
				serialize_struct.skip_field("reviewCount")?;
			}
			...
			if !Vec::is_empty(&self.r#best_rating) {
				serialize_struct.serialize_field("bestRating", {
					struct SerializeWith<'a>(&'a Vec<BestRatingProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#best_rating)
				})?;
			} else {
	...
	impl<'de> Deserialize<'de> for EmployerAggregateRating {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"ratingCount" => Ok(Field::RatingCount),
						"reviewCount" => Ok(Field::ReviewCount),
					...
					E: de::Error,
				{
					match value {
						...
						b"ratingCount" => Ok(Field::RatingCount),
						b"reviewCount" => Ok(Field::ReviewCount),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EmployerAggregateRating;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EmployerAggregateRating")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#rating_count_property = None;
					let mut r#review_count_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::RatingCount => {
								if r#rating_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"ratingCount",
									));
								}
								r#rating_count_property = Some({
									struct DeserializeWith(Vec<RatingCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ReviewCount => {
								if r#review_count_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"reviewCount",
									));
								}
								r#review_count_property = Some({
									struct DeserializeWith(Vec<ReviewCountProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(EmployerAggregateRating {
						r#item_reviewed: r#item_reviewed_property.unwrap_or_default(),
						r#rating_count: r#rating_count_property.unwrap_or_default(),
						r#review_count: r#review_count_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("EmployerAggregateRating", FIELDS, ClassVisitor)
		}
	}
}
