...
/// This trait is for properties from <https://schema.org/ApplyAction>.
pub trait ApplyActionTrait {}
impl ApplyActionTrait for ApplyAction {}
...
impl OrganizeActionTrait for ApplyAction {}
impl ThingTrait for ApplyAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ApplyAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ApplyAction", len)?;
	...
	impl<'de> Deserialize<'de> for ApplyAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ApplyAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ApplyAction")
				}
			...
			deserializer.deserialize_struct("ApplyAction", FIELDS, ClassVisitor)
		}
	}
}
