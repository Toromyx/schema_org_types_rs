...
/// This trait is for properties from <https://schema.org/MedicalIntangible>.
pub trait MedicalIntangibleTrait {}
impl MedicalIntangibleTrait for MedicalIntangible {}
impl MedicalEntityTrait for MedicalIntangible {
...
impl ThingTrait for MedicalIntangible {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalIntangible {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalIntangible", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalIntangible {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalIntangible;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalIntangible")
				}
			...
			deserializer.deserialize_struct("MedicalIntangible", FIELDS, ClassVisitor)
		}
	}
}
