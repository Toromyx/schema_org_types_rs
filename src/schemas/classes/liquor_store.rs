...
/// This trait is for properties from <https://schema.org/LiquorStore>.
pub trait LiquorStoreTrait {}
impl LiquorStoreTrait for LiquorStore {}
impl LocalBusinessTrait for LiquorStore {
...
impl StoreTrait for LiquorStore {}
impl ThingTrait for LiquorStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for LiquorStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LiquorStore", len)?;
	...
	impl<'de> Deserialize<'de> for LiquorStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LiquorStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LiquorStore")
				}
			...
			deserializer.deserialize_struct("LiquorStore", FIELDS, ClassVisitor)
		}
	}
}
