...
/// This trait is for properties from <https://schema.org/AutoRental>.
pub trait AutoRentalTrait {}
impl AutoRentalTrait for AutoRental {}
impl AutomotiveBusinessTrait for AutoRental {}
impl LocalBusinessTrait for AutoRental {
...
impl ThingTrait for AutoRental {
...
mod serde {
	...
	impl Serialize for AutoRental {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AutoRental", len)?;
	...
	impl<'de> Deserialize<'de> for AutoRental {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoRental;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoRental")
				}
			...
			deserializer.deserialize_struct("AutoRental", FIELDS, ClassVisitor)
		}
	}
}
