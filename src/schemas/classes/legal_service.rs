...
/// This trait is for properties from <https://schema.org/LegalService>.
pub trait LegalServiceTrait {}
impl LegalServiceTrait for LegalService {}
impl LocalBusinessTrait for LegalService {
...
impl ThingTrait for LegalService {
...
mod serde {
	...
	use super::*;
	impl Serialize for LegalService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LegalService", len)?;
	...
	impl<'de> Deserialize<'de> for LegalService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LegalService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LegalService")
				}
			...
			deserializer.deserialize_struct("LegalService", FIELDS, ClassVisitor)
		}
	}
}
