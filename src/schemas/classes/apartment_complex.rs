...
impl ApartmentComplexTrait for ApartmentComplex {
	fn get_number_of_accommodation_units(&self) -> &[NumberOfAccommodationUnitsProperty] {
...
impl ResidenceTrait for ApartmentComplex {
...
impl ThingTrait for ApartmentComplex {
...
mod serde {
	...
	use super::*;
	impl Serialize for ApartmentComplex {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ApartmentComplex", len)?;
	...
	impl<'de> Deserialize<'de> for ApartmentComplex {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ApartmentComplex;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ApartmentComplex")
				}
			...
			deserializer.deserialize_struct("ApartmentComplex", FIELDS, ClassVisitor)
		}
	}
}
