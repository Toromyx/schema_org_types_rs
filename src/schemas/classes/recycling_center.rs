...
/// This trait is for properties from <https://schema.org/RecyclingCenter>.
pub trait RecyclingCenterTrait {}
impl RecyclingCenterTrait for RecyclingCenter {}
impl LocalBusinessTrait for RecyclingCenter {
...
impl ThingTrait for RecyclingCenter {
...
mod serde {
	...
	use super::*;
	impl Serialize for RecyclingCenter {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RecyclingCenter", len)?;
	...
	impl<'de> Deserialize<'de> for RecyclingCenter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RecyclingCenter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RecyclingCenter")
				}
			...
			deserializer.deserialize_struct("RecyclingCenter", FIELDS, ClassVisitor)
		}
	}
}
