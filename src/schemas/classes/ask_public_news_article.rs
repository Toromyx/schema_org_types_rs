...
/// This trait is for properties from <https://schema.org/AskPublicNewsArticle>.
pub trait AskPublicNewsArticleTrait {}
impl AskPublicNewsArticleTrait for AskPublicNewsArticle {}
impl ArticleTrait for AskPublicNewsArticle {
...
impl CreativeWorkTrait for AskPublicNewsArticle {
...
impl NewsArticleTrait for AskPublicNewsArticle {
...
impl ThingTrait for AskPublicNewsArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for AskPublicNewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AskPublicNewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for AskPublicNewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AskPublicNewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AskPublicNewsArticle")
				}
			...
			deserializer.deserialize_struct("AskPublicNewsArticle", FIELDS, ClassVisitor)
		}
	}
}
