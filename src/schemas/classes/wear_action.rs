...
/// This trait is for properties from <https://schema.org/WearAction>.
pub trait WearActionTrait {}
impl WearActionTrait for WearAction {}
...
impl ConsumeActionTrait for WearAction {
...
impl ThingTrait for WearAction {
...
impl UseActionTrait for WearAction {}
#[cfg(feature = "serde")]
mod serde {
	...
	impl Serialize for WearAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "WearAction", len)?;
	...
	impl<'de> Deserialize<'de> for WearAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WearAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WearAction")
				}
			...
			deserializer.deserialize_struct("WearAction", FIELDS, ClassVisitor)
		}
	}
}
