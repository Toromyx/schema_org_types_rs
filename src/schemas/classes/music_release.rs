...
impl MusicReleaseTrait for MusicRelease {
	fn get_catalog_number(&self) -> &[CatalogNumberProperty] {
		self.r#catalog_number.as_slice()
	}
	fn take_catalog_number(&mut self) -> Vec<CatalogNumberProperty> {
		std::mem::take(&mut self.r#catalog_number)
	}
	fn get_credited_to(&self) -> &[CreditedToProperty] {
		self.r#credited_to.as_slice()
	}
	fn take_credited_to(&mut self) -> Vec<CreditedToProperty> {
		std::mem::take(&mut self.r#credited_to)
	}
	fn get_duration(&self) -> &[DurationProperty] {
	...
	fn get_music_release_format(&self) -> &[MusicReleaseFormatProperty] {
		self.r#music_release_format.as_slice()
	}
	fn take_music_release_format(&mut self) -> Vec<MusicReleaseFormatProperty> {
		std::mem::take(&mut self.r#music_release_format)
	}
	fn get_record_label(&self) -> &[RecordLabelProperty] {
		self.r#record_label.as_slice()
	}
	fn take_record_label(&mut self) -> Vec<RecordLabelProperty> {
		std::mem::take(&mut self.r#record_label)
	}
	fn get_release_of(&self) -> &[ReleaseOfProperty] {
		self.r#release_of.as_slice()
	}
	fn take_release_of(&mut self) -> Vec<ReleaseOfProperty> {
		std::mem::take(&mut self.r#release_of)
	}
}
impl CreativeWorkTrait for MusicRelease {
...
mod serde {
	...
	use super::*;
	impl Serialize for MusicRelease {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#catalog_number) as usize,
				!Vec::is_empty(&self.r#credited_to) as usize,
				!Vec::is_empty(&self.r#duration) as usize,
				!Vec::is_empty(&self.r#music_release_format) as usize,
				!Vec::is_empty(&self.r#record_label) as usize,
				!Vec::is_empty(&self.r#release_of) as usize,
				...
				!Vec::is_empty(&self.r#num_tracks) as usize,
				!Vec::is_empty(&self.r#track) as usize,
				!Vec::is_empty(&self.r#tracks) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MusicRelease", len)?;
			if !Vec::is_empty(&self.r#catalog_number) {
				serialize_struct.serialize_field("catalogNumber", {
					struct SerializeWith<'a>(&'a Vec<CatalogNumberProperty>);
					...
					&SerializeWith(&self.r#catalog_number)
				})?;
			} else {
				serialize_struct.skip_field("catalogNumber")?;
			}
			if !Vec::is_empty(&self.r#credited_to) {
				serialize_struct.serialize_field("creditedTo", {
					struct SerializeWith<'a>(&'a Vec<CreditedToProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#credited_to)
				})?;
			} else {
				serialize_struct.skip_field("creditedTo")?;
			}
			...
			if !Vec::is_empty(&self.r#music_release_format) {
				serialize_struct.serialize_field("musicReleaseFormat", {
					struct SerializeWith<'a>(&'a Vec<MusicReleaseFormatProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#music_release_format)
				})?;
			} else {
				serialize_struct.skip_field("musicReleaseFormat")?;
			}
			if !Vec::is_empty(&self.r#record_label) {
				serialize_struct.serialize_field("recordLabel", {
					struct SerializeWith<'a>(&'a Vec<RecordLabelProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#record_label)
				})?;
			} else {
				serialize_struct.skip_field("recordLabel")?;
			}
			if !Vec::is_empty(&self.r#release_of) {
				serialize_struct.serialize_field("releaseOf", {
					struct SerializeWith<'a>(&'a Vec<ReleaseOfProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#release_of)
				})?;
			} else {
				serialize_struct.skip_field("releaseOf")?;
			}
			...
			if !Vec::is_empty(&self.r#num_tracks) {
				serialize_struct.serialize_field("numTracks", {
					struct SerializeWith<'a>(&'a Vec<NumTracksProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#num_tracks)
				})?;
			} else {
				serialize_struct.skip_field("numTracks")?;
			}
			if !Vec::is_empty(&self.r#track) {
				serialize_struct.serialize_field("track", {
					struct SerializeWith<'a>(&'a Vec<TrackProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#track)
				})?;
			} else {
				serialize_struct.skip_field("track")?;
			}
			if !Vec::is_empty(&self.r#tracks) {
				serialize_struct.serialize_field("tracks", {
					struct SerializeWith<'a>(&'a Vec<TracksProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#tracks)
				})?;
			} else {
				serialize_struct.skip_field("tracks")?;
			}
	...
	impl<'de> Deserialize<'de> for MusicRelease {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"catalogNumber" => Ok(Field::CatalogNumber),
						"creditedTo" => Ok(Field::CreditedTo),
						"duration" => Ok(Field::Duration),
						"musicReleaseFormat" => Ok(Field::MusicReleaseFormat),
						"recordLabel" => Ok(Field::RecordLabel),
						"releaseOf" => Ok(Field::ReleaseOf),
				...
				{
					match value {
						b"catalogNumber" => Ok(Field::CatalogNumber),
						b"creditedTo" => Ok(Field::CreditedTo),
						b"duration" => Ok(Field::Duration),
						b"musicReleaseFormat" => Ok(Field::MusicReleaseFormat),
						b"recordLabel" => Ok(Field::RecordLabel),
						b"releaseOf" => Ok(Field::ReleaseOf),
						...
						b"numTracks" => Ok(Field::NumTracks),
						b"track" => Ok(Field::Track),
						b"tracks" => Ok(Field::Tracks),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicRelease;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicRelease")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#catalog_number_property = None;
					let mut r#credited_to_property = None;
					let mut r#duration_property = None;
					let mut r#music_release_format_property = None;
					let mut r#record_label_property = None;
					let mut r#release_of_property = None;
					...
					let mut r#num_tracks_property = None;
					let mut r#track_property = None;
					let mut r#tracks_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::CatalogNumber => {
								if r#catalog_number_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"catalogNumber",
									));
								}
								r#catalog_number_property = Some({
									struct DeserializeWith(Vec<CatalogNumberProperty>);
							...
							Field::CreditedTo => {
								if r#credited_to_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"creditedTo",
									));
								}
								r#credited_to_property = Some({
									struct DeserializeWith(Vec<CreditedToProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MusicReleaseFormat => {
								if r#music_release_format_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"musicReleaseFormat",
									));
								}
								r#music_release_format_property = Some({
									struct DeserializeWith(Vec<MusicReleaseFormatProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RecordLabel => {
								if r#record_label_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"recordLabel",
									));
								}
								r#record_label_property = Some({
									struct DeserializeWith(Vec<RecordLabelProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ReleaseOf => {
								if r#release_of_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"releaseOf",
									));
								}
								r#release_of_property = Some({
									struct DeserializeWith(Vec<ReleaseOfProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::NumTracks => {
								if r#num_tracks_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"numTracks",
									));
								}
								r#num_tracks_property = Some({
									struct DeserializeWith(Vec<NumTracksProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Track => {
								if r#track_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("track"));
								}
								r#track_property = Some({
									struct DeserializeWith(Vec<TrackProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Tracks => {
								if r#tracks_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("tracks"));
								}
								r#tracks_property = Some({
									struct DeserializeWith(Vec<TracksProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MusicRelease {
						r#catalog_number: r#catalog_number_property.unwrap_or_default(),
						r#credited_to: r#credited_to_property.unwrap_or_default(),
						r#duration: r#duration_property.unwrap_or_default(),
						r#music_release_format: r#music_release_format_property.unwrap_or_default(),
						r#record_label: r#record_label_property.unwrap_or_default(),
						r#release_of: r#release_of_property.unwrap_or_default(),
						...
						r#num_tracks: r#num_tracks_property.unwrap_or_default(),
						r#track: r#track_property.unwrap_or_default(),
						r#tracks: r#tracks_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MusicRelease", FIELDS, ClassVisitor)
		}
	}
}
