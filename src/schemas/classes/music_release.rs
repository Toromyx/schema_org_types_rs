...
pub struct MusicRelease {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "catalogNumber"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#catalog_number: Vec<CatalogNumberProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "creditedTo"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#credited_to: Vec<CreditedToProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "musicReleaseFormat"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#music_release_format: Vec<MusicReleaseFormatProperty>,
    #[cfg(any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "numTracks"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#num_tracks: Vec<NumTracksProperty>,
    #[cfg(any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "recordLabel"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#record_label: Vec<RecordLabelProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "releaseOf"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#release_of: Vec<ReleaseOfProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "track"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "tracks"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
