...
impl CreativeWorkTrait for SoftwareApplication {
...
impl ThingTrait for SoftwareApplication {
...
mod serde {
	...
	use super::*;
	impl Serialize for SoftwareApplication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SoftwareApplication", len)?;
	...
	impl<'de> Deserialize<'de> for SoftwareApplication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SoftwareApplication")
				}
			...
			deserializer.deserialize_struct("SoftwareApplication", FIELDS, ClassVisitor)
		}
	}
}
