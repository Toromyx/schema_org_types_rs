...
/// This trait is for properties from <https://schema.org/DefinedTermSet>.
pub trait DefinedTermSetTrait {
...
impl DefinedTermSetTrait for DefinedTermSet {
	fn get_has_defined_term(&self) -> &[HasDefinedTermProperty] {
...
impl CreativeWorkTrait for DefinedTermSet {
...
impl ThingTrait for DefinedTermSet {
...
mod serde {
	...
	use super::*;
	impl Serialize for DefinedTermSet {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DefinedTermSet", len)?;
	...
	impl<'de> Deserialize<'de> for DefinedTermSet {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DefinedTermSet;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DefinedTermSet")
				}
			...
			deserializer.deserialize_struct("DefinedTermSet", FIELDS, ClassVisitor)
		}
	}
}
