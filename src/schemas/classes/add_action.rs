...
/// This trait is for properties from <https://schema.org/AddAction>.
pub trait AddActionTrait {}
impl AddActionTrait for AddAction {}
...
impl UpdateActionTrait for AddAction {
...
mod serde {
	...
	impl Serialize for AddAction {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "AddAction", len)?;
	...
	impl<'de> Deserialize<'de> for AddAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AddAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AddAction")
				}
			...
			deserializer.deserialize_struct("AddAction", FIELDS, ClassVisitor)
		}
	}
}
