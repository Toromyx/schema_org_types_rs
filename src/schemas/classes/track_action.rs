...
/// This trait is for properties from <https://schema.org/TrackAction>.
pub trait TrackActionTrait {
...
impl TrackActionTrait for TrackAction {
	fn get_delivery_method(&self) -> &[DeliveryMethodProperty] {
...
impl FindActionTrait for TrackAction {}
impl ThingTrait for TrackAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for TrackAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TrackAction", len)?;
	...
	impl<'de> Deserialize<'de> for TrackAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TrackAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TrackAction")
				}
			...
			deserializer.deserialize_struct("TrackAction", FIELDS, ClassVisitor)
		}
	}
}
