...
/// This trait is for properties from <https://schema.org/GolfCourse>.
pub trait GolfCourseTrait {}
impl GolfCourseTrait for GolfCourse {}
impl LocalBusinessTrait for GolfCourse {
...
impl SportsActivityLocationTrait for GolfCourse {}
impl ThingTrait for GolfCourse {
...
mod serde {
	...
	impl Serialize for GolfCourse {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "GolfCourse", len)?;
	...
	impl<'de> Deserialize<'de> for GolfCourse {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GolfCourse;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GolfCourse")
				}
			...
			deserializer.deserialize_struct("GolfCourse", FIELDS, ClassVisitor)
		}
	}
}
