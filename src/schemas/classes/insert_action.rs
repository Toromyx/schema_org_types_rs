...
impl InsertActionTrait for InsertAction {
	fn get_to_location(&self) -> &[ToLocationProperty] {
...
impl AddActionTrait for InsertAction {}
impl ThingTrait for InsertAction {
...
impl UpdateActionTrait for InsertAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for InsertAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InsertAction", len)?;
	...
	impl<'de> Deserialize<'de> for InsertAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InsertAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InsertAction")
				}
			...
			deserializer.deserialize_struct("InsertAction", FIELDS, ClassVisitor)
		}
	}
}
