...
impl DrugLegalStatusTrait for DrugLegalStatus {
	fn get_applicable_location(&self) -> &[ApplicableLocationProperty] {
...
impl MedicalEntityTrait for DrugLegalStatus {
...
impl MedicalIntangibleTrait for DrugLegalStatus {}
impl ThingTrait for DrugLegalStatus {
...
mod serde {
	...
	use super::*;
	impl Serialize for DrugLegalStatus {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DrugLegalStatus", len)?;
	...
	impl<'de> Deserialize<'de> for DrugLegalStatus {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DrugLegalStatus;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DrugLegalStatus")
				}
			...
			deserializer.deserialize_struct("DrugLegalStatus", FIELDS, ClassVisitor)
		}
	}
}
