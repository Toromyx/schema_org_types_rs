...
/// This trait is for properties from <https://schema.org/MusicStore>.
pub trait MusicStoreTrait {}
impl MusicStoreTrait for MusicStore {}
impl LocalBusinessTrait for MusicStore {
...
impl StoreTrait for MusicStore {}
impl ThingTrait for MusicStore {
...
mod serde {
	...
	impl Serialize for MusicStore {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "MusicStore", len)?;
	...
	impl<'de> Deserialize<'de> for MusicStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicStore")
				}
			...
			deserializer.deserialize_struct("MusicStore", FIELDS, ClassVisitor)
		}
	}
}
