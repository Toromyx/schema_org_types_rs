...
/// This trait is for properties from <https://schema.org/MovieClip>.
pub trait MovieClipTrait {}
impl MovieClipTrait for MovieClip {}
impl ClipTrait for MovieClip {
...
impl CreativeWorkTrait for MovieClip {
...
mod serde {
	...
	impl Serialize for MovieClip {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "MovieClip", len)?;
	...
	impl<'de> Deserialize<'de> for MovieClip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MovieClip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MovieClip")
				}
			...
			deserializer.deserialize_struct("MovieClip", FIELDS, ClassVisitor)
		}
	}
}
