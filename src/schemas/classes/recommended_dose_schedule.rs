...
/// This trait is for properties from <https://schema.org/RecommendedDoseSchedule>.
pub trait RecommendedDoseScheduleTrait {}
impl RecommendedDoseScheduleTrait for RecommendedDoseSchedule {}
impl DoseScheduleTrait for RecommendedDoseSchedule {
...
impl MedicalEntityTrait for RecommendedDoseSchedule {
...
impl MedicalIntangibleTrait for RecommendedDoseSchedule {}
impl ThingTrait for RecommendedDoseSchedule {
...
mod serde {
	...
	use super::*;
	impl Serialize for RecommendedDoseSchedule {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RecommendedDoseSchedule", len)?;
	...
	impl<'de> Deserialize<'de> for RecommendedDoseSchedule {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RecommendedDoseSchedule;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RecommendedDoseSchedule")
				}
			...
			deserializer.deserialize_struct("RecommendedDoseSchedule", FIELDS, ClassVisitor)
		}
	}
}
