...
/// This trait is for properties from <https://schema.org/MobilePhoneStore>.
pub trait MobilePhoneStoreTrait {}
impl MobilePhoneStoreTrait for MobilePhoneStore {}
impl LocalBusinessTrait for MobilePhoneStore {
...
impl StoreTrait for MobilePhoneStore {}
impl ThingTrait for MobilePhoneStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for MobilePhoneStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MobilePhoneStore", len)?;
	...
	impl<'de> Deserialize<'de> for MobilePhoneStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MobilePhoneStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MobilePhoneStore")
				}
			...
			deserializer.deserialize_struct("MobilePhoneStore", FIELDS, ClassVisitor)
		}
	}
}
