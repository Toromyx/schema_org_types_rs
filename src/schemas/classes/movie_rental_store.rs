...
/// This trait is for properties from <https://schema.org/MovieRentalStore>.
pub trait MovieRentalStoreTrait {}
impl MovieRentalStoreTrait for MovieRentalStore {}
impl LocalBusinessTrait for MovieRentalStore {
...
impl StoreTrait for MovieRentalStore {}
impl ThingTrait for MovieRentalStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for MovieRentalStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MovieRentalStore", len)?;
	...
	impl<'de> Deserialize<'de> for MovieRentalStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MovieRentalStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MovieRentalStore")
				}
			...
			deserializer.deserialize_struct("MovieRentalStore", FIELDS, ClassVisitor)
		}
	}
}
