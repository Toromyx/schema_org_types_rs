...
pub struct Nerve {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/branch"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/branch"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/nerveMotor"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/nerveMotor"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/sensoryUnit"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/sensoryUnit"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/sourcedFrom"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/sourcedFrom"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
