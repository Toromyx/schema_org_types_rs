...
/// This trait is for properties from <https://schema.org/ControlAction>.
pub trait ControlActionTrait {}
impl ControlActionTrait for ControlAction {}
...
impl ThingTrait for ControlAction {
	...
	impl Serialize for ControlAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ControlAction", len)?;
	...
	impl<'de> Deserialize<'de> for ControlAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ControlAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ControlAction")
				}
			...
			deserializer.deserialize_struct("ControlAction", FIELDS, ClassVisitor)
		}
	}
}
