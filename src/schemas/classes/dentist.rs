...
/// This trait is for properties from <https://schema.org/Dentist>.
pub trait DentistTrait {}
impl DentistTrait for Dentist {}
impl LocalBusinessTrait for Dentist {
...
impl MedicalBusinessTrait for Dentist {}
impl MedicalOrganizationTrait for Dentist {
...
mod serde {
	...
	impl Serialize for Dentist {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Dentist", len)?;
	...
	impl<'de> Deserialize<'de> for Dentist {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Dentist;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Dentist")
				}
			...
			deserializer.deserialize_struct("Dentist", FIELDS, ClassVisitor)
		}
	}
}
