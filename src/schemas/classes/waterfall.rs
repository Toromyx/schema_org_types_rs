...
/// This trait is for properties from <https://schema.org/Waterfall>.
pub trait WaterfallTrait {}
impl WaterfallTrait for Waterfall {}
impl BodyOfWaterTrait for Waterfall {}
impl LandformTrait for Waterfall {}
...
mod serde {
	...
	impl Serialize for Waterfall {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Waterfall", len)?;
	...
	impl<'de> Deserialize<'de> for Waterfall {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Waterfall")
				}
			...
			deserializer.deserialize_struct("Waterfall", FIELDS, ClassVisitor)
		}
	}
}
