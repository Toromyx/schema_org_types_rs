...
mod serde {
	...
	use super::*;
	impl Serialize for BioChemEntity {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BioChemEntity", len)?;
	...
	impl<'de> Deserialize<'de> for BioChemEntity {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BioChemEntity;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BioChemEntity")
				}
			...
			deserializer.deserialize_struct("BioChemEntity", FIELDS, ClassVisitor)
		}
	}
}
