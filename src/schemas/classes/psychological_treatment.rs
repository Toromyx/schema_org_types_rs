...
/// This trait is for properties from <https://schema.org/PsychologicalTreatment>.
pub trait PsychologicalTreatmentTrait {}
impl PsychologicalTreatmentTrait for PsychologicalTreatment {}
impl MedicalEntityTrait for PsychologicalTreatment {
...
impl MedicalProcedureTrait for PsychologicalTreatment {
...
impl TherapeuticProcedureTrait for PsychologicalTreatment {
...
impl ThingTrait for PsychologicalTreatment {
...
mod serde {
	...
	use super::*;
	impl Serialize for PsychologicalTreatment {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PsychologicalTreatment", len)?;
	...
	impl<'de> Deserialize<'de> for PsychologicalTreatment {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PsychologicalTreatment;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PsychologicalTreatment")
				}
			...
			deserializer.deserialize_struct("PsychologicalTreatment", FIELDS, ClassVisitor)
		}
	}
}
