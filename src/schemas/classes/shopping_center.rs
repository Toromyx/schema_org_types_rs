...
/// This trait is for properties from <https://schema.org/ShoppingCenter>.
pub trait ShoppingCenterTrait {}
impl ShoppingCenterTrait for ShoppingCenter {}
impl LocalBusinessTrait for ShoppingCenter {
...
impl ThingTrait for ShoppingCenter {
...
mod serde {
	...
	use super::*;
	impl Serialize for ShoppingCenter {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ShoppingCenter", len)?;
	...
	impl<'de> Deserialize<'de> for ShoppingCenter {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ShoppingCenter;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ShoppingCenter")
				}
			...
			deserializer.deserialize_struct("ShoppingCenter", FIELDS, ClassVisitor)
		}
	}
}
