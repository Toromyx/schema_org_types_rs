...
/// This trait is for properties from <https://schema.org/HowToTool>.
pub trait HowToToolTrait {}
impl HowToToolTrait for HowToTool {}
impl HowToItemTrait for HowToTool {
...
impl ListItemTrait for HowToTool {
...
mod serde {
	...
	impl Serialize for HowToTool {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "HowToTool", len)?;
	...
	impl<'de> Deserialize<'de> for HowToTool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HowToTool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HowToTool")
				}
			...
			deserializer.deserialize_struct("HowToTool", FIELDS, ClassVisitor)
		}
	}
}
