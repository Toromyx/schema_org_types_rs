...
/// This trait is for properties from <https://schema.org/TrainReservation>.
pub trait TrainReservationTrait {}
impl TrainReservationTrait for TrainReservation {}
impl ReservationTrait for TrainReservation {
...
impl ThingTrait for TrainReservation {
...
mod serde {
	...
	use super::*;
	impl Serialize for TrainReservation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TrainReservation", len)?;
	...
	impl<'de> Deserialize<'de> for TrainReservation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TrainReservation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TrainReservation")
				}
			...
			deserializer.deserialize_struct("TrainReservation", FIELDS, ClassVisitor)
		}
	}
}
