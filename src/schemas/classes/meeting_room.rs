...
/// This trait is for properties from <https://schema.org/MeetingRoom>.
pub trait MeetingRoomTrait {}
impl MeetingRoomTrait for MeetingRoom {}
impl AccommodationTrait for MeetingRoom {
...
impl RoomTrait for MeetingRoom {}
impl ThingTrait for MeetingRoom {
...
mod serde {
	...
	use super::*;
	impl Serialize for MeetingRoom {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MeetingRoom", len)?;
	...
	impl<'de> Deserialize<'de> for MeetingRoom {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MeetingRoom")
				}
			...
			deserializer.deserialize_struct("MeetingRoom", FIELDS, ClassVisitor)
		}
	}
}
