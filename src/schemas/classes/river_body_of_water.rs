...
/// This trait is for properties from <https://schema.org/RiverBodyOfWater>.
pub trait RiverBodyOfWaterTrait {}
impl RiverBodyOfWaterTrait for RiverBodyOfWater {}
impl BodyOfWaterTrait for RiverBodyOfWater {}
impl LandformTrait for RiverBodyOfWater {}
...
impl ThingTrait for RiverBodyOfWater {
...
mod serde {
	...
	use super::*;
	impl Serialize for RiverBodyOfWater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RiverBodyOfWater", len)?;
	...
	impl<'de> Deserialize<'de> for RiverBodyOfWater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RiverBodyOfWater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RiverBodyOfWater")
				}
			...
			deserializer.deserialize_struct("RiverBodyOfWater", FIELDS, ClassVisitor)
		}
	}
}
