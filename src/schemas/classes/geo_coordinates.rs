...
impl StructuredValueTrait for GeoCoordinates {}
impl ThingTrait for GeoCoordinates {
	...
	impl Serialize for GeoCoordinates {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GeoCoordinates", len)?;
	...
	impl<'de> Deserialize<'de> for GeoCoordinates {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GeoCoordinates")
				}
			...
			deserializer.deserialize_struct("GeoCoordinates", FIELDS, ClassVisitor)
		}
	}
}
