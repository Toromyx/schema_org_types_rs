...
/// This trait is for properties from <https://schema.org/RadioClip>.
pub trait RadioClipTrait {}
impl RadioClipTrait for RadioClip {}
impl ClipTrait for RadioClip {
...
impl CreativeWorkTrait for RadioClip {
...
mod serde {
	...
	impl Serialize for RadioClip {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "RadioClip", len)?;
	...
	impl<'de> Deserialize<'de> for RadioClip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RadioClip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RadioClip")
				}
			...
			deserializer.deserialize_struct("RadioClip", FIELDS, ClassVisitor)
		}
	}
}
