...
mod serde {
	...
	use super::*;
	impl Serialize for HealthPlanFormulary {
	...
	impl<'de> Deserialize<'de> for HealthPlanFormulary {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HealthPlanFormulary;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HealthPlanFormulary")
				}
			...
			deserializer.deserialize_struct("HealthPlanFormulary", FIELDS, ClassVisitor)
		}
	}
}
