...
/// This trait is for properties from <https://schema.org/PerformingArtsTheater>.
pub trait PerformingArtsTheaterTrait {}
impl PerformingArtsTheaterTrait for PerformingArtsTheater {}
impl CivicStructureTrait for PerformingArtsTheater {
...
impl ThingTrait for PerformingArtsTheater {
...
mod serde {
	...
	use super::*;
	impl Serialize for PerformingArtsTheater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PerformingArtsTheater", len)?;
	...
	impl<'de> Deserialize<'de> for PerformingArtsTheater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PerformingArtsTheater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PerformingArtsTheater")
				}
			...
			deserializer.deserialize_struct("PerformingArtsTheater", FIELDS, ClassVisitor)
		}
	}
}
