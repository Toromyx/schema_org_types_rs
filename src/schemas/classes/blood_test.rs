...
/// This trait is for properties from <https://schema.org/BloodTest>.
pub trait BloodTestTrait {}
impl BloodTestTrait for BloodTest {}
impl MedicalEntityTrait for BloodTest {
...
impl MedicalTestTrait for BloodTest {
...
mod serde {
	...
	impl Serialize for BloodTest {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "BloodTest", len)?;
	...
	impl<'de> Deserialize<'de> for BloodTest {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BloodTest;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BloodTest")
				}
			...
			deserializer.deserialize_struct("BloodTest", FIELDS, ClassVisitor)
		}
	}
}
