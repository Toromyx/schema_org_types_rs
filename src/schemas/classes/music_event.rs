...
/// This trait is for properties from <https://schema.org/MusicEvent>.
pub trait MusicEventTrait {}
impl MusicEventTrait for MusicEvent {}
...
impl ThingTrait for MusicEvent {
...
mod serde {
	...
	impl Serialize for MusicEvent {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "MusicEvent", len)?;
	...
	impl<'de> Deserialize<'de> for MusicEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicEvent")
				}
			...
			deserializer.deserialize_struct("MusicEvent", FIELDS, ClassVisitor)
		}
	}
}
