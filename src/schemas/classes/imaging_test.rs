...
pub struct ImagingTest {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "imagingTechnique"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/imagingTechnique")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/imagingTechnique"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
