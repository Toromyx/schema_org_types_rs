...
/// This trait is for properties from <https://schema.org/LifestyleModification>.
pub trait LifestyleModificationTrait {}
impl LifestyleModificationTrait for LifestyleModification {}
impl MedicalEntityTrait for LifestyleModification {
...
impl ThingTrait for LifestyleModification {
...
mod serde {
	...
	use super::*;
	impl Serialize for LifestyleModification {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LifestyleModification", len)?;
	...
	impl<'de> Deserialize<'de> for LifestyleModification {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LifestyleModification;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LifestyleModification")
				}
			...
			deserializer.deserialize_struct("LifestyleModification", FIELDS, ClassVisitor)
		}
	}
}
