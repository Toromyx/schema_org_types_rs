...
/// This trait is for properties from <https://schema.org/ScholarlyArticle>.
pub trait ScholarlyArticleTrait {}
impl ScholarlyArticleTrait for ScholarlyArticle {}
impl ArticleTrait for ScholarlyArticle {
...
impl CreativeWorkTrait for ScholarlyArticle {
...
impl ThingTrait for ScholarlyArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for ScholarlyArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ScholarlyArticle", len)?;
	...
	impl<'de> Deserialize<'de> for ScholarlyArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ScholarlyArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ScholarlyArticle")
				}
			...
			deserializer.deserialize_struct("ScholarlyArticle", FIELDS, ClassVisitor)
		}
	}
}
