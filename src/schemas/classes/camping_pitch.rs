...
/// This trait is for properties from <https://schema.org/CampingPitch>.
pub trait CampingPitchTrait {}
impl CampingPitchTrait for CampingPitch {}
impl AccommodationTrait for CampingPitch {
...
impl ThingTrait for CampingPitch {
...
mod serde {
	...
	use super::*;
	impl Serialize for CampingPitch {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CampingPitch", len)?;
	...
	impl<'de> Deserialize<'de> for CampingPitch {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CampingPitch;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CampingPitch")
				}
			...
			deserializer.deserialize_struct("CampingPitch", FIELDS, ClassVisitor)
		}
	}
}
