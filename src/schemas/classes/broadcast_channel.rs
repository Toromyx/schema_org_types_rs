...
mod serde {
	...
	use super::*;
	impl Serialize for BroadcastChannel {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BroadcastChannel", len)?;
	...
	impl<'de> Deserialize<'de> for BroadcastChannel {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BroadcastChannel;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BroadcastChannel")
				}
			...
			deserializer.deserialize_struct("BroadcastChannel", FIELDS, ClassVisitor)
		}
	}
}
