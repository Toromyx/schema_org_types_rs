...
/// This trait is for properties from <https://schema.org/Consortium>.
pub trait ConsortiumTrait {}
impl ConsortiumTrait for Consortium {}
...
impl ThingTrait for Consortium {
...
mod serde {
	...
	impl Serialize for Consortium {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Consortium", len)?;
	...
	impl<'de> Deserialize<'de> for Consortium {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Consortium;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Consortium")
				}
			...
			deserializer.deserialize_struct("Consortium", FIELDS, ClassVisitor)
		}
	}
}
