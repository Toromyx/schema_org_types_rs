...
/// This trait is for properties from <https://schema.org/DiscussionForumPosting>.
pub trait DiscussionForumPostingTrait {}
impl DiscussionForumPostingTrait for DiscussionForumPosting {}
impl ArticleTrait for DiscussionForumPosting {
...
impl CreativeWorkTrait for DiscussionForumPosting {
...
impl SocialMediaPostingTrait for DiscussionForumPosting {
...
impl ThingTrait for DiscussionForumPosting {
...
mod serde {
	...
	use super::*;
	impl Serialize for DiscussionForumPosting {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DiscussionForumPosting", len)?;
	...
	impl<'de> Deserialize<'de> for DiscussionForumPosting {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = DiscussionForumPosting;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DiscussionForumPosting")
				}
			...
			deserializer.deserialize_struct("DiscussionForumPosting", FIELDS, ClassVisitor)
		}
	}
}
