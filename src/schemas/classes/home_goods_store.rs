...
/// This trait is for properties from <https://schema.org/HomeGoodsStore>.
pub trait HomeGoodsStoreTrait {}
impl HomeGoodsStoreTrait for HomeGoodsStore {}
impl LocalBusinessTrait for HomeGoodsStore {
...
impl StoreTrait for HomeGoodsStore {}
impl ThingTrait for HomeGoodsStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for HomeGoodsStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HomeGoodsStore", len)?;
	...
	impl<'de> Deserialize<'de> for HomeGoodsStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HomeGoodsStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HomeGoodsStore")
				}
			...
			deserializer.deserialize_struct("HomeGoodsStore", FIELDS, ClassVisitor)
		}
	}
}
