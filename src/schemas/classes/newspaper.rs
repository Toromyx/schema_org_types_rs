...
/// This trait is for properties from <https://schema.org/Newspaper>.
pub trait NewspaperTrait {}
impl NewspaperTrait for Newspaper {}
impl CreativeWorkTrait for Newspaper {
...
impl CreativeWorkSeriesTrait for Newspaper {
...
impl PeriodicalTrait for Newspaper {}
impl ThingTrait for Newspaper {
...
mod serde {
	...
	impl Serialize for Newspaper {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Newspaper", len)?;
	...
	impl<'de> Deserialize<'de> for Newspaper {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Newspaper")
				}
			...
			deserializer.deserialize_struct("Newspaper", FIELDS, ClassVisitor)
		}
	}
}
