...
/// This trait is for properties from <https://schema.org/ComedyEvent>.
pub trait ComedyEventTrait {}
impl ComedyEventTrait for ComedyEvent {}
impl EventTrait for ComedyEvent {
...
impl ThingTrait for ComedyEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for ComedyEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ComedyEvent", len)?;
	...
	impl<'de> Deserialize<'de> for ComedyEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ComedyEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ComedyEvent")
				}
			...
			deserializer.deserialize_struct("ComedyEvent", FIELDS, ClassVisitor)
		}
	}
}
