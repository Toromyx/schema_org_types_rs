...
pub struct MenuSection {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "hasMenuItem"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#has_menu_item: Vec<HasMenuItemProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "hasMenuSection"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#has_menu_section: Vec<HasMenuSectionProperty>,
    #[cfg(any(
        any(
