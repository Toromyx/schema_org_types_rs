...
pub struct MenuSection {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "hasMenuItem"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/hasMenuItem"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/hasMenuItem"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "hasMenuSection"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/hasMenuSection"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/hasMenuSection"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
