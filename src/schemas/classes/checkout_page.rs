...
/// This trait is for properties from <https://schema.org/CheckoutPage>.
pub trait CheckoutPageTrait {}
impl CheckoutPageTrait for CheckoutPage {}
impl CreativeWorkTrait for CheckoutPage {
...
impl ThingTrait for CheckoutPage {
...
impl WebPageTrait for CheckoutPage {
...
mod serde {
	...
	use super::*;
	impl Serialize for CheckoutPage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CheckoutPage", len)?;
	...
	impl<'de> Deserialize<'de> for CheckoutPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CheckoutPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CheckoutPage")
				}
			...
			deserializer.deserialize_struct("CheckoutPage", FIELDS, ClassVisitor)
		}
	}
}
