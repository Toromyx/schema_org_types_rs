...
/// This trait is for properties from <https://schema.org/ElementarySchool>.
pub trait ElementarySchoolTrait {}
impl ElementarySchoolTrait for ElementarySchool {}
impl CivicStructureTrait for ElementarySchool {
...
impl EducationalOrganizationTrait for ElementarySchool {
...
impl ThingTrait for ElementarySchool {
...
mod serde {
	...
	use super::*;
	impl Serialize for ElementarySchool {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ElementarySchool", len)?;
	...
	impl<'de> Deserialize<'de> for ElementarySchool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ElementarySchool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ElementarySchool")
				}
			...
			deserializer.deserialize_struct("ElementarySchool", FIELDS, ClassVisitor)
		}
	}
}
