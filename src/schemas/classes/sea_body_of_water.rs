...
/// This trait is for properties from <https://schema.org/SeaBodyOfWater>.
pub trait SeaBodyOfWaterTrait {}
impl SeaBodyOfWaterTrait for SeaBodyOfWater {}
impl BodyOfWaterTrait for SeaBodyOfWater {}
impl LandformTrait for SeaBodyOfWater {}
...
impl ThingTrait for SeaBodyOfWater {
...
mod serde {
	...
	use super::*;
	impl Serialize for SeaBodyOfWater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SeaBodyOfWater", len)?;
	...
	impl<'de> Deserialize<'de> for SeaBodyOfWater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SeaBodyOfWater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SeaBodyOfWater")
				}
			...
			deserializer.deserialize_struct("SeaBodyOfWater", FIELDS, ClassVisitor)
		}
	}
}
