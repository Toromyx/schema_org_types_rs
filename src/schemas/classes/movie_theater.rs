...
pub struct MovieTheater {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "screenCount"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/screenCount"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/screenCount"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
