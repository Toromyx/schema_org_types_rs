...
pub struct EndorseAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "endorsee"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/endorsee"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/endorsee"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
