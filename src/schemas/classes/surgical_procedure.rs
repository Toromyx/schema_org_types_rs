...
/// This trait is for properties from <https://schema.org/SurgicalProcedure>.
pub trait SurgicalProcedureTrait {}
impl SurgicalProcedureTrait for SurgicalProcedure {}
impl MedicalEntityTrait for SurgicalProcedure {
...
impl MedicalProcedureTrait for SurgicalProcedure {
...
impl ThingTrait for SurgicalProcedure {
...
mod serde {
	...
	use super::*;
	impl Serialize for SurgicalProcedure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SurgicalProcedure", len)?;
	...
	impl<'de> Deserialize<'de> for SurgicalProcedure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SurgicalProcedure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SurgicalProcedure")
				}
			...
			deserializer.deserialize_struct("SurgicalProcedure", FIELDS, ClassVisitor)
		}
	}
}
