...
/// This trait is for properties from <https://schema.org/Season>.
#[deprecated = "This schema is superseded by <https://schema.org/CreativeWorkSeason>."]
pub trait SeasonTrait {}
impl SeasonTrait for Season {}
impl CreativeWorkTrait for Season {
...
mod serde {
	...
	impl Serialize for Season {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Season", len)?;
	...
	impl<'de> Deserialize<'de> for Season {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Season;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Season")
				}
			...
			deserializer.deserialize_struct("Season", FIELDS, ClassVisitor)
		}
	}
}
