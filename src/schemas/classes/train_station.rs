...
/// This trait is for properties from <https://schema.org/TrainStation>.
pub trait TrainStationTrait {}
impl TrainStationTrait for TrainStation {}
impl CivicStructureTrait for TrainStation {
...
impl ThingTrait for TrainStation {
...
mod serde {
	...
	use super::*;
	impl Serialize for TrainStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TrainStation", len)?;
	...
	impl<'de> Deserialize<'de> for TrainStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TrainStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TrainStation")
				}
			...
			deserializer.deserialize_struct("TrainStation", FIELDS, ClassVisitor)
		}
	}
}
