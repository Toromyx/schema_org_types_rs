...
pub struct DataFeedItem {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "dateDeleted"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/dateDeleted"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/dateDeleted"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
