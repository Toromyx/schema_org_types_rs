...
pub struct OwnershipInfo {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "acquiredFrom"))]
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "ownedFrom"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "ownedThrough"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
