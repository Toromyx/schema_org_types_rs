...
mod serde {
	...
	use super::*;
	impl Serialize for ServiceChannel {
	...
	impl<'de> Deserialize<'de> for ServiceChannel {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ServiceChannel;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ServiceChannel")
				}
			...
			deserializer.deserialize_struct("ServiceChannel", FIELDS, ClassVisitor)
		}
	}
}
