...
/// This trait is for properties from <https://schema.org/Hostel>.
pub trait HostelTrait {}
impl HostelTrait for Hostel {}
impl LocalBusinessTrait for Hostel {
...
impl LodgingBusinessTrait for Hostel {
...
mod serde {
	...
	impl Serialize for Hostel {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Hostel", len)?;
	...
	impl<'de> Deserialize<'de> for Hostel {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Hostel;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Hostel")
				}
			...
			deserializer.deserialize_struct("Hostel", FIELDS, ClassVisitor)
		}
	}
}
