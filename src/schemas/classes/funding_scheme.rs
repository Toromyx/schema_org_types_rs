...
/// This trait is for properties from <https://schema.org/FundingScheme>.
pub trait FundingSchemeTrait {}
impl FundingSchemeTrait for FundingScheme {}
...
impl ThingTrait for FundingScheme {
...
mod serde {
	...
	use super::*;
	impl Serialize for FundingScheme {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FundingScheme", len)?;
	...
	impl<'de> Deserialize<'de> for FundingScheme {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FundingScheme;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FundingScheme")
				}
			...
			deserializer.deserialize_struct("FundingScheme", FIELDS, ClassVisitor)
		}
	}
}
