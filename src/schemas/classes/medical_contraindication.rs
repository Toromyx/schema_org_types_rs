...
/// This trait is for properties from <https://schema.org/MedicalContraindication>.
pub trait MedicalContraindicationTrait {}
impl MedicalContraindicationTrait for MedicalContraindication {}
impl MedicalEntityTrait for MedicalContraindication {
...
impl ThingTrait for MedicalContraindication {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalContraindication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalContraindication", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalContraindication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalContraindication;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalContraindication")
				}
			...
			deserializer.deserialize_struct("MedicalContraindication", FIELDS, ClassVisitor)
		}
	}
}
