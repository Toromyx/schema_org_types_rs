...
impl TherapeuticProcedureTrait for TherapeuticProcedure {
	fn get_adverse_outcome(&self) -> &[AdverseOutcomeProperty] {
...
impl MedicalEntityTrait for TherapeuticProcedure {
...
impl MedicalProcedureTrait for TherapeuticProcedure {
...
impl ThingTrait for TherapeuticProcedure {
...
mod serde {
	...
	use super::*;
	impl Serialize for TherapeuticProcedure {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TherapeuticProcedure", len)?;
	...
	impl<'de> Deserialize<'de> for TherapeuticProcedure {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TherapeuticProcedure;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TherapeuticProcedure")
				}
			...
			deserializer.deserialize_struct("TherapeuticProcedure", FIELDS, ClassVisitor)
		}
	}
}
