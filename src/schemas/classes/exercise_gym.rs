...
/// This trait is for properties from <https://schema.org/ExerciseGym>.
pub trait ExerciseGymTrait {}
impl ExerciseGymTrait for ExerciseGym {}
impl LocalBusinessTrait for ExerciseGym {
...
impl SportsActivityLocationTrait for ExerciseGym {}
impl ThingTrait for ExerciseGym {
...
mod serde {
	...
	use super::*;
	impl Serialize for ExerciseGym {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ExerciseGym", len)?;
	...
	impl<'de> Deserialize<'de> for ExerciseGym {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ExerciseGym;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ExerciseGym")
				}
			...
			deserializer.deserialize_struct("ExerciseGym", FIELDS, ClassVisitor)
		}
	}
}
