...
/// This trait is for properties from <https://schema.org/Synagogue>.
pub trait SynagogueTrait {}
impl SynagogueTrait for Synagogue {}
impl CivicStructureTrait for Synagogue {
...
impl PlaceOfWorshipTrait for Synagogue {}
impl ThingTrait for Synagogue {
...
mod serde {
	...
	impl Serialize for Synagogue {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Synagogue", len)?;
	...
	impl<'de> Deserialize<'de> for Synagogue {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Synagogue;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Synagogue")
				}
			...
			deserializer.deserialize_struct("Synagogue", FIELDS, ClassVisitor)
		}
	}
}
