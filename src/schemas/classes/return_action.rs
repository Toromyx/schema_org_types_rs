...
/// This trait is for properties from <https://schema.org/ReturnAction>.
pub trait ReturnActionTrait {
...
impl ReturnActionTrait for ReturnAction {
	fn get_recipient(&self) -> &[RecipientProperty] {
...
impl ThingTrait for ReturnAction {
...
impl TransferActionTrait for ReturnAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReturnAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReturnAction", len)?;
	...
	impl<'de> Deserialize<'de> for ReturnAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReturnAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReturnAction")
				}
			...
			deserializer.deserialize_struct("ReturnAction", FIELDS, ClassVisitor)
		}
	}
}
