...
pub struct CookAction {
	...
	pub r#food_establishment: Vec<FoodEstablishmentProperty>,
	/// <https://schema.org/foodEvent>
	pub r#food_event: Vec<FoodEventProperty>,
	/// <https://schema.org/recipe>
	pub r#recipe: Vec<RecipeProperty>,
...
pub trait CookActionTrait {
	/// Get <https://schema.org/foodEstablishment> from [`Self`] as borrowed slice.
	fn get_food_establishment(&self) -> &[FoodEstablishmentProperty];
	/// Take <https://schema.org/foodEstablishment> from [`Self`] as owned vector.
	fn take_food_establishment(&mut self) -> Vec<FoodEstablishmentProperty>;
	/// Get <https://schema.org/foodEvent> from [`Self`] as borrowed slice.
	fn get_food_event(&self) -> &[FoodEventProperty];
	/// Take <https://schema.org/foodEvent> from [`Self`] as owned vector.
	fn take_food_event(&mut self) -> Vec<FoodEventProperty>;
	/// Get <https://schema.org/recipe> from [`Self`] as borrowed slice.
	fn get_recipe(&self) -> &[RecipeProperty];
	/// Take <https://schema.org/recipe> from [`Self`] as owned vector.
	fn take_recipe(&mut self) -> Vec<RecipeProperty>;
}
impl CookActionTrait for CookAction {
	fn get_food_establishment(&self) -> &[FoodEstablishmentProperty] {
		self.r#food_establishment.as_slice()
	}
	fn take_food_establishment(&mut self) -> Vec<FoodEstablishmentProperty> {
		std::mem::take(&mut self.r#food_establishment)
	}
	fn get_food_event(&self) -> &[FoodEventProperty] {
		self.r#food_event.as_slice()
	}
	fn take_food_event(&mut self) -> Vec<FoodEventProperty> {
		std::mem::take(&mut self.r#food_event)
	}
	fn get_recipe(&self) -> &[RecipeProperty] {
		self.r#recipe.as_slice()
	}
	fn take_recipe(&mut self) -> Vec<RecipeProperty> {
		std::mem::take(&mut self.r#recipe)
	}
}
...
impl CreateActionTrait for CookAction {}
impl ThingTrait for CookAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CookAction {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#food_establishment) as usize,
				!Vec::is_empty(&self.r#food_event) as usize,
				!Vec::is_empty(&self.r#recipe) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "CookAction", len)?;
			if !Vec::is_empty(&self.r#food_establishment) {
				serialize_struct.serialize_field("foodEstablishment", {
					struct SerializeWith<'a>(&'a Vec<FoodEstablishmentProperty>);
					...
					&SerializeWith(&self.r#food_establishment)
				})?;
			} else {
				serialize_struct.skip_field("foodEstablishment")?;
			}
			if !Vec::is_empty(&self.r#food_event) {
				serialize_struct.serialize_field("foodEvent", {
					struct SerializeWith<'a>(&'a Vec<FoodEventProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#food_event)
				})?;
			} else {
				serialize_struct.skip_field("foodEvent")?;
			}
			if !Vec::is_empty(&self.r#recipe) {
				serialize_struct.serialize_field("recipe", {
					struct SerializeWith<'a>(&'a Vec<RecipeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#recipe)
				})?;
			} else {
				serialize_struct.skip_field("recipe")?;
			}
	...
	impl<'de> Deserialize<'de> for CookAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"foodEstablishment" => Ok(Field::FoodEstablishment),
						"foodEvent" => Ok(Field::FoodEvent),
						"recipe" => Ok(Field::Recipe),
				...
				{
					match value {
						b"foodEstablishment" => Ok(Field::FoodEstablishment),
						b"foodEvent" => Ok(Field::FoodEvent),
						b"recipe" => Ok(Field::Recipe),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CookAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CookAction")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#food_establishment_property = None;
					let mut r#food_event_property = None;
					let mut r#recipe_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::FoodEstablishment => {
								if r#food_establishment_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"foodEstablishment",
									));
								}
								r#food_establishment_property = Some({
									struct DeserializeWith(Vec<FoodEstablishmentProperty>);
							...
							Field::FoodEvent => {
								if r#food_event_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"foodEvent",
									));
								}
								r#food_event_property = Some({
									struct DeserializeWith(Vec<FoodEventProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Recipe => {
								if r#recipe_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("recipe"));
								}
								r#recipe_property = Some({
									struct DeserializeWith(Vec<RecipeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(CookAction {
						r#food_establishment: r#food_establishment_property.unwrap_or_default(),
						r#food_event: r#food_event_property.unwrap_or_default(),
						r#recipe: r#recipe_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("CookAction", FIELDS, ClassVisitor)
		}
	}
}
