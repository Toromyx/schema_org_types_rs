...
pub struct CookAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "foodEstablishment"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/foodEstablishment")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/foodEstablishment")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "foodEvent"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/foodEvent"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/foodEvent"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "recipe"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/recipe"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/recipe"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
