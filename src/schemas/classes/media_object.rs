...
impl MediaObjectTrait for MediaObject {
	fn get_associated_article(&self) -> &[AssociatedArticleProperty] {
...
impl CreativeWorkTrait for MediaObject {
...
impl ThingTrait for MediaObject {
...
mod serde {
	...
	use super::*;
	impl Serialize for MediaObject {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MediaObject", len)?;
	...
	impl<'de> Deserialize<'de> for MediaObject {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MediaObject")
				}
			...
			deserializer.deserialize_struct("MediaObject", FIELDS, ClassVisitor)
		}
	}
}
