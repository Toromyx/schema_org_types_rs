...
impl CommunicateActionTrait for CommunicateAction {
	fn get_about(&self) -> &[AboutProperty] {
...
impl InteractActionTrait for CommunicateAction {}
impl ThingTrait for CommunicateAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CommunicateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CommunicateAction", len)?;
	...
	impl<'de> Deserialize<'de> for CommunicateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CommunicateAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CommunicateAction")
				}
			...
			deserializer.deserialize_struct("CommunicateAction", FIELDS, ClassVisitor)
		}
	}
}
