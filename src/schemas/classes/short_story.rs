...
/// This trait is for properties from <https://schema.org/ShortStory>.
pub trait ShortStoryTrait {}
impl ShortStoryTrait for ShortStory {}
impl CreativeWorkTrait for ShortStory {
...
impl ThingTrait for ShortStory {
...
mod serde {
	...
	impl Serialize for ShortStory {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ShortStory", len)?;
	...
	impl<'de> Deserialize<'de> for ShortStory {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ShortStory;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ShortStory")
				}
			...
			deserializer.deserialize_struct("ShortStory", FIELDS, ClassVisitor)
		}
	}
}
