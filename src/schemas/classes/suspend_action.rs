...
/// This trait is for properties from <https://schema.org/SuspendAction>.
pub trait SuspendActionTrait {}
impl SuspendActionTrait for SuspendAction {}
...
impl ControlActionTrait for SuspendAction {}
impl ThingTrait for SuspendAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for SuspendAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SuspendAction", len)?;
	...
	impl<'de> Deserialize<'de> for SuspendAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SuspendAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SuspendAction")
				}
			...
			deserializer.deserialize_struct("SuspendAction", FIELDS, ClassVisitor)
		}
	}
}
