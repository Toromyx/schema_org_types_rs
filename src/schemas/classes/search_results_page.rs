...
/// This trait is for properties from <https://schema.org/SearchResultsPage>.
pub trait SearchResultsPageTrait {}
impl SearchResultsPageTrait for SearchResultsPage {}
impl CreativeWorkTrait for SearchResultsPage {
...
impl ThingTrait for SearchResultsPage {
...
impl WebPageTrait for SearchResultsPage {
...
mod serde {
	...
	use super::*;
	impl Serialize for SearchResultsPage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SearchResultsPage", len)?;
	...
	impl<'de> Deserialize<'de> for SearchResultsPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SearchResultsPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SearchResultsPage")
				}
			...
			deserializer.deserialize_struct("SearchResultsPage", FIELDS, ClassVisitor)
		}
	}
}
