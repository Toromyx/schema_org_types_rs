...
/// This trait is for properties from <https://schema.org/Ligament>.
pub trait LigamentTrait {}
impl LigamentTrait for Ligament {}
impl AnatomicalStructureTrait for Ligament {
...
impl MedicalEntityTrait for Ligament {
...
mod serde {
	...
	impl Serialize for Ligament {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Ligament", len)?;
	...
	impl<'de> Deserialize<'de> for Ligament {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Ligament;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Ligament")
				}
			...
			deserializer.deserialize_struct("Ligament", FIELDS, ClassVisitor)
		}
	}
}
