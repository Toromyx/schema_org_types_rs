...
/// This trait is for properties from <https://schema.org/CheckAction>.
pub trait CheckActionTrait {}
impl CheckActionTrait for CheckAction {}
...
impl FindActionTrait for CheckAction {}
impl ThingTrait for CheckAction {
...
mod serde {
	...
	impl Serialize for CheckAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CheckAction", len)?;
	...
	impl<'de> Deserialize<'de> for CheckAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CheckAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CheckAction")
				}
			...
			deserializer.deserialize_struct("CheckAction", FIELDS, ClassVisitor)
		}
	}
}
