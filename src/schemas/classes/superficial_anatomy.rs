...
pub struct SuperficialAnatomy {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "relatedAnatomy"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/relatedAnatomy"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/relatedAnatomy"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "significance"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/significance"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/significance"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
