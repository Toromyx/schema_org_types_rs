...
pub struct SuperficialAnatomy {
	...
	pub r#related_anatomy: Vec<RelatedAnatomyProperty>,
	...
	pub r#significance: Vec<SignificanceProperty>,
...
pub trait SuperficialAnatomyTrait {
	...
	/// Get <https://schema.org/relatedAnatomy> from [`Self`] as borrowed slice.
	fn get_related_anatomy(&self) -> &[RelatedAnatomyProperty];
	/// Take <https://schema.org/relatedAnatomy> from [`Self`] as owned vector.
	...
	/// Get <https://schema.org/significance> from [`Self`] as borrowed slice.
	fn get_significance(&self) -> &[SignificanceProperty];
	/// Take <https://schema.org/significance> from [`Self`] as owned vector.
	fn take_significance(&mut self) -> Vec<SignificanceProperty>;
}
impl SuperficialAnatomyTrait for SuperficialAnatomy {
	fn get_associated_pathophysiology(&self) -> &[AssociatedPathophysiologyProperty] {
	...
	fn get_related_anatomy(&self) -> &[RelatedAnatomyProperty] {
		self.r#related_anatomy.as_slice()
	}
	fn take_related_anatomy(&mut self) -> Vec<RelatedAnatomyProperty> {
		std::mem::take(&mut self.r#related_anatomy)
	}
	fn get_related_condition(&self) -> &[RelatedConditionProperty] {
	...
	fn get_significance(&self) -> &[SignificanceProperty] {
		self.r#significance.as_slice()
	}
	fn take_significance(&mut self) -> Vec<SignificanceProperty> {
		std::mem::take(&mut self.r#significance)
	}
}
impl MedicalEntityTrait for SuperficialAnatomy {
...
impl ThingTrait for SuperficialAnatomy {
...
mod serde {
	...
	use super::*;
	impl Serialize for SuperficialAnatomy {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SuperficialAnatomy", len)?;
			...
			if !Vec::is_empty(&self.r#related_anatomy) {
				serialize_struct.serialize_field("relatedAnatomy", {
					struct SerializeWith<'a>(&'a Vec<RelatedAnatomyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#related_anatomy)
				})?;
			} else {
				serialize_struct.skip_field("relatedAnatomy")?;
			}
			...
			if !Vec::is_empty(&self.r#significance) {
				serialize_struct.serialize_field("significance", {
					struct SerializeWith<'a>(&'a Vec<SignificanceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#significance)
				})?;
			} else {
				serialize_struct.skip_field("significance")?;
			}
	...
	impl<'de> Deserialize<'de> for SuperficialAnatomy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SuperficialAnatomy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SuperficialAnatomy")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::RelatedAnatomy => {
								if r#related_anatomy_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"relatedAnatomy",
									));
								}
								r#related_anatomy_property = Some({
									struct DeserializeWith(Vec<RelatedAnatomyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Significance => {
								if r#significance_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"significance",
									));
								}
								r#significance_property = Some({
									struct DeserializeWith(Vec<SignificanceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(SuperficialAnatomy {
						r#associated_pathophysiology: r#associated_pathophysiology_property
							.unwrap_or_default(),
						r#related_anatomy: r#related_anatomy_property.unwrap_or_default(),
						...
						r#significance: r#significance_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("SuperficialAnatomy", FIELDS, ClassVisitor)
		}
	}
}
