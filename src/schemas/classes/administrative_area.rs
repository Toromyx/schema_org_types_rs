...
/// This trait is for properties from <https://schema.org/AdministrativeArea>.
pub trait AdministrativeAreaTrait {}
impl AdministrativeAreaTrait for AdministrativeArea {}
...
impl ThingTrait for AdministrativeArea {
...
mod serde {
	...
	use super::*;
	impl Serialize for AdministrativeArea {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AdministrativeArea", len)?;
	...
	impl<'de> Deserialize<'de> for AdministrativeArea {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AdministrativeArea")
				}
			...
			deserializer.deserialize_struct("AdministrativeArea", FIELDS, ClassVisitor)
		}
	}
}
