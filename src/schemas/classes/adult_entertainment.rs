...
/// This trait is for properties from <https://schema.org/AdultEntertainment>.
pub trait AdultEntertainmentTrait {}
impl AdultEntertainmentTrait for AdultEntertainment {}
impl EntertainmentBusinessTrait for AdultEntertainment {}
impl LocalBusinessTrait for AdultEntertainment {
...
impl ThingTrait for AdultEntertainment {
...
mod serde {
	...
	use super::*;
	impl Serialize for AdultEntertainment {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AdultEntertainment", len)?;
	...
	impl<'de> Deserialize<'de> for AdultEntertainment {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AdultEntertainment;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AdultEntertainment")
				}
			...
			deserializer.deserialize_struct("AdultEntertainment", FIELDS, ClassVisitor)
		}
	}
}
