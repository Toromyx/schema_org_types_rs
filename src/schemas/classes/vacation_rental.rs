...
/// This trait is for properties from <https://schema.org/VacationRental>.
pub trait VacationRentalTrait {}
impl VacationRentalTrait for VacationRental {}
impl LocalBusinessTrait for VacationRental {
...
impl LodgingBusinessTrait for VacationRental {
...
impl ThingTrait for VacationRental {
...
mod serde {
	...
	use super::*;
	impl Serialize for VacationRental {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "VacationRental", len)?;
	...
	impl<'de> Deserialize<'de> for VacationRental {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = VacationRental;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema VacationRental")
				}
			...
			deserializer.deserialize_struct("VacationRental", FIELDS, ClassVisitor)
		}
	}
}
