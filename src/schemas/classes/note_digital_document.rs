...
pub struct NoteDigitalDocument {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "hasDigitalDocumentPermission"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/hasDigitalDocumentPermission")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/hasDigitalDocumentPermission")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
