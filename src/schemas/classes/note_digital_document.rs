...
/// This trait is for properties from <https://schema.org/NoteDigitalDocument>.
pub trait NoteDigitalDocumentTrait {}
impl NoteDigitalDocumentTrait for NoteDigitalDocument {}
impl CreativeWorkTrait for NoteDigitalDocument {
...
impl DigitalDocumentTrait for NoteDigitalDocument {
...
impl ThingTrait for NoteDigitalDocument {
...
mod serde {
	...
	use super::*;
	impl Serialize for NoteDigitalDocument {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "NoteDigitalDocument", len)?;
	...
	impl<'de> Deserialize<'de> for NoteDigitalDocument {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = NoteDigitalDocument;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema NoteDigitalDocument")
				}
			...
			deserializer.deserialize_struct("NoteDigitalDocument", FIELDS, ClassVisitor)
		}
	}
}
