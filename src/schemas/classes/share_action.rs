...
/// This trait is for properties from <https://schema.org/ShareAction>.
pub trait ShareActionTrait {}
impl ShareActionTrait for ShareAction {}
...
impl CommunicateActionTrait for ShareAction {
...
impl InteractActionTrait for ShareAction {}
impl ThingTrait for ShareAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ShareAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ShareAction", len)?;
	...
	impl<'de> Deserialize<'de> for ShareAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ShareAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ShareAction")
				}
			...
			deserializer.deserialize_struct("ShareAction", FIELDS, ClassVisitor)
		}
	}
}
