...
/// This trait is for properties from <https://schema.org/Restaurant>.
pub trait RestaurantTrait {}
impl RestaurantTrait for Restaurant {}
impl FoodEstablishmentTrait for Restaurant {
...
impl LocalBusinessTrait for Restaurant {
...
impl ThingTrait for Restaurant {
...
mod serde {
	...
	impl Serialize for Restaurant {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Restaurant", len)?;
	...
	impl<'de> Deserialize<'de> for Restaurant {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Restaurant")
				}
			...
			deserializer.deserialize_struct("Restaurant", FIELDS, ClassVisitor)
		}
	}
}
