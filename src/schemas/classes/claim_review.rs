...
pub struct ClaimReview {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "claimReviewed"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/claimReviewed"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/claimReviewed"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
