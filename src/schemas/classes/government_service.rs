...
pub struct GovernmentService {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "serviceOperator"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/serviceOperator"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/serviceOperator"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
