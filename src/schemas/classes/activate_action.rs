...
/// This trait is for properties from <https://schema.org/ActivateAction>.
pub trait ActivateActionTrait {}
impl ActivateActionTrait for ActivateAction {}
...
impl ControlActionTrait for ActivateAction {}
impl ThingTrait for ActivateAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ActivateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ActivateAction", len)?;
	...
	impl<'de> Deserialize<'de> for ActivateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ActivateAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ActivateAction")
				}
			...
			deserializer.deserialize_struct("ActivateAction", FIELDS, ClassVisitor)
		}
	}
}
