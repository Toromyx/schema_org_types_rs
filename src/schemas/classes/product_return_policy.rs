...
mod serde {
	...
	use super::*;
	impl Serialize for ProductReturnPolicy {
	...
	impl<'de> Deserialize<'de> for ProductReturnPolicy {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ProductReturnPolicy;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ProductReturnPolicy")
				}
			...
			deserializer.deserialize_struct("ProductReturnPolicy", FIELDS, ClassVisitor)
		}
	}
}
