...
pub struct ProductReturnPolicy {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "productReturnDays"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/productReturnDays")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/productReturnDays")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "productReturnLink"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/productReturnLink")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/productReturnLink")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
