...
/// This trait is for properties from <https://schema.org/WorkersUnion>.
pub trait WorkersUnionTrait {}
impl WorkersUnionTrait for WorkersUnion {}
...
impl ThingTrait for WorkersUnion {
...
mod serde {
	...
	use super::*;
	impl Serialize for WorkersUnion {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "WorkersUnion", len)?;
	...
	impl<'de> Deserialize<'de> for WorkersUnion {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WorkersUnion;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WorkersUnion")
				}
			...
			deserializer.deserialize_struct("WorkersUnion", FIELDS, ClassVisitor)
		}
	}
}
