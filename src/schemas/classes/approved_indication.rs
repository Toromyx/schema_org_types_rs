...
/// This trait is for properties from <https://schema.org/ApprovedIndication>.
pub trait ApprovedIndicationTrait {}
impl ApprovedIndicationTrait for ApprovedIndication {}
impl MedicalEntityTrait for ApprovedIndication {
...
impl MedicalIndicationTrait for ApprovedIndication {}
impl ThingTrait for ApprovedIndication {
...
mod serde {
	...
	use super::*;
	impl Serialize for ApprovedIndication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ApprovedIndication", len)?;
	...
	impl<'de> Deserialize<'de> for ApprovedIndication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ApprovedIndication;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ApprovedIndication")
				}
			...
			deserializer.deserialize_struct("ApprovedIndication", FIELDS, ClassVisitor)
		}
	}
}
