...
/// This trait is for properties from <https://schema.org/InteractAction>.
pub trait InteractActionTrait {}
impl InteractActionTrait for InteractAction {}
...
impl ThingTrait for InteractAction {
	...
	impl Serialize for InteractAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InteractAction", len)?;
	...
	impl<'de> Deserialize<'de> for InteractAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InteractAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InteractAction")
				}
			...
			deserializer.deserialize_struct("InteractAction", FIELDS, ClassVisitor)
		}
	}
}
