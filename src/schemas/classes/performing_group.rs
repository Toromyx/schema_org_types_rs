...
/// This trait is for properties from <https://schema.org/PerformingGroup>.
pub trait PerformingGroupTrait {}
impl PerformingGroupTrait for PerformingGroup {}
...
impl ThingTrait for PerformingGroup {
...
mod serde {
	...
	use super::*;
	impl Serialize for PerformingGroup {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PerformingGroup", len)?;
	...
	impl<'de> Deserialize<'de> for PerformingGroup {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PerformingGroup;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PerformingGroup")
				}
			...
			deserializer.deserialize_struct("PerformingGroup", FIELDS, ClassVisitor)
		}
	}
}
