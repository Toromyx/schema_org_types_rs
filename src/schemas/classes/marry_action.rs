...
/// This trait is for properties from <https://schema.org/MarryAction>.
pub trait MarryActionTrait {}
impl MarryActionTrait for MarryAction {}
...
impl InteractActionTrait for MarryAction {}
impl ThingTrait for MarryAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for MarryAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MarryAction", len)?;
	...
	impl<'de> Deserialize<'de> for MarryAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MarryAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MarryAction")
				}
			...
			deserializer.deserialize_struct("MarryAction", FIELDS, ClassVisitor)
		}
	}
}
