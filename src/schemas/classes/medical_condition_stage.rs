...
pub struct MedicalConditionStage {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "stageAsNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/stageAsNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/stageAsNumber"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "subStageSuffix"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/subStageSuffix"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/subStageSuffix"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
