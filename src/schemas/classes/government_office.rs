...
/// This trait is for properties from <https://schema.org/GovernmentOffice>.
pub trait GovernmentOfficeTrait {}
impl GovernmentOfficeTrait for GovernmentOffice {}
impl LocalBusinessTrait for GovernmentOffice {
...
impl ThingTrait for GovernmentOffice {
...
mod serde {
	...
	use super::*;
	impl Serialize for GovernmentOffice {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GovernmentOffice", len)?;
	...
	impl<'de> Deserialize<'de> for GovernmentOffice {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GovernmentOffice;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GovernmentOffice")
				}
			...
			deserializer.deserialize_struct("GovernmentOffice", FIELDS, ClassVisitor)
		}
	}
}
