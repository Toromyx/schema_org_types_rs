...
/// This trait is for properties from <https://schema.org/MovingCompany>.
pub trait MovingCompanyTrait {}
impl MovingCompanyTrait for MovingCompany {}
impl HomeAndConstructionBusinessTrait for MovingCompany {}
impl LocalBusinessTrait for MovingCompany {
...
impl ThingTrait for MovingCompany {
...
mod serde {
	...
	use super::*;
	impl Serialize for MovingCompany {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MovingCompany", len)?;
	...
	impl<'de> Deserialize<'de> for MovingCompany {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MovingCompany;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MovingCompany")
				}
			...
			deserializer.deserialize_struct("MovingCompany", FIELDS, ClassVisitor)
		}
	}
}
