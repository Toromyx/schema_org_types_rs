...
/// This trait is for properties from <https://schema.org/AmusementPark>.
pub trait AmusementParkTrait {}
impl AmusementParkTrait for AmusementPark {}
impl EntertainmentBusinessTrait for AmusementPark {}
impl LocalBusinessTrait for AmusementPark {
...
impl ThingTrait for AmusementPark {
...
mod serde {
	...
	use super::*;
	impl Serialize for AmusementPark {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AmusementPark", len)?;
	...
	impl<'de> Deserialize<'de> for AmusementPark {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AmusementPark;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AmusementPark")
				}
			...
			deserializer.deserialize_struct("AmusementPark", FIELDS, ClassVisitor)
		}
	}
}
