...
impl StructuredValueTrait for QuantitativeValueDistribution {}
impl ThingTrait for QuantitativeValueDistribution {
...
mod serde {
	...
	use super::*;
	impl Serialize for QuantitativeValueDistribution {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "QuantitativeValueDistribution", len)?;
	...
	impl<'de> Deserialize<'de> for QuantitativeValueDistribution {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = QuantitativeValueDistribution;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema QuantitativeValueDistribution")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					Ok(QuantitativeValueDistribution {
			...
			deserializer.deserialize_struct("QuantitativeValueDistribution", FIELDS, ClassVisitor)
		}
	}
}
