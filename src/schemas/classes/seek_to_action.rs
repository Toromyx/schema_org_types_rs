...
impl SeekToActionTrait for SeekToAction {
	fn get_start_offset(&self) -> &[StartOffsetProperty] {
...
impl ThingTrait for SeekToAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for SeekToAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SeekToAction", len)?;
	...
	impl<'de> Deserialize<'de> for SeekToAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SeekToAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SeekToAction")
				}
			...
			deserializer.deserialize_struct("SeekToAction", FIELDS, ClassVisitor)
		}
	}
}
