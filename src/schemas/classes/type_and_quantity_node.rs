...
pub struct TypeAndQuantityNode {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "amountOfThisGood"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/amountOfThisGood")
    )]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/amountOfThisGood"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
