...
impl MusicCompositionTrait for MusicComposition {
	fn get_composer(&self) -> &[ComposerProperty] {
	...
	fn get_first_performance(&self) -> &[FirstPerformanceProperty] {
		self.r#first_performance.as_slice()
	}
	fn take_first_performance(&mut self) -> Vec<FirstPerformanceProperty> {
		std::mem::take(&mut self.r#first_performance)
	}
	fn get_included_composition(&self) -> &[IncludedCompositionProperty] {
		self.r#included_composition.as_slice()
	}
	fn take_included_composition(&mut self) -> Vec<IncludedCompositionProperty> {
		std::mem::take(&mut self.r#included_composition)
	}
	fn get_iswc_code(&self) -> &[IswcCodeProperty] {
		self.r#iswc_code.as_slice()
	}
	fn take_iswc_code(&mut self) -> Vec<IswcCodeProperty> {
		std::mem::take(&mut self.r#iswc_code)
	}
	fn get_lyricist(&self) -> &[LyricistProperty] {
		self.r#lyricist.as_slice()
	}
	fn take_lyricist(&mut self) -> Vec<LyricistProperty> {
		std::mem::take(&mut self.r#lyricist)
	}
	fn get_lyrics(&self) -> &[LyricsProperty] {
		self.r#lyrics.as_slice()
	}
	fn take_lyrics(&mut self) -> Vec<LyricsProperty> {
		std::mem::take(&mut self.r#lyrics)
	}
	fn get_music_arrangement(&self) -> &[MusicArrangementProperty] {
		self.r#music_arrangement.as_slice()
	}
	fn take_music_arrangement(&mut self) -> Vec<MusicArrangementProperty> {
		std::mem::take(&mut self.r#music_arrangement)
	}
	fn get_music_composition_form(&self) -> &[MusicCompositionFormProperty] {
		self.r#music_composition_form.as_slice()
	}
	fn take_music_composition_form(&mut self) -> Vec<MusicCompositionFormProperty> {
		std::mem::take(&mut self.r#music_composition_form)
	}
	fn get_musical_key(&self) -> &[MusicalKeyProperty] {
		self.r#musical_key.as_slice()
	}
	fn take_musical_key(&mut self) -> Vec<MusicalKeyProperty> {
		std::mem::take(&mut self.r#musical_key)
	}
	fn get_recorded_as(&self) -> &[RecordedAsProperty] {
		self.r#recorded_as.as_slice()
	}
	fn take_recorded_as(&mut self) -> Vec<RecordedAsProperty> {
		std::mem::take(&mut self.r#recorded_as)
	}
}
impl CreativeWorkTrait for MusicComposition {
...
impl ThingTrait for MusicComposition {
...
mod serde {
	...
	use super::*;
	impl Serialize for MusicComposition {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#first_performance) as usize,
				!Vec::is_empty(&self.r#included_composition) as usize,
				!Vec::is_empty(&self.r#iswc_code) as usize,
				!Vec::is_empty(&self.r#lyricist) as usize,
				!Vec::is_empty(&self.r#lyrics) as usize,
				!Vec::is_empty(&self.r#music_arrangement) as usize,
				!Vec::is_empty(&self.r#music_composition_form) as usize,
				!Vec::is_empty(&self.r#musical_key) as usize,
				!Vec::is_empty(&self.r#recorded_as) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MusicComposition", len)?;
			...
			if !Vec::is_empty(&self.r#first_performance) {
				serialize_struct.serialize_field("firstPerformance", {
					struct SerializeWith<'a>(&'a Vec<FirstPerformanceProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#first_performance)
				})?;
			} else {
				serialize_struct.skip_field("firstPerformance")?;
			}
			if !Vec::is_empty(&self.r#included_composition) {
				serialize_struct.serialize_field("includedComposition", {
					struct SerializeWith<'a>(&'a Vec<IncludedCompositionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#included_composition)
				})?;
			} else {
				serialize_struct.skip_field("includedComposition")?;
			}
			if !Vec::is_empty(&self.r#iswc_code) {
				serialize_struct.serialize_field("iswcCode", {
					struct SerializeWith<'a>(&'a Vec<IswcCodeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#iswc_code)
				})?;
			} else {
				serialize_struct.skip_field("iswcCode")?;
			}
			if !Vec::is_empty(&self.r#lyricist) {
				serialize_struct.serialize_field("lyricist", {
					struct SerializeWith<'a>(&'a Vec<LyricistProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#lyricist)
				})?;
			} else {
				serialize_struct.skip_field("lyricist")?;
			}
			if !Vec::is_empty(&self.r#lyrics) {
				serialize_struct.serialize_field("lyrics", {
					struct SerializeWith<'a>(&'a Vec<LyricsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#lyrics)
				})?;
			} else {
				serialize_struct.skip_field("lyrics")?;
			}
			if !Vec::is_empty(&self.r#music_arrangement) {
				serialize_struct.serialize_field("musicArrangement", {
					struct SerializeWith<'a>(&'a Vec<MusicArrangementProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#music_arrangement)
				})?;
			} else {
				serialize_struct.skip_field("musicArrangement")?;
			}
			if !Vec::is_empty(&self.r#music_composition_form) {
				serialize_struct.serialize_field("musicCompositionForm", {
					struct SerializeWith<'a>(&'a Vec<MusicCompositionFormProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#music_composition_form)
				})?;
			} else {
				serialize_struct.skip_field("musicCompositionForm")?;
			}
			if !Vec::is_empty(&self.r#musical_key) {
				serialize_struct.serialize_field("musicalKey", {
					struct SerializeWith<'a>(&'a Vec<MusicalKeyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#musical_key)
				})?;
			} else {
				serialize_struct.skip_field("musicalKey")?;
			}
			if !Vec::is_empty(&self.r#recorded_as) {
				serialize_struct.serialize_field("recordedAs", {
					struct SerializeWith<'a>(&'a Vec<RecordedAsProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#recorded_as)
				})?;
			} else {
				serialize_struct.skip_field("recordedAs")?;
			}
	...
	impl<'de> Deserialize<'de> for MusicComposition {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"firstPerformance" => Ok(Field::FirstPerformance),
						"includedComposition" => Ok(Field::IncludedComposition),
						"iswcCode" => Ok(Field::IswcCode),
						"lyricist" => Ok(Field::Lyricist),
						"lyrics" => Ok(Field::Lyrics),
						"musicArrangement" => Ok(Field::MusicArrangement),
						"musicCompositionForm" => Ok(Field::MusicCompositionForm),
						"musicalKey" => Ok(Field::MusicalKey),
						"recordedAs" => Ok(Field::RecordedAs),
					...
					E: de::Error,
				{
					match value {
						...
						b"firstPerformance" => Ok(Field::FirstPerformance),
						b"includedComposition" => Ok(Field::IncludedComposition),
						b"iswcCode" => Ok(Field::IswcCode),
						b"lyricist" => Ok(Field::Lyricist),
						b"lyrics" => Ok(Field::Lyrics),
						b"musicArrangement" => Ok(Field::MusicArrangement),
						b"musicCompositionForm" => Ok(Field::MusicCompositionForm),
						b"musicalKey" => Ok(Field::MusicalKey),
						b"recordedAs" => Ok(Field::RecordedAs),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MusicComposition;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MusicComposition")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#first_performance_property = None;
					let mut r#included_composition_property = None;
					let mut r#iswc_code_property = None;
					let mut r#lyricist_property = None;
					let mut r#lyrics_property = None;
					let mut r#music_arrangement_property = None;
					let mut r#music_composition_form_property = None;
					let mut r#musical_key_property = None;
					let mut r#recorded_as_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::FirstPerformance => {
								if r#first_performance_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"firstPerformance",
									));
								}
								r#first_performance_property = Some({
									struct DeserializeWith(Vec<FirstPerformanceProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IncludedComposition => {
								if r#included_composition_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"includedComposition",
									));
								}
								r#included_composition_property = Some({
									struct DeserializeWith(Vec<IncludedCompositionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IswcCode => {
								if r#iswc_code_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"iswcCode",
									));
								}
								r#iswc_code_property = Some({
									struct DeserializeWith(Vec<IswcCodeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Lyricist => {
								if r#lyricist_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"lyricist",
									));
								}
								r#lyricist_property = Some({
									struct DeserializeWith(Vec<LyricistProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Lyrics => {
								if r#lyrics_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("lyrics"));
								}
								r#lyrics_property = Some({
									struct DeserializeWith(Vec<LyricsProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MusicArrangement => {
								if r#music_arrangement_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"musicArrangement",
									));
								}
								r#music_arrangement_property = Some({
									struct DeserializeWith(Vec<MusicArrangementProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MusicCompositionForm => {
								if r#music_composition_form_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"musicCompositionForm",
									));
								}
								r#music_composition_form_property = Some({
									struct DeserializeWith(Vec<MusicCompositionFormProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MusicalKey => {
								if r#musical_key_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"musicalKey",
									));
								}
								r#musical_key_property = Some({
									struct DeserializeWith(Vec<MusicalKeyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::RecordedAs => {
								if r#recorded_as_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"recordedAs",
									));
								}
								r#recorded_as_property = Some({
									struct DeserializeWith(Vec<RecordedAsProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(MusicComposition {
						...
						r#first_performance: r#first_performance_property.unwrap_or_default(),
						r#included_composition: r#included_composition_property.unwrap_or_default(),
						r#iswc_code: r#iswc_code_property.unwrap_or_default(),
						r#lyricist: r#lyricist_property.unwrap_or_default(),
						r#lyrics: r#lyrics_property.unwrap_or_default(),
						r#music_arrangement: r#music_arrangement_property.unwrap_or_default(),
						r#music_composition_form: r#music_composition_form_property
							.unwrap_or_default(),
						r#musical_key: r#musical_key_property.unwrap_or_default(),
						r#recorded_as: r#recorded_as_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("MusicComposition", FIELDS, ClassVisitor)
		}
	}
}
