...
pub struct ImageObject {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "exifData"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/exifData"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/exifData"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "representativeOfPage"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/representativeOfPage")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/representativeOfPage")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
