...
/// This trait is for properties from <https://schema.org/MedicalGuidelineRecommendation>.
pub trait MedicalGuidelineRecommendationTrait {
	/// Get <https://schema.org/recommendationStrength> from [`Self`] as borrowed slice.
	fn get_recommendation_strength(&self) -> &[RecommendationStrengthProperty];
	/// Take <https://schema.org/recommendationStrength> from [`Self`] as owned vector.
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalGuidelineRecommendation {
	...
	impl<'de> Deserialize<'de> for MedicalGuidelineRecommendation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalGuidelineRecommendation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalGuidelineRecommendation")
				}
			...
			deserializer.deserialize_struct("MedicalGuidelineRecommendation", FIELDS, ClassVisitor)
		}
	}
}
