...
pub struct LoseAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "winner"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/winner"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/winner"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
