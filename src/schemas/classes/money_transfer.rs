...
pub struct MoneyTransfer {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "beneficiaryBank"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/beneficiaryBank"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/beneficiaryBank"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
