...
/// This trait is for properties from <https://schema.org/OfficeEquipmentStore>.
pub trait OfficeEquipmentStoreTrait {}
impl OfficeEquipmentStoreTrait for OfficeEquipmentStore {}
impl LocalBusinessTrait for OfficeEquipmentStore {
...
impl StoreTrait for OfficeEquipmentStore {}
impl ThingTrait for OfficeEquipmentStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for OfficeEquipmentStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OfficeEquipmentStore", len)?;
	...
	impl<'de> Deserialize<'de> for OfficeEquipmentStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OfficeEquipmentStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OfficeEquipmentStore")
				}
			...
			deserializer.deserialize_struct("OfficeEquipmentStore", FIELDS, ClassVisitor)
		}
	}
}
