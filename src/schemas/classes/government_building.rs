...
/// This trait is for properties from <https://schema.org/GovernmentBuilding>.
pub trait GovernmentBuildingTrait {}
impl GovernmentBuildingTrait for GovernmentBuilding {}
impl CivicStructureTrait for GovernmentBuilding {
...
impl ThingTrait for GovernmentBuilding {
...
mod serde {
	...
	use super::*;
	impl Serialize for GovernmentBuilding {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GovernmentBuilding", len)?;
	...
	impl<'de> Deserialize<'de> for GovernmentBuilding {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GovernmentBuilding;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GovernmentBuilding")
				}
			...
			deserializer.deserialize_struct("GovernmentBuilding", FIELDS, ClassVisitor)
		}
	}
}
