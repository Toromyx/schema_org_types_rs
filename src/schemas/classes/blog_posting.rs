...
/// This trait is for properties from <https://schema.org/BlogPosting>.
pub trait BlogPostingTrait {}
...
mod serde {
	...
	use super::*;
	impl Serialize for BlogPosting {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BlogPosting", len)?;
	...
	impl<'de> Deserialize<'de> for BlogPosting {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BlogPosting")
				}
			...
			deserializer.deserialize_struct("BlogPosting", FIELDS, ClassVisitor)
		}
	}
}
