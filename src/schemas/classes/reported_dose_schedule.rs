...
/// This trait is for properties from <https://schema.org/ReportedDoseSchedule>.
pub trait ReportedDoseScheduleTrait {}
impl ReportedDoseScheduleTrait for ReportedDoseSchedule {}
impl DoseScheduleTrait for ReportedDoseSchedule {
...
impl MedicalEntityTrait for ReportedDoseSchedule {
...
impl MedicalIntangibleTrait for ReportedDoseSchedule {}
impl ThingTrait for ReportedDoseSchedule {
...
mod serde {
	...
	use super::*;
	impl Serialize for ReportedDoseSchedule {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ReportedDoseSchedule", len)?;
	...
	impl<'de> Deserialize<'de> for ReportedDoseSchedule {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ReportedDoseSchedule;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ReportedDoseSchedule")
				}
			...
			deserializer.deserialize_struct("ReportedDoseSchedule", FIELDS, ClassVisitor)
		}
	}
}
