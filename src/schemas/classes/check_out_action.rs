...
/// This trait is for properties from <https://schema.org/CheckOutAction>.
pub trait CheckOutActionTrait {}
impl CheckOutActionTrait for CheckOutAction {}
...
impl CommunicateActionTrait for CheckOutAction {
...
impl InteractActionTrait for CheckOutAction {}
impl ThingTrait for CheckOutAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CheckOutAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CheckOutAction", len)?;
	...
	impl<'de> Deserialize<'de> for CheckOutAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CheckOutAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CheckOutAction")
				}
			...
			deserializer.deserialize_struct("CheckOutAction", FIELDS, ClassVisitor)
		}
	}
}
