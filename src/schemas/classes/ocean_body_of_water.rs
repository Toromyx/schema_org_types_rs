...
/// This trait is for properties from <https://schema.org/OceanBodyOfWater>.
pub trait OceanBodyOfWaterTrait {}
impl OceanBodyOfWaterTrait for OceanBodyOfWater {}
impl BodyOfWaterTrait for OceanBodyOfWater {}
impl LandformTrait for OceanBodyOfWater {}
...
impl ThingTrait for OceanBodyOfWater {
...
mod serde {
	...
	use super::*;
	impl Serialize for OceanBodyOfWater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OceanBodyOfWater", len)?;
	...
	impl<'de> Deserialize<'de> for OceanBodyOfWater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OceanBodyOfWater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OceanBodyOfWater")
				}
			...
			deserializer.deserialize_struct("OceanBodyOfWater", FIELDS, ClassVisitor)
		}
	}
}
