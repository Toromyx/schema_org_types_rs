...
/// This trait is for properties from <https://schema.org/OrganizeAction>.
pub trait OrganizeActionTrait {}
impl OrganizeActionTrait for OrganizeAction {}
...
impl ThingTrait for OrganizeAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for OrganizeAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OrganizeAction", len)?;
	...
	impl<'de> Deserialize<'de> for OrganizeAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OrganizeAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OrganizeAction")
				}
			...
			deserializer.deserialize_struct("OrganizeAction", FIELDS, ClassVisitor)
		}
	}
}
