...
/// This trait is for properties from <https://schema.org/JewelryStore>.
pub trait JewelryStoreTrait {}
impl JewelryStoreTrait for JewelryStore {}
impl LocalBusinessTrait for JewelryStore {
...
impl StoreTrait for JewelryStore {}
impl ThingTrait for JewelryStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for JewelryStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "JewelryStore", len)?;
	...
	impl<'de> Deserialize<'de> for JewelryStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = JewelryStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema JewelryStore")
				}
			...
			deserializer.deserialize_struct("JewelryStore", FIELDS, ClassVisitor)
		}
	}
}
