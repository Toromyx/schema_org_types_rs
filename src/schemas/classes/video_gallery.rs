...
/// This trait is for properties from <https://schema.org/VideoGallery>.
pub trait VideoGalleryTrait {}
impl VideoGalleryTrait for VideoGallery {}
impl CollectionPageTrait for VideoGallery {}
impl CreativeWorkTrait for VideoGallery {
...
impl MediaGalleryTrait for VideoGallery {}
impl ThingTrait for VideoGallery {
...
impl WebPageTrait for VideoGallery {
...
mod serde {
	...
	use super::*;
	impl Serialize for VideoGallery {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "VideoGallery", len)?;
	...
	impl<'de> Deserialize<'de> for VideoGallery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = VideoGallery;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema VideoGallery")
				}
			...
			deserializer.deserialize_struct("VideoGallery", FIELDS, ClassVisitor)
		}
	}
}
