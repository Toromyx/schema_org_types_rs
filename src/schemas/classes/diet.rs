...
pub struct Diet {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "dietFeatures"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#diet_features: Vec<DietFeaturesProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "endorsers"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#endorsers: Vec<EndorsersProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "expertConsiderations"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#expert_considerations: Vec<ExpertConsiderationsProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "physiologicalBenefits"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#physiological_benefits: Vec<PhysiologicalBenefitsProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "risks"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#risks: Vec<RisksProperty>,
    #[cfg(any(
        any(
