...
impl MuscleTrait for Muscle {
	fn get_antagonist(&self) -> &[AntagonistProperty] {
		self.r#antagonist.as_slice()
	}
	fn take_antagonist(&mut self) -> Vec<AntagonistProperty> {
		std::mem::take(&mut self.r#antagonist)
	}
	fn get_blood_supply(&self) -> &[BloodSupplyProperty] {
		self.r#blood_supply.as_slice()
	}
	fn take_blood_supply(&mut self) -> Vec<BloodSupplyProperty> {
		std::mem::take(&mut self.r#blood_supply)
	}
	fn get_insertion(&self) -> &[InsertionProperty] {
		self.r#insertion.as_slice()
	}
	fn take_insertion(&mut self) -> Vec<InsertionProperty> {
		std::mem::take(&mut self.r#insertion)
	}
	fn get_muscle_action(&self) -> &[MuscleActionProperty] {
		self.r#muscle_action.as_slice()
	}
	fn take_muscle_action(&mut self) -> Vec<MuscleActionProperty> {
		std::mem::take(&mut self.r#muscle_action)
	}
	fn get_nerve(&self) -> &[NerveProperty] {
		self.r#nerve.as_slice()
	}
	fn take_nerve(&mut self) -> Vec<NerveProperty> {
		std::mem::take(&mut self.r#nerve)
	}
}
impl AnatomicalStructureTrait for Muscle {
...
impl MedicalEntityTrait for Muscle {
...
mod serde {
	...
	use super::*;
	impl Serialize for Muscle {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#antagonist) as usize,
				!Vec::is_empty(&self.r#blood_supply) as usize,
				!Vec::is_empty(&self.r#insertion) as usize,
				!Vec::is_empty(&self.r#muscle_action) as usize,
				!Vec::is_empty(&self.r#nerve) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Muscle", len)?;
			if !Vec::is_empty(&self.r#antagonist) {
				serialize_struct.serialize_field("antagonist", {
					struct SerializeWith<'a>(&'a Vec<AntagonistProperty>);
					...
					&SerializeWith(&self.r#antagonist)
				})?;
			} else {
				serialize_struct.skip_field("antagonist")?;
			}
			if !Vec::is_empty(&self.r#blood_supply) {
				serialize_struct.serialize_field("bloodSupply", {
					struct SerializeWith<'a>(&'a Vec<BloodSupplyProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#blood_supply)
				})?;
			} else {
				serialize_struct.skip_field("bloodSupply")?;
			}
			if !Vec::is_empty(&self.r#insertion) {
				serialize_struct.serialize_field("insertion", {
					struct SerializeWith<'a>(&'a Vec<InsertionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#insertion)
				})?;
			} else {
				serialize_struct.skip_field("insertion")?;
			}
			if !Vec::is_empty(&self.r#muscle_action) {
				serialize_struct.serialize_field("muscleAction", {
					struct SerializeWith<'a>(&'a Vec<MuscleActionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#muscle_action)
				})?;
			} else {
				serialize_struct.skip_field("muscleAction")?;
			}
			if !Vec::is_empty(&self.r#nerve) {
				serialize_struct.serialize_field("nerve", {
					struct SerializeWith<'a>(&'a Vec<NerveProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#nerve)
				})?;
			} else {
				serialize_struct.skip_field("nerve")?;
			}
	...
	impl<'de> Deserialize<'de> for Muscle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"antagonist" => Ok(Field::Antagonist),
						"bloodSupply" => Ok(Field::BloodSupply),
						"insertion" => Ok(Field::Insertion),
						"muscleAction" => Ok(Field::MuscleAction),
						"nerve" => Ok(Field::Nerve),
				...
				{
					match value {
						b"antagonist" => Ok(Field::Antagonist),
						b"bloodSupply" => Ok(Field::BloodSupply),
						b"insertion" => Ok(Field::Insertion),
						b"muscleAction" => Ok(Field::MuscleAction),
						b"nerve" => Ok(Field::Nerve),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Muscle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Muscle")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#antagonist_property = None;
					let mut r#blood_supply_property = None;
					let mut r#insertion_property = None;
					let mut r#muscle_action_property = None;
					let mut r#nerve_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Antagonist => {
								if r#antagonist_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"antagonist",
									));
								}
								r#antagonist_property = Some({
									struct DeserializeWith(Vec<AntagonistProperty>);
							...
							Field::BloodSupply => {
								if r#blood_supply_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"bloodSupply",
									));
								}
								r#blood_supply_property = Some({
									struct DeserializeWith(Vec<BloodSupplyProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Insertion => {
								if r#insertion_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"insertion",
									));
								}
								r#insertion_property = Some({
									struct DeserializeWith(Vec<InsertionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::MuscleAction => {
								if r#muscle_action_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"muscleAction",
									));
								}
								r#muscle_action_property = Some({
									struct DeserializeWith(Vec<MuscleActionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Nerve => {
								if r#nerve_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field("nerve"));
								}
								r#nerve_property = Some({
									struct DeserializeWith(Vec<NerveProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(Muscle {
						r#antagonist: r#antagonist_property.unwrap_or_default(),
						r#blood_supply: r#blood_supply_property.unwrap_or_default(),
						r#insertion: r#insertion_property.unwrap_or_default(),
						r#muscle_action: r#muscle_action_property.unwrap_or_default(),
						r#nerve: r#nerve_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("Muscle", FIELDS, ClassVisitor)
		}
	}
}
