...
/// This trait is for properties from <https://schema.org/CompleteDataFeed>.
pub trait CompleteDataFeedTrait {}
impl CompleteDataFeedTrait for CompleteDataFeed {}
impl CreativeWorkTrait for CompleteDataFeed {
...
impl DataFeedTrait for CompleteDataFeed {
	fn get_data_feed_element(&self) -> &[DataFeedElementProperty] {
		self.r#data_feed_element.as_slice()
	}
	fn take_data_feed_element(&mut self) -> Vec<DataFeedElementProperty> {
		std::mem::take(&mut self.r#data_feed_element)
	}
}
impl DatasetTrait for CompleteDataFeed {
	fn get_catalog(&self) -> &[CatalogProperty] {
		self.r#catalog.as_slice()
	}
	fn take_catalog(&mut self) -> Vec<CatalogProperty> {
		std::mem::take(&mut self.r#catalog)
	}
	fn get_dataset_time_interval(&self) -> &[DatasetTimeIntervalProperty] {
		self.r#dataset_time_interval.as_slice()
	}
	fn take_dataset_time_interval(&mut self) -> Vec<DatasetTimeIntervalProperty> {
		std::mem::take(&mut self.r#dataset_time_interval)
	}
	fn get_distribution(&self) -> &[DistributionProperty] {
		self.r#distribution.as_slice()
	}
	fn take_distribution(&mut self) -> Vec<DistributionProperty> {
		std::mem::take(&mut self.r#distribution)
	}
	fn get_included_data_catalog(&self) -> &[IncludedDataCatalogProperty] {
		self.r#included_data_catalog.as_slice()
	}
	fn take_included_data_catalog(&mut self) -> Vec<IncludedDataCatalogProperty> {
		std::mem::take(&mut self.r#included_data_catalog)
	}
	fn get_included_in_data_catalog(&self) -> &[IncludedInDataCatalogProperty] {
		self.r#included_in_data_catalog.as_slice()
	}
	fn take_included_in_data_catalog(&mut self) -> Vec<IncludedInDataCatalogProperty> {
		std::mem::take(&mut self.r#included_in_data_catalog)
	}
	...
	fn get_variables_measured(&self) -> &[VariablesMeasuredProperty] {
		self.r#variables_measured.as_slice()
	}
	fn take_variables_measured(&mut self) -> Vec<VariablesMeasuredProperty> {
		std::mem::take(&mut self.r#variables_measured)
	}
}
impl ThingTrait for CompleteDataFeed {
...
mod serde {
	...
	use super::*;
	impl Serialize for CompleteDataFeed {
			...
			S: Serializer,
		{
			let len: usize = [
				...
				!Vec::is_empty(&self.r#data_feed_element) as usize,
				!Vec::is_empty(&self.r#catalog) as usize,
				!Vec::is_empty(&self.r#dataset_time_interval) as usize,
				!Vec::is_empty(&self.r#distribution) as usize,
				!Vec::is_empty(&self.r#included_data_catalog) as usize,
				!Vec::is_empty(&self.r#included_in_data_catalog) as usize,
				...
				!Vec::is_empty(&self.r#variables_measured) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CompleteDataFeed", len)?;
			...
			if !Vec::is_empty(&self.r#data_feed_element) {
				serialize_struct.serialize_field("dataFeedElement", {
					struct SerializeWith<'a>(&'a Vec<DataFeedElementProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#data_feed_element)
				})?;
			} else {
				serialize_struct.skip_field("dataFeedElement")?;
			}
			if !Vec::is_empty(&self.r#catalog) {
				serialize_struct.serialize_field("catalog", {
					struct SerializeWith<'a>(&'a Vec<CatalogProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#catalog)
				})?;
			} else {
				serialize_struct.skip_field("catalog")?;
			}
			if !Vec::is_empty(&self.r#dataset_time_interval) {
				serialize_struct.serialize_field("datasetTimeInterval", {
					struct SerializeWith<'a>(&'a Vec<DatasetTimeIntervalProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#dataset_time_interval)
				})?;
			} else {
				serialize_struct.skip_field("datasetTimeInterval")?;
			}
			if !Vec::is_empty(&self.r#distribution) {
				serialize_struct.serialize_field("distribution", {
					struct SerializeWith<'a>(&'a Vec<DistributionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#distribution)
				})?;
			} else {
				serialize_struct.skip_field("distribution")?;
			}
			if !Vec::is_empty(&self.r#included_data_catalog) {
				serialize_struct.serialize_field("includedDataCatalog", {
					struct SerializeWith<'a>(&'a Vec<IncludedDataCatalogProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#included_data_catalog)
				})?;
			} else {
				serialize_struct.skip_field("includedDataCatalog")?;
			}
			if !Vec::is_empty(&self.r#included_in_data_catalog) {
				serialize_struct.serialize_field("includedInDataCatalog", {
					struct SerializeWith<'a>(&'a Vec<IncludedInDataCatalogProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#included_in_data_catalog)
				})?;
			} else {
				serialize_struct.skip_field("includedInDataCatalog")?;
			}
			...
			if !Vec::is_empty(&self.r#variables_measured) {
				serialize_struct.serialize_field("variablesMeasured", {
					struct SerializeWith<'a>(&'a Vec<VariablesMeasuredProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#variables_measured)
				})?;
			} else {
				serialize_struct.skip_field("variablesMeasured")?;
			}
	...
	impl<'de> Deserialize<'de> for CompleteDataFeed {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"dataFeedElement" => Ok(Field::DataFeedElement),
						"catalog" => Ok(Field::Catalog),
						"datasetTimeInterval" => Ok(Field::DatasetTimeInterval),
						"distribution" => Ok(Field::Distribution),
						"includedDataCatalog" => Ok(Field::IncludedDataCatalog),
						"includedInDataCatalog" => Ok(Field::IncludedInDataCatalog),
						"issn" => Ok(Field::Issn),
						...
						"variablesMeasured" => Ok(Field::VariablesMeasured),
					...
					E: de::Error,
				{
					match value {
						...
						b"dataFeedElement" => Ok(Field::DataFeedElement),
						b"catalog" => Ok(Field::Catalog),
						b"datasetTimeInterval" => Ok(Field::DatasetTimeInterval),
						b"distribution" => Ok(Field::Distribution),
						b"includedDataCatalog" => Ok(Field::IncludedDataCatalog),
						b"includedInDataCatalog" => Ok(Field::IncludedInDataCatalog),
						...
						b"variablesMeasured" => Ok(Field::VariablesMeasured),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CompleteDataFeed;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CompleteDataFeed")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					let mut r#data_feed_element_property = None;
					let mut r#catalog_property = None;
					let mut r#dataset_time_interval_property = None;
					let mut r#distribution_property = None;
					let mut r#included_data_catalog_property = None;
					let mut r#included_in_data_catalog_property = None;
					...
					let mut r#variables_measured_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::DataFeedElement => {
								if r#data_feed_element_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dataFeedElement",
									));
								}
								r#data_feed_element_property = Some({
									struct DeserializeWith(Vec<DataFeedElementProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Catalog => {
								if r#catalog_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"catalog",
									));
								}
								r#catalog_property = Some({
									struct DeserializeWith(Vec<CatalogProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::DatasetTimeInterval => {
								if r#dataset_time_interval_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"datasetTimeInterval",
									));
								}
								r#dataset_time_interval_property = Some({
									struct DeserializeWith(Vec<DatasetTimeIntervalProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Distribution => {
								if r#distribution_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"distribution",
									));
								}
								r#distribution_property = Some({
									struct DeserializeWith(Vec<DistributionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IncludedDataCatalog => {
								if r#included_data_catalog_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"includedDataCatalog",
									));
								}
								r#included_data_catalog_property = Some({
									struct DeserializeWith(Vec<IncludedDataCatalogProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::IncludedInDataCatalog => {
								if r#included_in_data_catalog_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"includedInDataCatalog",
									));
								}
								r#included_in_data_catalog_property = Some({
									struct DeserializeWith(Vec<IncludedInDataCatalogProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::VariablesMeasured => {
								if r#variables_measured_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"variablesMeasured",
									));
								}
								r#variables_measured_property = Some({
									struct DeserializeWith(Vec<VariablesMeasuredProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(CompleteDataFeed {
						...
						r#data_feed_element: r#data_feed_element_property.unwrap_or_default(),
						r#catalog: r#catalog_property.unwrap_or_default(),
						r#dataset_time_interval: r#dataset_time_interval_property
							.unwrap_or_default(),
						r#distribution: r#distribution_property.unwrap_or_default(),
						r#included_data_catalog: r#included_data_catalog_property
							.unwrap_or_default(),
						r#included_in_data_catalog: r#included_in_data_catalog_property
							.unwrap_or_default(),
						...
						r#variables_measured: r#variables_measured_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("CompleteDataFeed", FIELDS, ClassVisitor)
		}
	}
}
