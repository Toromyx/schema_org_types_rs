...
impl CreativeWorkSeasonTrait for CreativeWorkSeason {
	fn get_actor(&self) -> &[ActorProperty] {
...
impl CreativeWorkTrait for CreativeWorkSeason {
...
impl ThingTrait for CreativeWorkSeason {
...
mod serde {
	...
	use super::*;
	impl Serialize for CreativeWorkSeason {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CreativeWorkSeason", len)?;
	...
	impl<'de> Deserialize<'de> for CreativeWorkSeason {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CreativeWorkSeason;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CreativeWorkSeason")
				}
			...
			deserializer.deserialize_struct("CreativeWorkSeason", FIELDS, ClassVisitor)
		}
	}
}
