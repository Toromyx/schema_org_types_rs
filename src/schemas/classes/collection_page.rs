...
/// This trait is for properties from <https://schema.org/CollectionPage>.
pub trait CollectionPageTrait {}
impl CollectionPageTrait for CollectionPage {}
impl CreativeWorkTrait for CollectionPage {
...
impl ThingTrait for CollectionPage {
...
impl WebPageTrait for CollectionPage {
...
mod serde {
	...
	impl Serialize for CollectionPage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CollectionPage", len)?;
	...
	impl<'de> Deserialize<'de> for CollectionPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CollectionPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CollectionPage")
				}
			...
			deserializer.deserialize_struct("CollectionPage", FIELDS, ClassVisitor)
		}
	}
}
