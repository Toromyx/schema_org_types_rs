...
/// This trait is for properties from <https://schema.org/AnalysisNewsArticle>.
pub trait AnalysisNewsArticleTrait {}
impl AnalysisNewsArticleTrait for AnalysisNewsArticle {}
impl ArticleTrait for AnalysisNewsArticle {
...
impl CreativeWorkTrait for AnalysisNewsArticle {
...
impl NewsArticleTrait for AnalysisNewsArticle {
...
impl ThingTrait for AnalysisNewsArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for AnalysisNewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AnalysisNewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for AnalysisNewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AnalysisNewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AnalysisNewsArticle")
				}
			...
			deserializer.deserialize_struct("AnalysisNewsArticle", FIELDS, ClassVisitor)
		}
	}
}
