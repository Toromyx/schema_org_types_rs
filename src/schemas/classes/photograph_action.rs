...
/// This trait is for properties from <https://schema.org/PhotographAction>.
pub trait PhotographActionTrait {}
impl PhotographActionTrait for PhotographAction {}
...
impl CreateActionTrait for PhotographAction {}
impl ThingTrait for PhotographAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for PhotographAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PhotographAction", len)?;
	...
	impl<'de> Deserialize<'de> for PhotographAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PhotographAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PhotographAction")
				}
			...
			deserializer.deserialize_struct("PhotographAction", FIELDS, ClassVisitor)
		}
	}
}
