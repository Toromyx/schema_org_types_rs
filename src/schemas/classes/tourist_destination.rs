...
pub struct TouristDestination {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "includesAttraction"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/includesAttraction")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/includesAttraction")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "touristType"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/touristType"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/touristType"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
