...
pub struct TouristDestination {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "includesAttraction"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#includes_attraction: Vec<IncludesAttractionProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "touristType"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#tourist_type: Vec<TouristTypeProperty>,
    #[cfg(any(
