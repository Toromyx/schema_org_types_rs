...
/// This trait is for properties from <https://schema.org/TheaterEvent>.
pub trait TheaterEventTrait {}
impl TheaterEventTrait for TheaterEvent {}
impl EventTrait for TheaterEvent {
...
impl ThingTrait for TheaterEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for TheaterEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TheaterEvent", len)?;
	...
	impl<'de> Deserialize<'de> for TheaterEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TheaterEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TheaterEvent")
				}
			...
			deserializer.deserialize_struct("TheaterEvent", FIELDS, ClassVisitor)
		}
	}
}
