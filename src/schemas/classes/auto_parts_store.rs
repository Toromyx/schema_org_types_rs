...
/// This trait is for properties from <https://schema.org/AutoPartsStore>.
pub trait AutoPartsStoreTrait {}
impl AutoPartsStoreTrait for AutoPartsStore {}
impl AutomotiveBusinessTrait for AutoPartsStore {}
impl LocalBusinessTrait for AutoPartsStore {
...
impl StoreTrait for AutoPartsStore {}
impl ThingTrait for AutoPartsStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for AutoPartsStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AutoPartsStore", len)?;
	...
	impl<'de> Deserialize<'de> for AutoPartsStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AutoPartsStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AutoPartsStore")
				}
			...
			deserializer.deserialize_struct("AutoPartsStore", FIELDS, ClassVisitor)
		}
	}
}
