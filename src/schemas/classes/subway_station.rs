...
/// This trait is for properties from <https://schema.org/SubwayStation>.
pub trait SubwayStationTrait {}
impl SubwayStationTrait for SubwayStation {}
impl CivicStructureTrait for SubwayStation {
...
impl ThingTrait for SubwayStation {
...
mod serde {
	...
	use super::*;
	impl Serialize for SubwayStation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SubwayStation", len)?;
	...
	impl<'de> Deserialize<'de> for SubwayStation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SubwayStation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SubwayStation")
				}
			...
			deserializer.deserialize_struct("SubwayStation", FIELDS, ClassVisitor)
		}
	}
}
