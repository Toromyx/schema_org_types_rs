...
pub struct RsvpAction {
	...
	pub r#additional_number_of_guests: Vec<AdditionalNumberOfGuestsProperty>,
	/// <https://schema.org/comment>
	pub r#comment: Vec<CommentProperty>,
	/// <https://schema.org/rsvpResponse>
	pub r#rsvp_response: Vec<RsvpResponseProperty>,
...
pub trait RsvpActionTrait {
	/// Get <https://schema.org/additionalNumberOfGuests> from [`Self`] as borrowed slice.
	fn get_additional_number_of_guests(&self) -> &[AdditionalNumberOfGuestsProperty];
	/// Take <https://schema.org/additionalNumberOfGuests> from [`Self`] as owned vector.
	...
	/// Get <https://schema.org/rsvpResponse> from [`Self`] as borrowed slice.
	fn get_rsvp_response(&self) -> &[RsvpResponseProperty];
	/// Take <https://schema.org/rsvpResponse> from [`Self`] as owned vector.
	fn take_rsvp_response(&mut self) -> Vec<RsvpResponseProperty>;
}
impl RsvpActionTrait for RsvpAction {
	fn get_additional_number_of_guests(&self) -> &[AdditionalNumberOfGuestsProperty] {
		self.r#additional_number_of_guests.as_slice()
	}
	fn take_additional_number_of_guests(&mut self) -> Vec<AdditionalNumberOfGuestsProperty> {
		std::mem::take(&mut self.r#additional_number_of_guests)
	}
	fn get_comment(&self) -> &[CommentProperty] {
	...
	fn get_rsvp_response(&self) -> &[RsvpResponseProperty] {
		self.r#rsvp_response.as_slice()
	}
	fn take_rsvp_response(&mut self) -> Vec<RsvpResponseProperty> {
		std::mem::take(&mut self.r#rsvp_response)
	}
}
...
impl CommunicateActionTrait for RsvpAction {
	...
	fn get_language(&self) -> &[LanguageProperty] {
		self.r#language.as_slice()
	}
	fn take_language(&mut self) -> Vec<LanguageProperty> {
		std::mem::take(&mut self.r#language)
	}
...
impl InformActionTrait for RsvpAction {
...
impl InteractActionTrait for RsvpAction {}
impl ThingTrait for RsvpAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for RsvpAction {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#additional_number_of_guests) as usize,
				!Vec::is_empty(&self.r#comment) as usize,
				!Vec::is_empty(&self.r#rsvp_response) as usize,
				...
				!Vec::is_empty(&self.r#language) as usize,
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "RsvpAction", len)?;
			if !Vec::is_empty(&self.r#additional_number_of_guests) {
				serialize_struct.serialize_field("additionalNumberOfGuests", {
					struct SerializeWith<'a>(&'a Vec<AdditionalNumberOfGuestsProperty>);
					...
					&SerializeWith(&self.r#additional_number_of_guests)
				})?;
			} else {
				serialize_struct.skip_field("additionalNumberOfGuests")?;
			}
			...
			if !Vec::is_empty(&self.r#rsvp_response) {
				serialize_struct.serialize_field("rsvpResponse", {
					struct SerializeWith<'a>(&'a Vec<RsvpResponseProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#rsvp_response)
				})?;
			} else {
				serialize_struct.skip_field("rsvpResponse")?;
			}
			...
			if !Vec::is_empty(&self.r#language) {
				serialize_struct.serialize_field("language", {
					struct SerializeWith<'a>(&'a Vec<LanguageProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#language)
				})?;
			} else {
				serialize_struct.skip_field("language")?;
			}
	...
	impl<'de> Deserialize<'de> for RsvpAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"additionalNumberOfGuests" => Ok(Field::AdditionalNumberOfGuests),
						"comment" => Ok(Field::Comment),
						"rsvpResponse" => Ok(Field::RsvpResponse),
				...
				{
					match value {
						b"additionalNumberOfGuests" => Ok(Field::AdditionalNumberOfGuests),
						b"comment" => Ok(Field::Comment),
						b"rsvpResponse" => Ok(Field::RsvpResponse),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RsvpAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RsvpAction")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#additional_number_of_guests_property = None;
					let mut r#comment_property = None;
					let mut r#rsvp_response_property = None;
					...
					let mut r#language_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::AdditionalNumberOfGuests => {
								if r#additional_number_of_guests_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"additionalNumberOfGuests",
									));
								}
								r#additional_number_of_guests_property = Some({
									struct DeserializeWith(Vec<AdditionalNumberOfGuestsProperty>);
							...
							Field::RsvpResponse => {
								if r#rsvp_response_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"rsvpResponse",
									));
								}
								r#rsvp_response_property = Some({
									struct DeserializeWith(Vec<RsvpResponseProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Language => {
								if r#language_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"language",
									));
								}
								r#language_property = Some({
									struct DeserializeWith(Vec<LanguageProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(RsvpAction {
						r#additional_number_of_guests: r#additional_number_of_guests_property
							.unwrap_or_default(),
						r#comment: r#comment_property.unwrap_or_default(),
						r#rsvp_response: r#rsvp_response_property.unwrap_or_default(),
						...
						r#language: r#language_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("RsvpAction", FIELDS, ClassVisitor)
		}
	}
}
