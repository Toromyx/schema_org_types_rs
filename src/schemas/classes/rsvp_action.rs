...
pub struct RsvpAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "additionalNumberOfGuests"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/additionalNumberOfGuests")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/additionalNumberOfGuests")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "rsvpResponse"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/rsvpResponse"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/rsvpResponse"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
