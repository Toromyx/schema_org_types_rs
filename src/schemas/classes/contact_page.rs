...
/// This trait is for properties from <https://schema.org/ContactPage>.
pub trait ContactPageTrait {}
impl ContactPageTrait for ContactPage {}
impl CreativeWorkTrait for ContactPage {
...
impl ThingTrait for ContactPage {
...
impl WebPageTrait for ContactPage {
...
mod serde {
	...
	use super::*;
	impl Serialize for ContactPage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ContactPage", len)?;
	...
	impl<'de> Deserialize<'de> for ContactPage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ContactPage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ContactPage")
				}
			...
			deserializer.deserialize_struct("ContactPage", FIELDS, ClassVisitor)
		}
	}
}
