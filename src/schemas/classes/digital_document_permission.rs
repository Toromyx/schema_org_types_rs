...
pub struct DigitalDocumentPermission {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "grantee"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/grantee"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/grantee"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "permissionType"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/permissionType"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/permissionType"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
