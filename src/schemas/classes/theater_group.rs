...
/// This trait is for properties from <https://schema.org/TheaterGroup>.
pub trait TheaterGroupTrait {}
impl TheaterGroupTrait for TheaterGroup {}
...
impl PerformingGroupTrait for TheaterGroup {}
impl ThingTrait for TheaterGroup {
...
mod serde {
	...
	use super::*;
	impl Serialize for TheaterGroup {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "TheaterGroup", len)?;
	...
	impl<'de> Deserialize<'de> for TheaterGroup {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TheaterGroup;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TheaterGroup")
				}
			...
			deserializer.deserialize_struct("TheaterGroup", FIELDS, ClassVisitor)
		}
	}
}
