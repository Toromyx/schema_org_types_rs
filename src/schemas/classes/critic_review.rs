...
/// This trait is for properties from <https://schema.org/CriticReview>.
pub trait CriticReviewTrait {}
impl CriticReviewTrait for CriticReview {}
impl CreativeWorkTrait for CriticReview {
...
impl ReviewTrait for CriticReview {
...
impl ThingTrait for CriticReview {
...
mod serde {
	...
	use super::*;
	impl Serialize for CriticReview {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CriticReview", len)?;
	...
	impl<'de> Deserialize<'de> for CriticReview {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CriticReview;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CriticReview")
				}
			...
			deserializer.deserialize_struct("CriticReview", FIELDS, ClassVisitor)
		}
	}
}
