...
pub struct ReviewAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "resultReview"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/resultReview"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/resultReview"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
