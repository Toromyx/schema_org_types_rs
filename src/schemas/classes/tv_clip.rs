...
pub struct TvClip {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "clipNumber"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#clip_number: Vec<ClipNumberProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "endOffset"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#end_offset: Vec<EndOffsetProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "partOfEpisode"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#part_of_episode: Vec<PartOfEpisodeProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "partOfSeason"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "partOfSeries"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "partOfTVSeries"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#part_of_tv_series: Vec<PartOfTvSeriesProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "startOffset"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#start_offset: Vec<StartOffsetProperty>,
    #[cfg(any(
        any(
