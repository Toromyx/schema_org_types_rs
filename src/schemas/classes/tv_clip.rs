...
impl ClipTrait for TvClip {
	...
	fn get_clip_number(&self) -> &[ClipNumberProperty] {
		self.r#clip_number.as_slice()
	}
	fn take_clip_number(&mut self) -> Vec<ClipNumberProperty> {
		std::mem::take(&mut self.r#clip_number)
	}
	...
	fn get_end_offset(&self) -> &[EndOffsetProperty] {
		self.r#end_offset.as_slice()
	}
	fn take_end_offset(&mut self) -> Vec<EndOffsetProperty> {
		std::mem::take(&mut self.r#end_offset)
	}
	...
	fn get_part_of_episode(&self) -> &[PartOfEpisodeProperty] {
		self.r#part_of_episode.as_slice()
	}
	fn take_part_of_episode(&mut self) -> Vec<PartOfEpisodeProperty> {
		std::mem::take(&mut self.r#part_of_episode)
	}
	...
	fn get_start_offset(&self) -> &[StartOffsetProperty] {
		self.r#start_offset.as_slice()
	}
	fn take_start_offset(&mut self) -> Vec<StartOffsetProperty> {
		std::mem::take(&mut self.r#start_offset)
	}
}
impl CreativeWorkTrait for TvClip {
...
mod serde {
	...
	impl Serialize for TvClip {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "TvClip", len)?;
			...
			if !Vec::is_empty(&self.r#clip_number) {
				serialize_struct.serialize_field("clipNumber", {
					struct SerializeWith<'a>(&'a Vec<ClipNumberProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#clip_number)
				})?;
			} else {
				serialize_struct.skip_field("clipNumber")?;
			}
			...
			if !Vec::is_empty(&self.r#end_offset) {
				serialize_struct.serialize_field("endOffset", {
					struct SerializeWith<'a>(&'a Vec<EndOffsetProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#end_offset)
				})?;
			} else {
				serialize_struct.skip_field("endOffset")?;
			}
			...
			if !Vec::is_empty(&self.r#part_of_episode) {
				serialize_struct.serialize_field("partOfEpisode", {
					struct SerializeWith<'a>(&'a Vec<PartOfEpisodeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#part_of_episode)
				})?;
			} else {
				serialize_struct.skip_field("partOfEpisode")?;
			}
			...
			if !Vec::is_empty(&self.r#start_offset) {
				serialize_struct.serialize_field("startOffset", {
					struct SerializeWith<'a>(&'a Vec<StartOffsetProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#start_offset)
				})?;
			} else {
				serialize_struct.skip_field("startOffset")?;
			}
	...
	impl<'de> Deserialize<'de> for TvClip {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = TvClip;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema TVClip")
				}
					...
					A: de::MapAccess<'de>,
				{
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							...
							Field::ClipNumber => {
								if r#clip_number_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"clipNumber",
									));
								}
								r#clip_number_property = Some({
									struct DeserializeWith(Vec<ClipNumberProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::EndOffset => {
								if r#end_offset_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"endOffset",
									));
								}
								r#end_offset_property = Some({
									struct DeserializeWith(Vec<EndOffsetProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::PartOfEpisode => {
								if r#part_of_episode_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"partOfEpisode",
									));
								}
								r#part_of_episode_property = Some({
									struct DeserializeWith(Vec<PartOfEpisodeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::StartOffset => {
								if r#start_offset_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"startOffset",
									));
								}
								r#start_offset_property = Some({
									struct DeserializeWith(Vec<StartOffsetProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
			...
			deserializer.deserialize_struct("TvClip", FIELDS, ClassVisitor)
		}
	}
}
