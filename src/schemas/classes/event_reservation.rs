...
/// This trait is for properties from <https://schema.org/EventReservation>.
pub trait EventReservationTrait {}
impl EventReservationTrait for EventReservation {}
impl ReservationTrait for EventReservation {
...
impl ThingTrait for EventReservation {
...
mod serde {
	...
	use super::*;
	impl Serialize for EventReservation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "EventReservation", len)?;
	...
	impl<'de> Deserialize<'de> for EventReservation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EventReservation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EventReservation")
				}
			...
			deserializer.deserialize_struct("EventReservation", FIELDS, ClassVisitor)
		}
	}
}
