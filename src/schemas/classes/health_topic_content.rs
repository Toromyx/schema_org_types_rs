...
pub struct HealthTopicContent {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "hasHealthAspect"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/hasHealthAspect"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/hasHealthAspect"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
