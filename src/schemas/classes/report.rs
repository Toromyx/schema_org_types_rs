...
pub struct Report {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "reportNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/reportNumber"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/reportNumber"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
