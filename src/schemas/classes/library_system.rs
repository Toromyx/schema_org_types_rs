...
/// This trait is for properties from <https://schema.org/LibrarySystem>.
pub trait LibrarySystemTrait {}
impl LibrarySystemTrait for LibrarySystem {}
...
impl ThingTrait for LibrarySystem {
...
mod serde {
	...
	use super::*;
	impl Serialize for LibrarySystem {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LibrarySystem", len)?;
	...
	impl<'de> Deserialize<'de> for LibrarySystem {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LibrarySystem;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LibrarySystem")
				}
			...
			deserializer.deserialize_struct("LibrarySystem", FIELDS, ClassVisitor)
		}
	}
}
