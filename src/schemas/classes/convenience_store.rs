...
/// This trait is for properties from <https://schema.org/ConvenienceStore>.
pub trait ConvenienceStoreTrait {}
impl ConvenienceStoreTrait for ConvenienceStore {}
impl LocalBusinessTrait for ConvenienceStore {
...
impl StoreTrait for ConvenienceStore {}
impl ThingTrait for ConvenienceStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for ConvenienceStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ConvenienceStore", len)?;
	...
	impl<'de> Deserialize<'de> for ConvenienceStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ConvenienceStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ConvenienceStore")
				}
			...
			deserializer.deserialize_struct("ConvenienceStore", FIELDS, ClassVisitor)
		}
	}
}
