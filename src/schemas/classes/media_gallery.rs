...
/// This trait is for properties from <https://schema.org/MediaGallery>.
pub trait MediaGalleryTrait {}
impl MediaGalleryTrait for MediaGallery {}
impl CollectionPageTrait for MediaGallery {}
impl CreativeWorkTrait for MediaGallery {
...
impl ThingTrait for MediaGallery {
...
impl WebPageTrait for MediaGallery {
	...
	impl Serialize for MediaGallery {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MediaGallery", len)?;
	...
	impl<'de> Deserialize<'de> for MediaGallery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MediaGallery;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MediaGallery")
				}
			...
			deserializer.deserialize_struct("MediaGallery", FIELDS, ClassVisitor)
		}
	}
}
