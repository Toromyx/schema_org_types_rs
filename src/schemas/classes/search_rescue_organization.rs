...
/// This trait is for properties from <https://schema.org/SearchRescueOrganization>.
pub trait SearchRescueOrganizationTrait {}
impl SearchRescueOrganizationTrait for SearchRescueOrganization {}
...
impl ThingTrait for SearchRescueOrganization {
...
mod serde {
	...
	use super::*;
	impl Serialize for SearchRescueOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SearchRescueOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for SearchRescueOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SearchRescueOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SearchRescueOrganization")
				}
			...
			deserializer.deserialize_struct("SearchRescueOrganization", FIELDS, ClassVisitor)
		}
	}
}
