...
/// This trait is for properties from <https://schema.org/SchoolDistrict>.
pub trait SchoolDistrictTrait {}
impl SchoolDistrictTrait for SchoolDistrict {}
impl AdministrativeAreaTrait for SchoolDistrict {}
...
impl ThingTrait for SchoolDistrict {
...
mod serde {
	...
	use super::*;
	impl Serialize for SchoolDistrict {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SchoolDistrict", len)?;
	...
	impl<'de> Deserialize<'de> for SchoolDistrict {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SchoolDistrict;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SchoolDistrict")
				}
			...
			deserializer.deserialize_struct("SchoolDistrict", FIELDS, ClassVisitor)
		}
	}
}
