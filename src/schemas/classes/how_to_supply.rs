...
impl HowToSupplyTrait for HowToSupply {
	fn get_estimated_cost(&self) -> &[EstimatedCostProperty] {
...
impl HowToItemTrait for HowToSupply {
...
impl ListItemTrait for HowToSupply {
...
impl ThingTrait for HowToSupply {
...
mod serde {
	...
	use super::*;
	impl Serialize for HowToSupply {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HowToSupply", len)?;
	...
	impl<'de> Deserialize<'de> for HowToSupply {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HowToSupply;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HowToSupply")
				}
			...
			deserializer.deserialize_struct("HowToSupply", FIELDS, ClassVisitor)
		}
	}
}
