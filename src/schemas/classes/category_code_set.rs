...
pub struct CategoryCodeSet {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "hasCategoryCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/hasCategoryCode"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/hasCategoryCode"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
