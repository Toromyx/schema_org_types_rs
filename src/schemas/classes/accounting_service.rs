...
/// This trait is for properties from <https://schema.org/AccountingService>.
pub trait AccountingServiceTrait {}
impl AccountingServiceTrait for AccountingService {}
impl FinancialServiceTrait for AccountingService {
...
impl LocalBusinessTrait for AccountingService {
...
impl ThingTrait for AccountingService {
...
mod serde {
	...
	use super::*;
	impl Serialize for AccountingService {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AccountingService", len)?;
	...
	impl<'de> Deserialize<'de> for AccountingService {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AccountingService;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AccountingService")
				}
			...
			deserializer.deserialize_struct("AccountingService", FIELDS, ClassVisitor)
		}
	}
}
