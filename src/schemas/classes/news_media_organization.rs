...
pub struct NewsMediaOrganization {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "masthead"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/masthead"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/masthead"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "missionCoveragePrioritiesPolicy"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/missionCoveragePrioritiesPolicy")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/missionCoveragePrioritiesPolicy")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
    ...
    #[cfg_attr(feature = "serde", serde(rename = "noBylinesPolicy"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/noBylinesPolicy"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/noBylinesPolicy"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "verificationFactCheckingPolicy"))]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "https://schema.org/verificationFactCheckingPolicy")
    )]
    #[cfg_attr(
        feature = "serde",
        serde(alias = "http://schema.org/verificationFactCheckingPolicy")
    )]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
