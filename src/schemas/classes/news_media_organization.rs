			...
			impl<'de> Visitor<'de> for FieldVisitor {
					...
					E: de::Error,
				{
					match value {
						...
						"missionCoveragePrioritiesPolicy" => Ok(Field::MissionCoveragePrioritiesPolicy),
						#[cfg(any(
							any(
								feature = "naics-property-schema",
								feature = "general-schema-section"
						...
						"verificationFactCheckingPolicy" => Ok(Field::VerificationFactCheckingPolicy),
						_ => Ok(Field::Ignore),
					}
				}
					...
					E: de::Error,
				{
					match value {
						...
						b"missionCoveragePrioritiesPolicy" => Ok(Field::MissionCoveragePrioritiesPolicy),
						#[cfg(any(
							any(
								feature = "naics-property-schema",
								feature = "general-schema-section"
						...
						b"verificationFactCheckingPolicy" => Ok(Field::VerificationFactCheckingPolicy),
						_ => Ok(Field::Ignore),
					}
				}
			}
