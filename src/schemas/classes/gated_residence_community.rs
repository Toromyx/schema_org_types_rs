...
/// This trait is for properties from <https://schema.org/GatedResidenceCommunity>.
pub trait GatedResidenceCommunityTrait {}
impl GatedResidenceCommunityTrait for GatedResidenceCommunity {}
...
impl ResidenceTrait for GatedResidenceCommunity {
...
impl ThingTrait for GatedResidenceCommunity {
...
mod serde {
	...
	use super::*;
	impl Serialize for GatedResidenceCommunity {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GatedResidenceCommunity", len)?;
	...
	impl<'de> Deserialize<'de> for GatedResidenceCommunity {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GatedResidenceCommunity;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GatedResidenceCommunity")
				}
			...
			deserializer.deserialize_struct("GatedResidenceCommunity", FIELDS, ClassVisitor)
		}
	}
}
