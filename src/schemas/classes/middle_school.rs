...
/// This trait is for properties from <https://schema.org/MiddleSchool>.
pub trait MiddleSchoolTrait {}
impl MiddleSchoolTrait for MiddleSchool {}
impl CivicStructureTrait for MiddleSchool {
...
impl EducationalOrganizationTrait for MiddleSchool {
...
impl ThingTrait for MiddleSchool {
...
mod serde {
	...
	use super::*;
	impl Serialize for MiddleSchool {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MiddleSchool", len)?;
	...
	impl<'de> Deserialize<'de> for MiddleSchool {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MiddleSchool;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MiddleSchool")
				}
			...
			deserializer.deserialize_struct("MiddleSchool", FIELDS, ClassVisitor)
		}
	}
}
