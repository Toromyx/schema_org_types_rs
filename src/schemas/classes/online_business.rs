...
/// This trait is for properties from <https://schema.org/OnlineBusiness>.
pub trait OnlineBusinessTrait {}
impl OnlineBusinessTrait for OnlineBusiness {}
...
impl ThingTrait for OnlineBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for OnlineBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OnlineBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for OnlineBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OnlineBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OnlineBusiness")
				}
			...
			deserializer.deserialize_struct("OnlineBusiness", FIELDS, ClassVisitor)
		}
	}
}
