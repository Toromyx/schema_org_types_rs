...
/// This trait is for properties from <https://schema.org/LakeBodyOfWater>.
pub trait LakeBodyOfWaterTrait {}
impl LakeBodyOfWaterTrait for LakeBodyOfWater {}
impl BodyOfWaterTrait for LakeBodyOfWater {}
impl LandformTrait for LakeBodyOfWater {}
...
impl ThingTrait for LakeBodyOfWater {
...
mod serde {
	...
	use super::*;
	impl Serialize for LakeBodyOfWater {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LakeBodyOfWater", len)?;
	...
	impl<'de> Deserialize<'de> for LakeBodyOfWater {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LakeBodyOfWater;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LakeBodyOfWater")
				}
			...
			deserializer.deserialize_struct("LakeBodyOfWater", FIELDS, ClassVisitor)
		}
	}
}
