...
/// This trait is for properties from <https://schema.org/UnRegisterAction>.
pub trait UnRegisterActionTrait {}
impl UnRegisterActionTrait for UnRegisterAction {}
...
impl InteractActionTrait for UnRegisterAction {}
impl ThingTrait for UnRegisterAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for UnRegisterAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UnRegisterAction", len)?;
	...
	impl<'de> Deserialize<'de> for UnRegisterAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UnRegisterAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UnRegisterAction")
				}
			...
			deserializer.deserialize_struct("UnRegisterAction", FIELDS, ClassVisitor)
		}
	}
}
