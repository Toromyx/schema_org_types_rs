...
/// This trait is for properties from <https://schema.org/ListenAction>.
pub trait ListenActionTrait {}
impl ListenActionTrait for ListenAction {}
...
impl ConsumeActionTrait for ListenAction {
...
impl ThingTrait for ListenAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ListenAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ListenAction", len)?;
	...
	impl<'de> Deserialize<'de> for ListenAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ListenAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ListenAction")
				}
			...
			deserializer.deserialize_struct("ListenAction", FIELDS, ClassVisitor)
		}
	}
}
