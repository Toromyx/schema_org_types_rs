...
/// This trait is for properties from <https://schema.org/ResearchProject>.
pub trait ResearchProjectTrait {}
impl ResearchProjectTrait for ResearchProject {}
...
impl ProjectTrait for ResearchProject {}
impl ThingTrait for ResearchProject {
...
mod serde {
	...
	impl Serialize for ResearchProject {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ResearchProject", len)?;
	...
	impl<'de> Deserialize<'de> for ResearchProject {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ResearchProject;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ResearchProject")
				}
			...
			deserializer.deserialize_struct("ResearchProject", FIELDS, ClassVisitor)
		}
	}
}
