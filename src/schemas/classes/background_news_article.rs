...
/// This trait is for properties from <https://schema.org/BackgroundNewsArticle>.
pub trait BackgroundNewsArticleTrait {}
impl BackgroundNewsArticleTrait for BackgroundNewsArticle {}
impl ArticleTrait for BackgroundNewsArticle {
...
impl CreativeWorkTrait for BackgroundNewsArticle {
...
impl NewsArticleTrait for BackgroundNewsArticle {
...
impl ThingTrait for BackgroundNewsArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for BackgroundNewsArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BackgroundNewsArticle", len)?;
	...
	impl<'de> Deserialize<'de> for BackgroundNewsArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BackgroundNewsArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BackgroundNewsArticle")
				}
			...
			deserializer.deserialize_struct("BackgroundNewsArticle", FIELDS, ClassVisitor)
		}
	}
}
