...
/// This trait is for properties from <https://schema.org/CovidTestingFacility>.
pub trait CovidTestingFacilityTrait {}
impl CovidTestingFacilityTrait for CovidTestingFacility {}
impl LocalBusinessTrait for CovidTestingFacility {
...
impl MedicalBusinessTrait for CovidTestingFacility {}
impl MedicalClinicTrait for CovidTestingFacility {
...
impl MedicalOrganizationTrait for CovidTestingFacility {
...
impl ThingTrait for CovidTestingFacility {
...
mod serde {
	...
	use super::*;
	impl Serialize for CovidTestingFacility {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CovidTestingFacility", len)?;
	...
	impl<'de> Deserialize<'de> for CovidTestingFacility {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CovidTestingFacility;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CovidTestingFacility")
				}
			...
			deserializer.deserialize_struct("CovidTestingFacility", FIELDS, ClassVisitor)
		}
	}
}
