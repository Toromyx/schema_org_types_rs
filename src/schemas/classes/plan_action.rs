...
pub struct PlanAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "scheduledTime"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/scheduledTime"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/scheduledTime"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
