...
/// This trait is for properties from <https://schema.org/MotorcycleDealer>.
pub trait MotorcycleDealerTrait {}
impl MotorcycleDealerTrait for MotorcycleDealer {}
impl AutomotiveBusinessTrait for MotorcycleDealer {}
impl LocalBusinessTrait for MotorcycleDealer {
...
impl ThingTrait for MotorcycleDealer {
...
mod serde {
	...
	use super::*;
	impl Serialize for MotorcycleDealer {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MotorcycleDealer", len)?;
	...
	impl<'de> Deserialize<'de> for MotorcycleDealer {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MotorcycleDealer;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MotorcycleDealer")
				}
			...
			deserializer.deserialize_struct("MotorcycleDealer", FIELDS, ClassVisitor)
		}
	}
}
