...
impl SoftwareSourceCodeTrait for SoftwareSourceCode {
	fn get_code_repository(&self) -> &[CodeRepositoryProperty] {
		self.r#code_repository.as_slice()
	}
	fn take_code_repository(&mut self) -> Vec<CodeRepositoryProperty> {
		std::mem::take(&mut self.r#code_repository)
	}
	fn get_code_sample_type(&self) -> &[CodeSampleTypeProperty] {
		self.r#code_sample_type.as_slice()
	}
	fn take_code_sample_type(&mut self) -> Vec<CodeSampleTypeProperty> {
		std::mem::take(&mut self.r#code_sample_type)
	}
	fn get_programming_language(&self) -> &[ProgrammingLanguageProperty] {
		self.r#programming_language.as_slice()
	}
	fn take_programming_language(&mut self) -> Vec<ProgrammingLanguageProperty> {
		std::mem::take(&mut self.r#programming_language)
	}
	fn get_runtime(&self) -> &[RuntimeProperty] {
		self.r#runtime.as_slice()
	}
	fn take_runtime(&mut self) -> Vec<RuntimeProperty> {
		std::mem::take(&mut self.r#runtime)
	}
	fn get_runtime_platform(&self) -> &[RuntimePlatformProperty] {
	...
	fn get_sample_type(&self) -> &[SampleTypeProperty] {
		self.r#sample_type.as_slice()
	}
	fn take_sample_type(&mut self) -> Vec<SampleTypeProperty> {
		std::mem::take(&mut self.r#sample_type)
	}
	fn get_target_product(&self) -> &[TargetProductProperty] {
		self.r#target_product.as_slice()
	}
	fn take_target_product(&mut self) -> Vec<TargetProductProperty> {
		std::mem::take(&mut self.r#target_product)
	}
}
impl CreativeWorkTrait for SoftwareSourceCode {
...
impl ThingTrait for SoftwareSourceCode {
...
mod serde {
	...
	use super::*;
	impl Serialize for SoftwareSourceCode {
		fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
		where
			S: Serializer,
		{
			let len: usize = [
				!Vec::is_empty(&self.r#code_repository) as usize,
				!Vec::is_empty(&self.r#code_sample_type) as usize,
				!Vec::is_empty(&self.r#programming_language) as usize,
				!Vec::is_empty(&self.r#runtime) as usize,
				!Vec::is_empty(&self.r#runtime_platform) as usize,
				!Vec::is_empty(&self.r#sample_type) as usize,
				!Vec::is_empty(&self.r#target_product) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SoftwareSourceCode", len)?;
			if !Vec::is_empty(&self.r#code_repository) {
				serialize_struct.serialize_field("codeRepository", {
					struct SerializeWith<'a>(&'a Vec<CodeRepositoryProperty>);
					...
					&SerializeWith(&self.r#code_repository)
				})?;
			} else {
				serialize_struct.skip_field("codeRepository")?;
			}
			if !Vec::is_empty(&self.r#code_sample_type) {
				serialize_struct.serialize_field("codeSampleType", {
					struct SerializeWith<'a>(&'a Vec<CodeSampleTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#code_sample_type)
				})?;
			} else {
				serialize_struct.skip_field("codeSampleType")?;
			}
			if !Vec::is_empty(&self.r#programming_language) {
				serialize_struct.serialize_field("programmingLanguage", {
					struct SerializeWith<'a>(&'a Vec<ProgrammingLanguageProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#programming_language)
				})?;
			} else {
				serialize_struct.skip_field("programmingLanguage")?;
			}
			if !Vec::is_empty(&self.r#runtime) {
				serialize_struct.serialize_field("runtime", {
					struct SerializeWith<'a>(&'a Vec<RuntimeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#runtime)
				})?;
			} else {
				serialize_struct.skip_field("runtime")?;
			}
			...
			if !Vec::is_empty(&self.r#sample_type) {
				serialize_struct.serialize_field("sampleType", {
					struct SerializeWith<'a>(&'a Vec<SampleTypeProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#sample_type)
				})?;
			} else {
				serialize_struct.skip_field("sampleType")?;
			}
			if !Vec::is_empty(&self.r#target_product) {
				serialize_struct.serialize_field("targetProduct", {
					struct SerializeWith<'a>(&'a Vec<TargetProductProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#target_product)
				})?;
			} else {
				serialize_struct.skip_field("targetProduct")?;
			}
	...
	impl<'de> Deserialize<'de> for SoftwareSourceCode {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"codeRepository" => Ok(Field::CodeRepository),
						"codeSampleType" => Ok(Field::CodeSampleType),
						"programmingLanguage" => Ok(Field::ProgrammingLanguage),
						"runtime" => Ok(Field::Runtime),
						"runtimePlatform" => Ok(Field::RuntimePlatform),
						"sampleType" => Ok(Field::SampleType),
						"targetProduct" => Ok(Field::TargetProduct),
				...
				{
					match value {
						b"codeRepository" => Ok(Field::CodeRepository),
						b"codeSampleType" => Ok(Field::CodeSampleType),
						b"programmingLanguage" => Ok(Field::ProgrammingLanguage),
						b"runtime" => Ok(Field::Runtime),
						b"runtimePlatform" => Ok(Field::RuntimePlatform),
						b"sampleType" => Ok(Field::SampleType),
						b"targetProduct" => Ok(Field::TargetProduct),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SoftwareSourceCode;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SoftwareSourceCode")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#code_repository_property = None;
					let mut r#code_sample_type_property = None;
					let mut r#programming_language_property = None;
					let mut r#runtime_property = None;
					let mut r#runtime_platform_property = None;
					let mut r#sample_type_property = None;
					let mut r#target_product_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::CodeRepository => {
								if r#code_repository_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"codeRepository",
									));
								}
								r#code_repository_property = Some({
									struct DeserializeWith(Vec<CodeRepositoryProperty>);
							...
							Field::CodeSampleType => {
								if r#code_sample_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"codeSampleType",
									));
								}
								r#code_sample_type_property = Some({
									struct DeserializeWith(Vec<CodeSampleTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ProgrammingLanguage => {
								if r#programming_language_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"programmingLanguage",
									));
								}
								r#programming_language_property = Some({
									struct DeserializeWith(Vec<ProgrammingLanguageProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Runtime => {
								if r#runtime_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"runtime",
									));
								}
								r#runtime_property = Some({
									struct DeserializeWith(Vec<RuntimeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::SampleType => {
								if r#sample_type_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"sampleType",
									));
								}
								r#sample_type_property = Some({
									struct DeserializeWith(Vec<SampleTypeProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TargetProduct => {
								if r#target_product_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"targetProduct",
									));
								}
								r#target_product_property = Some({
									struct DeserializeWith(Vec<TargetProductProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(SoftwareSourceCode {
						r#code_repository: r#code_repository_property.unwrap_or_default(),
						r#code_sample_type: r#code_sample_type_property.unwrap_or_default(),
						r#programming_language: r#programming_language_property.unwrap_or_default(),
						r#runtime: r#runtime_property.unwrap_or_default(),
						r#runtime_platform: r#runtime_platform_property.unwrap_or_default(),
						r#sample_type: r#sample_type_property.unwrap_or_default(),
						r#target_product: r#target_product_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("SoftwareSourceCode", FIELDS, ClassVisitor)
		}
	}
}
