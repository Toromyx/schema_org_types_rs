...
/// This trait is for properties from <https://schema.org/BoatReservation>.
pub trait BoatReservationTrait {}
impl BoatReservationTrait for BoatReservation {}
impl ReservationTrait for BoatReservation {
...
impl ThingTrait for BoatReservation {
...
mod serde {
	...
	use super::*;
	impl Serialize for BoatReservation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BoatReservation", len)?;
	...
	impl<'de> Deserialize<'de> for BoatReservation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BoatReservation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BoatReservation")
				}
			...
			deserializer.deserialize_struct("BoatReservation", FIELDS, ClassVisitor)
		}
	}
}
