...
/// This trait is for properties from <https://schema.org/SiteNavigationElement>.
pub trait SiteNavigationElementTrait {}
impl SiteNavigationElementTrait for SiteNavigationElement {}
impl CreativeWorkTrait for SiteNavigationElement {
...
impl ThingTrait for SiteNavigationElement {
...
impl WebPageElementTrait for SiteNavigationElement {
...
mod serde {
	...
	use super::*;
	impl Serialize for SiteNavigationElement {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SiteNavigationElement", len)?;
	...
	impl<'de> Deserialize<'de> for SiteNavigationElement {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SiteNavigationElement;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SiteNavigationElement")
				}
			...
			deserializer.deserialize_struct("SiteNavigationElement", FIELDS, ClassVisitor)
		}
	}
}
