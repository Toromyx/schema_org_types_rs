...
pub struct MedicalObservationalStudy {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "studyDesign"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/studyDesign"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/studyDesign"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
