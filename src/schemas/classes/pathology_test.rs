...
pub struct PathologyTest {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "tissueSample"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/tissueSample"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/tissueSample"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
