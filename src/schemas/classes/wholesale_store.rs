...
/// This trait is for properties from <https://schema.org/WholesaleStore>.
pub trait WholesaleStoreTrait {}
impl WholesaleStoreTrait for WholesaleStore {}
impl LocalBusinessTrait for WholesaleStore {
...
impl StoreTrait for WholesaleStore {}
impl ThingTrait for WholesaleStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for WholesaleStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "WholesaleStore", len)?;
	...
	impl<'de> Deserialize<'de> for WholesaleStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = WholesaleStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema WholesaleStore")
				}
			...
			deserializer.deserialize_struct("WholesaleStore", FIELDS, ClassVisitor)
		}
	}
}
