...
impl AudioObjectTrait for AudioObject {
	fn get_caption(&self) -> &[CaptionProperty] {
...
impl CreativeWorkTrait for AudioObject {
...
impl MediaObjectTrait for AudioObject {
...
impl ThingTrait for AudioObject {
...
mod serde {
	...
	use super::*;
	impl Serialize for AudioObject {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AudioObject", len)?;
	...
	impl<'de> Deserialize<'de> for AudioObject {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AudioObject;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AudioObject")
				}
			...
			deserializer.deserialize_struct("AudioObject", FIELDS, ClassVisitor)
		}
	}
}
