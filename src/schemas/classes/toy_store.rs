...
/// This trait is for properties from <https://schema.org/ToyStore>.
pub trait ToyStoreTrait {}
impl ToyStoreTrait for ToyStore {}
impl LocalBusinessTrait for ToyStore {
...
impl StoreTrait for ToyStore {}
impl ThingTrait for ToyStore {
...
mod serde {
	...
	impl Serialize for ToyStore {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "ToyStore", len)?;
	...
	impl<'de> Deserialize<'de> for ToyStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ToyStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ToyStore")
				}
			...
			deserializer.deserialize_struct("ToyStore", FIELDS, ClassVisitor)
		}
	}
}
