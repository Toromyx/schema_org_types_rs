...
impl CreativeWorkSeriesTrait for CreativeWorkSeries {
	fn get_end_date(&self) -> &[EndDateProperty] {
...
impl CreativeWorkTrait for CreativeWorkSeries {
...
impl ThingTrait for CreativeWorkSeries {
...
mod serde {
	...
	use super::*;
	impl Serialize for CreativeWorkSeries {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CreativeWorkSeries", len)?;
	...
	impl<'de> Deserialize<'de> for CreativeWorkSeries {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CreativeWorkSeries;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CreativeWorkSeries")
				}
			...
			deserializer.deserialize_struct("CreativeWorkSeries", FIELDS, ClassVisitor)
		}
	}
}
