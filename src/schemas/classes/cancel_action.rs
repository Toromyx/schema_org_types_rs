...
/// This trait is for properties from <https://schema.org/CancelAction>.
pub trait CancelActionTrait {}
impl CancelActionTrait for CancelAction {}
...
impl OrganizeActionTrait for CancelAction {}
impl PlanActionTrait for CancelAction {
...
impl ThingTrait for CancelAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for CancelAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CancelAction", len)?;
	...
	impl<'de> Deserialize<'de> for CancelAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = CancelAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CancelAction")
				}
			...
			deserializer.deserialize_struct("CancelAction", FIELDS, ClassVisitor)
		}
	}
}
