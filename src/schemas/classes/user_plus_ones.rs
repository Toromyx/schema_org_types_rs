...
/// This trait is for properties from <https://schema.org/UserPlusOnes>.
#[deprecated = "This schema is superseded by <https://schema.org/InteractionCounter>."]
pub trait UserPlusOnesTrait {}
impl UserPlusOnesTrait for UserPlusOnes {}
impl EventTrait for UserPlusOnes {
...
impl ThingTrait for UserPlusOnes {
...
impl UserInteractionTrait for UserPlusOnes {}
#[cfg(feature = "serde")]
mod serde {
	...
	use super::*;
	impl Serialize for UserPlusOnes {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UserPlusOnes", len)?;
	...
	impl<'de> Deserialize<'de> for UserPlusOnes {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = UserPlusOnes;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UserPlusOnes")
				}
			...
			deserializer.deserialize_struct("UserPlusOnes", FIELDS, ClassVisitor)
		}
	}
}
