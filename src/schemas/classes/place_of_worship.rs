...
/// This trait is for properties from <https://schema.org/PlaceOfWorship>.
pub trait PlaceOfWorshipTrait {}
impl PlaceOfWorshipTrait for PlaceOfWorship {}
impl CivicStructureTrait for PlaceOfWorship {
...
impl ThingTrait for PlaceOfWorship {
...
mod serde {
	...
	use super::*;
	impl Serialize for PlaceOfWorship {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PlaceOfWorship", len)?;
	...
	impl<'de> Deserialize<'de> for PlaceOfWorship {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PlaceOfWorship;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PlaceOfWorship")
				}
			...
			deserializer.deserialize_struct("PlaceOfWorship", FIELDS, ClassVisitor)
		}
	}
}
