...
/// This trait is for properties from <https://schema.org/ChildrensEvent>.
pub trait ChildrensEventTrait {}
impl ChildrensEventTrait for ChildrensEvent {}
impl EventTrait for ChildrensEvent {
...
impl ThingTrait for ChildrensEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for ChildrensEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ChildrensEvent", len)?;
	...
	impl<'de> Deserialize<'de> for ChildrensEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ChildrensEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ChildrensEvent")
				}
			...
			deserializer.deserialize_struct("ChildrensEvent", FIELDS, ClassVisitor)
		}
	}
}
