...
pub trait UpdateActionTrait {
	...
	/// Take <https://schema.org/targetCollection> from [`Self`] as owned vector.
	fn take_target_collection(&mut self) -> Vec<TargetCollectionProperty>;
}
impl UpdateActionTrait for UpdateAction {
	fn get_collection(&self) -> &[CollectionProperty] {
...
impl ThingTrait for UpdateAction {
	...
	impl Serialize for UpdateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "UpdateAction", len)?;
	...
	impl<'de> Deserialize<'de> for UpdateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema UpdateAction")
				}
			...
			deserializer.deserialize_struct("UpdateAction", FIELDS, ClassVisitor)
		}
	}
}
