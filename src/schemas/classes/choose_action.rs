...
impl AssessActionTrait for ChooseAction {}
impl ThingTrait for ChooseAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for ChooseAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ChooseAction", len)?;
	...
	impl<'de> Deserialize<'de> for ChooseAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ChooseAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ChooseAction")
				}
			...
			deserializer.deserialize_struct("ChooseAction", FIELDS, ClassVisitor)
		}
	}
}
