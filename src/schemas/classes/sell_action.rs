...
pub struct SellAction {
    ...
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/buyer"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/buyer"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "warrantyPromise"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/warrantyPromise"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/warrantyPromise"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
