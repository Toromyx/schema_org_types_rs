...
/// This trait is for properties from <https://schema.org/PreventionIndication>.
pub trait PreventionIndicationTrait {}
impl PreventionIndicationTrait for PreventionIndication {}
impl MedicalEntityTrait for PreventionIndication {
...
impl MedicalIndicationTrait for PreventionIndication {}
impl ThingTrait for PreventionIndication {
...
mod serde {
	...
	use super::*;
	impl Serialize for PreventionIndication {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "PreventionIndication", len)?;
	...
	impl<'de> Deserialize<'de> for PreventionIndication {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = PreventionIndication;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema PreventionIndication")
				}
			...
			deserializer.deserialize_struct("PreventionIndication", FIELDS, ClassVisitor)
		}
	}
}
