...
/// This trait is for properties from <https://schema.org/OutletStore>.
pub trait OutletStoreTrait {}
impl OutletStoreTrait for OutletStore {}
impl LocalBusinessTrait for OutletStore {
...
impl StoreTrait for OutletStore {}
impl ThingTrait for OutletStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for OutletStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OutletStore", len)?;
	...
	impl<'de> Deserialize<'de> for OutletStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OutletStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OutletStore")
				}
			...
			deserializer.deserialize_struct("OutletStore", FIELDS, ClassVisitor)
		}
	}
}
