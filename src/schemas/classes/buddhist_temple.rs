...
/// This trait is for properties from <https://schema.org/BuddhistTemple>.
pub trait BuddhistTempleTrait {}
impl BuddhistTempleTrait for BuddhistTemple {}
impl CivicStructureTrait for BuddhistTemple {
...
impl PlaceOfWorshipTrait for BuddhistTemple {}
impl ThingTrait for BuddhistTemple {
...
mod serde {
	...
	use super::*;
	impl Serialize for BuddhistTemple {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BuddhistTemple", len)?;
	...
	impl<'de> Deserialize<'de> for BuddhistTemple {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BuddhistTemple;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BuddhistTemple")
				}
			...
			deserializer.deserialize_struct("BuddhistTemple", FIELDS, ClassVisitor)
		}
	}
}
