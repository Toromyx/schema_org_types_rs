...
pub struct ApiReference {
	...
	pub r#assembly: Vec<AssemblyProperty>,
	/// <https://schema.org/assemblyVersion>
	pub r#assembly_version: Vec<AssemblyVersionProperty>,
	/// <https://schema.org/executableLibraryName>
	pub r#executable_library_name: Vec<ExecutableLibraryNameProperty>,
	/// <https://schema.org/programmingModel>
	pub r#programming_model: Vec<ProgrammingModelProperty>,
	/// <https://schema.org/targetPlatform>
	pub r#target_platform: Vec<TargetPlatformProperty>,
	...
	pub r#dependencies: Vec<DependenciesProperty>,
	/// <https://schema.org/proficiencyLevel>
	pub r#proficiency_level: Vec<ProficiencyLevelProperty>,
...
/// This trait is for properties from <https://schema.org/APIReference>.
pub trait ApiReferenceTrait {
	/// Get <https://schema.org/assembly> from [`Self`] as borrowed slice.
	#[deprecated = "This schema is superseded by <https://schema.org/executableLibraryName>."]
	fn get_assembly(&self) -> &[AssemblyProperty];
	/// Take <https://schema.org/assembly> from [`Self`] as owned vector.
	#[deprecated = "This schema is superseded by <https://schema.org/executableLibraryName>."]
	fn take_assembly(&mut self) -> Vec<AssemblyProperty>;
	/// Get <https://schema.org/assemblyVersion> from [`Self`] as borrowed slice.
	fn get_assembly_version(&self) -> &[AssemblyVersionProperty];
	/// Take <https://schema.org/assemblyVersion> from [`Self`] as owned vector.
	fn take_assembly_version(&mut self) -> Vec<AssemblyVersionProperty>;
	/// Get <https://schema.org/executableLibraryName> from [`Self`] as borrowed slice.
	fn get_executable_library_name(&self) -> &[ExecutableLibraryNameProperty];
	/// Take <https://schema.org/executableLibraryName> from [`Self`] as owned vector.
	fn take_executable_library_name(&mut self) -> Vec<ExecutableLibraryNameProperty>;
	/// Get <https://schema.org/programmingModel> from [`Self`] as borrowed slice.
	fn get_programming_model(&self) -> &[ProgrammingModelProperty];
	/// Take <https://schema.org/programmingModel> from [`Self`] as owned vector.
	fn take_programming_model(&mut self) -> Vec<ProgrammingModelProperty>;
	/// Get <https://schema.org/targetPlatform> from [`Self`] as borrowed slice.
	fn get_target_platform(&self) -> &[TargetPlatformProperty];
	/// Take <https://schema.org/targetPlatform> from [`Self`] as owned vector.
	fn take_target_platform(&mut self) -> Vec<TargetPlatformProperty>;
}
impl ApiReferenceTrait for ApiReference {
	fn get_assembly(&self) -> &[AssemblyProperty] {
		self.r#assembly.as_slice()
	}
	fn take_assembly(&mut self) -> Vec<AssemblyProperty> {
		std::mem::take(&mut self.r#assembly)
	}
	fn get_assembly_version(&self) -> &[AssemblyVersionProperty] {
		self.r#assembly_version.as_slice()
	}
	fn take_assembly_version(&mut self) -> Vec<AssemblyVersionProperty> {
		std::mem::take(&mut self.r#assembly_version)
	}
	fn get_executable_library_name(&self) -> &[ExecutableLibraryNameProperty] {
		self.r#executable_library_name.as_slice()
	}
	fn take_executable_library_name(&mut self) -> Vec<ExecutableLibraryNameProperty> {
		std::mem::take(&mut self.r#executable_library_name)
	}
	fn get_programming_model(&self) -> &[ProgrammingModelProperty] {
		self.r#programming_model.as_slice()
	}
	fn take_programming_model(&mut self) -> Vec<ProgrammingModelProperty> {
		std::mem::take(&mut self.r#programming_model)
	}
	fn get_target_platform(&self) -> &[TargetPlatformProperty] {
		self.r#target_platform.as_slice()
	}
	fn take_target_platform(&mut self) -> Vec<TargetPlatformProperty> {
		std::mem::take(&mut self.r#target_platform)
	}
}
impl ArticleTrait for ApiReference {
...
impl CreativeWorkTrait for ApiReference {
...
mod serde {
	...
	impl Serialize for ApiReference {
		...
		{
			let len: usize = [
				!Vec::is_empty(&self.r#assembly) as usize,
				!Vec::is_empty(&self.r#assembly_version) as usize,
				!Vec::is_empty(&self.r#executable_library_name) as usize,
				!Vec::is_empty(&self.r#programming_model) as usize,
				!Vec::is_empty(&self.r#target_platform) as usize,
				...
				!Vec::is_empty(&self.r#dependencies) as usize,
				!Vec::is_empty(&self.r#proficiency_level) as usize,
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ApiReference", len)?;
			if !Vec::is_empty(&self.r#assembly) {
				serialize_struct.serialize_field("assembly", {
					struct SerializeWith<'a>(&'a Vec<AssemblyProperty>);
					...
					&SerializeWith(&self.r#assembly)
				})?;
			} else {
				serialize_struct.skip_field("assembly")?;
			}
			if !Vec::is_empty(&self.r#assembly_version) {
				serialize_struct.serialize_field("assemblyVersion", {
					struct SerializeWith<'a>(&'a Vec<AssemblyVersionProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#assembly_version)
				})?;
			} else {
				serialize_struct.skip_field("assemblyVersion")?;
			}
			if !Vec::is_empty(&self.r#executable_library_name) {
				serialize_struct.serialize_field("executableLibraryName", {
					struct SerializeWith<'a>(&'a Vec<ExecutableLibraryNameProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#executable_library_name)
				})?;
			} else {
				serialize_struct.skip_field("executableLibraryName")?;
			}
			if !Vec::is_empty(&self.r#programming_model) {
				serialize_struct.serialize_field("programmingModel", {
					struct SerializeWith<'a>(&'a Vec<ProgrammingModelProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#programming_model)
				})?;
			} else {
				serialize_struct.skip_field("programmingModel")?;
			}
			if !Vec::is_empty(&self.r#target_platform) {
				serialize_struct.serialize_field("targetPlatform", {
					struct SerializeWith<'a>(&'a Vec<TargetPlatformProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#target_platform)
				})?;
			} else {
				serialize_struct.skip_field("targetPlatform")?;
			}
			...
			if !Vec::is_empty(&self.r#dependencies) {
				serialize_struct.serialize_field("dependencies", {
					struct SerializeWith<'a>(&'a Vec<DependenciesProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#dependencies)
				})?;
			} else {
				serialize_struct.skip_field("dependencies")?;
			}
			if !Vec::is_empty(&self.r#proficiency_level) {
				serialize_struct.serialize_field("proficiencyLevel", {
					struct SerializeWith<'a>(&'a Vec<ProficiencyLevelProperty>);
					impl<'a> Serialize for SerializeWith<'a> {
						fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
						where
							S: Serializer,
					...
					&SerializeWith(&self.r#proficiency_level)
				})?;
			} else {
				serialize_struct.skip_field("proficiencyLevel")?;
			}
	...
	impl<'de> Deserialize<'de> for ApiReference {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for FieldVisitor {
				...
				{
					match value {
						"assembly" => Ok(Field::Assembly),
						"assemblyVersion" => Ok(Field::AssemblyVersion),
						"executableLibraryName" => Ok(Field::ExecutableLibraryName),
						"programmingModel" => Ok(Field::ProgrammingModel),
						"targetPlatform" => Ok(Field::TargetPlatform),
						...
						"dependencies" => Ok(Field::Dependencies),
						"proficiencyLevel" => Ok(Field::ProficiencyLevel),
				...
				{
					match value {
						b"assembly" => Ok(Field::Assembly),
						b"assemblyVersion" => Ok(Field::AssemblyVersion),
						b"executableLibraryName" => Ok(Field::ExecutableLibraryName),
						b"programmingModel" => Ok(Field::ProgrammingModel),
						b"targetPlatform" => Ok(Field::TargetPlatform),
						...
						b"dependencies" => Ok(Field::Dependencies),
						b"proficiencyLevel" => Ok(Field::ProficiencyLevel),
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ApiReference;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema APIReference")
				}
				fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error>
				where
					A: de::MapAccess<'de>,
				{
					let mut r#assembly_property = None;
					let mut r#assembly_version_property = None;
					let mut r#executable_library_name_property = None;
					let mut r#programming_model_property = None;
					let mut r#target_platform_property = None;
					...
					let mut r#dependencies_property = None;
					let mut r#proficiency_level_property = None;
					...
					while let Some(key) = map.next_key::<Field>()? {
						match key {
							Field::Assembly => {
								if r#assembly_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"assembly",
									));
								}
								r#assembly_property = Some({
									struct DeserializeWith(Vec<AssemblyProperty>);
							...
							Field::AssemblyVersion => {
								if r#assembly_version_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"assemblyVersion",
									));
								}
								r#assembly_version_property = Some({
									struct DeserializeWith(Vec<AssemblyVersionProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ExecutableLibraryName => {
								if r#executable_library_name_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"executableLibraryName",
									));
								}
								r#executable_library_name_property = Some({
									struct DeserializeWith(Vec<ExecutableLibraryNameProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ProgrammingModel => {
								if r#programming_model_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"programmingModel",
									));
								}
								r#programming_model_property = Some({
									struct DeserializeWith(Vec<ProgrammingModelProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::TargetPlatform => {
								if r#target_platform_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"targetPlatform",
									));
								}
								r#target_platform_property = Some({
									struct DeserializeWith(Vec<TargetPlatformProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::Dependencies => {
								if r#dependencies_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"dependencies",
									));
								}
								r#dependencies_property = Some({
									struct DeserializeWith(Vec<DependenciesProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
							...
							Field::ProficiencyLevel => {
								if r#proficiency_level_property.is_some() {
									return Err(<A::Error as de::Error>::duplicate_field(
										"proficiencyLevel",
									));
								}
								r#proficiency_level_property = Some({
									struct DeserializeWith(Vec<ProficiencyLevelProperty>);
									impl<'de> Deserialize<'de> for DeserializeWith {
										fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
										where
											D: Deserializer<'de>,
					...
					Ok(ApiReference {
						r#assembly: r#assembly_property.unwrap_or_default(),
						r#assembly_version: r#assembly_version_property.unwrap_or_default(),
						r#executable_library_name: r#executable_library_name_property
							.unwrap_or_default(),
						r#programming_model: r#programming_model_property.unwrap_or_default(),
						r#target_platform: r#target_platform_property.unwrap_or_default(),
						...
						r#dependencies: r#dependencies_property.unwrap_or_default(),
						r#proficiency_level: r#proficiency_level_property.unwrap_or_default(),
			...
			deserializer.deserialize_struct("ApiReference", FIELDS, ClassVisitor)
		}
	}
}
