...
/// This trait is for properties from <https://schema.org/Pond>.
pub trait PondTrait {}
impl PondTrait for Pond {}
impl BodyOfWaterTrait for Pond {}
impl LandformTrait for Pond {}
...
mod serde {
	...
	impl Serialize for Pond {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Pond", len)?;
	...
	impl<'de> Deserialize<'de> for Pond {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Pond;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Pond")
				}
			...
			deserializer.deserialize_struct("Pond", FIELDS, ClassVisitor)
		}
	}
}
