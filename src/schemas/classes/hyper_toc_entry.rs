...
pub struct HyperTocEntry {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "tocContinuation"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#toc_continuation: Vec<TocContinuationProperty>,
    #[cfg(any(
        any(
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "utterances"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    )]
    pub r#utterances: Vec<UtterancesProperty>,
    #[cfg(any(
        any(
