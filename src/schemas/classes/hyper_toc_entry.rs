...
pub struct HyperTocEntry {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "tocContinuation"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/tocContinuation"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/tocContinuation"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
    ...
    #[cfg_attr(feature = "serde", serde(rename = "utterances"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/utterances"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/utterances"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
