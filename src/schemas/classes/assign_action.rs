...
/// This trait is for properties from <https://schema.org/AssignAction>.
pub trait AssignActionTrait {}
impl AssignActionTrait for AssignAction {}
...
impl AllocateActionTrait for AssignAction {}
impl OrganizeActionTrait for AssignAction {}
impl ThingTrait for AssignAction {
	...
	impl Serialize for AssignAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AssignAction", len)?;
	...
	impl<'de> Deserialize<'de> for AssignAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AssignAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AssignAction")
				}
			...
			deserializer.deserialize_struct("AssignAction", FIELDS, ClassVisitor)
		}
	}
}
