...
/// This trait is for properties from <https://schema.org/Church>.
pub trait ChurchTrait {}
impl ChurchTrait for Church {}
impl CivicStructureTrait for Church {
...
impl PlaceOfWorshipTrait for Church {}
impl ThingTrait for Church {
...
mod serde {
	...
	impl Serialize for Church {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Church", len)?;
	...
	impl<'de> Deserialize<'de> for Church {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Church;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Church")
				}
			...
			deserializer.deserialize_struct("Church", FIELDS, ClassVisitor)
		}
	}
}
