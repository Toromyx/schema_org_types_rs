...
pub struct Thesis {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "inSupportOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/inSupportOf"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/inSupportOf"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
