...
/// This trait is for properties from <https://schema.org/HinduTemple>.
pub trait HinduTempleTrait {}
impl HinduTempleTrait for HinduTemple {}
impl CivicStructureTrait for HinduTemple {
...
impl PlaceOfWorshipTrait for HinduTemple {}
impl ThingTrait for HinduTemple {
...
mod serde {
	...
	use super::*;
	impl Serialize for HinduTemple {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "HinduTemple", len)?;
	...
	impl<'de> Deserialize<'de> for HinduTemple {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = HinduTemple;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema HinduTemple")
				}
			...
			deserializer.deserialize_struct("HinduTemple", FIELDS, ClassVisitor)
		}
	}
}
