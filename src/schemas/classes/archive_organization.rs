...
pub struct ArchiveOrganization {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "archiveHeld"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/archiveHeld"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/archiveHeld"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
