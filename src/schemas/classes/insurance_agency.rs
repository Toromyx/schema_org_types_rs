...
/// This trait is for properties from <https://schema.org/InsuranceAgency>.
pub trait InsuranceAgencyTrait {}
impl InsuranceAgencyTrait for InsuranceAgency {}
impl FinancialServiceTrait for InsuranceAgency {
...
impl LocalBusinessTrait for InsuranceAgency {
...
impl ThingTrait for InsuranceAgency {
...
mod serde {
	...
	use super::*;
	impl Serialize for InsuranceAgency {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InsuranceAgency", len)?;
	...
	impl<'de> Deserialize<'de> for InsuranceAgency {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InsuranceAgency")
				}
			...
			deserializer.deserialize_struct("InsuranceAgency", FIELDS, ClassVisitor)
		}
	}
}
