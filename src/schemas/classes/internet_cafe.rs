...
/// This trait is for properties from <https://schema.org/InternetCafe>.
pub trait InternetCafeTrait {}
impl InternetCafeTrait for InternetCafe {}
impl LocalBusinessTrait for InternetCafe {
...
impl ThingTrait for InternetCafe {
...
mod serde {
	...
	use super::*;
	impl Serialize for InternetCafe {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "InternetCafe", len)?;
	...
	impl<'de> Deserialize<'de> for InternetCafe {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = InternetCafe;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema InternetCafe")
				}
			...
			deserializer.deserialize_struct("InternetCafe", FIELDS, ClassVisitor)
		}
	}
}
