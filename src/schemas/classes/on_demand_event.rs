...
/// This trait is for properties from <https://schema.org/OnDemandEvent>.
pub trait OnDemandEventTrait {}
impl OnDemandEventTrait for OnDemandEvent {}
impl EventTrait for OnDemandEvent {
...
impl PublicationEventTrait for OnDemandEvent {
...
impl ThingTrait for OnDemandEvent {
...
mod serde {
	...
	use super::*;
	impl Serialize for OnDemandEvent {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "OnDemandEvent", len)?;
	...
	impl<'de> Deserialize<'de> for OnDemandEvent {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = OnDemandEvent;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema OnDemandEvent")
				}
			...
			deserializer.deserialize_struct("OnDemandEvent", FIELDS, ClassVisitor)
		}
	}
}
