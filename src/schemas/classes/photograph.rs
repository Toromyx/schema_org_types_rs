...
/// This trait is for properties from <https://schema.org/Photograph>.
pub trait PhotographTrait {}
impl PhotographTrait for Photograph {}
impl CreativeWorkTrait for Photograph {
...
impl ThingTrait for Photograph {
...
mod serde {
	...
	impl Serialize for Photograph {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Photograph", len)?;
	...
	impl<'de> Deserialize<'de> for Photograph {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Photograph;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Photograph")
				}
			...
			deserializer.deserialize_struct("Photograph", FIELDS, ClassVisitor)
		}
	}
}
