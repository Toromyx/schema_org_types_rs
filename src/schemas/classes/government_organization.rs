...
/// This trait is for properties from <https://schema.org/GovernmentOrganization>.
pub trait GovernmentOrganizationTrait {}
impl GovernmentOrganizationTrait for GovernmentOrganization {}
...
impl ThingTrait for GovernmentOrganization {
...
mod serde {
	...
	use super::*;
	impl Serialize for GovernmentOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GovernmentOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for GovernmentOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GovernmentOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GovernmentOrganization")
				}
			...
			deserializer.deserialize_struct("GovernmentOrganization", FIELDS, ClassVisitor)
		}
	}
}
