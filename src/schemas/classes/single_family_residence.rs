...
impl SingleFamilyResidenceTrait for SingleFamilyResidence {
	fn get_number_of_rooms(&self) -> &[NumberOfRoomsProperty] {
...
impl AccommodationTrait for SingleFamilyResidence {
...
impl HouseTrait for SingleFamilyResidence {
	fn get_number_of_rooms(&self) -> &[NumberOfRoomsProperty] {
		self.r#number_of_rooms.as_slice()
	}
	fn take_number_of_rooms(&mut self) -> Vec<NumberOfRoomsProperty> {
...
impl ThingTrait for SingleFamilyResidence {
...
mod serde {
	...
	use super::*;
	impl Serialize for SingleFamilyResidence {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "SingleFamilyResidence", len)?;
	...
	impl<'de> Deserialize<'de> for SingleFamilyResidence {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = SingleFamilyResidence;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema SingleFamilyResidence")
				}
			...
			deserializer.deserialize_struct("SingleFamilyResidence", FIELDS, ClassVisitor)
		}
	}
}
