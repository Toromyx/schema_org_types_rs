...
/// This trait is for properties from <https://schema.org/RoofingContractor>.
pub trait RoofingContractorTrait {}
impl RoofingContractorTrait for RoofingContractor {}
impl HomeAndConstructionBusinessTrait for RoofingContractor {}
impl LocalBusinessTrait for RoofingContractor {
...
impl ThingTrait for RoofingContractor {
...
mod serde {
	...
	use super::*;
	impl Serialize for RoofingContractor {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "RoofingContractor", len)?;
	...
	impl<'de> Deserialize<'de> for RoofingContractor {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = RoofingContractor;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema RoofingContractor")
				}
			...
			deserializer.deserialize_struct("RoofingContractor", FIELDS, ClassVisitor)
		}
	}
}
