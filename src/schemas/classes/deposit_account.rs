...
/// This trait is for properties from <https://schema.org/DepositAccount>.
pub trait DepositAccountTrait {}
impl DepositAccountTrait for DepositAccount {}
impl BankAccountTrait for DepositAccount {
...
impl FinancialProductTrait for DepositAccount {
...
impl InvestmentOrDepositTrait for DepositAccount {
...
impl ServiceTrait for DepositAccount {
...
impl ThingTrait for DepositAccount {
...
mod serde {
	...
	use super::*;
	impl Serialize for DepositAccount {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "DepositAccount", len)?;
	...
	impl<'de> Deserialize<'de> for DepositAccount {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema DepositAccount")
				}
			...
			deserializer.deserialize_struct("DepositAccount", FIELDS, ClassVisitor)
		}
	}
}
