...
pub struct DepositAccount {
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "accountMinimumInflow"))]
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "accountOverdraftLimit"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
    ...
    #[cfg_attr(any(feature = "serde", doc), serde(rename = "bankAccountType"))]
    #[cfg_attr(any(feature = "serde", doc), serde(default))]
    #[cfg_attr(
        any(feature = "serde", doc),
        serde(skip_serializing_if = "Vec::is_empty")
