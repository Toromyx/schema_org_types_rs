...
/// This trait is for properties from <https://schema.org/ImageGallery>.
pub trait ImageGalleryTrait {}
impl ImageGalleryTrait for ImageGallery {}
impl CollectionPageTrait for ImageGallery {}
impl CreativeWorkTrait for ImageGallery {
...
impl MediaGalleryTrait for ImageGallery {}
impl ThingTrait for ImageGallery {
...
impl WebPageTrait for ImageGallery {
...
mod serde {
	...
	use super::*;
	impl Serialize for ImageGallery {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ImageGallery", len)?;
	...
	impl<'de> Deserialize<'de> for ImageGallery {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ImageGallery")
				}
			...
			deserializer.deserialize_struct("ImageGallery", FIELDS, ClassVisitor)
		}
	}
}
