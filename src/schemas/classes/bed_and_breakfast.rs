...
/// This trait is for properties from <https://schema.org/BedAndBreakfast>.
pub trait BedAndBreakfastTrait {}
impl BedAndBreakfastTrait for BedAndBreakfast {}
impl LocalBusinessTrait for BedAndBreakfast {
...
impl LodgingBusinessTrait for BedAndBreakfast {
...
impl ThingTrait for BedAndBreakfast {
...
mod serde {
	...
	use super::*;
	impl Serialize for BedAndBreakfast {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "BedAndBreakfast", len)?;
	...
	impl<'de> Deserialize<'de> for BedAndBreakfast {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = BedAndBreakfast;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema BedAndBreakfast")
				}
			...
			deserializer.deserialize_struct("BedAndBreakfast", FIELDS, ClassVisitor)
		}
	}
}
