...
/// This trait is for properties from <https://schema.org/GroceryStore>.
pub trait GroceryStoreTrait {}
impl GroceryStoreTrait for GroceryStore {}
impl LocalBusinessTrait for GroceryStore {
...
impl StoreTrait for GroceryStore {}
impl ThingTrait for GroceryStore {
...
mod serde {
	...
	use super::*;
	impl Serialize for GroceryStore {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "GroceryStore", len)?;
	...
	impl<'de> Deserialize<'de> for GroceryStore {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GroceryStore;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GroceryStore")
				}
			...
			deserializer.deserialize_struct("GroceryStore", FIELDS, ClassVisitor)
		}
	}
}
