...
/// This trait is for properties from <https://schema.org/FundingAgency>.
pub trait FundingAgencyTrait {}
impl FundingAgencyTrait for FundingAgency {}
...
impl ProjectTrait for FundingAgency {}
impl ThingTrait for FundingAgency {
...
mod serde {
	...
	use super::*;
	impl Serialize for FundingAgency {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "FundingAgency", len)?;
	...
	impl<'de> Deserialize<'de> for FundingAgency {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = FundingAgency;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema FundingAgency")
				}
			...
			deserializer.deserialize_struct("FundingAgency", FIELDS, ClassVisitor)
		}
	}
}
