...
/// This trait is for properties from <https://schema.org/Statement>.
pub trait StatementTrait {}
impl StatementTrait for Statement {}
impl CreativeWorkTrait for Statement {
...
mod serde {
	...
	impl Serialize for Statement {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Statement", len)?;
	...
	impl<'de> Deserialize<'de> for Statement {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Statement")
				}
			...
			deserializer.deserialize_struct("Statement", FIELDS, ClassVisitor)
		}
	}
}
