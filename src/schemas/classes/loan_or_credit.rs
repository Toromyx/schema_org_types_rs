...
impl LoanOrCreditTrait for LoanOrCredit {
	fn get_amount(&self) -> &[AmountProperty] {
	...
	fn take_grace_period(&mut self) -> Vec<GracePeriodProperty> {
		std::mem::take(&mut self.r#grace_period)
	}
	fn get_loan_repayment_form(&self) -> &[LoanRepaymentFormProperty] {
		self.r#loan_repayment_form.as_slice()
	}
	fn take_loan_repayment_form(&mut self) -> Vec<LoanRepaymentFormProperty> {
		std::mem::take(&mut self.r#loan_repayment_form)
	}
	fn get_loan_term(&self) -> &[LoanTermProperty] {
		self.r#loan_term.as_slice()
	}
	fn take_loan_term(&mut self) -> Vec<LoanTermProperty> {
		std::mem::take(&mut self.r#loan_term)
	}
	fn get_loan_type(&self) -> &[LoanTypeProperty] {
		self.r#loan_type.as_slice()
	}
	fn take_loan_type(&mut self) -> Vec<LoanTypeProperty> {
		std::mem::take(&mut self.r#loan_type)
	}
	fn get_recourse_loan(&self) -> &[RecourseLoanProperty] {
		self.r#recourse_loan.as_slice()
	}
	fn take_recourse_loan(&mut self) -> Vec<RecourseLoanProperty> {
		std::mem::take(&mut self.r#recourse_loan)
	}
	fn get_renegotiable_loan(&self) -> &[RenegotiableLoanProperty] {
		self.r#renegotiable_loan.as_slice()
	}
	fn take_renegotiable_loan(&mut self) -> Vec<RenegotiableLoanProperty> {
		std::mem::take(&mut self.r#renegotiable_loan)
	}
	fn get_required_collateral(&self) -> &[RequiredCollateralProperty] {
		self.r#required_collateral.as_slice()
	}
	fn take_required_collateral(&mut self) -> Vec<RequiredCollateralProperty> {
		std::mem::take(&mut self.r#required_collateral)
	}
}
impl FinancialProductTrait for LoanOrCredit {
...
impl ServiceTrait for LoanOrCredit {
...
impl ThingTrait for LoanOrCredit {
...
mod serde {
	...
	use super::*;
	impl Serialize for LoanOrCredit {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "LoanOrCredit", len)?;
	...
	impl<'de> Deserialize<'de> for LoanOrCredit {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = LoanOrCredit;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema LoanOrCredit")
				}
			...
			deserializer.deserialize_struct("LoanOrCredit", FIELDS, ClassVisitor)
		}
	}
}
