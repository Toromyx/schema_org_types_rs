...
/// This trait is for properties from <https://schema.org/AdvertiserContentArticle>.
pub trait AdvertiserContentArticleTrait {}
impl AdvertiserContentArticleTrait for AdvertiserContentArticle {}
impl ArticleTrait for AdvertiserContentArticle {
...
impl CreativeWorkTrait for AdvertiserContentArticle {
...
impl ThingTrait for AdvertiserContentArticle {
...
mod serde {
	...
	use super::*;
	impl Serialize for AdvertiserContentArticle {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AdvertiserContentArticle", len)?;
	...
	impl<'de> Deserialize<'de> for AdvertiserContentArticle {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AdvertiserContentArticle;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AdvertiserContentArticle")
				}
			...
			deserializer.deserialize_struct("AdvertiserContentArticle", FIELDS, ClassVisitor)
		}
	}
}
