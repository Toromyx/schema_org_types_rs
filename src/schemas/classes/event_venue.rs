...
/// This trait is for properties from <https://schema.org/EventVenue>.
pub trait EventVenueTrait {}
impl EventVenueTrait for EventVenue {}
impl CivicStructureTrait for EventVenue {
...
impl ThingTrait for EventVenue {
...
mod serde {
	...
	impl Serialize for EventVenue {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "EventVenue", len)?;
	...
	impl<'de> Deserialize<'de> for EventVenue {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = EventVenue;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema EventVenue")
				}
			...
			deserializer.deserialize_struct("EventVenue", FIELDS, ClassVisitor)
		}
	}
}
