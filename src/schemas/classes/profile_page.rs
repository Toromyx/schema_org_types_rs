...
/// This trait is for properties from <https://schema.org/ProfilePage>.
pub trait ProfilePageTrait {}
impl ProfilePageTrait for ProfilePage {}
impl CreativeWorkTrait for ProfilePage {
...
impl ThingTrait for ProfilePage {
...
impl WebPageTrait for ProfilePage {
...
mod serde {
	...
	use super::*;
	impl Serialize for ProfilePage {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ProfilePage", len)?;
	...
	impl<'de> Deserialize<'de> for ProfilePage {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ProfilePage;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ProfilePage")
				}
			...
			deserializer.deserialize_struct("ProfilePage", FIELDS, ClassVisitor)
		}
	}
}
