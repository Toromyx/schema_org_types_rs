	...
	impl<'de> Deserialize<'de> for GameServer {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = GameServer;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema GameServer")
				}
			...
			deserializer.deserialize_struct("GameServer", FIELDS, ClassVisitor)
		}
	}
}
