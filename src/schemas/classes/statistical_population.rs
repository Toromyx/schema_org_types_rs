...
impl StatisticalPopulationTrait for StatisticalPopulation {
	fn get_population_type(&self) -> &[PopulationTypeProperty] {
...
impl ThingTrait for StatisticalPopulation {
...
mod serde {
	...
	use super::*;
	impl Serialize for StatisticalPopulation {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "StatisticalPopulation", len)?;
	...
	impl<'de> Deserialize<'de> for StatisticalPopulation {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = StatisticalPopulation;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema StatisticalPopulation")
				}
			...
			deserializer.deserialize_struct("StatisticalPopulation", FIELDS, ClassVisitor)
		}
	}
}
