...
/// This trait is for properties from <https://schema.org/ResearchOrganization>.
...
mod serde {
	...
	use super::*;
	impl Serialize for ResearchOrganization {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ResearchOrganization", len)?;
	...
	impl<'de> Deserialize<'de> for ResearchOrganization {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ResearchOrganization;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ResearchOrganization")
				}
			...
			deserializer.deserialize_struct("ResearchOrganization", FIELDS, ClassVisitor)
		}
	}
}
