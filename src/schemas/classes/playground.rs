...
/// This trait is for properties from <https://schema.org/Playground>.
pub trait PlaygroundTrait {}
impl PlaygroundTrait for Playground {}
impl CivicStructureTrait for Playground {
...
impl ThingTrait for Playground {
...
mod serde {
	...
	impl Serialize for Playground {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Playground", len)?;
	...
	impl<'de> Deserialize<'de> for Playground {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Playground;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Playground")
				}
			...
			deserializer.deserialize_struct("Playground", FIELDS, ClassVisitor)
		}
	}
}
