...
/// This trait is for properties from <https://schema.org/MedicalBusiness>.
pub trait MedicalBusinessTrait {}
impl MedicalBusinessTrait for MedicalBusiness {}
impl LocalBusinessTrait for MedicalBusiness {
...
impl ThingTrait for MedicalBusiness {
...
mod serde {
	...
	use super::*;
	impl Serialize for MedicalBusiness {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "MedicalBusiness", len)?;
	...
	impl<'de> Deserialize<'de> for MedicalBusiness {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = MedicalBusiness;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema MedicalBusiness")
				}
			...
			deserializer.deserialize_struct("MedicalBusiness", FIELDS, ClassVisitor)
		}
	}
}
