...
pub struct LendAction {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "borrower"))]
    #[cfg_attr(feature = "serde", serde(alias = "https://schema.org/borrower"))]
    #[cfg_attr(feature = "serde", serde(alias = "http://schema.org/borrower"))]
    #[cfg_attr(feature = "serde", serde(default))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Vec::is_empty"))]
    #[cfg_attr(
        feature = "serde",
