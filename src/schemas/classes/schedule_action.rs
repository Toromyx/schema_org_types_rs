...
/// This trait is for properties from <https://schema.org/ScheduleAction>.
pub trait ScheduleActionTrait {}
impl ScheduleActionTrait for ScheduleAction {}
...
impl OrganizeActionTrait for ScheduleAction {}
impl PlanActionTrait for ScheduleAction {
...
impl ThingTrait for ScheduleAction {
	...
	impl Serialize for ScheduleAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "ScheduleAction", len)?;
	...
	impl<'de> Deserialize<'de> for ScheduleAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = ScheduleAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema ScheduleAction")
				}
			...
			deserializer.deserialize_struct("ScheduleAction", FIELDS, ClassVisitor)
		}
	}
}
