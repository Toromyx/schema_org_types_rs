...
/// This trait is for properties from <https://schema.org/AchieveAction>.
pub trait AchieveActionTrait {}
impl AchieveActionTrait for AchieveAction {}
...
impl ThingTrait for AchieveAction {
...
mod serde {
	...
	use super::*;
	impl Serialize for AchieveAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "AchieveAction", len)?;
	...
	impl<'de> Deserialize<'de> for AchieveAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = AchieveAction;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema AchieveAction")
				}
			...
			deserializer.deserialize_struct("AchieveAction", FIELDS, ClassVisitor)
		}
	}
}
