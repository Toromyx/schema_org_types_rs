...
/// This trait is for properties from <https://schema.org/CreateAction>.
pub trait CreateActionTrait {}
impl CreateActionTrait for CreateAction {}
...
impl ThingTrait for CreateAction {
	...
	impl Serialize for CreateAction {
			...
			S: Serializer,
		{
			...
			let mut serialize_struct =
				Serializer::serialize_struct(serializer, "CreateAction", len)?;
	...
	impl<'de> Deserialize<'de> for CreateAction {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				...
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema CreateAction")
				}
			...
			deserializer.deserialize_struct("CreateAction", FIELDS, ClassVisitor)
		}
	}
}
