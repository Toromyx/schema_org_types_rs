...
pub trait BookTrait {
	/// Get <https://schema.org/abridged> from [`Self`] as borrowed slice.
	fn get_abridged(&self) -> &[AbridgedProperty];
	/// Take <https://schema.org/abridged> from [`Self`] as owned vector.
	fn take_abridged(&mut self) -> Vec<AbridgedProperty>;
	/// Get <https://schema.org/bookEdition> from [`Self`] as borrowed slice.
	fn get_book_edition(&self) -> &[BookEditionProperty];
	/// Take <https://schema.org/bookEdition> from [`Self`] as owned vector.
	fn take_book_edition(&mut self) -> Vec<BookEditionProperty>;
	/// Get <https://schema.org/bookFormat> from [`Self`] as borrowed slice.
	fn get_book_format(&self) -> &[BookFormatProperty];
	/// Take <https://schema.org/bookFormat> from [`Self`] as owned vector.
	fn take_book_format(&mut self) -> Vec<BookFormatProperty>;
	/// Get <https://schema.org/illustrator> from [`Self`] as borrowed slice.
	fn get_illustrator(&self) -> &[IllustratorProperty];
	/// Take <https://schema.org/illustrator> from [`Self`] as owned vector.
	fn take_illustrator(&mut self) -> Vec<IllustratorProperty>;
	/// Get <https://schema.org/isbn> from [`Self`] as borrowed slice.
	fn get_isbn(&self) -> &[IsbnProperty];
	/// Take <https://schema.org/isbn> from [`Self`] as owned vector.
	fn take_isbn(&mut self) -> Vec<IsbnProperty>;
	/// Get <https://schema.org/numberOfPages> from [`Self`] as borrowed slice.
	fn get_number_of_pages(&self) -> &[NumberOfPagesProperty];
	/// Take <https://schema.org/numberOfPages> from [`Self`] as owned vector.
...
impl CreativeWorkTrait for Book {
...
mod serde {
	...
	impl Serialize for Book {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Book", len)?;
	...
	impl<'de> Deserialize<'de> for Book {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Book;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Book")
				}
			...
			deserializer.deserialize_struct("Book", FIELDS, ClassVisitor)
		}
	}
}
