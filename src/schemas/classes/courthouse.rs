...
/// This trait is for properties from <https://schema.org/Courthouse>.
pub trait CourthouseTrait {}
impl CourthouseTrait for Courthouse {}
impl CivicStructureTrait for Courthouse {
...
impl GovernmentBuildingTrait for Courthouse {}
...
impl ThingTrait for Courthouse {
...
mod serde {
	...
	impl Serialize for Courthouse {
			...
			S: Serializer,
		{
			...
			.iter()
			.sum();
			let mut serialize_struct = Serializer::serialize_struct(serializer, "Courthouse", len)?;
	...
	impl<'de> Deserialize<'de> for Courthouse {
			...
			D: Deserializer<'de>,
		{
			...
			impl<'de> Visitor<'de> for ClassVisitor {
				type Value = Courthouse;
				fn expecting(&self, formatter: &mut Formatter) -> fmt::Result {
					formatter.write_str("schema.org schema Courthouse")
				}
			...
			deserializer.deserialize_struct("Courthouse", FIELDS, ClassVisitor)
		}
	}
}
